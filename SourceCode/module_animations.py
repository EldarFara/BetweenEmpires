...
amf_priority_striked        = 79
amf_priority_impaling       = 80
amf_priority_fall_from_horse= 81
amf_priority_impaled        = 82
amf_priority_die            = 95
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   [9.0, "pistol_stand2", 0, 314, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["stand_crossbow", 0, amf_client_prediction,
   [7.0, "stance_rifle1_1", 0, 110, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [10.0, "stance_rifle1_2", 0, 251, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [12.0, "stance_rifle1_3", 0, 294, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [9.0, "stance_rifle1_4", 0, 225, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [25.0, "stance_rifle1_5", 0, 624, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [9.0, "stance_rifle1_6", 0, 213, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [7.0, "stance_rifle1_7", 0, 134, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [19.0, "stance_rifle1_8", 0, 569, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],
 ],
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [0.8, "alt_run_forward_staff", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "alt_run_forward_staff2", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "alt_run_forward_staff3", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_crossright_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_forward_right_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "alt_run_forward_right_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
...
##   [0.8, "run_crossleft_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_forward_left_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "alt_run_forward_left_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
...
#   [1.0, "anim_human", 7040, 7000, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ...
 ["run_backward_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.7, "alt_run_backward_staff", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "alt_run_backward_staff_right", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "alt_run_backward_staff_left", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [1.0, "anim_human", 6100, 6120, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1, "walk_rifle1_1", 0, 32, arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1, "walk_rifle1_2", 0, 32, arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
["walk_right", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
 ...
 ["stand_to_crouch", acf_enforce_lowerbody, 0,
   [1.3, "crouch_down", 50, 50,  arf_blend_in_1, 0, (0.0,0,0.0)],
 ],
 ["crouch_to_stand", acf_enforce_lowerbody, 0,
   [1.0, "crouch_down", 56, 56,  arf_blend_in_1, 0, (0.0,0,0.0)],
 ],
...
# ],
 ...
 ["lancer_ride_4_no_shield",  acf_enforce_lowerbody | acf_synch_with_horse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
   [0.5, "lancer_ride4_no_shield1", 0, 15, arf_cyclic | arf_blend_in_128], 
   [0.5, "lancer_ride4_no_shield2", 0, 15, arf_cyclic | arf_blend_in_128], 
 ],
...
# duration and controlled via weapon speed.
 ...
 ["ready_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.5, "rifle_aim1", 0, 0, blend_in_ready],
 ],
 ["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_cancel|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.2, "rifle_aim1", 4, 7, arf_blend_in_1],
 ],
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [7, "reload_rifle1", 0, 340, arf_blend_in_8|arf_stick_item_to_left_hand, pack2f(0.40, 0.94)],
    [7, "reload_rifle1b", 0, 640, arf_blend_in_8|arf_stick_item_to_left_hand, pack2f(0.40, 0.94)],
    [7, "reload_rifle1c", 0, 580, arf_blend_in_8|arf_stick_item_to_left_hand, pack2f(0.40, 0.94)],
  ],
 ["reload_crossbow_horseback", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [10, "reload_rifle1", 0, 340, arf_blend_in_8|arf_stick_item_to_left_hand],
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
  ...
  ["ready_pistol", acf_anim_length(100)|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_pistol|amf_keep|amf_client_owner_prediction,
    [0.2, "pistol_aim1", 14, 14, arf_blend_in_8],
  ],
  ["release_pistol", acf_anim_length(100)|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_pistol|amf_play|amf_client_owner_prediction,
    [0.5, "pistol_aim1", 14, 19, arf_blend_in_1],
  ],
  ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [2.25, "reload_pistol2", 0, 13, arf_blend_in_8],
  ],
...
["ready_slash_horseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
 ...
 ["ready_overswing_staff", acf_overswing|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
	[ready_durn, "spear_thrust_overhead", 0, 20, blend_in_ready],
 ],
 ["release_overswing_staff", acf_overswing|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
 	[0.6, "spear_thrust_overhead", 20, 41, blend_in_release],
 ],
 ["release_overswing_staff_continue", acf_rot_vertical_bow, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.3, "spear_thrust_overhead", 41, 52, arf_blend_in_2],
 ],
 ["blocked_overswing_staff", acf_rot_vertical_bow, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [0.3, "spear_thrust_overhead", 26, 22, arf_blend_in_2],
 ],
 ["parried_overswing_staff", acf_rot_vertical_bow, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.3, "spear_thrust_overhead", 26, 22, arf_blend_in_2],
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
  ...
  ["fall_face_hold", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [2.2, "death_face1", 8, 60, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 0.6],
  ],
  ["fall_chest_front", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [1.0, "death_chest1", 4, 37, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.6],
    [1.2, "death_chest2", 1, 37, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.6],
    [2.2, "death_chest3", 8, 55, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.4],
  ],
  ["fall_abdomen_hold_front", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [2.8, "death_abdomen1", 0, 75, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.3],
    [2.7, "death_abdomen2", 5, 96, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 0.5],
  ],
  ["fall_head_front", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4b", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.4],
    [2, "death_generic1", 0, 36, arf_blend_in_16|arf_make_custom_sound,pack2f(0, 0.5), (0, 0, 0), 1.3],
    [2, "death_generic1b", 0, 36, arf_blend_in_16|arf_make_custom_sound,pack2f(0, 0.5), (0, 0, 0), 1.3],
    [2, "death_generic2", 0, 48, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.3],
    [2, "death_generic2b", 0, 48, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.3],
  ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_unarmed", 0, amf_client_prediction,
   [11.0, "crouch_with_melee", 0, 19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["crouch_single", 0, amf_client_prediction,
   [11.0, "crouch_with_melee", 0, 19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["crouch_greatsword", 0, amf_client_prediction,
   [6.0, "crouch_with_melee", 0, 19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ],
 ["crouch_staff", 0, amf_client_prediction,
   [5.0, "parabellum_rifle_stance1_crouch", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ["crouch_crossbow", 0, amf_client_prediction,
   [2.0, "parabellum_rifle_stance1_crouch", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ...
 ["crouch_release_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.5, "crouch_fire_pistol", 12, 21, arf_blend_in_1],
 ],
 ...
 ["reload_musket_two_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [5, "reload_rifle1", 160, 340, arf_blend_in_8|arf_stick_item_to_left_hand],
 ],
 ["reload_musket_one_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [3, "reload_rifle1", 240, 340, arf_blend_in_8|arf_stick_item_to_left_hand],
 ],
 ...
 ["unused_human_anim_44", 0, amf_priority_jump|amf_client_prediction|amf_play|amf_restart,
   [6.0, "stance_rifle2_1", 0, 60, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [6.0, "stance_rifle2_2", 0, 60, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [6.0, "stance_rifle2_3", 0, 60, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [6.0, "stance_rifle2_4", 0, 60, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
 ],
 ["unused_human_anim_45", 0, amf_priority_cancel|amf_play|amf_keep,
   [1, "sentry_stance", 0, 0, arf_blend_in_0], 
 ],
 ["lever_action_shot", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_mount|amf_rider_rot_crossbow|amf_play|amf_client_owner_prediction,
    [0.8, "lever_action_shot", 0, 4, arf_blend_in_1|arf_stick_item_to_left_hand],],
 ["spencer_shot", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_mount|amf_rider_rot_crossbow|amf_play|amf_client_owner_prediction,
  ...
  ["bolt_action_shot", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_mount|amf_rider_rot_crossbow|amf_play|amf_client_owner_prediction,
    [1.7, "bolt_shot", 2, 38, arf_blend_in_1|arf_stick_item_to_left_hand],
  ],
 ...
 ["Yuri_CannonRopePulling_Right", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_use_cycle_period|amf_client_prediction|amf_play,
   [2, "Yuri_CannonRopePulling_Right", 0, 32, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
 ["YuriCancelAnimation", acf_enforce_lowerbody, amf_priority_die|amf_client_prediction|amf_play,
   [0.01, "anim_human", 50, 52, arf_blend_in_0],
 ],
 ["Yuri_CannonBarrelCleaningLeft", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [4.0, "Yuri_CannonBarrelCleaningLeft", 1, 17, arf_blend_in_0],
 ],
 ["Yuri_CannonBarrelCleaningRight", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
 ...
 ["Yuri_CannonRamrodDrop", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [4.0, "Yuri_CannonRamrodPick", 0, 21, arf_blend_in_0],
 ],
 ["Yuri_CannonFuseAdjusting", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [4.0, "reload_pistol2", 0, 5, arf_blend_in_0],
 ],
 ["Yuri_CannonCartridgeInserting", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [2.0, "Yuri_CannonCartridgeInserting", 0, 2, arf_blend_in_0],
 ],
 ["Yuri_CannonRamrodReadyStance", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonRamrodReadyStance", 0, 1, arf_blend_in_0],
 ],
 ["Yuri_CannonAiming", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonAiming", 0, 0, arf_blend_in_0],
 ],
 ["Yuri_CannonEarsPlugging_Left", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonEarsPlugging_Left", 0, 0, arf_blend_in_0],
 ],
 ["Yuri_CannonEarsPlugging_Right", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonEarsPlugging_Right", 0, 0, arf_blend_in_0],
 ],
 ["Yuri_CannonEarsPlugging_Left_Shot", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [0.8, "Yuri_CannonEarsPlugging_Left", 0, 6, arf_blend_in_0],
 ],
 ["Yuri_CannonEarsPlugging_Right_Shot", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [0.8, "Yuri_CannonEarsPlugging_Right", 0, 6, arf_blend_in_0],
 ],
 ["Yuri_CannonLighting", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonLighting", 0, 0, arf_blend_in_0],
 ],
 ["Yuri_CannonLighting_Shot", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [0.25, "Yuri_CannonLighting", 0, 2, arf_blend_in_0],
 ],
 ["Yuri_ImpaledByLance_Front", acf_enforce_all, amf_priority_impaled|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_ImpaledByLance_Front1", 8, 0, arf_blend_in_0],
   [2.0, "Yuri_ImpaledByLance_Front2", 8, 0, arf_blend_in_0],
 ],
 ["Yuri_CouchedLance", acf_enforce_lowerbody|acf_synch_with_horse|acf_rot_vertical_sword, amf_rider_rot_couched_lance|amf_priority_fall_from_horse|amf_use_cycle_period|amf_client_prediction|amf_play,
   [0.5, "Yuri_CouchedLance2", 0, 15, arf_cyclic|arf_blend_in_128], 
 ],
 ["Yuri_ThrowingImpaledOut", acf_enforce_lowerbody|acf_synch_with_horse|acf_rot_vertical_sword, amf_rider_rot_couched_lance|amf_priority_fall_from_horse|amf_client_prediction|amf_play,
   [0.3, "Yuri_ThrowingImpaledOut", 0, 15, arf_blend_in_128], 
 ],
 ["Yuri_ImpaledByLance_Back", acf_enforce_all, amf_priority_impaled|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_ImpaledByLance_Back1", 4, 1, arf_blend_in_0],
 ],
 ["Yuri_CannonOneEarPlugging_Right", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [2.0, "Yuri_CannonOneEarPlugging_Right", 9, 0, arf_blend_in_0],
 ],
 ["Yuri_CannonOneEarPlugging_Right_Shot", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [0.6, "Yuri_CannonOneEarPlugging_Shot_Right", 0, 3, arf_blend_in_0],
 ],
 ["Yuri_CannonCartridgeInsertingBreech", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [2.0, "Yuri_CannonCartridgeInsertingBreech", 0, 1, arf_blend_in_0],
 ],
 ["Yuri_CannonBarrelCleaningBreech", acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [4.0, "Yuri_CannonBarrelCleaningBreech", 1, 17, arf_blend_in_0],
 ],
  ["fanning", acf_rot_vertical_sword, amf_priority_cancel|amf_rider_rot_pistol|amf_restart|amf_keep|amf_client_owner_prediction,
    [0.2, "fanning", 0, 3, arf_blend_in_8],
  ],
  ["fanning_sa", acf_rot_vertical_sword, amf_priority_cancel|amf_rider_rot_pistol|amf_restart|amf_keep|amf_client_owner_prediction,
    [0.6, "fanning_sa", 0, 17, arf_blend_in_8],
  ],
  ["bolt_shot_straightpull", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_mount|amf_rider_rot_crossbow|amf_play|amf_client_owner_prediction,
    [1.7, "bolt_shot_straightpull", 4, 17, arf_blend_in_1|arf_stick_item_to_left_hand],
  ],
 ["prone_rifle_shoot", acf_rot_vertical_bow|acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_continue_to_next,
   [1.5, "prone_rifle1", 0, 16, arf_blend_in_0|arf_stick_item_to_left_hand],
 ],
 ["prone_rifle_idle", acf_rot_vertical_bow|acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
 ...
 ["prone_rifle_reload", acf_rot_vertical_bow|acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [6, "prone_rifle1", 16, 43, arf_blend_in_0|arf_stick_item_to_left_hand],
 ],
 ["walk_forward_staff_2", acf_enforce_all, amf_priority_jump|amf_use_cycle_period|amf_client_prediction,
   ...
   [1, "walk_rifle2_2", 0, 32, arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1, "walk_rifle2_3", 0, 32, arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1, "walk_rifle2_4", 0, 32, arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ...
 ["digging", acf_enforce_all, amf_priority_fall_from_horse|amf_play|amf_client_prediction,
   [2.0, "digging1", 0, 6, arf_cyclic],
   [5.0, "digging2", 0, 125, arf_cyclic],
 ],
 ["mg_shooting1", acf_align_with_ground, amf_priority_mount|amf_keep|amf_restart,
    [0.25, "mg_shooting1", 1, 3, arf_blend_in_1],],
 ["coachman", acf_enforce_all, amf_priority_impaled|amf_play|amf_keep|amf_client_prediction,
   [300, "coachman", 0, 456, arf_cyclic],
 ],
 ["shotgun_shot", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_mount|amf_rider_rot_crossbow|amf_play|amf_client_owner_prediction,
    [0.6, "shotgun_shot", 1, 5, arf_blend_in_1],],
 ["release_lmg", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_mount|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [2, "rifle_aim1", 0, 0, arf_blend_in_1],
 ],
 ["grenade_throw", acf_rot_vertical_bow|acf_enforce_all, amf_priority_mount|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.9, "throwing_grenade_left", 20, 65, arf_blend_in_0],],
  ["bolt_action_shot_fast", acf_anim_length(100)|acf_enforce_all|acf_rot_vertical_bow, amf_priority_equip|amf_rider_rot_crossbow|amf_restart|amf_play|amf_client_owner_prediction,
    [0.5, "bolt_shot", 21, 37, arf_blend_in_1|arf_stick_item_to_left_hand],
  ],
 ["gasmask_wearing", acf_align_with_ground, amf_priority_mount|amf_client_prediction|amf_play,
    [1.2, "gasmask_wearing1", 0, 4, arf_blend_in_1],],
 ["prone_rifle_notarget", acf_rot_vertical_bow|acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_keep|amf_client_prediction,
   [1.5, "prone_rifle2", 0, 0, arf_blend_in_0],
   [1.5, "prone_rifle3", 0, 0, arf_blend_in_0],
 ],
 ["mg_shooting2", acf_align_with_ground, amf_priority_mount|amf_keep|amf_restart,
    [0.25, "mg_shooting2", 1, 3, arf_blend_in_1],],
 ["prone_rifle_noweapon", acf_rot_vertical_bow|acf_enforce_lowerbody, amf_priority_fall_from_horse|amf_play|amf_client_prediction|amf_keep,
   [3.0, "prone_noweapon", 0, 0, arf_blend_in_0|arf_stick_item_to_left_hand],
 ],
