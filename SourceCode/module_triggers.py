...
(call_script, "script_create_alliance_between_factions", ":faction_britain", ":faction_france"),
	...
	(store_add, ":provocation_slot", ":faction_bulgaria", slot_faction_provocation_days_with_factions_begin), (val_sub, ":provocation_slot", kingdoms_begin),
	(faction_set_slot, ":faction_greece", ":provocation_slot", 60),
	...
	(faction_set_slot, ":faction_bulgaria", ":provocation_slot", 60),
	(store_add, ":provocation_slot", ":faction_austria", slot_faction_provocation_days_with_factions_begin), (val_sub, ":provocation_slot", kingdoms_begin),
	(faction_set_slot, ":faction_romania", ":provocation_slot", 60),
(set_relation, ":faction_bulgaria", ":faction_austria", 45),
(set_relation, ":faction_bulgaria", ":faction_germany", 45),
(set_relation, ":faction_turkey", ":faction_austria", 45),
(set_relation, ":faction_turkey", ":faction_germany", 45),
(set_relation, ":faction_romania", ":faction_russia", 45),
(set_relation, ":faction_romania", ":faction_britain", 45),
(set_relation, ":faction_romania", ":faction_france", 45),
(set_relation, ":faction_romania", ":faction_serbia", 45),
(set_relation, ":faction_romania", ":faction_italy", 45),
(set_relation, ":faction_italy", ":faction_russia", 45),
(set_relation, ":faction_italy", ":faction_britain", 45),
(set_relation, ":faction_italy", ":faction_france", 45),
(set_relation, ":faction_italy", ":faction_serbia", 45),
(set_relation, ":faction_italy", ":faction_italy", 45),
]),
