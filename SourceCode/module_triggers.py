...
(assign, ":music_situation", mtf_culture_westeurope),
	...
	(store_faction_of_party, ":faction", ":center_no"),
		...
		(store_distance_to_party_from_party, ":party_distance", "p_main_party", ":center_no"),
		(lt, ":party_distance", 20),
		(assign, ":music_situation", mtf_culture_spain),
		(try_end),
		(try_begin),
		...
		(store_distance_to_party_from_party, ":party_distance", "p_main_party", ":center_no"),
		(lt, ":party_distance", 20),
		(assign, ":music_situation", mtf_culture_italy),
		(try_end),
		(try_begin),
...
(is_between, ":hours", 3, 100),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_1"),
	(assign, ":faction_france", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_france", "fac_kingdom_1"),
	(try_end),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_5"),
	(assign, ":faction_germany", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_germany", "fac_kingdom_5"),
	(try_end),
(store_relation, ":relation", ":faction_germany", ":faction_france"),
(lt, ":relation", -1),
], [
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_26"),
	(assign, ":faction_belgium", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_belgium", "fac_kingdom_26"),
	(try_end),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_5"),
	(assign, ":faction_germany", "fac_player_supporters_faction"),
	...
	(assign, ":faction_germany", "fac_kingdom_5"),
	(try_end),
(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_germany", ":faction_belgium", 1),
]),
...
(is_between, ":hours", 3, 100),
	...
	(assign, ":faction_britain", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_britain", "fac_kingdom_7"),
	(try_end),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_5"),
	(assign, ":faction_germany", "fac_player_supporters_faction"),
	...
	(assign, ":faction_germany", "fac_kingdom_5"),
	(try_end),
(store_relation, ":relation", ":faction_germany", ":faction_britain"),
(lt, ":relation", -1),
], [
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_26"),
	...
	(assign, ":faction_italy", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_italy", "fac_kingdom_4"),
	(try_end),
	(try_begin),
	...
	(try_end),
(call_script, "script_create_alliance_between_factions", ":faction_belgium", ":faction_russia"),
(call_script, "script_create_alliance_between_factions", ":faction_belgium", ":faction_serbia"),
(call_script, "script_create_alliance_between_factions", ":faction_belgium", ":faction_britain"),
(call_script, "script_create_alliance_between_factions", ":faction_belgium", ":faction_france"),
(call_script, "script_create_alliance_between_factions", ":faction_russia", ":faction_belgium"),
(call_script, "script_create_alliance_between_factions", ":faction_russia", ":faction_serbia"),
(call_script, "script_create_alliance_between_factions", ":faction_russia", ":faction_britain"),
(call_script, "script_create_alliance_between_factions", ":faction_russia", ":faction_france"),
(call_script, "script_create_alliance_between_factions", ":faction_serbia", ":faction_belgium"),
(call_script, "script_create_alliance_between_factions", ":faction_serbia", ":faction_russia"),
(call_script, "script_create_alliance_between_factions", ":faction_serbia", ":faction_britain"),
(call_script, "script_create_alliance_between_factions", ":faction_serbia", ":faction_france"),
(call_script, "script_create_alliance_between_factions", ":faction_britain", ":faction_belgium"),
(call_script, "script_create_alliance_between_factions", ":faction_britain", ":faction_russia"),
(call_script, "script_create_alliance_between_factions", ":faction_britain", ":faction_serbia"),
(call_script, "script_create_alliance_between_factions", ":faction_britain", ":faction_france"),
	(store_add, ":provocation_slot", ":faction_austria", slot_faction_provocation_days_with_factions_begin), (val_sub, ":provocation_slot", kingdoms_begin),
	(faction_set_slot, ":faction_italy", ":provocation_slot", 60),
	(store_add, ":provocation_slot", ":faction_russia", slot_faction_provocation_days_with_factions_begin), (val_sub, ":provocation_slot", kingdoms_begin),
	(faction_set_slot, ":faction_turkey", ":provocation_slot", 60),
]),
