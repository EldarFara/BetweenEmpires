...
skills = [
  ...
  ("reserved_2","Desperate Stand",sf_base_att_cha|sf_inactive,10,"NOEFFECT When company discipline level drops below retreat limit, it will wait for some time before retreating. If discipline level returned to level above retreat limit after waiting time is over, company won't retreat. The time they will wait increases by 0.3 seconds per skill level. (Leader skill)"), 
