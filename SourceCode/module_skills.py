...
skills = [
  ...
  ("reserved_1","Captain",sf_base_att_cha,10,"Increases discipline level of all companies that are close to player by 1%% per skill level. Area of discipline bonus is 20 meters and increases by 3 meters by skill level. (Leader skill)"), 
  ("reserved_2","Desperate Stand",sf_base_att_cha,10,"NOEFFECT When company discipline level drops below retreat limit, it will wait for some time before retreating. If discipline level returned to level above retreat limit after waiting time is over, company won't retreat. The time they will wait increases by 0.3 seconds per skill level. (Leader skill)"), 
  ("reserved_3","Inspirer",sf_base_att_cha,10,"Decreases retreat limit (the percentage of discipline, above of which company will retreat) by 1%% per skill level. Default retreat limit is 15%%. (Leader skill)"), 
