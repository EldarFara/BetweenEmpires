...
skills = [
  ...
  ("reserved_1","Captain",sf_base_att_cha,10,"Increases discipline level of company closest to player by 1%% per skill level, but only if that company is within 20 meters range to player. (Leader skill)"), 
