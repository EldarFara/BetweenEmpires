...
skills = [
  ...
  ("reserved_1","Captain",sf_base_att_cha,10,"NOEFFECT Increases discipline level of all companies that are close to player by 1%% per skill level. Area of discipline bonus is 20 meters and increases by 2 meter by skill level. (Leader skill)"), 
  ("reserved_2","Inspirer",sf_base_att_cha,10,"NOEFFECT When company discipline level drops below retreat limit, it will wait for some time before retreating. If discipline level returned to level above retreat limit after waiting time is over, company won't retreat. The time they will wait increases by 0.3 seconds per skill level. (Leader skill)"), 
  ("reserved_3","Desperate Stand",sf_base_att_cha,10,"NOEFFECT Decreases retreat limit (the percentage of discipline, above of which company will retreat) by 1%% per skill level. Default retreat limit is 15%%. (Leader skill)"), 
  ...
  ("shield","Shield",sf_base_att_agi|sf_inactive,10,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)"),
  ...
  ("power_throw","Power Throw",sf_base_att_str|sf_inactive,10,"Each point to this skill increases throwing damage by 10%%. (Personal skill)"),
