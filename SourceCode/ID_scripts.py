...
script_store_company_average_position_to_pos = 626
script_rotate_pos31_towards_pos30 = 627
script_store_average_coordinates_of_infantry_in_attack_formation_in_pos30 = 628
script_store_mouse_projection_to_pos3 = 629
script_store_highest_position_around_pos30_into_pos31 = 630
script_player_team_form_square = 631
script_troop_tree_recursive_backtracking = 632
script_troop_tree_recursive_detect_max_tier = 633
script_prsnt_line = 634
script_get_page_no_of_troop_tree_for_troop_on = 635
script_prsnt_upgrade_tree_troop_and_name = 636
script_prsnt_upgrade_tree_troop_cost = 637
script_prsnt_lines = 638
script_get_custom_troop_info = 639
script_store_custom_troop_info_to_slot = 640
script_clear_array = 641
script_custom_troop_button_action = 642
script_custom_troop_inventory_initialization = 643
script_custom_troop_inventory_reset = 644
script_custom_troop_inventory_change = 645
script_custom_troop_inventory_total_price = 646
script_custom_troop_inventory_total_weight = 647
script_custom_troop_item_judge = 648
script_set_custom_troop_pionts_initialization = 649
script_player_faction_troops = 650
script_item_detial = 651
script_rotate_pos31_towards_pos30_xy = 652
script_rotate_pos31_towards_pos30_yz = 653
script_turn_pos_towards_pos = 654
script_yuri_posalligntogroundlevel = 655
script_yuri_posalligntoterrainlevel = 656
script_cf_yurispawncannon = 657
script_yuri_getaveragepos = 658
script_cf_yuri_didcannoneerarriveathisposition = 659
script_yuri_cannoneerapplyramrodstance = 660
script_cf_yuri_isagentalive = 661
script_get_cannoneer_officer_faction_cannon_he_type = 662
script_get_cannoneer_officer_faction_cannon_rifling_type = 663
script_get_cannoneer_officer_faction_cannon_projectile_type = 664
script_cf_get_agent_faction_rifle_type = 665
script_explode_at_pos = 666
script_initialize_factions_technology_and_presets = 667
script_yurigetangleforhowitzeraiming = 668
script_yuribatteryholdposition = 669
script_cf_if_party_has_low_cannons_amount = 670
script_get_company_soldiers_number = 671
script_company_hold_pos30_defensive_line = 672
script_set_item_merchandise_probabilities_according_to_current_year = 673
script_cf_pts_check_tech_availability = 674
script_pts_create_tech_button = 675
script_pts_create_selected_tech_name = 676
script_pts_create_selected_tech_description = 677
script_cf_if_agent_faction_invented_technology = 678
script_cf_if_party_faction_invented_technology = 679
script_set_player_kingdom_init = 680
script_play_distant_sound_at_pos_based_on_distance = 681
script_reset_companies_accuracy = 682
script_cf_if_team_has_artillery_shells = 683
script_team_consume_artillery_shell = 684
script_cf_if_team_faction_uses_volley_fire = 685
script_cf_if_team_faction_invented_technology = 686
script_cf_random = 687
script_change_faction_flag = 688
script_cf_current_sky_can_rain = 689
script_cf_yuricannoncanoneersretreat = 690
script_cf_get_agent_faction_flag_material = 691
script_shotgun_shot = 692
script_cf_get_party_faction_flag_material = 693
script_cf_current_sky_has_no_direct_sunlight = 694
script_cf_item_can_be_used_by_custom_troop = 695
script_walled_centers_assign_closest_centers = 696
script_cf_if_center_borders_a_faction_by_land = 697
script_cf_if_center_borders_a_faction = 698
script_cf_if_faction_has_access_to_sea = 699
script_cf_if_faction_borders_a_faction = 700
script_cf_if_faction_borders_a_faction_by_land = 701
script_async_randomly_start_war_peace_new = 702
script_init_preset_wars = 703
script_faction_annex_faction = 704
script_remove_lord_from_game = 705
script_get_strength_modifier_for_faction_by_technologies = 706
script_async_init_ai_calculation = 707
script_async_recalculate_ais = 708
script_create_random_provocation = 709
script_create_random_relation_increasing = 710
script_create_random_alliance = 711
script_faction_change_infamy = 712
script_cf_peace_negotiations_if_center_can_appear_in_the_list = 713
script_peace_negotiations_add_center = 714
script_cf_peace_negotiations_if_center_is_of_allies = 715
script_cf_peace_negotiations_if_center_is_of_enemies = 716
script_cf_peace_negotiations_if_faction_is_ally = 717
script_cf_peace_negotiations_if_faction_is_enemy = 718
script_peace_negotiations_detect_allies_and_enemies = 719
script_peace_negotiations_calculate_victory_points = 720
script_peace_negotiations_enemy_rethink = 721
script_peace_negotiations_calculate_infamy_cost = 722
script_create_alliance_between_factions = 723
script_cf_if_faction_decides_to_support_ally_against_enemy = 724
script_break_alliance_between_factions = 725
script_cf_if_faction_is_in_alliance_with_faction = 726
script_faction_calculate_power = 727
script_async_calculate_castle_prosperities_by_using_its_villages = 728
script_cf_get_faction_rifle_type = 729
script_get_company_foramtion_discipline_penalty_multiplier = 730
script_copmany_decide_prone_or_crouch = 731
script_pai_siege_defender_take_cover = 732
script_pai_find_teams_company_closest_to_pos = 733
script_cf_if_company_has_no_soldiers = 734
script_pps_init = 735
script_get_slot_pvol_of_party = 736
script_get_slot_pvol_of_class = 737
script_get_slot_class_support_of_party = 738
script_get_slot_influence_of_party = 739
script_get_slot_political_activity_of_class = 740
script_get_slot_wealth_of_class = 741
script_get_slot_name_of_party = 742
script_get_slot_desc_of_party = 743
script_get_slot_places_in_parliament_of_party = 744
script_get_color_of_political_party = 745
script_get_slot_conservatism_of_party = 746
script_get_slot_places_in_executivebranch_of_party = 747
script_pps_calculate_faction_class_support_of_party = 748
script_pps_calculate_faction_class_political_activity = 749
script_pps_calculate_faction_party_influence = 750
script_pps_faction_parliament_election = 751
script_pps_faction_executivebranch_election = 752
script_pps_menu_display_faction = 753
script_pps_faction_iteration = 754
script_pes_create_factory_in_center = 755
script_pes_open_factory_in_center = 756
script_pes_center_iteration = 757
script_pes_center_villages_iteration = 758
script_pes_center_factory_iteration = 759
script_pes_find_and_buy_resource = 760
script_pes_employ_workers = 761
script_pes_employ_workers_initial = 762
script_pes_init = 763
script_company_play_vo = 764
script_company_decide_play_vo = 765
script_company_digin = 766
script_cf_if_agent_is_in_trench = 767
script_mg_spawn = 768
script_mg_deploy = 769
script_mg_undeploy = 770
script_mg_decide_fire = 771
script_mg_fire = 772
script_add_penaltytodiscipline_fromfire_to_target_of_agent = 773
script_faction_get_machineguns = 774
script_cf_if_party_has_low_mg_amount = 775
script_faction_calculate_pps_pes_slots = 776
script_pss_init = 777
script_pss_agent_iteration = 778
script_pes_region_menu_display_region = 779
script_get_factory_name_and_photo_for_type = 780
script_get_resource_measure_string_for_type = 781
script_pes_resource_bought = 782
script_pes_center_factory_decide_fire_workers = 783
script_pes_center_population_buy_resources = 784
script_pes_iteration_start = 785
script_get_resource_name_for_type_capitalized = 786
script_pes_resource_menu_display_resource = 787
script_pes_resource_is_produced_by_center = 788
script_pes_resource_is_demanded_by_center = 789
script_get_factory_description_for_type = 790
script_pes_produce_handicraft_resource_in_center = 791
script_pes_center_decide_build_factory = 792
script_pes_iteration_start_reshuffle = 793
script_pes_iteration_start_oversea_supply = 794
script_pes_iteration_start_prices_change = 795
script_pes_center_build_factories = 796
script_pes_center_change_population_literacy_urbanization = 797
script_cf_pps_will_law_bill_succeed_in_faction = 798
script_pps_calculate_faction_classes_wealth = 799
script_pps_get_bonus_party_support_for_class = 800
script_pps_faction_calculate_budget = 801
script_pes_iteration_start_faction_taxes = 802
script_pps_faction_calculate_corruption_level = 803
script_cf_pai_if_team_timer_is_more_than_zero = 804
script_cf_pai_if_team_timer_is_zero = 805
script_pai_tick_team_timer = 806
script_pai_set_team_timer = 807
script_cf_pai_if_team_global_tactic_is_value = 808
script_pai_team_set_global_tactic = 809
script_pai_set_up_attack_according_to_preset = 810
script_pai_attack_group_set_position = 811
script_pai_attack_group_charge = 812
script_cf_pai_attack_group_get_lead_company = 813
