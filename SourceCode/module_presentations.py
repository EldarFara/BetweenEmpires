...
(ti_on_presentation_load,
	...
	(call_script,"script_pts_create_tech_button", slot_faction_technology_woundedevacuation, 10), (assign, "$g_faction_technologies_tech_woundedevacuation", reg1),
	...
	(position_set_x, pos1, 209), (position_set_y, pos1, 400), (str_store_string, s1, "@Four-battalion^^Regiments"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 400), (str_store_string, s1, "@Improved Shell^^Percussion Mechanism"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 100), (str_store_string, s1, "@Improved Combat^^Logistics"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_improvedlogistics, 8), (assign, "$g_faction_technologies_tech_improvedlogistics", reg1),
