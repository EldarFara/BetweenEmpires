...
("pps_menu", 0, mesh_load_window2, [
	...
	(create_slider_overlay, "$overlay_slider_law_income_law", 1, 100),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_slider_law_income_law", pos1),
	...
	(create_slider_overlay, "$overlay_slider_law_goodsservices_law", 1, 100),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_slider_law_goodsservices_law", pos1),
	...
	(create_slider_overlay, "$overlay_slider_law_importexport_law", 1, 100),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_slider_law_importexport_law", pos1),
	...
	(store_trigger_param_2, ":value"),
		...
		(eq, ":object", "$overlay_slider_law_income_law"),
			...
			(call_script, "script_pps_calculate_balance_from_law_in_faction", law_income_tax, ":value", "$pps_menu_selected_faction"), (assign, reg10, reg1),
		...
		(eq, ":object", "$overlay_slider_law_importexport_law"),
			...
			(assign, reg10, ":value"),
			(overlay_set_text, "$overlay_text_law_importexport_law", "@Import/Export tax: {reg10}%", tf_center_justify),
