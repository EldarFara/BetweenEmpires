...
(ti_on_presentation_event_state_change,
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2500000), (assign, "$g_faction_technologies_selected_tech_date", 1856),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1900),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2500000), (assign, "$g_faction_technologies_selected_tech_date", 1890),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1856),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 3500000), (assign, "$g_faction_technologies_selected_tech_date", 1865),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 3000000), (assign, "$g_faction_technologies_selected_tech_date", 1900),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1910),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 3500000), (assign, "$g_faction_technologies_selected_tech_date", 1870),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1870),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 3000000), (assign, "$g_faction_technologies_selected_tech_date", 1880),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1880),
	(else_try),
	...
	(assign, "$g_faction_technologies_selected_tech_cost", 2000000), (assign, "$g_faction_technologies_selected_tech_date", 1890),
	(try_end),
...
("pps_menu", 0, mesh_load_window2, [
	...
	(position_set_x, pos1, 150), (position_set_y, pos1, 620), (overlay_set_position, "$overlay_text_parliament_composition", pos1),
	...
	(position_set_x, pos1, 150), (position_set_y, pos1, 565), (overlay_set_position, "$overlay_text_executive_branch_composition", pos1),
	...
	(create_mesh_overlay, "$overlay_mesh_law_child_labor", "mesh_pps_law_card"),
	(position_set_x, pos1, 630), (position_set_y, pos1, 80), (overlay_set_position, "$overlay_mesh_law_child_labor", pos1),
	(create_text_overlay, "$overlay_text_law_child_labor", "@Child Labor", tf_center_justify),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_child_labor", pos1),
	(position_set_x, pos1, 630), (position_set_y, pos1, 100), (overlay_set_position, "$overlay_text_law_child_labor", pos1),
	(create_button_overlay, "$overlay_text_law_child_labor_short", "@Allowed"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_child_labor_short", pos1),
	(position_set_x, pos1, 575), (position_set_y, pos1, 85), (overlay_set_position, "$overlay_text_law_child_labor_short", pos1),
	(create_button_overlay, "$overlay_text_law_child_labor_allowed", "@Restrictions"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_child_labor_allowed", pos1),
	(position_set_x, pos1, 575), (position_set_y, pos1, 75), (overlay_set_position, "$overlay_text_law_child_labor_allowed", pos1),
	(create_button_overlay, "$overlay_text_law_child_labor_allowed", "@Outlawed"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_child_labor_allowed", pos1),
	(position_set_x, pos1, 575), (position_set_y, pos1, 65), (overlay_set_position, "$overlay_text_law_child_labor_allowed", pos1),
...
(val_sub, reg2, 40),
(val_mul, reg2, 25),
(store_mod, reg3, reg2, 100), (val_div, reg2, 100),
...
(create_text_overlay, "$overlay_text_army_size_satisfaction_penalty", "@-{reg2}.{reg3}% to quality of life", tf_left_align),
(position_set_x, pos1, 800), (position_set_y, pos1, 800), (overlay_set_size, "$overlay_text_army_size_satisfaction_penalty", pos1),
(position_set_x, pos1, 700), (position_set_y, pos1, 610), (overlay_set_position, "$overlay_text_army_size_satisfaction_penalty", pos1),
...
(position_set_x, pos1, 500), (position_set_y, pos1, 310), (overlay_set_position, "$overlay_text_battle_efficiency_value", pos1),
	...
	(store_trigger_param_2, ":value"),
		...
		(val_mul, reg2, 25),
		(store_mod, reg3, reg2, 100), (val_div, reg2, 100),
		(overlay_set_text, "$overlay_text_army_size_satisfaction_penalty", "@-{reg2}.{reg3}% to quality of life"),
		(try_end),
