...
##        (overlay_set_color, reg1, 0),
        ...
        (assign, reg0, ":wealth"),
        (create_text_overlay, reg1, "@Wealth: {reg0} pounds", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
        ...
        (create_text_overlay, reg1, "@Inventory: {reg0} pounds", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
 ...
 ("prebattle_custom_deployment", 0, mesh_load_window2, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_text_overlay, "$prebattle_menu_deployment_plan_text", "@Deployment Plan", tf_center_justify|tf_single_line),
      (position_set_x, pos1, 1700),
      (position_set_y, pos1, 1700),
      (overlay_set_size, "$prebattle_menu_deployment_plan_text", pos1),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 690),
      (overlay_set_position, "$prebattle_menu_deployment_plan_text", pos1),

	  (party_get_slot, ":round_size", "p_main_party", slot_party_prebattle_size_in_battle),
	  (party_get_num_companions, ":round_size", "p_main_party"),
	  (val_sub, ":round_size", 1),
	  (party_set_slot, "p_main_party", slot_party_prebattle_size_in_battle, ":round_size"),
	  (assign, reg1, ":round_size"),
	  (create_text_overlay, reg0, "@You have {reg1} combatants available.", tf_center_justify|tf_single_line),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 650),
      (overlay_set_position, reg0, pos1),
	  
      (create_text_overlay, reg0, "@Combatant",  tf_center_justify),
	  ...
	  (store_mul, ":cur_y", ":num_of_stacks", ":cur_y_adder"),
		...
		(create_text_overlay, reg60, "@{reg0}", 0),
		(try_begin), 		
		...
		(create_text_overlay, reg0, "@of {reg0} combatants", 0),
      ...
      (create_game_button_overlay, "$g_presentation_obj_custom_battle_designer_20", "@All to max", 0),
      (position_set_x, pos1, 722),
      (position_set_y, pos1, 15),
      (overlay_set_position, "$g_presentation_obj_custom_battle_designer_20", pos1),
	  
	  (create_game_button_overlay, "$g_presentation_obj_custom_battle_designer_18", "@All to zero", 0),
	...
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text2", "@1st"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 567),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text2", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text3", "@2nd"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 527),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text3", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text4", "@3rd"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 487),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text4", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text5", "@4th"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 447),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text5", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text6", "@5th"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 407),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text6", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text7", "@6th"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 367),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text7", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text8", "@7th"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 327),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text8", pos1),
	(create_text_overlay, "$prebattle_menu_autocompanyassignment_text9", "@8th"),
	(position_set_x, pos1, 627), 
	(position_set_y, pos1, 287),
	(overlay_set_position, "$prebattle_menu_autocompanyassignment_text9", pos1),
	(position_set_x, pos1, 1000),
	(position_set_y, pos1, 1000),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text2", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text3", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text4", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text5", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text6", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text7", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text8", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text9", pos1),
	(create_combo_button_overlay, "$prebattle_menu_company1_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 560),
	(overlay_set_position, "$prebattle_menu_company1_type", pos1),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company1_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company2_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 520),
	(overlay_set_position, "$prebattle_menu_company2_type", pos1),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company2_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company3_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 480),
	(overlay_set_position, "$prebattle_menu_company3_type", pos1),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company3_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company4_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 440),
	(overlay_set_position, "$prebattle_menu_company4_type", pos1),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company4_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company5_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 400),
	(overlay_set_position, "$prebattle_menu_company5_type", pos1),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company5_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company6_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 360),
	(overlay_set_position, "$prebattle_menu_company6_type", pos1),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company6_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company7_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 320),
	(overlay_set_position, "$prebattle_menu_company7_type", pos1),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company7_type", "@Line Infantry Company   "),
	(create_combo_button_overlay, "$prebattle_menu_company8_type"),
	(position_set_x, pos1, 788), 
	(position_set_y, pos1, 280),
	(overlay_set_position, "$prebattle_menu_company8_type", pos1),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Disabled                            "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Howitzers Battery                "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Field Guns Battery               "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Guards Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Mounted Rifles Company   "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Melee Cavalry Company   "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Guard Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Light Infantry Company    "),
	(overlay_add_item, "$prebattle_menu_company8_type", "@Line Infantry Company   "),
	(position_set_x, pos1, 1000),
	(position_set_y, pos1, 1000),
	(overlay_set_size, "$prebattle_menu_company1_type", pos1),
	(overlay_set_size, "$prebattle_menu_company2_type", pos1),
	(overlay_set_size, "$prebattle_menu_company3_type", pos1),
	(overlay_set_size, "$prebattle_menu_company4_type", pos1),
	(overlay_set_size, "$prebattle_menu_company5_type", pos1),
	(overlay_set_size, "$prebattle_menu_company6_type", pos1),
	(overlay_set_size, "$prebattle_menu_company7_type", pos1),
	(overlay_set_size, "$prebattle_menu_company8_type", pos1),
	(position_set_x, pos1, 930),
	(position_set_y, pos1, 930),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text2", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text3", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text4", pos1),
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text5", pos1),
	...
	(overlay_set_size, "$prebattle_menu_autocompanyassignment_text9", pos1),
	(try_begin),
	(overlay_set_val, "$prebattle_menu_company1_type", 6),
	(overlay_set_val, "$prebattle_menu_company2_type", 0),
	(overlay_set_val, "$prebattle_menu_company3_type", 0),
	(overlay_set_val, "$prebattle_menu_company4_type", 0),
	(overlay_set_val, "$prebattle_menu_company5_type", 0),
	(overlay_set_val, "$prebattle_menu_company6_type", 0),
	(overlay_set_val, "$prebattle_menu_company7_type", 0),
	(overlay_set_val, "$prebattle_menu_company8_type", 0),
		(try_begin),
		(eq, "$player_company1_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company1_type", 8),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company1_type", 7),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company1_type", 6),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company1_type", 5),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company1_type", 4),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company1_type", 3),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company1_type", 2),
		(else_try),
		(eq, "$player_company1_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company1_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company2_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company2_type", 8),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company2_type", 7),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company2_type", 6),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company2_type", 5),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company2_type", 4),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company2_type", 3),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company2_type", 2),
		(else_try),
		(eq, "$player_company2_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company2_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company3_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company3_type", 8),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company3_type", 7),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company3_type", 6),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company3_type", 5),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company3_type", 4),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company3_type", 3),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company3_type", 2),
		(else_try),
		(eq, "$player_company3_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company3_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company4_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company4_type", 8),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company4_type", 7),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company4_type", 6),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company4_type", 5),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company4_type", 4),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company4_type", 3),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company4_type", 2),
		(else_try),
		(eq, "$player_company4_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company4_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company5_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company5_type", 8),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company5_type", 7),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company5_type", 6),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company5_type", 5),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company5_type", 4),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company5_type", 3),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company5_type", 2),
		(else_try),
		(eq, "$player_company5_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company5_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company6_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company6_type", 8),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company6_type", 7),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company6_type", 6),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company6_type", 5),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company6_type", 4),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company6_type", 3),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company6_type", 2),
		(else_try),
		(eq, "$player_company6_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company6_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company7_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company7_type", 8),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company7_type", 7),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company7_type", 6),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company7_type", 5),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company7_type", 4),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company7_type", 3),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company7_type", 2),
		(else_try),
		(eq, "$player_company7_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company7_type", 1),
		(try_end),
		(try_begin),
		(eq, "$player_company8_type", pbs_troop_type_line),
		(overlay_set_val, "$prebattle_menu_company8_type", 8),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_light),
		(overlay_set_val, "$prebattle_menu_company8_type", 7),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_guard),
		(overlay_set_val, "$prebattle_menu_company8_type", 6),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_cavmelee),
		(overlay_set_val, "$prebattle_menu_company8_type", 5),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_cavranged),
		(overlay_set_val, "$prebattle_menu_company8_type", 4),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_cavguard),
		(overlay_set_val, "$prebattle_menu_company8_type", 3),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_fieldguns),
		(overlay_set_val, "$prebattle_menu_company8_type", 2),
		(else_try),
		(eq, "$player_company8_type", pbs_troop_type_howitzers),
		(overlay_set_val, "$prebattle_menu_company8_type", 1),
		(try_end),
	(try_end),
      ]),
	...
	(try_begin), #company types
	(eq, ":object", "$prebattle_menu_company1_type"),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company1_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company1_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company1_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company1_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company1_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company1_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company1_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company1_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(overlay_set_val, ":object", 8),
		(assign, "$player_company1_type", pbs_troop_type_line),
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company2_type"),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company2_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company2_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company2_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company2_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company2_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company2_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company2_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company2_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company2_type", 0),
		(assign, "$player_company3_type", 0),
		(assign, "$player_company4_type", 0),
		(assign, "$player_company5_type", 0),
		(assign, "$player_company6_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company3_type"),
		(try_begin),
		(eq, "$player_company2_type", 0),
		(overlay_set_val, "$prebattle_menu_company3_type", 0),
		(try_end),
	(neq, "$player_company2_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company3_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company3_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company3_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company3_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company3_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company3_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company3_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company3_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company3_type", 0),
		(assign, "$player_company4_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company4_type"),
		(try_begin),
		(eq, "$player_company3_type", 0),
		(overlay_set_val, "$prebattle_menu_company4_type", 0),
		(try_end),
	(neq, "$player_company3_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company4_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company4_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company4_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company4_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company4_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company4_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company4_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company4_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company4_type", 0),
		(assign, "$player_company5_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company5_type"),
		(try_begin),
		(eq, "$player_company4_type", 0),
		(overlay_set_val, "$prebattle_menu_company5_type", 0),
		(try_end),
	(neq, "$player_company4_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company5_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company5_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company5_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company5_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company5_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company5_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company5_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company5_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company5_type", 0),
		(assign, "$player_company6_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company6_type"),
		(try_begin),
		(eq, "$player_company5_type", 0),
		(overlay_set_val, "$prebattle_menu_company6_type", 0),
		(try_end),
	(neq, "$player_company5_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company6_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company6_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company6_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company6_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company6_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company6_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company6_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company6_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company6_type", 0),
		(assign, "$player_company7_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company7_type"),
		(try_begin),
		(eq, "$player_company6_type", 0),
		(overlay_set_val, "$prebattle_menu_company7_type", 0),
		(try_end),
	(neq, "$player_company6_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company7_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company7_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company7_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company7_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company7_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company7_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company7_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company7_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company7_type", 0),
		(assign, "$player_company8_type", 0),
		...
		(try_end),
	(else_try),
	(eq, ":object", "$prebattle_menu_company8_type"),
		(try_begin),
		(eq, "$player_company7_type", 0),
		(overlay_set_val, "$prebattle_menu_company8_type", 0),
		(try_end),
	(neq, "$player_company7_type", 0),
		(try_begin),
		(eq, ":value", 8),
		(assign, "$player_company8_type", pbs_troop_type_line),
		(else_try),
		(eq, ":value", 7),
		(assign, "$player_company8_type", pbs_troop_type_light),
		(else_try),
		(eq, ":value", 6),
		(assign, "$player_company8_type", pbs_troop_type_guard),
		(else_try),
		(eq, ":value", 5),
		(assign, "$player_company8_type", pbs_troop_type_cavmelee),
		(else_try),
		(eq, ":value", 4),
		(assign, "$player_company8_type", pbs_troop_type_cavranged),
		(else_try),
		(eq, ":value", 3),
		(assign, "$player_company8_type", pbs_troop_type_cavguard),
		(else_try),
		(eq, ":value", 2),
		(assign, "$player_company8_type", pbs_troop_type_fieldguns),
		(else_try),
		(eq, ":value", 1),
		(assign, "$player_company8_type", pbs_troop_type_howitzers),
		(else_try),
		(eq, ":value", 0),
		(assign, "$player_company8_type", 0),
		(try_end),
	(try_end),
	   	...
	   	(try_begin), #Buttons
			(eq, ":object", "$g_presentation_obj_custom_battle_designer_20"), #All to max
			(assign, ":in_count", 0),
			(party_get_num_companion_stacks, ":num_of_stacks", "p_main_party"),
		    (try_for_range, ":i", 0, ":num_of_stacks"),
			    (party_stack_get_troop_id, ":troop_id", "p_main_party", ":i"),
			    ...
			    (troop_set_slot, ":troop_id", slot_troop_prebattle_first_round, ":stack_size"),
			    (overlay_set_val, ":overlay_id", ":stack_size"),
				(val_add, ":in_count", ":stack_size"),
		    (try_end),
			(party_set_slot, "p_main_party", slot_party_prebattle_in_battle_count, ":in_count"),
			(assign, reg1, ":in_count"),
			(overlay_set_text, reg60, "@{reg1}"),
		(else_try),
		    (eq, ":object", "$g_presentation_obj_custom_battle_designer_18"), #All to zero
			(party_get_num_companion_stacks, ":num_of_stacks", "p_main_party"),
		    (try_for_range, ":i", 0, ":num_of_stacks"),
			    (party_stack_get_troop_id, ":troop_id", "p_main_party", ":i"),
			    (neq, ":troop_id", "trp_player"),
		...
		(else_try),
		    (eq, ":object", "$g_presentation_obj_custom_battle_designer_19"), #Done
...
will be merged into one that has highest number of soldiers."),
	(try_begin),
	(faction_slot_ge, "fac_player_supporters_faction", slot_faction_technology_adaptivetraining, 10000),
	(val_add, ":x_activeability", 35),
	(position_set_x, pos1, 1000), (position_set_y, pos1, 1000),
	...
	(overlay_set_tooltip, "$menu_pbs_activeability_digin", "@\Dig In^^Selected companies will dig in,^creating trenches on their position.^Company types: Line infantry, Guard."),
	(try_end),
(presentation_set_duration, 999999),
]),
...
(store_trigger_param_1, ":object"),
	...
	(assign, ":types_are_ok", 1),
		...
		(try_begin),
		(eq, ":types_are_ok", 0),
		(display_message, "@Cannot dig in: wrong company types (only line infantry and guard inantry can dig in)."),
		(try_end),
	(eq, ":types_are_ok", 1),
		(try_for_range, ":company", 0, 8),
		(class_is_listening_order, "$g_player_team", ":company"),
  ...
  ("custom_kingdom_troop", 0, mesh_load_window2, [
    (ti_on_presentation_load,
      [
        ...
        (str_store_faction_name, s7, "fac_player_supporters_faction"),
	    (create_text_overlay,"$g_presentation_obj_13","@{s7} 's Army",),		
...
("custom_troop_item", 0, mesh_troop_info_win_2, [
	...
	(try_begin),
	(lt, "$cheat_find_item_range_begin", 619),
	(assign, "$cheat_find_item_range_begin", 619),
	(try_end),
...
(ti_on_presentation_load,
	...
	(position_set_x, pos1, 110), (position_set_y, pos1, 1300), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 37000), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 403), (position_set_y, pos1, 1300), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 20790), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 403), (position_set_y, pos1, 921), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 10700), (position_set_y, pos1, 100), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 308), (position_set_y, pos1, 920), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 5000), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 505), (position_set_y, pos1, 920), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 16200), (overlay_set_size, reg1, pos1),
	
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 301), (position_set_y, pos1, 626), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 21400), (position_set_y, pos1, 100), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 357), (position_set_y, pos1, 625), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 8160), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 353), (position_set_y, pos1, 478), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 16050), (position_set_y, pos1, 100), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 209), (position_set_y, pos1, 476), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 8500), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 505), (position_set_y, pos1, 475), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 20000), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 206), (position_set_y, pos1, 323), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 10710), (position_set_y, pos1, 100), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 110), (position_set_y, pos1, 322), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 5000), (overlay_set_size, reg1, pos1),
	(create_mesh_overlay, reg1, "mesh_faction_technologies_connection_line"),
	(position_set_x, pos1, 308), (position_set_y, pos1, 322), (overlay_set_position, reg1, pos1),
	(position_set_x, pos1, 100), (position_set_y, pos1, 12000), (overlay_set_size, reg1, pos1),
	
	# Techs
	(position_set_x, pos1, 110), (position_set_y, pos1, 1300), (str_store_string, s1, "@Rifled Caplock^^Muskets"),
	...
	(position_set_x, pos1, 110), (position_set_y, pos1, 850), (str_store_string, s1, "@American Civil War^^Experience"),
	...
	(position_set_x, pos1, 110), (position_set_y, pos1, 700), (str_store_string, s1, "@Ambulances"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_woundedevacuation, 0), (assign, "$g_faction_technologies_tech_woundedevacuation", reg1),
	(position_set_x, pos1, 403), (position_set_y, pos1, 1300), (str_store_string, s1, "@Crimean War^^Medical Experience"),
	...
	(position_set_x, pos1, 403), (position_set_y, pos1, 1150), (str_store_string, s1, "@Conscription"),
	...
	(position_set_x, pos1, 403), (position_set_y, pos1, 1000), (str_store_string, s1, "@Conversion Breech-loaded^^Rifles"),
	...
	(position_set_x, pos1, 308), (position_set_y, pos1, 850), (str_store_string, s1, "@Rifled Cannons"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 850), (str_store_string, s1, "@Baggage Trains"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 700), (str_store_string, s1, "@Modern^^Breech-loaded Rifles"),
	...
	(position_set_x, pos1, 357), (position_set_y, pos1, 550), (str_store_string, s1, "@Skirmish Line^^Tactics"),
	...
	(position_set_x, pos1, 209), (position_set_y, pos1, 400), (str_store_string, s1, "@Regimental System^^Reform"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_fourbattalions, 9), (assign, "$g_faction_technologies_tech_fourbattalions", reg1),
	(position_set_x, pos1, 110), (position_set_y, pos1, 250), (str_store_string, s1, "@Breech-loaded^^Cannons"),
	...
	(position_set_x, pos1, 308), (position_set_y, pos1, 250), (str_store_string, s1, "@Magazine Rifles"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 400), (str_store_string, s1, "@Improved Percussion^^Mechanisms"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 250), (str_store_string, s1, "@Smokeless Powder"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_hetypelate, 0), (assign, "$g_faction_technologies_tech_hetypelate", reg1),
	(position_set_x, pos1, 505), (position_set_y, pos1, 100), (str_store_string, s1, "@Machine Guns"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_improvedlogistics, 0), (assign, "$g_faction_technologies_tech_improvedlogistics", reg1),
	(position_set_x, pos1, 308), (position_set_y, pos1, 100), (str_store_string, s1, "@Infantry Adaptive^^Training"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_adaptivetraining, 6), (assign, "$g_faction_technologies_tech_adaptivetraining", reg1),
...
(ti_on_presentation_event_state_change,
	...
	(str_store_string, s1, "@Baggage Trains"), (call_script,"script_pts_create_selected_tech_name"),
	...
	(str_store_string, s1, "@Ambulances"), (call_script,"script_pts_create_selected_tech_name"),
	...
	(str_store_string, s1, "@Regimental System^Reform"), (call_script,"script_pts_create_selected_tech_name"),
	...
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_acwexperience"),
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_ammoincrease"),
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_cannonsrifling"),
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_woundedevacuation"),
	...
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_fourbattalions"),
	...
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_hetypelate"),
	(this_or_next|eq, ":object", "$g_faction_technologies_tech_improvedlogistics"),
...
(ti_on_presentation_load, [
	...
	(create_text_overlay, reg1, "@War reparations amount: {reg11} pounds", tf_center_justify),
	...
	(position_set_x, pos1, 350), (position_set_y, pos1, 50), (overlay_set_position, "$peace_negotiations_infamy_cost_text", pos1),
	(position_set_x, pos1, 1000), (position_set_y, pos1, 1000), (overlay_set_size, "$peace_negotiations_infamy_cost_text", pos1),
...
("pps_menu", 0, mesh_load_window2, [
	...
	(assign, ":index", 0),
		...
		(troop_set_slot, "trp_temp_array_a", ":index", ":faction"),
	...
	(position_set_x, pos1, 160), (position_set_y, pos1, 570), (overlay_set_position, "$overlay_text_parliament_composition", pos1),
	...
	(position_set_x, pos1, 160), (position_set_y, pos1, 510), (overlay_set_position, "$overlay_text_executive_branch_composition", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 570), (overlay_set_position, "$overlay_text_class0", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 470), (overlay_set_position, "$overlay_text_class1", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 370), (overlay_set_position, "$overlay_text_class2", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 270), (overlay_set_position, "$overlay_text_class3", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 170), (overlay_set_position, "$overlay_text_class4", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 555), (overlay_set_position, "$overlay_text_class0_loyalty_to_parties", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 455), (overlay_set_position, "$overlay_text_class1_loyalty_to_parties", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 355), (overlay_set_position, "$overlay_text_class2_loyalty_to_parties", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 255), (overlay_set_position, "$overlay_text_class3_loyalty_to_parties", pos1),
	...
	(position_set_x, pos1, 470), (position_set_y, pos1, 155), (overlay_set_position, "$overlay_text_class4_loyalty_to_parties", pos1),
	...
	(faction_get_slot, reg4, "$pps_menu_selected_faction", slot_faction_class_upper_aristocracy_attitude), (val_div, reg4, 100),
	(create_text_overlay, "$overlay_text_class0_wealth", "@Wealth: {reg1}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 520), (overlay_set_position, "$overlay_text_class0_wealth", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class0_wealth", pos1),
	(create_text_overlay, "$overlay_text_class0_satisfaction", "@Satisfaction with needs: {reg2}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 490), (overlay_set_position, "$overlay_text_class0_satisfaction", pos1),
	...
	(position_set_x, pos1, 490), (position_set_y, pos1, 520), (overlay_set_position, "$overlay_text_class0_political_activity", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class0_political_activity", pos1),
	(create_text_overlay, "$overlay_text_class0_militancy", "@Militancy: {reg4}%", 0),
	(position_set_x, pos1, 490), (position_set_y, pos1, 490), (overlay_set_position, "$overlay_text_class0_militancy", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class0_militancy", pos1),
	...
	(faction_get_slot, reg4, "$pps_menu_selected_faction", slot_faction_class_upper_bourgeoisie_attitude), (val_div, reg4, 100),
	(create_text_overlay, "$overlay_text_class1_wealth", "@Wealth: {reg1}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 420), (overlay_set_position, "$overlay_text_class1_wealth", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class1_wealth", pos1),
	(create_text_overlay, "$overlay_text_class1_satisfaction", "@Satisfaction with needs: {reg2}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 390), (overlay_set_position, "$overlay_text_class1_satisfaction", pos1),
	...
	(position_set_x, pos1, 490), (position_set_y, pos1, 420), (overlay_set_position, "$overlay_text_class1_political_activity", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class1_political_activity", pos1),
	(create_text_overlay, "$overlay_text_class1_militancy", "@Militancy: {reg4}%", 0),
	(position_set_x, pos1, 490), (position_set_y, pos1, 390), (overlay_set_position, "$overlay_text_class1_militancy", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class1_militancy", pos1),
	...
	(faction_get_slot, reg4, "$pps_menu_selected_faction", slot_faction_class_middle_attitude), (val_div, reg4, 100),
	(create_text_overlay, "$overlay_text_class2_wealth", "@Wealth: {reg1}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 320), (overlay_set_position, "$overlay_text_class2_wealth", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class2_wealth", pos1),
	(create_text_overlay, "$overlay_text_class2_satisfaction", "@Satisfaction with needs: {reg2}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 290), (overlay_set_position, "$overlay_text_class2_satisfaction", pos1),
	...
	(position_set_x, pos1, 490), (position_set_y, pos1, 320), (overlay_set_position, "$overlay_text_class2_political_activity", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class2_political_activity", pos1),
	(create_text_overlay, "$overlay_text_class2_militancy", "@Militancy: {reg4}%", 0),
	(position_set_x, pos1, 490), (position_set_y, pos1, 290), (overlay_set_position, "$overlay_text_class2_militancy", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class2_militancy", pos1),
	...
	(faction_get_slot, reg4, "$pps_menu_selected_faction", slot_faction_class_lower_urban_attitude), (val_div, reg4, 100),
	(create_text_overlay, "$overlay_text_class3_wealth", "@Wealth: {reg1}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 220), (overlay_set_position, "$overlay_text_class3_wealth", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class3_wealth", pos1),
	(create_text_overlay, "$overlay_text_class3_satisfaction", "@Satisfaction with needs: {reg2}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 190), (overlay_set_position, "$overlay_text_class3_satisfaction", pos1),
	...
	(position_set_x, pos1, 490), (position_set_y, pos1, 220), (overlay_set_position, "$overlay_text_class3_political_activity", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class3_political_activity", pos1),
	(create_text_overlay, "$overlay_text_class3_militancy", "@Militancy: {reg4}%", 0),
	(position_set_x, pos1, 490), (position_set_y, pos1, 190), (overlay_set_position, "$overlay_text_class3_militancy", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class3_militancy", pos1),
	...
	(faction_get_slot, reg4, "$pps_menu_selected_faction", slot_faction_class_lower_rural_attitude), (val_div, reg4, 100),
	(create_text_overlay, "$overlay_text_class4_wealth", "@Wealth: {reg1}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 120), (overlay_set_position, "$overlay_text_class4_wealth", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class4_wealth", pos1),
	(create_text_overlay, "$overlay_text_class4_satisfaction", "@Satisfaction with needs: {reg2}%", 0),
	(position_set_x, pos1, 350), (position_set_y, pos1, 90), (overlay_set_position, "$overlay_text_class4_satisfaction", pos1),
	...
	(position_set_x, pos1, 490), (position_set_y, pos1, 120), (overlay_set_position, "$overlay_text_class4_political_activity", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class4_political_activity", pos1),
	(create_text_overlay, "$overlay_text_class4_militancy", "@Militancy: {reg4}%", 0),
	(position_set_x, pos1, 490), (position_set_y, pos1, 90), (overlay_set_position, "$overlay_text_class4_militancy", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_class4_militancy", pos1),
	...
	(position_set_x, pos1, 800), (position_set_y, pos1, 650), (overlay_set_position, "$overlay_text_state_laws", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_nomination_rules", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 590), (overlay_set_position, "$overlay_mesh_law_nomination_rules", pos1),
	(create_text_overlay, "$overlay_text_law_nomination_rules", "@Nomination Rules", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 610), (overlay_set_position, "$overlay_text_law_nomination_rules", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 595), (overlay_set_position, "$overlay_text_law_nomination_rules_rich_only", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 585), (overlay_set_position, "$overlay_text_law_nomination_rules_universal", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_vote_franchise", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 490), (overlay_set_position, "$overlay_mesh_law_vote_franchise", pos1),
	(create_text_overlay, "$overlay_text_law_vote_franchise", "@Vote Franchise", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 510), (overlay_set_position, "$overlay_text_law_vote_franchise", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_vote_franchise", pos1),
	(create_button_overlay, "$overlay_text_law_vote_franchise_aristocracy_only", "@Aristocracy Only"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 450), (overlay_set_size, "$overlay_text_law_vote_franchise_aristocracy_only", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 495), (overlay_set_position, "$overlay_text_law_vote_franchise_aristocracy_only", pos1),
	(create_button_overlay, "$overlay_text_law_vote_franchise_rich_only_only", "@Upper Class Only"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 450), (overlay_set_size, "$overlay_text_law_vote_franchise_rich_only_only", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 485), (overlay_set_position, "$overlay_text_law_vote_franchise_rich_only_only", pos1),
	(create_button_overlay, "$overlay_text_law_vote_franchise_upper_and_middle_only", "@Upper and Middle Class Only"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 450), (overlay_set_size, "$overlay_text_law_vote_franchise_upper_and_middle_only", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 475), (overlay_set_position, "$overlay_text_law_vote_franchise_upper_and_middle_only", pos1),
	(create_button_overlay, "$overlay_text_law_vote_franchise_universal_weighted", "@Universal Weighted"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 450), (overlay_set_size, "$overlay_text_law_vote_franchise_universal_weighted", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 465), (overlay_set_position, "$overlay_text_law_vote_franchise_universal_weighted", pos1),
	(create_button_overlay, "$overlay_text_law_vote_franchise_universal", "@Universal"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 450), (overlay_set_size, "$overlay_text_law_vote_franchise_universal", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 455), (overlay_set_position, "$overlay_text_law_vote_franchise_universal", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_voting_openness", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 390), (overlay_set_position, "$overlay_mesh_law_voting_openness", pos1),
	(create_text_overlay, "$overlay_text_law_voting_openness", "@Voting System", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 410), (overlay_set_position, "$overlay_text_law_voting_openness", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 395), (overlay_set_position, "$overlay_text_law_voting_openness_harassment", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 385), (overlay_set_position, "$overlay_text_law_voting_openness_non_secret_ballot", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 375), (overlay_set_position, "$overlay_text_law_voting_openness_secret_ballot", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_press", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 290), (overlay_set_position, "$overlay_mesh_law_press", pos1),
	(create_text_overlay, "$overlay_text_law_press", "@Press Censorship", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 310), (overlay_set_position, "$overlay_text_law_press", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 295), (overlay_set_position, "$overlay_text_law_press_state_press", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 285), (overlay_set_position, "$overlay_text_law_press_heavy_censorship", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 275), (overlay_set_position, "$overlay_text_law_press_light_censorship", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 265), (overlay_set_position, "$overlay_text_law_press_free_press", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_executive_branch", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 190), (overlay_set_position, "$overlay_mesh_law_executive_branch", pos1),
	(create_text_overlay, "$overlay_text_law_executive_branch", "@Executive Branch Elective Posts", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 210), (overlay_set_position, "$overlay_text_law_executive_branch", pos1),
	(position_set_x, pos1, 430), (position_set_y, pos1, 430), (overlay_set_size, "$overlay_text_law_executive_branch", pos1),
	(create_button_overlay, "$overlay_text_law_executive_branch_selected_by_state", "@Selected by State"),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 195), (overlay_set_position, "$overlay_text_law_executive_branch_selected_by_state", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 185), (overlay_set_position, "$overlay_text_law_executive_branch_partially_by_voting", pos1),
	...
	(position_set_x, pos1, 615), (position_set_y, pos1, 175), (overlay_set_position, "$overlay_text_law_executive_branch_mostly_by_voting", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_military_service_term", "mesh_pps_law_card"),
	(position_set_x, pos1, 670), (position_set_y, pos1, 90), (overlay_set_position, "$overlay_mesh_law_military_service_term", pos1),
	(create_text_overlay, "$overlay_text_law_military_service_term", "@Military Service Term", tf_center_justify),
	(position_set_x, pos1, 670), (position_set_y, pos1, 110), (overlay_set_position, "$overlay_text_law_military_service_term", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_military_service_term", pos1),
	(create_button_overlay, "$overlay_text_law_military_service_term_short", "@Short"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_military_service_term_short", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 95), (overlay_set_position, "$overlay_text_law_military_service_term_short", pos1),
	(create_button_overlay, "$overlay_text_law_military_service_term_medium", "@Medium"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_military_service_term_medium", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 85), (overlay_set_position, "$overlay_text_law_military_service_term_medium", pos1),
	(create_button_overlay, "$overlay_text_law_military_service_term_long", "@Long"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_military_service_term_long", pos1),
	(position_set_x, pos1, 615), (position_set_y, pos1, 75), (overlay_set_position, "$overlay_text_law_military_service_term_long", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_income_tax", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 590), (overlay_set_position, "$overlay_mesh_law_income_tax", pos1),
	(create_text_overlay, "$overlay_text_law_income_tax", "@Income Tax", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 610), (overlay_set_position, "$overlay_text_law_income_tax", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_income_tax", pos1),
	(create_button_overlay, "$overlay_text_law_income_tax_very_big", "@Very Big"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_income_tax_very_big", pos1),
	(position_set_x, pos1, 745), (position_set_y, pos1, 595), (overlay_set_position, "$overlay_text_law_income_tax_very_big", pos1),
	(create_button_overlay, "$overlay_text_law_income_tax_big", "@Big"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_income_tax_big", pos1),
	(position_set_x, pos1, 745), (position_set_y, pos1, 585), (overlay_set_position, "$overlay_text_law_income_tax_big", pos1),
	(create_button_overlay, "$overlay_text_law_income_tax_medium", "@Medium"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_income_tax_medium", pos1),
	(position_set_x, pos1, 745), (position_set_y, pos1, 575), (overlay_set_position, "$overlay_text_law_income_tax_medium", pos1),
	(create_button_overlay, "$overlay_text_law_income_tax_low", "@Low"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_income_tax_low", pos1),
	(position_set_x, pos1, 745), (position_set_y, pos1, 565), (overlay_set_position, "$overlay_text_law_income_tax_low", pos1),
	(create_button_overlay, "$overlay_text_law_income_tax_very_low", "@Very Low"),
	(position_set_x, pos1, 450), (position_set_y, pos1, 420), (overlay_set_size, "$overlay_text_law_income_tax_very_low", pos1),
	(position_set_x, pos1, 745), (position_set_y, pos1, 555), (overlay_set_position, "$overlay_text_law_income_tax_very_low", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_goodsservices_tax", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 490), (overlay_set_position, "$overlay_mesh_law_goodsservices_tax", pos1),
	(create_text_overlay, "$overlay_text_law_goodsservices_tax", "@Goods and Services Tax", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 510), (overlay_set_position, "$overlay_text_law_goodsservices_tax", pos1),
	(position_set_x, pos1, 550), (position_set_y, pos1, 550), (overlay_set_size, "$overlay_text_law_goodsservices_tax", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_importexport_tax", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 390), (overlay_set_position, "$overlay_mesh_law_importexport_tax", pos1),
	(create_text_overlay, "$overlay_text_law_importexport_tax", "@Import Duties", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 410), (overlay_set_position, "$overlay_text_law_importexport_tax", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_importexport_tax", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_education_expenses", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 290), (overlay_set_position, "$overlay_mesh_law_education_expenses", pos1),
	(create_text_overlay, "$overlay_text_law_education_expenses", "@Education Expenses", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 310), (overlay_set_position, "$overlay_text_law_education_expenses", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_education_expenses", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_infrastucture_expenses", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 190), (overlay_set_position, "$overlay_mesh_law_infrastucture_expenses", pos1),
	(create_text_overlay, "$overlay_text_law_infrastucture_expenses", "@Infrastructure Expenses", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 210), (overlay_set_position, "$overlay_text_law_infrastucture_expenses", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_infrastucture_expenses", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_healthcare_expenses", "mesh_pps_law_card"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 90), (overlay_set_position, "$overlay_mesh_law_healthcare_expenses", pos1),
	(create_text_overlay, "$overlay_text_law_healthcare_expenses", "@Healthcare Expenses", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 110), (overlay_set_position, "$overlay_text_law_healthcare_expenses", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_healthcare_expenses", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_workers_conditions", "mesh_pps_law_card"),
	(position_set_x, pos1, 920), (position_set_y, pos1, 590), (overlay_set_position, "$overlay_mesh_law_workers_conditions", pos1),
	(create_text_overlay, "$overlay_text_law_workers_conditions", "@Production Safety Regulations", tf_center_justify),
	(position_set_x, pos1, 920), (position_set_y, pos1, 610), (overlay_set_position, "$overlay_text_law_workers_conditions", pos1),
	(position_set_x, pos1, 500), (position_set_y, pos1, 500), (overlay_set_size, "$overlay_text_law_workers_conditions", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_workers_wage", "mesh_pps_law_card"),
	(position_set_x, pos1, 920), (position_set_y, pos1, 490), (overlay_set_position, "$overlay_mesh_law_workers_wage", pos1),
	(create_text_overlay, "$overlay_text_law_workers_wage", "@Minimum Wage", tf_center_justify),
	(position_set_x, pos1, 920), (position_set_y, pos1, 510), (overlay_set_position, "$overlay_text_law_workers_wage", pos1),
	...
	(position_set_x, pos1, 920), (position_set_y, pos1, 390), (overlay_set_position, "$overlay_mesh_law_trade_unions", pos1),
	(create_text_overlay, "$overlay_text_law_trade_unions", "@Trade Unions", tf_center_justify),
	(position_set_x, pos1, 920), (position_set_y, pos1, 410), (overlay_set_position, "$overlay_text_law_trade_unions", pos1),
	...
	(position_set_x, pos1, 920), (position_set_y, pos1, 290), (overlay_set_position, "$overlay_mesh_law_public_meetings", pos1),
	(create_text_overlay, "$overlay_text_law_public_meetings", "@Public Meetings", tf_center_justify),
	(position_set_x, pos1, 920), (position_set_y, pos1, 310), (overlay_set_position, "$overlay_text_law_public_meetings", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_public_meetings", pos1),
	(create_mesh_overlay, "$overlay_mesh_law_military_expenses", "mesh_pps_law_card"),
	(position_set_x, pos1, 920), (position_set_y, pos1, 190), (overlay_set_position, "$overlay_mesh_law_military_expenses", pos1),
	(create_text_overlay, "$overlay_text_law_military_expenses", "@Military Expenses", tf_center_justify),
	(position_set_x, pos1, 920), (position_set_y, pos1, 210), (overlay_set_position, "$overlay_text_law_military_expenses", pos1),
	(position_set_x, pos1, 600), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_text_law_military_expenses", pos1),
	...
	(store_trigger_param_2, ":value"),
		...
		(troop_get_slot, "$pps_menu_selected_faction", "trp_temp_array_a", ":value"),
		(call_script, "script_pps_menu_display_faction"),
		(try_end),
	]),
	(ti_on_presentation_run,
...
("pes_region", 0, mesh_load_window2, [
	...
	(str_store_faction_name, s1, "$pes_region_selected_faction"),
	...
	(faction_get_slot, reg1, "$pes_region_selected_faction", slot_faction_population),
	...
	(faction_get_slot, reg1, "$pes_region_selected_faction", slot_faction_literacy),
	...
	(faction_get_slot, reg1, "$pes_region_selected_faction", slot_faction_urbanization),
	(store_mod, reg2, reg1, 100), (val_div, reg1, 100),
	...
	(faction_get_slot, reg1, "$pes_region_selected_faction", slot_faction_gdp),
	(create_text_overlay, "$overlay_text_pes_faction_gdp", "@Daily GDP is {reg1} pounds.", tf_center_justify),
	...
	(faction_get_slot, reg1, "$pes_region_selected_faction", slot_faction_workers),
	(faction_get_slot, reg2, "$pes_region_selected_faction", slot_faction_workers_massproduction),
	(faction_get_slot, reg3, "$pes_region_selected_faction", slot_faction_workers_handicraft),
	...
	(assign, ":index", 0),
		(try_for_range, ":center", walled_centers_begin, walled_centers_end),
		(store_faction_of_party, ":faction", ":center"),
		(eq, ":faction", "$pes_region_selected_faction"),
	...
	(store_trigger_param_2, ":value"),
		...
		(assign, reg10, ":factory_price"),
			...
			(str_store_string, s1, "@ +"),
			(try_end),
		(overlay_set_text, ":overlay_factory_playershare_price", "@Balance change:{s1}{reg10} pounds."),
			(try_begin),
			(lt, ":factory_price", 0),
		...
		(store_troop_gold, ":gold", "trp_player"),
			...
			(overlay_set_text, ":overlay_factory_playershare_price", "@Balance change: +0 pounds."),
		...
		(store_add, ":slot_devmode", slot_center_factory1_devmode, ":target_factory"),
			(try_begin),
			(eq, ":object", ":overlay1"),
			(party_set_slot, "$pes_region_selected_center", ":slot_devmode", 0),
			(else_try),
			(eq, ":object", ":overlay2"),
			(party_set_slot, "$pes_region_selected_center", ":slot_devmode", 1),
			(else_try),
			(eq, ":object", ":overlay3"),
			(party_set_slot, "$pes_region_selected_center", ":slot_devmode", 2),
			(else_try),
			(eq, ":object", ":overlay4"),
			(party_set_slot, "$pes_region_selected_center", ":slot_devmode", 3),
			(try_end),
		(call_script, "script_pes_region_menu_display_region"),
		(else_try),
		(assign, ":target_factory", -1),
...
("pes_resource", 0, mesh_load_window2, [
	...
	(try_for_range, ":faction", "fac_player_supporters_faction", pes_number_of_factions),
	(store_sub, ":faction_array_sub", ":faction", "fac_player_supporters_faction"),
	(store_add, ":array", "trp_array_1", ":faction_array_sub"),
	(create_mesh_overlay, reg1, "mesh_menu_flag1"),
	(troop_set_slot, ":array", pes_resource_menu_faction_flag1, reg1),
	(create_mesh_overlay, reg1, "mesh_menu_flag1"),
	(troop_set_slot, ":array", pes_resource_menu_faction_flag2, reg1),
	(create_text_overlay, reg1, "@ ", tf_center_justify),
	(troop_set_slot, ":array", pes_resource_menu_faction_name1, reg1),
	(create_text_overlay, reg1, "@ ", tf_center_justify),
	(troop_set_slot, ":array", pes_resource_menu_faction_name2, reg1),
	(create_text_overlay, reg1, "@ ", tf_center_justify),
...
("pes_region_build_factory", 0, mesh_load_window2, [
	...
	(assign, ":x1", 150), (assign, ":y1", 600),
	(store_add, ":x2", ":x1", -70), (store_add, ":y2", ":y1", 80), (store_add, ":y3", ":y1", -80), 
	(create_image_button_overlay, "$overlay_steel_bg", "mesh_pes_region_factorycard", "mesh_pes_region_factorycard"),
	(overlay_set_material, "$overlay_steel_bg", "@pes_region_factorycard2"),
	(position_set_x, pos1, 800), (position_set_y, pos1, 600), (overlay_set_size, "$overlay_steel_bg", pos1),
	(position_set_x, pos1, ":x1"), (position_set_y, pos1, ":y1"), (overlay_set_position, "$overlay_steel_bg", pos1),
	(create_mesh_overlay, "$overlay_steel_photo", "mesh_pes_region_factorycard"),
	(position_set_x, pos1, 650), (position_set_y, pos1, 230), (overlay_set_size, "$overlay_steel_photo", pos1),
	(position_set_x, pos1, ":x1"), (position_set_y, pos1, ":y1"), (overlay_set_position, "$overlay_steel_photo", pos1),
	(overlay_set_material, "$overlay_steel_photo", "@pes_region_factory_photo_steel"),
	(create_text_overlay, "$overlay_steel_name", "@Steel Factory", tf_center_justify),
	(position_set_x, pos1, 800), (position_set_y, pos1, 800), (overlay_set_size, "$overlay_steel_name", pos1),
	(position_set_x, pos1, ":x1"), (position_set_y, pos1, ":y2"), (overlay_set_position, "$overlay_steel_name", pos1),
	(create_text_overlay, "$overlay_steel_desc", "@Produces steel out^of coal and iron.", tf_left_align),
	(position_set_x, pos1, 800), (position_set_y, pos1, 800), (overlay_set_size, "$overlay_steel_desc", pos1),
	(position_set_x, pos1, ":x2"), (position_set_y, pos1, ":y3"), (overlay_set_position, "$overlay_steel_desc", pos1),
