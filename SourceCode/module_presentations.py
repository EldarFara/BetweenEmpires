...
(ti_on_presentation_event_state_change, [
	...
	(presentation_set_duration, 0),
		...
		(call_script,"script_set_player_kingdom_init", "fac_kingdom_28", "p_town_68", "fac_culture_28", "trp_knight_28_1", "trp_knight_29_1", "trp_kingdom_28_lord", "scn_castle_102_interior"),
		(else_try),
