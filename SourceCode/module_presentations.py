...
(ti_on_presentation_load, [
	...
	(assign, ":faction_number", 0),
		...
		(store_add, ":text_coor_y", ":coor_y", 44),
			(try_for_range, ":index_x", 0, 4),
			(val_add, ":faction_number", 1),
			(le, ":faction_number", 33),
...
(ti_on_presentation_event_state_change, [
	...
	(store_add, ":string", "str_flag1_0", "$g_faction_selection_selected_faction_number"),
	(str_store_string, s1, ":string"),
...
("pes_region", 0, mesh_load_window2, [
	...
	(create_text_overlay, "$overlay_text_pes_center_urbanization", "@Urbanization is .%", tf_center_justify),
		...
		(create_text_overlay, reg1, "@ ", tf_left_align),
		(troop_set_slot, ":array", pes_region_menu_overlay_factory_found_raw_resources, reg1),
		(create_text_overlay, reg1, "@ ", tf_left_align),
