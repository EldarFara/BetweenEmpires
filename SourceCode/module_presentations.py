...
("pes_resource", 0, mesh_load_window2, [
	...
	(create_text_overlay, "$overlay_text_pes_resource_factionlist_producersamount", "@Producer^amount", tf_center_justify),
	...
	(try_for_range, ":faction", "fac_player_supporters_faction", kingdoms_end),
	(faction_slot_eq, ":faction", slot_faction_state, sfs_active),
