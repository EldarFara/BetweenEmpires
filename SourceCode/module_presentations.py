...
will be merged into one that has highest number of soldiers."),
	...
	(try_end),
	(try_begin),
	(faction_slot_ge, "fac_player_supporters_faction", slot_faction_technology_coveringfire, 10000),
	(val_add, ":x_activeability", 35),
	(position_set_x, pos1, 1000), (position_set_y, pos1, 1000),
...
(set_fixed_point_multiplier, 1000),
	...
	(call_script, "script_if_coveringfire_is_on_for_selected_companies"),
		...
		(try_end),
	(overlay_set_tooltip, "$menu_pbs_activeability_coveringfire", "@{s1}^^Turning on suspression fire will increase shooting speed^and decreasing enemy discipline level three times faster,^on exchange of drastically decreasing your own accuracy.^Company types: any."),
	(try_end),
	(try_begin),
