...
(ti_on_presentation_load,
	...
	# Techs
	(position_set_x, pos1, 110), (position_set_y, pos1, 1300), (str_store_string, s1, "@Rifled Muskets"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 400), (str_store_string, s1, "@Improved Shell^^Percussion Mechanisms"),
	...
	(call_script,"script_pts_create_tech_button", slot_faction_technology_improvedlogistics, 10), (assign, "$g_faction_technologies_tech_improvedlogistics", reg1),
	(position_set_x, pos1, 308), (position_set_y, pos1, 100), (str_store_string, s1, "@Infantry Adaptive^^Training"),
	(call_script,"script_pts_create_tech_button", slot_faction_technology_adaptivetraining, 8), (assign, "$g_faction_technologies_tech_adaptivetraining", reg1),
