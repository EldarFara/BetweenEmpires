...
("pes_region_build_factory", 0, mesh_load_window2, [
	...
	(position_set_x, pos1, 500), (position_set_y, pos1, 670), (overlay_set_position, "$overlay_pes_region_build_factory_title", pos1),
	(store_troop_gold, reg10, "trp_player"),
	(create_text_overlay, "$overlay_pes_region_build_factory_balance", "@Your current balance is {reg10} pounds.", tf_center_justify),
	...
	(create_slider_overlay, "$overlay_capital_slider", 50000, 300000),
	...
	(create_text_overlay, "$overlay_capital_title", "@Initial Capital: 50000 pounds.", tf_center_justify),
	...
	(create_game_button_overlay, "$overlay_build_factory", "@Start Enterprice", tf_center_justify),
...
(assign, ":x", 105), (assign, ":y", 550),
	...
	(store_trigger_param_2, ":value"),
		...
		(store_troop_gold, ":gold", "trp_player"),
			...
			(assign, ":finish", 0),
				...
				(assign, ":finish", 0),
					...
					(eq, ":finish", 0),
					(val_add, ":slot_type", 1),
					(party_slot_eq, "$pes_region_selected_center", ":slot_type", 0),
					...
					(try_end),
				(else_try),
				(display_message, "@Same type of factory is already built in this town."),
				(try_end),
			(else_try),
			(display_message, "@Not enough money."),
			(try_end),
		...
		(assign, reg10, ":value"),
		(overlay_set_text, "$overlay_capital_title", "@Initial Capital: {reg10} pounds."),
		(else_try),
