...
("pes_region", 0, mesh_load_window2, [
	...
	(store_mod, reg2, reg1, 1000000), (val_div, reg1, 100000), (val_div, reg2, 1000),
		(try_begin),
		(str_store_string, s2, "@{!}"),
		(lt, reg2, 100),
	...
	(position_set_x, pos1, 150), (position_set_y, pos1, 655), (overlay_set_position, "$overlay_text_pes_faction_literacy", pos1),
	...
	(position_set_x, pos1, 150), (position_set_y, pos1, 630), (overlay_set_position, "$overlay_text_pes_faction_urbanization", pos1),
	...
	(create_text_overlay, "$overlay_text_pes_center_urbanization", "@Urbanization is .%", tf_center_justify),
