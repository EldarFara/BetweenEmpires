...
(ti_on_presentation_load,
	...
	(position_set_x, pos1, 110), (position_set_y, pos1, 700), (str_store_string, s1, "@Organization of Evacuation^^of the Wounded"),
	...
	(position_set_x, pos1, 403), (position_set_y, pos1, 1000), (str_store_string, s1, "@Breech-loaded^^Rifles"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 850), (str_store_string, s1, "@Increase of Ammunition"),
	...
	(position_set_x, pos1, 505), (position_set_y, pos1, 700), (str_store_string, s1, "@Small Caliber^^Breech-loaded Rifles"),
