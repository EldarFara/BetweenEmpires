...
pbs_company_state = (0.4, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(team_set_slot, ":team", ":slot_team_moving_soldier_number", 0),
		(store_add, ":slot_team_soldier_number", slot_team_company1_soldier_number, ":company"),
		(team_set_slot, ":team", ":slot_team_soldier_number", 0),
		(try_end),
	(try_end),
	...
	(team_get_slot, ":moving_soldier_number", ":team", ":slot_team_moving_soldier_number"),
	(val_add, ":soldier_number", 1),
	(agent_get_animation, ":anim", ":agent", 0),
		(try_begin),
		(is_between, ":anim", "anim_run_forward", "anim_stand_to_crouch"),
		(val_add, ":moving_soldier_number", 1),
		(try_end),
		(try_begin),
		(agent_get_horse, ":horse", ":agent"),
		(neq, ":horse", -1),
		(is_between, ":anim", "anim_ride_2", "anim_ride_jump_end"),
		(val_add, ":moving_soldier_number", 1),
		(try_end),
	(team_set_slot, ":team", ":slot_team_soldier_number", ":soldier_number"),
	(team_set_slot, ":team", ":slot_team_moving_soldier_number", ":moving_soldier_number"),
	(try_end),
],[])
...
pbs_company_energy = (0.5, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(gt, ":soldier_number", 0),
		(store_mul, ":proportion", ":moving_soldier_number", 100),
		(val_div, ":proportion", ":soldier_number"),
			(try_begin),
...
(set_show_messages, 0),
	(try_for_range, ":team", 0, 4),
		...
		(team_set_slot, ":team", ":slot_team_discipline", 10000),
		(store_add, ":slot_team_energy", slot_team_company1_energy, ":company"),
		(team_set_slot, ":team", ":slot_team_energy", 10000),
		(try_end),
	(try_end),
(set_show_messages, 1),
],
...
(team_set_slot, "$g_player_team", slot_team_company3_type, "$player_company3_type"),
(team_set_slot, "$g_player_team", slot_team_company4_type, "$player_company4_type"),
(team_set_slot, "$g_player_team", slot_team_company5_type, "$player_company5_type"),
...
(call_script, "script_company_get_name_battle_menu", "$g_player_team", 3), (class_set_name, 3, "@4th {s1}"),
(call_script, "script_company_get_name_battle_menu", "$g_player_team", 4), (class_set_name, 4, "@5th {s1}"),
(call_script, "script_company_get_name_battle_menu", "$g_player_team", 5), (class_set_name, 5, "@6th {s1}"),
(call_script, "script_company_get_name_battle_menu", "$g_player_team", 6), (class_set_name, 6, "@7th {s1}"),
(call_script, "script_company_get_name_battle_menu", "$g_player_team", 7), (class_set_name, 7, "@8th {s1}"),
...
(assign, ":soldiers_number", 9999),
(assign, ":company_to_assign", -1),
	...
	(store_add, ":slot_team_company_soldier_number", slot_team_company1_soldier_number, ":current_company"),
	(team_get_slot, ":company_soldier_number", ":team", ":slot_team_company_soldier_number"),
	(le, ":company_soldier_number", ":soldiers_number"),
	(assign, ":soldiers_number", ":company_soldier_number"),
	(assign, ":company_to_assign", ":current_company"),
	(try_end),
	
	(try_begin),
	(eq, ":company_to_assign", -1),
		(try_begin),
	...
	(store_add, ":slot_team_company_soldier_number", slot_team_company1_soldier_number, ":company_to_assign"),
	(team_get_slot, ":company_soldier_number", ":team", ":slot_team_company_soldier_number"),
