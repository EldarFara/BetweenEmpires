		...
		(eq, ":CannonIsActive", 1),
			...
			(set_fixed_point_multiplier, 100),
				...
				(position_rotate_x_floating, pos3, ":Angle"),
					...
					(else_try),
					(store_random_in_range, ":Random1", -25, 25),
					(store_random_in_range, ":Random2", -25, 25),
					(try_end),
			...
			(val_mul, ":AngleAlpha", 100),
				...
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballHEType, ":HEType"),
					...
					(position_rotate_x_floating, pos2, ":AngleForHowitzer", 0), (position_move_y, pos2, 100, 0),
						(try_begin),
						(eq, ":RiflingType", cannon_rifling_type_notrifled),
						(store_random_in_range, ":Random1", -200, 200),
						(store_random_in_range, ":Random2", -400, 400),
						(else_try),
						(store_random_in_range, ":Random1", -70, 70),
						(store_random_in_range, ":Random2", -150, 150),
						(try_end),
