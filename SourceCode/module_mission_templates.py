...
pbs_company_discipline = (0.2, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(val_clamp, ":penaltytodiscipline_fromfire", 0, 6001),
	...
	(try_for_range, ":team", 0, 4),
		...
		(val_clamp, ":penaltytodiscipline_fromcloseenemy", 0, 3001),
...
pbs_agents_modifiers = (0.5, 0, 0, [
	...
	(assign, ":energy_damage_modifier", 100),
		...
		(val_add, ":energy_accuracy_modifier", 60),
		(try_end),
		(try_begin),
		(le, ":energy", 50),
		(store_div, ":energy_damage_modifier", ":energy", 1),
		(val_add, ":energy_damage_modifier", 50),
		(try_end),
	...
	(store_div, ":ranged_damage", 100, ":damage"),
	(val_mul, ":ranged_damage", 100),
	(agent_set_ranged_damage_modifier, ":agent", ":ranged_damage"),
	(try_end),
],
[])
...
(set_show_messages, 0),
	...
	(try_end),
(set_show_messages, 1),
(troop_set_slot, "trp_faction4_troop5", slot_troop_pbs_type, pbs_troop_type_light),
(troop_set_slot, "trp_faction4_troop6", slot_troop_pbs_type, pbs_troop_type_light),
(troop_set_slot, "trp_faction4_troop7", slot_troop_pbs_type, pbs_troop_type_light),
(troop_set_slot, "trp_faction4_troop8", slot_troop_pbs_type, pbs_troop_type_guard),
(troop_set_slot, "trp_faction4_troop9", slot_troop_pbs_type, pbs_troop_type_guard),
(troop_set_slot, "trp_faction4_troop10", slot_troop_pbs_type, pbs_troop_type_cavmelee),
(troop_set_slot, "trp_faction4_troop11", slot_troop_pbs_type, pbs_troop_type_cavmelee),
(troop_set_slot, "trp_faction4_troop12", slot_troop_pbs_type, pbs_troop_type_cavranged),
(troop_set_slot, "trp_faction4_troop13", slot_troop_pbs_type, pbs_troop_type_cavranged),
],
[])
