...
(this_or_next|eq, ":TroopOfAgent", "trp_faction1_cannoneer_officer"),
(eq, ":TroopOfAgent", "trp_faction1_cannoneer"),
...
#(display_debug_message, "@YuriCannon100MS Begin"),
	(try_for_prop_instances, ":CannonBody", "spr_YuriCannon1_Body"),
...
#(display_debug_message, "@YuriCannonRuntime Begin"),
	...
	(prop_instance_stop_sound, ":Cannonball"),
		...
		(scene_prop_set_visibility, ":Cannonball", 0),
			(try_begin),
			(eq, ":ProjectileType", cannon_projectile_type_cannonball),
			(play_sound_at_position, "snd_Yuri_CannonballHit_Ground", pos1, sf_vol_15),
			(else_try),
			(call_script, "script_explode_at_pos", pos1),
			(try_end),
		(try_end),
	(eq, ":ProjectileType", cannon_projectile_type_cannonball),
...
#(display_debug_message, "@YuriCannon33MS Begin"),
	...
	(eq, ":CannonIsActive", 1),
		...
		(val_mul, ":AngleAlpha", 100),
			...
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballAngleAlpha, ":AngleAlpha"),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballMuzzleVelocity, 250),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFlyingTime, 0),
...
pbs_agents_modifiers = (0.5, 0, 0, [
	...
	(neg|agent_is_routed, ":agent"),
	(agent_get_troop_id, ":troop", ":agent"),
	(neq, ":troop", "trp_faction1_cannoneer_officer"),
	(neq, ":troop", "trp_faction1_cannoneer"),
	(agent_get_team, ":team", ":agent"),
	(assign, ":speed", 110),
	(assign, ":accuracy", 30),
	(assign, ":damage", 100),
...
(team_get_slot, ":global_tactic", "$g_enemy_team", slot_team_pai_global_tactic),
	...
	(call_script, "script_store_company_average_position_to_pos30", "$g_player_team", company1),
	(call_script, "script_rotate_pos31_towards_pos30"),
	(call_script, "script_team_create_infantry_formation_on_pos31", "$g_enemy_team", formation_type_melee),
	(try_end),
