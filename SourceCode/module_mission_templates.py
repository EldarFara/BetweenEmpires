...
(neq, ":animation", "anim_fanning_sa"),
(agent_get_wielded_item, ":item_id", ":player", 0),
(this_or_next|eq, ":item_id", "itm_sidearm_smithwesson_no2"),
...
(this_or_next|eq, ":item_id", "itm_sidearm_pepperbox2"),
(this_or_next|eq, ":item_id", "itm_sidearm_lefaucheux"),
(this_or_next|eq, ":item_id", "itm_sidearm_mas1873"),
(this_or_next|eq, ":item_id", "itm_sidearm_reichsrevolver1879"),
...
(position_move_y, pos10, 30, 0),
(position_move_z, pos10, 10, 0),
(copy_position, pos11, pos10),
(set_fixed_point_multiplier, 100),
(store_random_in_range, ":x_offset", -750, 750),
(store_random_in_range, ":z_offset", -750, 750),
...
(add_missile, ":player", pos11, 10000, ":item_id", 0, "itm_ammo_pistol", 0),
	(try_begin),
	(assign, ":shot_animation", "anim_fanning"),
	(this_or_next|eq, ":item_id", "itm_sidearm_colt_dragoon"),
	(this_or_next|eq, ":item_id", "itm_sidearm_colt_walker"),
	(this_or_next|eq, ":item_id", "itm_sidearm_beaumont"),
	(this_or_next|eq, ":item_id", "itm_sidearm_remington1"),
	...
	(this_or_next|eq, ":item_id", "itm_sidearm_reichsrevolver1879"),
	(eq, ":item_id", "itm_sidearm_colt_m1873"),
	(assign, ":shot_animation", "anim_fanning_sa"),
	(try_end),
(agent_set_animation, ":player", ":shot_animation", 1),
])
...
pbs_company_penaltytodiscipline_fromcasualties_1000ms = (1, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(store_add, ":slot_team_penaltytodiscipline_fromcasualties", slot_team_company1_penaltytodiscipline_fromcasualties, ":company"),
		(team_get_slot, ":penaltytodiscipline_fromcasualties", ":team", ":slot_team_penaltytodiscipline_fromcasualties"),
		(val_sub, ":penaltytodiscipline_fromcasualties", 15),
		(val_clamp, ":penaltytodiscipline_fromcasualties", 0, 3500),
...
(val_clamp, ":soldier_number", 15, 41),
(store_div, ":penalty", 6000, ":soldier_number"),
...
(assign, ":item_id", reg0),
(this_or_next|is_between,":item_id", "itm_rifle_italian_m1844", "itm_rifle_italian_vetterlivitali_carbine_m"),
...
(this_or_next|eq,":item_id", "itm_rifle_russian_m1856"),
(this_or_next|eq,":item_id", "itm_rifle_middle_east_musket1"),
...
(this_or_next|eq,":item_id", "itm_rifle_middle_east_musket5"), 
(this_or_next|eq,":item_id", "itm_rifle_russian_mosin"),
(this_or_next|eq,":item_id", "itm_rifle_german_m1888"),
...
(get_distance_between_positions_in_meters, ":distance", pos1, pos2),
	(try_begin),
	(is_between, ":distance", 50, 175),
	(val_add, ":distance", -50),
	(val_div, ":distance", 5),
	(store_sub, ":modifier", 100, ":distance"),
	(val_mul, ":damage", ":modifier"),
	(val_div, ":damage", 100),
	(else_try),
	(ge, ":distance", 175),
	(val_mul, ":damage", 75),
...
(agent_get_party_id, ":party", ":agent"),
	...
	(neq, ":player", ":agent"),
	(options_get_damage_to_friends, ":options_damage_to_friends"),
		(try_begin),
		(eq, ":options_damage_to_friends", 0),
		(val_div, ":damage", 2),
		(else_try),
		(eq, ":options_damage_to_friends", 1),
		(val_mul, ":damage", 3),
		(val_div, ":damage", 4),
		(try_end),
	(try_end),
	(try_begin),
	(eq, ":player", ":agent"),
	(options_get_damage_to_player, ":options_damage_to_player"),
		(try_begin),
		(eq, ":options_damage_to_player", 0),
		(val_div, ":damage", 4),
		(else_try),
...
(agent_is_alive, ":player"),
	...
	(agent_get_animation, ":animation", ":player", 1),
	(eq, ":animation", "anim_ready_pistol"),
	(agent_get_wielded_item, ":item", ":player", 0),
	(eq, ":item", "itm_sidearm_lemat"),
	(agent_slot_eq, ":player", slot_agent_lemat_canister_has_been_shot, 0),
	(agent_set_slot, ":player",  slot_agent_lemat_canister_has_been_shot, 1),
	(agent_get_bone_position, pos10, ":player", 18, 1),
	(agent_get_look_position, pos11, ":player"),
	(position_copy_rotation, pos10, pos11),
	(position_move_y, pos10, 30, 0),
	(position_move_z, pos10, 10, 0),
	(particle_system_burst_no_sync, "psys_musket_smoke", pos10, 10),
	(particle_system_burst_no_sync, "psys_musket_flash", pos10, 1),
	(assign, "$ignore_script_game_missile_launch", 1),
		(try_for_range, ":unused", 1, 25),
		(copy_position, pos11, pos10),
		(set_fixed_point_multiplier, 100),
		(store_random_in_range, ":x_offset", -750, 750),
		(store_random_in_range, ":z_offset", -750, 750),
		(position_rotate_x_floating, pos11, ":x_offset"),
		(position_rotate_z_floating, pos11, ":z_offset"),
		(add_missile, ":player", pos11, 5000, "itm_canister_shot_small", 0, "itm_canister_shot_small_projectile", 0),
		(try_end),
	(assign, "$ignore_script_game_missile_launch", 0),
	(agent_play_sound, ":player", "snd_shot_caplockpistol"),		
	(agent_set_animation, ":player", "anim_release_pistol", 1),
	(try_end),
	(try_begin),
	(agent_slot_eq, ":player", slot_agent_lemat_canister_has_been_shot, 1),
	(agent_get_animation, ":animation", ":player", 1),
...
(store_trigger_param_1, ":Agent"),
(agent_is_active, ":Agent"),
(agent_get_troop_id, ":TroopOfAgent", ":Agent"),
(is_between, ":TroopOfAgent", "trp_factionplayer_fieldgun_cannoneer_officer", "trp_cannoneers_end"),
(agent_get_slot, ":CannonBody", ":Agent", YuriSlotAgent_CannonProp),
(prop_instance_is_valid, ":CannonBody"),
(agent_get_position, pos1, ":Agent"),
(position_move_y, pos1, -90000, 0),
(scene_prop_get_slot, ":CannonCannoneerOfficer", ":CannonBody", YuriSlotProp_CannoneerOfficer),
(scene_prop_get_slot, ":CannonCannoneer1", ":CannonBody", YuriSlotProp_Cannoneer1),
(scene_prop_get_slot, ":CannonCannoneer2", ":CannonBody", YuriSlotProp_Cannoneer2),
(scene_prop_get_slot, ":CannonCannoneer3", ":CannonBody", YuriSlotProp_Cannoneer3),
(scene_prop_get_slot, ":CannonRope1", ":CannonBody", YuriSlotProp_CannonRope1),
(scene_prop_get_slot, ":CannonRope2", ":CannonBody", YuriSlotProp_CannonRope2),
(scene_prop_get_slot, ":CannonRamrod1", ":CannonBody", YuriSlotProp_CannonRamrod1),
(scene_prop_get_slot, ":CannonRamrod2", ":CannonBody", YuriSlotProp_CannonRamrod2),
	(try_begin),
	(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneerOfficer"),
	(agent_clear_scripted_mode, ":CannonCannoneerOfficer"),
	(agent_force_rethink, ":CannonCannoneerOfficer"),
	(agent_start_running_away, ":CannonCannoneerOfficer", pos1),
	(agent_set_slot, ":CannonCannoneerOfficer",  slot_agent_is_running_away, 1),
	(agent_set_speed_modifier, ":CannonCannoneerOfficer", 115),
	(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 0),
	(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 1),
	(try_end),
	(try_begin),
	(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer1"),
	(agent_clear_scripted_mode, ":CannonCannoneer1"),
	(agent_force_rethink, ":CannonCannoneer1"),
	(agent_start_running_away, ":CannonCannoneer1", pos1),
	(agent_set_scripted_destination_no_attack, ":CannonCannoneer1", pos1),
	(agent_set_slot, ":CannonCannoneer1",  slot_agent_is_running_away, 1),
	(agent_set_speed_modifier, ":CannonCannoneer1", 115),
	(agent_set_animation, ":CannonCannoneer1", "anim_YuriCancelAnimation", 0),
	(agent_set_animation, ":CannonCannoneer1", "anim_YuriCancelAnimation", 1),
	(try_end),
	(try_begin),
	(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer2"),
	(agent_clear_scripted_mode, ":CannonCannoneer2"),
	(agent_force_rethink, ":CannonCannoneer2"),
	(agent_start_running_away, ":CannonCannoneer2", pos1),
	(agent_set_slot, ":CannonCannoneer2",  slot_agent_is_running_away, 1),
	(agent_set_scripted_destination_no_attack, ":CannonCannoneer2", pos1),
	(agent_set_speed_modifier, ":CannonCannoneer2", 115),
	(agent_set_animation, ":CannonCannoneer2", "anim_YuriCancelAnimation", 0),
	(agent_set_animation, ":CannonCannoneer2", "anim_YuriCancelAnimation", 1),
	(try_end),
	(try_begin),
	(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer3"),
	(agent_clear_scripted_mode, ":CannonCannoneer3"),
	(agent_force_rethink, ":CannonCannoneer3"),
	(agent_start_running_away, ":CannonCannoneer3", pos1),
	(agent_set_scripted_destination_no_attack, ":CannonCannoneer3", pos1),
	(agent_set_slot, ":CannonCannoneer3",  slot_agent_is_running_away, 1),
	(agent_set_speed_modifier, ":CannonCannoneer3", 115),
	(agent_set_animation, ":CannonCannoneer3", "anim_YuriCancelAnimation", 0),
	(agent_set_animation, ":CannonCannoneer3", "anim_YuriCancelAnimation", 1),
	(try_end),
(scene_prop_set_visibility, ":CannonRope1", 0),
(scene_prop_set_visibility, ":CannonRope2", 0),
(scene_prop_set_visibility, ":CannonRamrod1", 0),
...
(store_trigger_param_1, ":Agent"),
(agent_is_active, ":Agent"),
(call_script, "script_YuriSpawnCannon", ":Agent"),
])

YuriCannon100MS = (
0.1, 0, 0, [],
[
#(display_debug_message, "@YuriCannon100MS Begin"),
	(try_for_range, ":TypeOfCannonBody", "spr_YuriCannon1_Body", "spr_YuriCannon1_Wheels"),
		(try_for_prop_instances, ":CannonBody", ":TypeOfCannonBody"),
		(scene_prop_get_slot, ":Cannonball", ":CannonBody", YuriSlotProp_CannonCannonball),
		(scene_prop_get_slot, ":AngleAlpha", ":Cannonball", YuriSlotProp_CannonballAngleAlpha),
		(scene_prop_get_slot, ":MuzzleVelocity", ":Cannonball", YuriSlotProp_CannonballMuzzleVelocity),
		(scene_prop_get_slot, ":FuseBallTimer", ":Cannonball", YuriSlotProp_CannonballFuseBallTimer),
		(scene_prop_get_slot, ":ProjectileType", ":Cannonball", YuriSlotProp_CannonballProjectileType),
			(try_begin),
			(gt, ":FuseBallTimer", 1),
			(val_sub, ":FuseBallTimer", 1),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFuseBallTimer, ":FuseBallTimer"),
			(eq, ":FuseBallTimer", 1),
			(eq, ":ProjectileType", cannon_projectile_type_cannonball),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFuseBallTimer, -1),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIsFlying, 0),
			(scene_prop_set_visibility, ":Cannonball", 0),
			(scene_prop_get_slot, ":CannonCannoneerOfficer", ":CannonBody", YuriSlotProp_CannoneerOfficer),
			(scene_prop_get_slot, ":HEType", ":Cannonball", YuriSlotProp_CannonballHEType),
			(prop_instance_get_position, pos20, ":Cannonball"),
			(call_script, "script_explode_at_pos", ":CannonCannoneerOfficer", pos20, explosion_type_big, ":HEType"),
			(try_end),
		(scene_prop_slot_eq, ":Cannonball", YuriSlotProp_CannonballIsFlying, 1),
		(val_mul, ":MuzzleVelocity", 100),
		(scene_prop_get_slot, ":FlyingTime", ":Cannonball", YuriSlotProp_CannonballFlyingTime),
		(val_add, ":FlyingTime", 1),
		(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFlyingTime, ":FlyingTime"),
		(set_fixed_point_multiplier, 100),
		(store_cos, ":VelocityX", ":AngleAlpha"),
		(set_fixed_point_multiplier, 1),
		(val_mul, ":VelocityX", ":MuzzleVelocity"),
		(val_div, ":VelocityX", 1000),
		(set_fixed_point_multiplier, 100),
		(store_sin, ":VelocityY", ":AngleAlpha"),
	# (assign, reg3, ":VelocityY"),
		(set_fixed_point_multiplier, 1),
		(val_mul, ":VelocityY", ":MuzzleVelocity"),
		(val_div, ":VelocityY", 100),
		(store_mul, ":gt", 98, ":FlyingTime"),
		(val_sub, ":VelocityY", ":gt"),
		(val_div, ":VelocityY", 10),
		(prop_instance_get_position, pos1, ":Cannonball"),
		(init_position, pos2),
		(position_copy_origin, pos2, pos1),
		(set_fixed_point_multiplier, 100),
		(get_angle_between_positions, ":Angle", pos2, pos1),
		(position_rotate_z_floating, pos2, ":Angle", 1),
		(set_fixed_point_multiplier, 1),
		(position_move_y, pos2, ":VelocityX", 0),
		(position_move_z, pos2, ":VelocityY", 1),
	# (assign, reg0, ":VelocityY"), (assign, reg1, ":VelocityX"), (assign, reg2, ":AngleAlpha"),
	# (display_message, "@VelocityY {reg0} VelocityX {reg1} AngleAlpha {reg2} Sine {reg3}"),
		(get_distance_between_positions, ":Hypotenuse", pos1, pos2), (val_mul, ":VelocityY", 100),
		(set_fixed_point_multiplier, 100),
		(store_div, ":Angle", ":VelocityY", ":Hypotenuse"),
		(store_asin, ":Angle", ":Angle"),
		(position_rotate_x_floating, pos2, ":Angle", 0),
		(set_fixed_point_multiplier, 1),
		(prop_instance_animate_to_position, ":Cannonball", pos2, 10),
		(try_end),
	(try_end),
#(display_debug_message, "@YuriCannon100MS End"),
])
...
0, 0, 0, [],
[
#(display_debug_message, "@YuriCannonRuntime Begin"),
	(try_for_range, ":TypeOfCannonBody", "spr_YuriCannon1_Body", "spr_YuriCannon1_Wheels"),
		(try_for_prop_instances, ":CannonBody", ":TypeOfCannonBody"),
		(scene_prop_get_slot, ":CannonCannoneerOfficer", ":CannonBody", YuriSlotProp_CannoneerOfficer),
		(scene_prop_get_slot, ":Cannonball", ":CannonBody", YuriSlotProp_CannonCannonball),
		...
		(prop_instance_get_position, pos1, ":Cannonball"), (copy_position, pos2, pos1),
		(position_move_z, pos1, -45, 1), (position_move_z, pos2, 45, 1),
			(try_for_agents, ":Agent"),
			(agent_is_active, ":Agent"),
			(agent_is_alive, ":Agent"),
			(agent_get_position, pos3, ":Agent"),
			(position_move_z, pos3, 85, 1),
				(try_for_range, ":pos", pos1, pos2+1),
				(get_distance_between_positions, ":Distance", ":pos", pos3),
				(le, ":Distance", 100),
				(agent_get_team, ":TeamOfAgent", ":Agent"),
				(teams_are_enemies, ":TeamOfAgent", ":TeamOfOfficer"),
				(play_sound_at_position, "snd_Yuri_CannonballHit_Man", pos3),
				(agent_deliver_damage_to_agent_advanced, ":unused", ":CannonCannoneerOfficer", ":Agent", 200),
				(try_end),
			(try_end),
		(prop_instance_get_position, pos1, ":Cannonball"),
			(try_begin),
			(scene_prop_slot_eq, ":Cannonball", YuriSlotProp_CannonballIncomingSoundWasPlayed, 0),
			(mission_cam_get_position, pos2),
			(position_transform_position_to_local, pos3, pos1, pos2),
			(set_fixed_point_multiplier, 1),
			(position_get_x, ":CoordinateX", pos3),
			(position_get_y, ":CoordinateY", pos3),
			(position_get_z, ":CoordinateZ", pos3),
			(is_between, ":CoordinateY", 40, 110),
			(is_between, ":CoordinateX", -60, 60),
			(is_between, ":CoordinateZ", -60, 60),
			(prop_instance_play_sound, ":Cannonball", "snd_Yuri_Incoming_Projectile1"),
			(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIncomingSoundWasPlayed, 1),
			(try_end),
		(prop_instance_get_position, pos1, ":Cannonball"),
		...
		(copy_position, pos31, pos1),
		(position_move_y, pos30, 50, 0),
		(position_move_y, pos31, -50, 0),
		(position_set_z_to_ground_level, pos30),
		(position_set_z_to_ground_level, pos31),
		(get_distance_between_positions, ":Hypotenuse", pos30, pos31),
		(set_fixed_point_multiplier, 100),
		(position_get_z, ":CoorZ1", pos30),
		(position_get_z, ":CoorZ2", pos31),
		(store_sub, ":Cathetus", ":CoorZ1", ":CoorZ2"),
		(val_mul, ":Cathetus", 100),
		(store_div, ":Angle", ":Cathetus", ":Hypotenuse"),
		(set_fixed_point_multiplier, 100),
		(store_asin, ":Angle", ":Angle"),
		(set_fixed_point_multiplier, 1),
		(call_script, "script_get_modulus_of_value", ":Angle"), (assign, ":Angle", reg0),
		(prop_instance_get_position, pos1, ":Cannonball"),
		(prop_instance_stop_sound, ":Cannonball"),
			(try_begin),
			(eq, ":ProjectileType", cannon_projectile_type_cannonball),
				(try_begin),
				(le, ":Angle", 1000),
				(ge, ":MuzzleVelocity", 80),
				(position_set_z_to_ground_level, pos1),
				(set_fixed_point_multiplier, 100),
				(position_rotate_x_floating, pos1, ":Angle"), (position_rotate_x_floating, pos1, ":Angle"), 
				(store_random_in_range, ":Random", 100, 600), (position_rotate_x_floating, pos1, ":Random"),
				(set_fixed_point_multiplier, 1),
				(val_div, ":MuzzleVelocity", 2),
				(init_position, pos2), (position_copy_origin, pos2, pos1),
				(set_fixed_point_multiplier, 100), (get_angle_between_positions, ":Angle", pos2, pos1), (position_rotate_z_floating, pos2, ":Angle", 1), (set_fixed_point_multiplier, 1),
				(position_transform_position_to_local, pos3, pos2, pos1), (position_get_rotation_around_x, ":AngleAlpha", pos3), (val_mul, ":AngleAlpha", 100),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballAngleAlpha, ":AngleAlpha"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballMuzzleVelocity, ":MuzzleVelocity"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFlyingTime, 0),
				(position_move_y, pos1, 35, 0),
				(prop_instance_set_position, ":Cannonball", pos1),
				(prop_instance_animate_to_position, ":Cannonball", pos1, 0),
				(else_try),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIsFlying, 0),
				(scene_prop_set_visibility, ":Cannonball", 0),
				(try_end),
			...
			(position_set_z_to_ground_level, pos1),
				(try_begin),
				(eq, ":ProjectileType", cannon_projectile_type_early_shell),
				(assign, ":Chance", 65),
				(else_try),
				(assign, ":Chance", 95),
				(try_end),
			(store_random_in_range, ":Random", 0, 100),
				...
				(call_script, "script_explode_at_pos", ":CannonCannoneerOfficer", pos20, explosion_type_medium, ":HEType"),
				(try_end),
			(try_end),
		(this_or_next|eq, ":ProjectileType", cannon_projectile_type_cannonball),
		(gt, ":Random", ":Chance"),
		(play_sound_at_position, "snd_Yuri_CannonballHit_Ground", pos1, sf_vol_2),
		(position_get_distance_to_terrain, ":Distance", pos1),
		(le, ":Distance", 10),
		(particle_system_burst, "psys_cannon_ball_hit", pos1, 10),
		(prop_instance_get_position, pos1, ":Cannonball"),
		(position_set_z_to_ground_level, pos1),
		(call_script, "script_Yuri_PosAllignToGroundLevel", pos1),
		(set_spawn_position, pos1),
		(spawn_scene_prop, "spr_YuriCannonballCrater"),
		(assign, ":Prop", reg0),
			(try_begin),
	...
	(agent_is_alive, ":Agent"),
		...
		(agent_get_troop_id, ":TroopOfAgent", ":Target"),
		(is_between, ":TroopOfAgent", "trp_factionplayer_fieldgun_cannoneer_officer", "trp_cannoneers_end"),
		(agent_get_position, pos1, ":Agent"),
		...
		(ge, ":Distance", 15),
		(le, ":Distance", 150),
		(agent_get_slot, ":CannonBody", ":Target", YuriSlotAgent_CannonProp),
		(prop_instance_is_valid, ":CannonBody"),
		(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonIsActive, 20),
		(try_end),
	(agent_get_troop_id, ":TroopOfAgent", ":Agent"),
	(is_between, ":TroopOfAgent", "trp_factionplayer_fieldgun_cannoneer_officer", "trp_cannoneers_end"),
	(agent_get_slot, ":CannonBody", ":Agent", YuriSlotAgent_CannonProp),
	(prop_instance_is_valid, ":CannonBody"),
	(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonIsActive, 1),
	(agent_get_position, pos1, ":Agent"),
	...
	(set_fixed_point_multiplier, 1),
	(try_end),
#(display_debug_message, "@YuriCannonRuntime End"),
])

YuriCannon33MS = (
0.03333, 0, 0, [],
[
#(display_debug_message, "@YuriCannon33MS Begin"),
	(try_for_range, ":TypeOfCannonBody", "spr_YuriCannon1_Body", "spr_YuriCannon1_Wheels"),
		(try_for_prop_instances, ":CannonBody", ":TypeOfCannonBody"),
		(scene_prop_get_slot, ":CannonCannoneerOfficer", ":CannonBody", YuriSlotProp_CannoneerOfficer),
		(scene_prop_get_slot, ":CannonCannoneer1", ":CannonBody", YuriSlotProp_Cannoneer1),
		(scene_prop_get_slot, ":CannonCannoneer2", ":CannonBody", YuriSlotProp_Cannoneer2),
		(scene_prop_get_slot, ":CannonCannoneer3", ":CannonBody", YuriSlotProp_Cannoneer3),
		(scene_prop_get_slot, ":CannonWheels", ":CannonBody", YuriSlotProp_CannonWheels),
		(scene_prop_get_slot, ":CannonWheels_RotationX", ":CannonWheels", YuriSlotProp_CannonWheels_RotationX),
		(scene_prop_get_slot, ":CannonBarrel", ":CannonBody", YuriSlotProp_CannonBarrel),
		(scene_prop_get_slot, ":CannonBarrel_RotationX", ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationX),
		(scene_prop_get_slot, ":CannonBarrel_RotationZ", ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationZ),
		(scene_prop_get_slot, ":CannonRope1", ":CannonBody", YuriSlotProp_CannonRope1),
		(scene_prop_get_slot, ":CannonRope2", ":CannonBody", YuriSlotProp_CannonRope2),
		(scene_prop_get_slot, ":CannonRamrod1", ":CannonBody", YuriSlotProp_CannonRamrod1),
		(scene_prop_get_slot, ":CannonRamrod2", ":CannonBody", YuriSlotProp_CannonRamrod2),
		(scene_prop_get_slot, ":CannonMode", ":CannonBody", YuriSlotProp_CannonMode),
		(scene_prop_get_slot, ":CannonTimer", ":CannonBody", YuriSlotProp_CannonTimer),
		(scene_prop_get_slot, ":Cannonball", ":CannonBody", YuriSlotProp_CannonCannonball),
		(scene_prop_get_slot, ":CannonRecoilVelocity", ":CannonBody", YuriSlotProp_CannonRecoilVelocity),
		(scene_prop_get_slot, ":CannonTeamNumber", ":CannonBody", YuriSlotProp_CannonTeamNumber),
		(scene_prop_get_slot, ":CannonIsActive", ":CannonBody", YuriSlotProp_CannonIsActive),
# (scene_prop_get_slot, reg0, ":CannonBody", YuriSlotProp_CannonMode),
# (display_message, "@{reg0}"),
		(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneerOfficer"),
		(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer1"),
		(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer2"),
		(call_script, "script_cf_Yuri_IsAgentAlive", ":CannonCannoneer3"),
		(call_script, "script_get_cannoneer_officer_faction_cannon_projectile_type", ":CannonCannoneerOfficer"), (assign, ":ProjectileType", reg0),
		(call_script, "script_get_cannoneer_officer_faction_cannon_rifling_type", ":CannonCannoneerOfficer"), (assign, ":RiflingType", reg0),
		(call_script, "script_get_cannoneer_officer_faction_cannon_he_type", ":CannonCannoneerOfficer"), (assign, ":HEType", reg0),
			(try_begin),
			(gt, ":CannonIsActive", 1),
			(val_sub, ":CannonIsActive", 1),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonIsActive, ":CannonIsActive"),
			(try_end),
		(eq, ":CannonIsActive", 1),
			(try_begin),
			(gt, ":CannonTimer", 0),
			(val_sub, ":CannonTimer", 1),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, ":CannonTimer"),
			(try_end),
			(try_begin),
			(gt, ":CannonRecoilVelocity", 0),
			(val_sub, ":CannonRecoilVelocity", 6),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonRecoilVelocity, ":CannonRecoilVelocity"),
			(try_end),
			(try_begin), # YuriCannonMode_Initial
			(eq, ":CannonMode", YuriCannonMode_Initial),
			(prop_instance_get_position, pos1, ":CannonBody"),
			(call_script, "script_Yuri_PosAllignToGroundLevel", pos1),
			(prop_instance_set_position, ":CannonBody", pos1),
			(position_move_z, pos1, 70, 0),
			(prop_instance_set_position, ":CannonWheels", pos1),
			(position_move_z, pos1, 40, 0),
			(prop_instance_set_position, ":CannonBarrel", pos1),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Moving_Initial),
			(else_try), # YuriCannonMode_Moving_Initial
			(eq, ":CannonMode", YuriCannonMode_Moving_Initial),
			(prop_instance_get_position, pos1, ":CannonBody"),
			(copy_position, pos2, pos1),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 200, 0),
			(position_move_x, pos3, -125, 0),
			(agent_set_scripted_destination, ":CannonCannoneer1", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneer1", pos3),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 200, 0),
			(position_move_x, pos3, 125, 0),
			(agent_set_scripted_destination, ":CannonCannoneer2", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneer2", pos3),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, -300, 0),
			(position_move_x, pos3, -125, 0),
			(agent_set_scripted_destination, ":CannonCannoneer3", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneer3", pos3),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, -300, 0),
			(position_move_x, pos3, 125, 0),
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 1),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 0),
			(agent_force_rethink, ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Moving_CannoneersWalkingToPositions),
			(else_try), # YuriCannonMode_Moving_CannoneersWalkingToPositions
			(eq, ":CannonMode", YuriCannonMode_Moving_CannoneersWalkingToPositions),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			(prop_instance_stop_sound, ":CannonBody"),
			(prop_instance_play_sound, ":CannonBody", "snd_Yuri_CannonCarriageMoving1"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Moving_Pulling),
			(prop_instance_deform_in_range, ":CannonBody", 1, 1, 0),
			(agent_get_team, ":TeamOfOfficer", ":CannonCannoneerOfficer"),
			(agent_get_division , ":Division", ":CannonCannoneerOfficer"),
			(agent_get_look_position, pos1, ":CannonCannoneerOfficer"),
			(team_get_order_position, pos2, ":TeamOfOfficer", ":Division"),
			(set_fixed_point_multiplier, 1),
			(get_angle_between_positions, ":Angle", pos2, pos1),
			(position_rotate_z, pos2, ":Angle", 0),
			(team_get_slot, ":Amount", ":TeamOfOfficer", YuriSlotTeam_CannonsAmount),
			(val_sub, ":Amount", 1), (val_mul, ":Amount", -300), (position_move_x, pos2, ":Amount", 0),
			(val_mul, ":CannonTeamNumber", 600), (position_move_x, pos2, ":CannonTeamNumber", 0),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 200, 0),
			(position_move_x, pos3, -125, 0),
			(agent_set_scripted_destination, ":CannonCannoneer1", pos3, 1, 1),
			...
			(position_move_x, pos3, 125, 0),
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonRopePulling_Left", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonRopePulling_Right", 1),
			(scene_prop_set_visibility, ":CannonRope1", 1),
			(scene_prop_set_visibility, ":CannonRope2", 1),
			(else_try), # YuriCannonMode_Moving_Pulling
			(eq, ":CannonMode", YuriCannonMode_Moving_Pulling),
			(agent_get_position, pos1, ":CannonCannoneer1"),
			(agent_get_position, pos2, ":CannonCannoneer2"),
			(call_script, "script_Yuri_GetAveragePos", pos1, pos2, pos3),
			(position_move_y, pos3, -200, 0),	
			(position_move_x, pos3, -75, 0),	
			(position_set_z_to_ground_level, pos3),
			(position_move_x, pos3, 75, 0),	
			(call_script, "script_Yuri_PosAllignToGroundLevel", pos3),
			(prop_instance_animate_to_position, ":CannonBody", pos3, 15),
			(position_move_z, pos3, 70, 0),
			(copy_position, pos4, pos3),
			(copy_position, pos5, pos3),
			(val_add, ":CannonWheels_RotationX", -35),
			(set_fixed_point_multiplier, 10),
			(position_rotate_x_floating, pos4, ":CannonWheels_RotationX"),
			(set_fixed_point_multiplier, 1),
			(scene_prop_set_slot, ":CannonWheels", YuriSlotProp_CannonWheels_RotationX, ":CannonWheels_RotationX"),
			(prop_instance_animate_to_position, ":CannonWheels", pos4, 15),
			(position_move_z, pos3, 40, 0),
			(scene_prop_get_slot, ":CannonBarrel_RotationX", ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationX),
			(scene_prop_get_slot, ":CannonBarrel_RotationZ", ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationZ),
			(position_rotate_x, pos3, ":CannonBarrel_RotationX", 0), (position_rotate_z, pos3, ":CannonBarrel_RotationZ", 0),
			(prop_instance_animate_to_position, ":CannonBarrel", pos3, 15),
			(copy_position, pos7, pos5),
			(position_move_x, pos5, -90, 0),
			(agent_get_bone_position, pos6, ":CannonCannoneer1", 13, 1),
			(call_script, "script_turn_pos_towards_pos", pos5, pos6),
			(prop_instance_animate_to_position, ":CannonRope1", pos5, 25),
			(agent_get_position, pos1, ":CannonCannoneer1"),
			(get_distance_between_positions, ":Scale", pos1, pos5),
			(val_div, ":Scale", 2),
			(set_fixed_point_multiplier, 100),
			(prop_instance_set_scale, ":CannonRope1", 100, ":Scale", 100),
			(set_fixed_point_multiplier, 1),
			(copy_position, pos5, pos7),
			(position_move_x, pos5, 90, 0),
			(agent_get_bone_position, pos6, ":CannonCannoneer2", 18, 1),
			(call_script, "script_turn_pos_towards_pos", pos5, pos6),
			(prop_instance_animate_to_position, ":CannonRope2", pos5, 25),
			(agent_get_position, pos1, ":CannonCannoneer2"),
			(get_distance_between_positions, ":Scale", pos1, pos5),
			(val_div, ":Scale", 2),
			(set_fixed_point_multiplier, 100),
			(prop_instance_set_scale, ":CannonRope2", 100, ":Scale", 100),
			(set_fixed_point_multiplier, 1),		(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(prop_instance_stop_sound, ":CannonBody"),
				(try_begin),
				(scene_prop_get_slot, ":CannonLastReloadingPhase", ":CannonBody", YuriSlotProp_CannonLastReloadingPhase),
				(neq, ":CannonLastReloadingPhase", 0),
				(val_add, ":CannonLastReloadingPhase", 100),
				(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, ":CannonLastReloadingPhase"),
				(else_try),
				(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_Initial),
				(try_end),
			(prop_instance_get_position, pos2, ":CannonBarrel"),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 150, 0),
			...
			(position_move_x, pos3, 100, 0),
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneerOfficer", pos3),
			(agent_set_animation, ":CannonCannoneer1", "anim_YuriCancelAnimation", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_YuriCancelAnimation", 1),
			(scene_prop_set_visibility, ":CannonRope1", 0),
			(scene_prop_set_visibility, ":CannonRope2", 0),
			(scene_prop_set_visibility, ":CannonRamrod1", 1),
			(scene_prop_set_visibility, ":CannonRamrod2", 1),
			(agent_get_bone_position, pos1, ":CannonCannoneer1", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod2", pos1, 4),
			(else_try), # YuriCannonMode_InterrruptedReloading_Initial
			(eq, ":CannonMode", YuriCannonMode_InterrruptedReloading_Initial),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_Initial),
			(else_try), # YuriCannonMode_Reloading_Initial
			(eq, ":CannonMode", YuriCannonMode_Reloading_Initial),
			(agent_get_bone_position, pos1, ":CannonCannoneer1", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod2", pos1, 4),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_BarrelCleaning),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonBarrelCleaningLeft", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonRamrodWetting", 1),
			(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_CannonRamrod1"),
			(agent_get_scripted_destination, pos1, ":CannonCannoneer2"),
			(agent_set_position, ":CannonCannoneer2", pos1),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 40),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(else_try),  # YuriCannonMode_Reloading_BarrelCleaning, timer = 40
			(eq, ":CannonMode", YuriCannonMode_Reloading_BarrelCleaning),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			...
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (position_move_y, pos1, -30, 0), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 3),
			(agent_get_animation, ":Animation1", ":CannonCannoneer1", 1),
			(agent_get_animation, ":Animation2", ":CannonCannoneer2", 1),
				(try_begin),
				(neq, ":Animation1", "anim_Yuri_CannonBarrelCleaningLeft"),
				(agent_get_bone_position, pos1, ":CannonCannoneer1", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod2", pos1, 4),
				(else_try),
				(agent_get_bone_position, pos1, ":CannonCannoneer1", 19, 1),
				(prop_instance_get_position, pos2, ":CannonBarrel"), (position_move_y, pos2, -100, 0),
				(get_distance_between_positions, ":Distance", pos1, pos2), (position_move_y, pos2, ":Distance", 0), (position_move_y, pos2, -30, 0),
				(prop_instance_animate_to_position, ":CannonRamrod2", pos2, 4),
				(try_end),
			(neq, ":Animation1", "anim_Yuri_CannonBarrelCleaningLeft"),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_BarrelWetting),
				(try_begin),
				(assign, ":TimerTime", 65),
				(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon2_Body"),
				(eq, ":TypeOfCannonBody", "spr_YuriCannon2Breech_Body"),
				(eq, ":ProjectileType", cannon_projectile_type_cannonball),
				(val_add, ":TimerTime", 60),
				(try_end),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, ":TimerTime"),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonRamrodDrop", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonBarrelCleaningRight", 1),
			(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_CannonRamrod1"),
			(else_try),  # YuriCannonMode_Reloading_BarrelWetting, timer = 65 (125 for fuse bombs)
			(eq, ":CannonMode", YuriCannonMode_Reloading_BarrelWetting),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
				(try_begin),
				(assign, ":TimerTimeToDropRamrod", 42), (assign, ":TimerTimeToDropRamrodSubOne", 41),
				(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon2_Body"),
				(eq, ":TypeOfCannonBody", "spr_YuriCannon2Breech_Body"),
				(eq, ":ProjectileType", cannon_projectile_type_cannonball),
				(val_add, ":TimerTimeToDropRamrod", 60), (val_add, ":TimerTimeToDropRamrodSubOne", 60),
				(try_end),
				(try_begin),
				(scene_prop_slot_ge, ":CannonBody", YuriSlotProp_CannonTimer, ":TimerTimeToDropRamrod"),
				(agent_get_bone_position, pos1, ":CannonCannoneer1", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod2", pos1, 3),
				(else_try),
				(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, ":TimerTimeToDropRamrodSubOne"),
					(try_begin),
					(agent_equip_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge", 1),
					(agent_set_wielded_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge"),
					(try_end),
				(try_end),
			(agent_get_animation, ":Animation1", ":CannonCannoneer1", 1),
			(agent_get_animation, ":Animation2", ":CannonCannoneer2", 1),
				...
				(eq, ":TypeOfCannonBody", "spr_YuriCannon2Breech_Body"),
				(eq, ":ProjectileType", cannon_projectile_type_cannonball),
				(neq, ":Animation1", "anim_Yuri_CannonRamrodDrop"),
				(neq, ":Animation1", "anim_Yuri_CannonFuseAdjusting"),
				(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonFuseAdjusting", 1),
				(try_end),
				(try_begin),
				(neq, ":Animation2", "anim_Yuri_CannonBarrelCleaningRight"),
				(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
				(else_try),
				(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1),
				(prop_instance_get_position, pos2, ":CannonBarrel"), (position_move_y, pos2, -100, 0),
				(get_distance_between_positions, ":Distance", pos1, pos2), (position_move_y, pos2, ":Distance", 0), (position_move_y, pos2, -90, 0),
				(prop_instance_animate_to_position, ":CannonRamrod1", pos2, 4),
				(try_end),
			(neq, ":Animation1", "anim_Yuri_CannonRamrodDrop"),
			(neq, ":Animation2", "anim_Yuri_CannonBarrelCleaningRight"),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(call_script, "script_cf_if_team_has_artillery_shells", ":CannonCannoneerOfficer"),
			(call_script, "script_team_consume_artillery_shell", ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_LoadingCartridge),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 40),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonCartridgeInserting", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonRamrodReadyStance", 1),
			(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_CannonballInsert1"),
			(agent_get_position, pos1, ":CannonCannoneer1"),
			(position_move_y, pos1, -65, 0),
			(agent_set_scripted_destination, ":CannonCannoneer1", pos1, 1, 1),
			(agent_start_running_away, ":CannonCannoneer1", pos1),
			(else_try), # YuriCannonMode_InterrruptedReloading_LoadCartridge
			(eq, ":CannonMode", YuriCannonMode_InterrruptedReloading_LoadCartridge),
			(scene_prop_set_visibility, ":CannonRamrod1", 0),
			(scene_prop_set_visibility, ":CannonRamrod2", 0),
			(prop_instance_get_position, pos2, ":CannonBarrel"),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 125, 0),
			(position_move_x, pos3, -50, 0),
			(agent_set_scripted_destination, ":CannonCannoneer1", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneer1", pos3),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, 105, 0),
			(position_move_x, pos3, 50, 0),
			(agent_set_scripted_destination, ":CannonCannoneer2", pos3, 1, 1),
			(agent_start_running_away, ":CannonCannoneer2", pos3),
			(copy_position, pos3, pos2),
			...
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_InterrruptedReloading_LoadCartridge_Moving),
			(else_try), # YuriCannonMode_InterrruptedReloading_LoadCartridge_Moving
			(eq, ":CannonMode", YuriCannonMode_InterrruptedReloading_LoadCartridge_Moving),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			...
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonCartridgeInserting", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonRamrodReadyStance", 1),
			(prop_instance_play_sound, ":CannonBody", "snd_Yuri_CannonballInsert1"),
			(scene_prop_set_visibility, ":CannonRamrod1", 1),
				(try_begin),
				(agent_equip_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge", 1),
				(agent_set_wielded_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge"),
				(try_end),
			(else_try), # YuriCannonMode_Reloading_LoadingCartridge, timer = 40
			(eq, ":CannonMode", YuriCannonMode_Reloading_LoadingCartridge),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonLastReloadingPhase, YuriCannonMode_Reloading_LoadingCartridge),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (position_rotate_x, pos1, 180), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(agent_get_animation, ":Animation1", ":CannonCannoneer1", 1),
				(try_begin),
				(neq, ":Animation1", "anim_Yuri_CannonCartridgeInserting"),
				(agent_unequip_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge", 1),
				(agent_set_animation, ":CannonCannoneer1", "anim_YuriCancelAnimation", 1),
				(try_end),
			(neq, ":Animation1", "anim_Yuri_CannonCartridgeInserting"),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Reloading_PushingCartridge),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 40),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonBarrelCleaningRight", 1),
			(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_CannonRamrod1"),
			(else_try), # YuriCannonMode_Reloading_PushingCartridge, timer = 40
			(eq, ":CannonMode", YuriCannonMode_Reloading_PushingCartridge),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_animation, ":Animation2", ":CannonCannoneer2", 1),
				...
				(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1),
				(prop_instance_get_position, pos2, ":CannonBarrel"), (position_move_y, pos2, -100, 0),
				(get_distance_between_positions, ":Distance", pos1, pos2), (position_move_y, pos2, ":Distance", 0), (position_move_y, pos2, 10, 0), (position_rotate_x, pos2, 180),
				(prop_instance_animate_to_position, ":CannonRamrod1", pos2, 4),
				(try_end),
			(neq, ":Animation2", "anim_Yuri_CannonBarrelCleaningRight"),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_Initial),
			(prop_instance_get_position, pos3, ":CannonBarrel"),
			...
			(agent_start_running_away, ":CannonCannoneer2", pos3),
			(prop_instance_get_position, pos3, ":CannonBarrel"),
			(position_move_y, pos3, -250, 0),
			(position_move_x, pos3, 0, 0),
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(else_try), # YuriCannonMode_Firing_Initial
			(eq, ":CannonMode", YuriCannonMode_Firing_Initial),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (position_rotate_x, pos1, 180), (position_move_y, pos1, -40, 0), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_Yuri_CannonAiming", 1),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_Yuri_CannonAiming", 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_Aiming),
			(store_random_in_range, ":Random", 60, 80),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, ":Random"),
			(else_try), # YuriCannonMode_Firing_Aiming, timer = 60-80
			(eq, ":CannonMode", YuriCannonMode_Firing_Aiming),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (position_rotate_x, pos1, 180), (position_move_y, pos1, -40, 0), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(call_script, "script_Yuri_CannoneerApplyRamrodStance", ":CannonCannoneer2"),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(agent_get_look_position, pos2, ":CannonCannoneerOfficer"),
			(set_fixed_point_multiplier, 100),
			(get_angle_between_positions, ":Angle", pos1, pos2),
			(set_fixed_point_multiplier, 1),
				(try_begin),
				(neq, ":Angle", 0),
				(call_script, "script_get_modulus_of_value", ":Angle"), (assign, ":Angle3", reg0),
				(val_div, ":Angle", ":Angle3"),
				(ge, ":Angle3", 100),
				(val_mul, ":Angle", 100),
				(try_end),
			(set_fixed_point_multiplier, 100),
			(position_rotate_z_floating, pos1, ":Angle", 0),
			(set_fixed_point_multiplier, 1),
			(position_transform_position_to_local, pos3, pos1, pos2), (position_get_rotation_around_x, ":Angle1", pos3),
				(try_begin),
				(get_angle_between_positions, ":Angle", pos1, pos2),
				(is_between, ":Angle", -90, 90),
				(position_rotate_x, pos1, ":Angle1"),
				(try_end),
			(prop_instance_animate_to_position, ":CannonBarrel", pos1, 4),
			(prop_instance_get_position, pos3, ":CannonBody"),
			(set_fixed_point_multiplier, 1),
			(get_angle_between_positions, ":Angle", pos3, pos1),
			(scene_prop_set_slot, ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationZ, ":Angle"),
			(position_get_rotation_around_x, ":Angle1", pos1), (position_get_rotation_around_x, ":Angle2", pos3), (store_sub, ":Angle1", ":Angle1", ":Angle2"),
			(scene_prop_set_slot, ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationX, ":Angle1"),
				(try_begin),
				(this_or_next|ge, ":Angle", 12),
				(le, ":Angle", -12),
				(call_script, "script_get_modulus_of_value", ":Angle"), (assign, ":Angle3", reg0),
				(val_div, ":Angle", ":Angle3"), (val_mul, ":Angle", 4),
				(position_rotate_z, pos3, ":Angle", 0),
				(call_script, "script_Yuri_PosAllignToGroundLevel", pos3),
				(prop_instance_animate_to_position, ":CannonBody", pos3, 15),
				(position_move_z, pos3, 70, 0),
				(copy_position, pos4, pos3),
				...
				(try_end),
			(prop_instance_get_position, pos1, ":CannonBody"),
			(position_move_y, pos1, -250, 0),
			(position_move_x, pos1, 0, 0),
			(position_copy_rotation, pos1, pos2),
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos1, 1, 1),
			(agent_get_team, ":TeamOfOfficer", ":CannonCannoneerOfficer"),
			(agent_get_division , ":Division", ":CannonCannoneerOfficer"),
			...
			(agent_get_position, pos2, ":Target"),
			(position_move_z, pos1, 90, 1), (position_move_z, pos2, 150, 1),
			(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon2_Body"),
			(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon2Breech_Body"),
			(position_has_line_of_sight_to_position, pos1, pos2),
			(prop_instance_get_position, pos1, ":CannonBarrel"), (agent_get_look_position, pos2, ":Target"),
			(call_script, "script_turn_pos_towards_pos", pos1, pos2),
			(prop_instance_get_position, pos3, ":CannonBarrel"),
			(set_fixed_point_multiplier, 1),
			(get_angle_between_positions, ":Angle", pos3, pos1),
			(le, ":Angle", 4), (ge, ":Angle", -4),
			...
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 1),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_YuriCancelAnimation", 0),
			(prop_instance_get_position, pos1, ":CannonRamrod1"),
			(position_move_x, pos3, 100, 1),
			(position_set_z_to_ground_level, pos1),
			(call_script, "script_Yuri_PosAllignToGroundLevel", pos1),
			(prop_instance_animate_to_position, ":CannonRamrod1", pos1, 25),
			(agent_get_position, pos1, ":CannonCannoneerOfficer"),
			(agent_get_position, pos2, ":Target"),
			(get_distance_between_positions, ":Angle", pos1, pos2),
			(val_div, ":Angle", 120),
			(val_add, ":Angle", -75),
			(set_fixed_point_multiplier, 5),
			(position_get_z, ":Pos1_Z", pos1),
			(position_get_z, ":Pos2_Z", pos2),
			(store_sub, ":Z_Difference", ":Pos2_Z", ":Pos1_Z"),
			(val_add, ":Angle", ":Z_Difference"),
			(prop_instance_get_position, pos3, ":CannonBarrel"),
			(agent_get_look_position, pos2, ":CannonCannoneerOfficer"),
			(position_copy_rotation, pos3, pos2),
			(set_fixed_point_multiplier, 100),
				(try_begin),
				(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon1_Body"),
				(eq, ":TypeOfCannonBody", "spr_YuriCannon1Breech_Body"),
				(position_rotate_x_floating, pos3, ":Angle"),
					(try_begin),
					(eq, ":RiflingType", cannon_rifling_type_notrifled),
					(store_random_in_range, ":Random1", -60, 40),
					(store_random_in_range, ":Random2", -100, 100),
					(else_try),
					(store_random_in_range, ":Random1", -30, 20),
					(store_random_in_range, ":Random2", -50, 50),
					(try_end),
				(position_rotate_x_floating, pos3, ":Random1"),
				(position_rotate_z_floating, pos3, ":Random2"),
				(position_rotate_y_floating, pos3, 200),
				(else_try),
				(init_position, pos4),
				(position_copy_origin, pos4, pos3),
				(set_fixed_point_multiplier, 100),
				(get_angle_between_positions, ":Angle2", pos4, pos3),
				(position_rotate_z_floating, pos4, ":Angle2", 1),
				(set_fixed_point_multiplier, 1),
				(agent_get_position, pos2, ":Target"),
				(call_script, "script_YuriGetAngleForHowitzerAiming", pos3, pos2), (assign, ":AngleForHowitzer", reg1),
				(set_fixed_point_multiplier, 100),
				(position_rotate_x_floating, pos4, ":AngleForHowitzer", 0),
				(set_fixed_point_multiplier, 1),
				(copy_position, pos3, pos4),
				(try_end),
			(set_fixed_point_multiplier, 1),
			(prop_instance_animate_to_position, ":CannonBarrel", pos3, 15),
			(prop_instance_get_animation_target_position, pos1, ":CannonBarrel"), (prop_instance_get_position, pos3, ":CannonBody"),
			(set_fixed_point_multiplier, 1), (get_angle_between_positions, ":Angle", pos3, pos1),
			(position_transform_position_to_local, pos2, pos3, pos1), (position_get_rotation_around_x, ":Angle1", pos2),
			(scene_prop_set_slot, ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationZ, ":Angle"),
			(scene_prop_set_slot, ":CannonBarrel", YuriSlotProp_CannonBarrel_RotationX, ":Angle1"),
			(else_try), # YuriCannonMode_Firing_PreparingToFire, timer = 30-60
			(eq, ":CannonMode", YuriCannonMode_Firing_PreparingToFire),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			...
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(call_script, "script_cf_if_team_has_artillery_shells", ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_Lighting),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 20),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonEarsPlugging_Left", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonEarsPlugging_Right", 1),
			(agent_set_animation, ":CannonCannoneer3", "anim_Yuri_CannonLighting", 1),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_Yuri_CannonOneEarPlugging_Right", 1),
			(scene_prop_set_visibility, ":CannonRope1", 1),
			(else_try), # YuriCannonMode_Firing_Lighting, timer = 20
			(eq, ":CannonMode", YuriCannonMode_Firing_Lighting),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			...
			(position_get_rotation_around_x, ":AngleAlpha", pos3),
			(val_mul, ":AngleAlpha", 100),
				(try_begin),
				(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon1_Body"),
				(eq, ":TypeOfCannonBody", "spr_YuriCannon1Breech_Body"),
				(prop_instance_get_position, pos1, ":CannonBarrel"), (position_move_y, pos1, 150, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIsFlying, 1),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballAngleAlpha, ":AngleAlpha"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballMuzzleVelocity, 300),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFlyingTime, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIncomingSoundWasPlayed, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballProjectileType, ":ProjectileType"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballHEType, ":HEType"),
				(prop_instance_set_position, ":Cannonball", pos1),
				(scene_prop_set_visibility, ":Cannonball", 1),
				(else_try),
				(prop_instance_get_position, pos1, ":CannonBarrel"), (position_move_y, pos1, 100, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIsFlying, 1),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballAngleAlpha, ":AngleAlpha"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballMuzzleVelocity, howitzer_muzzle_velocity),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFlyingTime, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballIncomingSoundWasPlayed, 0),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballProjectileType, ":ProjectileType"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballHEType, ":HEType"),
					...
					(call_script, "script_YuriGetAngleForHowitzerAiming", pos1, pos4), (assign, ":AngleForHowitzer", reg1),
					(set_fixed_point_multiplier, 100),
					(position_rotate_x_floating, pos2, ":AngleForHowitzer", 0), (position_move_y, pos2, 100, 0),
						...
						(else_try),
						(store_random_in_range, ":Random1", -600, 600),
						(store_random_in_range, ":Random2", -600, 600),
						(try_end),
					(position_rotate_x_floating, pos2, ":Random1"),
					(position_rotate_z_floating, pos2, ":Random2"),
					(set_fixed_point_multiplier, 1),
					(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballAngleAlpha, ":AngleForHowitzer"),
					(prop_instance_set_position, ":Cannonball", pos2),
					(get_distance_between_positions_in_meters, ":Min", pos4, pos2),
					(val_div, ":Min", 8),
					(else_try),
						(try_begin),
						(ge, ":AngleAlpha", 180),
						(store_div, ":AngleAlphaDiv100", ":AngleAlpha", 100),
						(store_sub, ":Min", 360, ":AngleAlphaDiv100"),
						(val_mul, ":Min", -1),
						(else_try),
						(assign, ":Min", ":AngleAlphaDiv100"),
						(try_end),
					(val_add, ":Min", 90), (val_div, ":Min", 2),
					(prop_instance_set_position, ":Cannonball", pos1),
					(try_end),
				(store_add, ":Max", ":Min", 35), (store_random_in_range, ":Random", ":Min", ":Max"),
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballFuseBallTimer, ":Random"),
				(scene_prop_set_visibility, ":Cannonball", 1),
				(try_end),
			(prop_instance_get_position, pos1, ":CannonBarrel"), (position_move_y, pos1, 150, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonRecoilVelocity, 90),
			(particle_system_burst, "psys_musket_flash", pos1, 50),
			(particle_system_burst, "psys_cannon_smoke", pos1, 150),
				(try_begin),
				(mission_cam_get_position, pos2),
				(get_distance_between_positions_in_meters, ":Distance", pos1, pos2),
				(le, ":Distance", 40),
				(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_Cannon_Fire1"),
				(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_Cannon_Fire1"),
				(else_try),
				(val_mul, ":Distance", 100),
				(call_script, "script_play_distant_sound_at_pos_based_on_distance", "snd_Yuri_Cannon_Fire_Far1", ":Distance", pos1),
				(try_end),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_Shot),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonLastReloadingPhase, YuriCannonMode_Reloading_Initial),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 20),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonEarsPlugging_Left_Shot", 1),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonEarsPlugging_Right_Shot", 1),
			(agent_set_animation, ":CannonCannoneer3", "anim_Yuri_CannonLighting_Shot", 1),
			(agent_set_animation, ":CannonCannoneerOfficer", "anim_Yuri_CannonOneEarPlugging_Right_Shot", 1),
			(else_try), # YuriCannonMode_Firing_Shot, timer = 20
			(eq, ":CannonMode", YuriCannonMode_Firing_Shot),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			...
			(set_fixed_point_multiplier, 100), (prop_instance_set_scale, ":CannonRope1", 100, ":Scale", 100), (set_fixed_point_multiplier, 1),
				(try_begin),
				(gt, ":CannonRecoilVelocity", 0),
				(val_mul, ":CannonRecoilVelocity", -1),
				(prop_instance_get_position, pos3, ":CannonBody"),
				(position_move_y, pos3, ":CannonRecoilVelocity", 0),
				(call_script, "script_Yuri_PosAllignToGroundLevel", pos3),
				(prop_instance_animate_to_position, ":CannonBody", pos3, 15),
				(position_move_z, pos3, 70, 0),
				(copy_position, pos4, pos3),
				(val_mul, ":CannonRecoilVelocity", -25),
				(val_div, ":CannonRecoilVelocity", 10),
				(val_add, ":CannonWheels_RotationX", ":CannonRecoilVelocity"),
				(set_fixed_point_multiplier, 10),
				(position_rotate_x_floating, pos4, ":CannonWheels_RotationX"),
				(set_fixed_point_multiplier, 1),
				(scene_prop_set_slot, ":CannonWheels", YuriSlotProp_CannonWheels_RotationX, ":CannonWheels_RotationX"),
				...
				(try_end),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_PreparingToPullBack),
			(scene_prop_set_visibility, ":CannonRope1", 0),
			(prop_instance_get_position, pos1, ":CannonBody"),
			...
			(agent_start_running_away, ":CannonCannoneer2", pos3),
			(agent_set_animation, ":CannonCannoneer3", "anim_YuriCancelAnimation", 1),
			(else_try), # YuriCannonMode_Firing_PreparingToPullBack
			(eq, ":CannonMode", YuriCannonMode_Firing_PreparingToPullBack),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_PullingBack),
			(prop_instance_stop_sound, ":CannonBody"),
			(prop_instance_play_sound, ":CannonBody", "snd_Yuri_CannonCarriageMoving1"),
			...
			(scene_prop_set_visibility, ":CannonRope1", 1),
			(scene_prop_set_visibility, ":CannonRope2", 1),
			(else_try), # YuriCannonMode_Firing_PullingBack
			(eq, ":CannonMode", YuriCannonMode_Firing_PullingBack),
			(prop_instance_get_position, pos1, ":CannonBody"),
			(position_move_y, pos1, 10000, 0),
			# (agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			# (agent_set_look_target_position, ":CannonCannoneer3", pos1),
			...
			(agent_get_position, pos2, ":CannonCannoneer2"),
			(call_script, "script_Yuri_GetAveragePos", pos1, pos2, pos3),
			(agent_get_look_position, pos4, ":CannonCannoneerOfficer"),
			...
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(prop_instance_get_animation_target_position, pos3, ":CannonBody"),
			(agent_get_look_position, pos2, ":CannonCannoneerOfficer"),
			(set_fixed_point_multiplier, 100),
			(get_angle_between_positions, ":Angle", pos3, pos2),
			(position_rotate_z_floating, pos3, ":Angle", 1),
			(set_fixed_point_multiplier, 1),
			(call_script, "script_Yuri_PosAllignToGroundLevel", pos3),
			(prop_instance_animate_to_position, ":CannonBody", pos3, 15),
			(position_move_z, pos3, 70, 0),
			(copy_position, pos4, pos3),
			(val_add, ":CannonWheels_RotationX", -15),
			(set_fixed_point_multiplier, 10),
			(position_rotate_x_floating, pos4, ":CannonWheels_RotationX"),
			(set_fixed_point_multiplier, 1),
			(scene_prop_set_slot, ":CannonWheels", YuriSlotProp_CannonWheels_RotationX, ":CannonWheels_RotationX"),
			...
			(prop_instance_animate_to_position, ":CannonBarrel", pos3, 15),
			(prop_instance_stop_sound, ":CannonBody"),
			(prop_instance_get_animation_target_position, pos2, ":CannonBarrel"),
				(try_begin),
				(this_or_next|eq, ":TypeOfCannonBody", "spr_YuriCannon1Breech_Body"),
				(eq, ":TypeOfCannonBody", "spr_YuriCannon2Breech_Body"),
				(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_BreechReloading_Initial),
				(copy_position, pos3, pos2),
				(position_move_y, pos3, -85, 0),
				(position_move_x, pos3, -50, 0),
				(agent_set_scripted_destination, ":CannonCannoneer1", pos3, 1, 1),
				(agent_start_running_away, ":CannonCannoneer1", pos3),
				(copy_position, pos3, pos2),
			...
			(scene_prop_set_visibility, ":CannonRamrod1", 1),
			(scene_prop_set_visibility, ":CannonRamrod2", 1),
			(else_try), # YuriCannonMode_BreechReloading_Initial
			(eq, ":CannonMode", YuriCannonMode_BreechReloading_Initial),
			(scene_prop_set_visibility, ":CannonRamrod2", 0),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_BreechReloading_BarrelCleaning),
			(agent_set_animation, ":CannonCannoneer2", "anim_Yuri_CannonBarrelCleaningBreech", 1),
			(prop_instance_play_sound, ":CannonBarrel", "snd_Yuri_CannonRamrod1"),
			(agent_get_scripted_destination, pos1, ":CannonCannoneer2"),
			(agent_set_position, ":CannonCannoneer2", pos1),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 40),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(else_try),  # YuriCannonMode_BreechReloading_BarrelCleaning, timer = 40
			(eq, ":CannonMode", YuriCannonMode_BreechReloading_BarrelCleaning),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_animation, ":Animation1", ":CannonCannoneer2", 1),
				(try_begin),
				(neq, ":Animation1", "anim_Yuri_CannonBarrelCleaningBreech"),
				(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
				(else_try),
				(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1),
				(prop_instance_get_position, pos2, ":CannonBarrel"), (position_move_y, pos2, -300, 0),
				(get_distance_between_positions, ":Distance", pos1, pos2), (position_move_y, pos2, ":Distance", 0), (position_rotate_z, pos2, 180, 0),
				(prop_instance_animate_to_position, ":CannonRamrod1", pos2, 4),
				(try_end),
			(neq, ":Animation1", "anim_Yuri_CannonBarrelCleaningBreech"),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(call_script, "script_cf_if_team_has_artillery_shells", ":CannonCannoneerOfficer"),
			(call_script, "script_team_consume_artillery_shell", ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_BreechReloading_LoadingCartridge),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonTimer, 40),
			(agent_set_animation, ":CannonCannoneer1", "anim_Yuri_CannonCartridgeInsertingBreech", 1),
			(prop_instance_play_sound, ":CannonBody", "snd_Yuri_CannonballInsert1"),
			(scene_prop_set_visibility, ":CannonRamrod1", 1),
				(try_begin),
				(agent_equip_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge", 1),
				(agent_set_wielded_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge"),
				(try_end),
			(else_try), # YuriCannonMode_InterrruptedBreechReloading_LoadingCartridge
			(eq, ":CannonMode", YuriCannonMode_InterrruptedBreechReloading_LoadingCartridge),
			(scene_prop_set_visibility, ":CannonRamrod1", 0),
			(prop_instance_get_position, pos2, ":CannonBarrel"),
			(copy_position, pos3, pos2),
			(position_move_y, pos3, -85, 0),
			...
			(agent_set_scripted_destination, ":CannonCannoneerOfficer", pos3, 1, 1),
			(agent_stop_running_away, ":CannonCannoneerOfficer"),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_InterrruptedBreechReloading_LoadingCartridge_Moving),
			(else_try), # YuriCannonMode_InterrruptedBreechReloading_LoadingCartridge_Moving
			(eq, ":CannonMode", YuriCannonMode_InterrruptedBreechReloading_LoadingCartridge_Moving),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer1"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer2"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneer3"),
			(call_script, "script_cf_Yuri_DidCannoneerArriveAtHisPosition", ":CannonCannoneerOfficer"),
			...
			(scene_prop_set_visibility, ":CannonRamrod1", 1),
				...
				(agent_set_wielded_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge"),
				(try_end),
			(else_try), # YuriCannonMode_BreechReloading_LoadingCartridge, timer = 40
			(eq, ":CannonMode", YuriCannonMode_BreechReloading_LoadingCartridge),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonLastReloadingPhase, YuriCannonMode_BreechReloading_LoadingCartridge),
			(prop_instance_get_position, pos1, ":CannonBarrel"),
			(position_move_y, pos1, 10000, 0),
			(agent_set_look_target_position, ":CannonCannoneer1", pos1), (agent_set_look_target_position, ":CannonCannoneer2", pos1),
			(agent_set_look_target_position, ":CannonCannoneer3", pos1),
			(agent_get_bone_position, pos1, ":CannonCannoneer2", 19, 1), (position_rotate_x, pos1, 180), (prop_instance_animate_to_position, ":CannonRamrod1", pos1, 4),
			(agent_get_animation, ":Animation1", ":CannonCannoneer1", 1),
			(neq, ":Animation1", "anim_Yuri_CannonCartridgeInsertingBreech"),
			(agent_unequip_item, ":CannonCannoneer1", "itm_YuriCannonballCartridge", 1),
			(agent_set_animation, ":CannonCannoneer1", "anim_YuriCancelAnimation", 1),
			(scene_prop_slot_eq, ":CannonBody", YuriSlotProp_CannonTimer, 0),
			(scene_prop_set_slot, ":CannonBody", YuriSlotProp_CannonMode, YuriCannonMode_Firing_Initial),
		...
		(try_end),
	(try_end),
#(display_debug_message, "@YuriCannon33MS End"),
])
...
pbs_company_penaltytodiscipline_fromcloseenemy = (0.5, 0, 0, [
	...
	(team_set_slot, ":team", ":slot_team_penaltytodiscipline_fromcloseenemy", 0),
	(try_end),
	...
	(val_div, ":dist", 4),
		...
		(try_end),
	(store_add, ":slot_team_penaltytodiscipline_fromcloseenemy", slot_team_company1_penaltytodiscipline_fromcloseenemy, ":company"),
	(team_get_slot, ":penaltytodiscipline_fromcloseenemy", ":team", ":slot_team_penaltytodiscipline_fromcloseenemy"),
	(store_sub, ":penalty", 5000, ":dist"),
	(store_add, ":slot_team_soldier_number", slot_team_company1_soldier_number, ":company"),
	(team_get_slot, ":soldier_number", ":team", ":slot_team_soldier_number"),
...
pbs_company_discipline = (0.2, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(val_sub, ":penaltytodiscipline_fromfire", 25),
		(val_clamp, ":penaltytodiscipline_fromfire", 0, 3501),
	...
	(try_for_range, ":team", 0, 4),
		...
		(team_get_slot, ":soldier_number", ":team", ":slot_team_soldier_number"),
		(store_add, ":slot_team_guards_number", slot_team_company1_guards_number, ":company"),
		(team_get_slot, ":guards_number", ":team", ":slot_team_guards_number"),
		(store_add, ":slot_team_penaltytodiscipline_fromfire", slot_team_company1_penaltytodiscipline_fromfire, ":company"),
		(team_get_slot, ":penaltytodiscipline_fromfire", ":team", ":slot_team_penaltytodiscipline_fromfire"),
		(store_add, ":slot_team_penaltytodiscipline_fromcloseenemy", slot_team_company1_penaltytodiscipline_fromcloseenemy, ":company"),
		(team_get_slot, ":penaltytodiscipline_fromcloseenemy", ":team", ":slot_team_penaltytodiscipline_fromcloseenemy"),
		...
		(assign, ":discipline", 9000),
		(val_sub, ":discipline", ":penaltytodiscipline_fromfire"),
		(val_sub, ":discipline", ":penaltytodiscipline_fromcloseenemy"),
		(val_sub, ":discipline", ":penaltytodiscipline_fromcasualties"),
		(store_mul, ":guards_bonus", ":guards_number", 10),
		(val_div, ":guards_bonus", ":soldier_number"),
		(val_mul, ":guards_bonus", 100),
		(val_add, ":discipline", ":guards_bonus"),
		(val_clamp, ":discipline", 100, 10001),
			(try_begin),
			(eq, ":team", "$g_player_team"),
			(main_hero_fallen),
			(val_add, ":discipline", -1500),
			(try_end),
...
timer_1000ms = (1, 0, 0, [
	...
	(team_get_slot, ":retreat_timer", ":team", slot_team_pai_retreat_timer),
		(try_begin),
		(gt, ":timer", 0),
		(val_sub, ":timer", 1),
		...
		(try_begin),
		(gt, ":retreat_timer", 0),
		(val_sub, ":retreat_timer", 1),
		(team_set_slot, ":team", slot_team_pai_retreat_timer, ":retreat_timer"),
		(try_end),
		(try_for_range, ":company", 0, 8),
		...
		(gt, ":timer", 0),
		(val_sub, ":timer", 1),
		(team_set_slot, ":team", ":slot_team_timer", ":timer"),
			(try_begin),
			(store_add, ":slot_team_state", slot_team_company1_state, ":company"),
			(team_slot_eq, ":team", ":slot_team_state", pbs_state_retreating),
			(eq, ":timer", 0),
			(team_set_slot, ":team", ":slot_team_state", pbs_state_generic),
			(call_script, "script_company_play_bugle", ":team", ":company", "snd_bugle_stop_retreat"),
			(call_script, "script_company_stop_retreat", ":team", ":company"),
			(try_end),
		(try_end),
	(try_end),
(gt, "$bugle_cooldown", 0),
...
pbs_company_state = (0.4, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(store_add, ":slot_team_guards_number", slot_team_company1_guards_number, ":company"),
		(team_set_slot, ":team", ":slot_team_guards_number", 0),
		(store_add, ":slot_team_aiming_number", slot_team_company1_aiming_soldier_number, ":company"),
		(team_set_slot, ":team", ":slot_team_aiming_number", 0),
		(try_end),
	(try_end),
	(try_for_agents,":agent"),
	(agent_is_active, ":agent"),
	...
	(team_get_slot, ":guards_number", ":team", ":slot_team_guards_number"),
	(team_get_slot, ":aiming_soldier_number", ":team", ":slot_team_aiming_number"),
	(val_add, ":soldier_number", 1),
	(agent_get_troop_id, ":troop", ":agent"),
		(try_begin),
		(this_or_next|troop_slot_eq, ":troop", slot_troop_pbs_type, pbs_troop_type_guard),
		(troop_slot_eq, ":troop", slot_troop_pbs_type, pbs_troop_type_cavguard),
		(val_add, ":guards_number", 1),
		(try_end),
	(agent_get_animation, ":anim", ":agent", 0),
	(agent_get_animation, ":anim1", ":agent", 1),
		(try_begin),
		(this_or_next|eq, ":anim1", "anim_ready_crossbow"),
		(this_or_next|eq, ":anim1", "anim_ready_musket"),
		(eq, ":anim1", "anim_ready_pistol"),
		(val_add, ":aiming_soldier_number", 1),
		(try_end),
		(try_begin),
	...
	(team_set_slot, ":team", ":slot_team_aiming_number", ":aiming_soldier_number"),
	(try_end),
],[])
...
pbs_company_retreat = (1, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(neq, ":type", pbs_troop_type_fieldguns), (neq, ":type", pbs_troop_type_howitzers),
		(store_add, ":slot_team_discipline", slot_team_company1_discipline, ":company"),
		(team_get_slot, ":discipline", ":team", ":slot_team_discipline"),
		(lt, ":discipline", 1500),
		(store_add, ":slot_team_state", slot_team_company1_state, ":company"),
		(neg|team_slot_eq, ":team", ":slot_team_state", pbs_state_retreating),
		(call_script, "script_company_retreat", ":team", ":company"),
		(call_script, "script_company_play_bugle", ":team", ":company", "snd_bugle_retreat"),
			(try_begin),
			(eq, "$g_player_team", ":team"),
			(store_add, reg0, ":company", 1),
			(display_message, "@{reg0}. Company was forced to retreat."),
			(try_end),
		(try_end),
	(try_end),
],[])
...
pbs_company_energy = (0.5, 0, 0, [
	(try_for_range, ":team", 0, 4),
		...
		(val_div, ":proportion", ":soldier_number"),
			...
			(this_or_next|eq, ":type", pbs_troop_type_cavguard),
			...
			(val_add, ":energy", 15),
				...
				(this_or_next|eq, ":type", pbs_troop_type_cavmelee),
				(this_or_next|eq, ":type", pbs_troop_type_cavranged),
				(eq, ":type", pbs_troop_type_cavguard),
				(val_add, ":energy", 10),
				(try_end),
			(try_end),
		(val_clamp, ":energy", 100, 10001),
...
(call_script, "script_reset_companies_accuracy"),
	...
	(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
		(try_begin),
		(team_slot_eq, ":team", ":slot_team_type", pbs_troop_type_light),
		(assign, ":damage", 70),
		(else_try),
		(this_or_next|team_slot_eq, ":team", ":slot_team_type", pbs_troop_type_guard),
		(team_slot_eq, ":team", ":slot_team_type", pbs_troop_type_cavguard),
		(assign, ":damage", 115),
		(try_end),
		(try_begin),
		(team_slot_eq, ":team", ":slot_team_run_mode", pbs_run_mode_running),
	...
	(assign, ":energy_accuracy_modifier", 100),
	(assign, ":energy_damage_modifier", 100),
		...
		(val_add, ":energy_accuracy_modifier", 50),
		(try_end),
		(try_begin),
		(le, ":energy", 70),
		(store_div, ":energy_damage_modifier", ":energy", 1),
		(val_add, ":energy_damage_modifier", 70),
		(try_end),
	(val_mul, ":damage", ":energy_damage_modifier"),
	(val_div, ":damage", 100),
	...
	(store_add, ":slot_team_discipline", slot_team_company1_discipline, ":company"),
	(team_get_slot, ":discipline", ":team", ":slot_team_discipline"),
	(val_div, ":discipline", 100),
	(assign, ":discipline_accuracy_modifier", 100),
		(try_begin),
		(le, ":discipline", 80),
		(store_div, ":discipline_accuracy_modifier", ":discipline", 2),
		(val_add, ":discipline_accuracy_modifier", 45),
		(try_end),
	...
	(agent_set_damage_modifier, ":agent", ":damage"),
	(store_add, ":slot_team_accuracy", slot_team_company1_accuracy, ":company"),
	(team_get_slot, ":company_accuracy", ":team", ":slot_team_accuracy"),
	(val_add, ":company_accuracy", ":accuracy"),
	(team_set_slot, ":team", ":slot_team_accuracy", ":company_accuracy"),
	(try_end),
	...
	(try_for_range, ":team", 0, 4),
		...
		(val_mul, ":company_accuracy", 167),
		(val_div, ":company_accuracy", 100),
		(val_div, ":company_accuracy", ":soldier_number"),
		(team_set_slot, ":team", ":slot_team_accuracy", ":company_accuracy"),
		(try_end),
	(try_end),
],
...
(agent_is_human, ":agent"),
(agent_is_non_player, ":agent"),
(call_script, "script_cf_get_agent_faction_rifle_type", ":agent"), (assign, ":rifle_type", reg0),
...
(store_add, ":slot_item_analog", slot_item_rifled_analog-1, ":rifle_type"),
	...
	(agent_equip_item, ":agent", ":analog", ":slot"),
	(try_end),
], [])
...
bot_animation = (0, 0, 0,[
	...
	(this_or_next|team_slot_eq, ":team", ":slot_team_company_type", pbs_troop_type_light),
	(agent_slot_eq, ":agent", slot_agent_square_formation_state, 1),
	(agent_get_animation, ":anim", ":agent", 0),
...
(team_get_slot, ":global_tactic", "$g_enemy_team", slot_team_pai_global_tactic),
	...
	(eq, ":timer", 0),
		...
		(else_try),
		(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_initial),
		(try_end),
	(try_end),
	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_attack_forming_ranks), # Formed ranks - approaching enemy
	(eq, ":timer", 0),
	(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_approaching),
	(try_end),
	(try_begin),
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching), # Approaching enemy - searching target that is closest enemy company
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching_close),
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_charging),
	(eq, ":global_tactic", pai_global_tactic_attack_stop_retreat),
	(eq, ":timer", 0),
	(team_set_slot, "$g_enemy_team", slot_team_pai_timer, 25),
	...
	(position_rotate_z, pos1, ":z_coor", 1),
	(assign, ":min_dist", 999999), (assign, ":target_team", -1), (assign, ":target_company", -1),
		(try_for_range, ":team", 0, 4),
		(this_or_next|eq, ":team", "$g_player_team"),
		(eq, ":team", "$g_allies_team"),
			(try_for_range, ":company", 0, 8),
			(call_script, "script_cf_if_company_has_soldiers", ":team", ":company"),
			(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
			(team_get_slot, ":type", ":team", ":slot_team_type"),
			(this_or_next|eq, ":type", pbs_troop_type_line),
			(this_or_next|eq, ":type", pbs_troop_type_light),
			(this_or_next|eq, ":type", pbs_troop_type_guard),
			(this_or_next|eq, ":type", pbs_troop_type_fieldguns),
			(eq, ":type", pbs_troop_type_howitzers),
			(call_script, "script_store_company_average_position_to_pos30", ":team", ":company"),
			(get_distance_between_positions, ":dist", pos30, pos1),
			(le, ":dist", ":min_dist"),
			(assign, ":min_dist", ":dist"),
			(assign, ":target_team", ":team"),
		...
		(try_end),
	(neq, ":target_team", -1),
	(neq, ":target_company", -1),
	(team_set_slot, "$g_enemy_team", slot_team_pai_target_team, ":target_team"),
	(team_set_slot, "$g_enemy_team", slot_team_pai_target_company, ":target_company"),
		(try_for_range, ":company", 0, 8), # Switch to ranged weapons and walk mode
		...
		(team_slot_eq, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_generic),
		(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":type", "$g_enemy_team", ":slot_team_type"),
		(team_give_order, "$g_enemy_team", ":company", mordr_use_ranged_weapons),
		(store_add, ":slot_team_run_mode", slot_team_company1_run_mode, ":company"),
		(team_set_slot, "$g_enemy_team", ":slot_team_run_mode", pbs_run_mode_walking),
			(try_begin),
			(eq, ":global_tactic", pai_global_tactic_attack_stop_retreat),
			(team_set_slot, "$g_enemy_team", ":slot_team_run_mode", pbs_run_mode_running),
			(try_end),
		(try_end),
...
# (display_message, "@distance {reg0}"),
	...
	(position_move_y, pos31, 2500, 0),
		...
		(else_try),
		(gt, ":distance", 3000), 
		(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_approaching_close),
		(else_try),
	...
	(team_get_slot, ":global_tactic", "$g_enemy_team", slot_team_pai_global_tactic),
		(try_begin),
		(eq, ":global_tactic", pai_global_tactic_attack_approaching),# Approach enemy
		(call_script, "script_team_create_infantry_formation_on_pos31", "$g_enemy_team", formation_type_ranged),
		(try_end),
		(try_begin),
		...
		(call_script, "script_team_create_infantry_formation_on_pos31", "$g_enemy_team", formation_type_melee),
			...
			(team_give_order, "$g_enemy_team", ":company", mordr_use_melee_weapons),
			(store_add, ":slot_team_run_mode", slot_team_company1_run_mode, ":company"),
			(team_set_slot, "$g_enemy_team", ":slot_team_run_mode", pbs_run_mode_running),
			(try_end),
		(team_set_slot, "$g_enemy_team", slot_team_pai_timer, 10),
		(try_end),
		(try_begin),
		(eq, ":global_tactic", pai_global_tactic_attack_charging), # Entire formation melee charge at 30 meters distance
			(try_for_range, ":company", 0, 8),
			(call_script, "script_cf_if_company_has_soldiers", "$g_enemy_team", ":company"),
			(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":company"),
			(team_slot_eq, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_generic),
...
(team_get_slot, ":timer", "$g_enemy_team", slot_team_pai_timer),
(team_get_slot, ":retreat_timer", "$g_enemy_team", slot_team_pai_retreat_timer),
(team_get_slot, ":global_tactic", "$g_enemy_team", slot_team_pai_global_tactic),
	(try_begin), #Stop approaching and start general retreat if more than 50% of formation is already retreating
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching),
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching_close),
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_charging),
	(eq, ":global_tactic", pai_global_tactic_attack_retreat),
		(try_begin),
		(assign, ":continue", 1),
		(eq, ":global_tactic", pai_global_tactic_attack_retreat),
		(eq, ":retreat_timer", 0),
	...
	(assign, ":retreating_number", 0),
		...
		(val_add, ":number", 1),
		(store_add, ":slot_team_state", slot_team_company1_state, ":company"),
		(team_slot_eq, "$g_enemy_team", ":slot_team_state", pbs_state_retreating),
		(val_add, ":retreating_number", 1),
		(try_end),
	(neq, ":number", 0),
	(val_mul, ":retreating_number", 100),
	(val_div, ":retreating_number", ":number"),
	(ge, ":retreating_number", 50),
(display_message, "@PAI RETREAT"),
		(try_for_range, ":company", 0, 8),
		(call_script, "script_cf_if_company_has_soldiers", "$g_enemy_team", ":company"),
		(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":company"),
		(team_slot_eq, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_generic),
		(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":type", "$g_enemy_team", ":slot_team_type"),
		(call_script, "script_company_retreat", "$g_enemy_team", ":company"),
		(call_script, "script_company_play_bugle", "$g_enemy_team", ":company", "snd_bugle_retreat"),
		(try_end),
		(try_begin),
		(neq, ":global_tactic", pai_global_tactic_attack_retreat),
		(team_set_slot, "$g_enemy_team", slot_team_pai_retreat_timer, 25),
		(try_end),
	(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_retreat),
	(try_end),
...
(team_get_slot, ":global_tactic", "$g_enemy_team", slot_team_pai_global_tactic),
	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_attack_retreat), # Stop general retreat
	(eq, ":retreat_timer", 0),
	(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_stop_retreat),
	(team_set_slot, "$g_enemy_team", slot_team_pai_timer, 25), # This should be depedent on squad retreat time
	(try_end),

	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_attack_initial),
	(eq, ":timer", 0),
	(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_attack_forming_ranks), # Forming battle formation for attack
	(team_set_slot, "$g_enemy_team", slot_team_pai_timer, 40),
	(team_get_slot, ":x_coor", "$g_enemy_team", slot_team_pai_start_position_x),
	(team_get_slot, ":y_coor", "$g_enemy_team", slot_team_pai_start_position_y),
	(team_get_slot, ":z_coor", "$g_enemy_team", slot_team_pai_start_position_z_rot),
	(init_position, pos31),
	(position_set_x, pos31, ":x_coor"),
	(position_set_y, pos31, ":y_coor"),
	(position_rotate_z, pos31, ":z_coor", 1),
		(try_begin),
		(eq, "$g_battle_type", battle_type_siege),
		(entry_point_get_position, pos31, 0),
		(try_end),
	(copy_position, pos1, pos31), (copy_position, pos30, pos31),
	(call_script, "script_company_hold_pos30", "$g_enemy_team", company8), (copy_position, pos31, pos1),
	(position_move_y, pos31, 2000, 0),
	(call_script, "script_team_create_infantry_formation_on_pos31", "$g_enemy_team", formation_type_ranged),
	(try_end),

	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_defend_initial),
	(eq, ":timer", 0),
	...
	(team_get_slot, ":z_coor", "$g_enemy_team", slot_team_pai_start_position_z_rot),
	(init_position, pos30),
	(position_set_x, pos30, ":x_coor"),
	(position_set_y, pos30, ":y_coor"),
	(position_rotate_z, pos30, ":z_coor", 1),
	(call_script, "script_store_highest_position_around_pos30_into_pos31"),
	(position_move_y, pos31, 1000, 0),
	(team_get_leader, ":leader", "$g_player_team"),
	(agent_get_position, pos30, ":leader"),
	(call_script, "script_rotate_pos31_towards_pos30"),
	(call_script, "script_team_create_infantry_formation_on_pos31", "$g_enemy_team", formation_type_melee),
	(position_move_y, pos31, -3000, 0),
	(copy_position, pos30, pos31),
	(call_script, "script_company_hold_pos30", "$g_enemy_team", company8),
	...
	(try_begin), # Cavalry will try to cover infantry with chasing enemy cavalry companies that are far from their infantry
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching),
	(this_or_next|eq, ":global_tactic", pai_global_tactic_attack_approaching_close),
	(eq, ":global_tactic", pai_global_tactic_defend_holding_position),
	(team_get_slot, ":target_team2", "$g_enemy_team", slot_team_pai_target_team),
	(team_get_slot, ":target_company2", "$g_enemy_team", slot_team_pai_target_company),
	(call_script, "script_cf_if_company_has_soldiers", ":target_team2", ":target_company2"),
	(call_script, "script_store_company_average_position_to_pos30", ":target_team2", ":target_company2"),
	(copy_position, pos3, pos30),
	(team_get_slot, ":x_coor", "$g_enemy_team", slot_team_pai_start_position_x),
	(team_get_slot, ":y_coor", "$g_enemy_team", slot_team_pai_start_position_y),
	(team_get_slot, ":z_coor", "$g_enemy_team", slot_team_pai_start_position_z_rot),
	(init_position, pos1),
	...
	(assign, ":min_dist", 999999), (assign, ":target_team", -1), (assign, ":target_company", -1),
		...
		(this_or_next|eq, ":team", "$g_player_team"),
		(eq, ":team", "$g_allies_team"),
			(try_for_range, ":enemy_company", 0, 8),
			(call_script, "script_cf_if_company_has_soldiers", ":team", ":enemy_company"),
			(store_add, ":slot_team_type", slot_team_company1_type, ":enemy_company"),
			(team_get_slot, ":type", ":team", ":slot_team_type"),
			(this_or_next|eq, ":type", pbs_troop_type_cavmelee),
			(this_or_next|eq, ":type", pbs_troop_type_cavranged),
			(eq, ":type", pbs_troop_type_cavguard),
			(call_script, "script_store_company_average_position_to_pos30", ":team", ":enemy_company"),
			(get_distance_between_positions, ":dist", pos30, pos1),
			(le, ":dist", ":min_dist"),
			(assign, ":min_dist", ":dist"),
			(assign, ":target_team", ":team"),
			(assign, ":target_company", ":enemy_company"),
			(try_end),
		(try_end),
	(call_script, "script_store_company_average_position_to_pos30", ":target_team", ":target_company"),
	(copy_position, pos2, pos30),
	(get_distance_between_positions, ":dist", pos2, pos3),
	(gt, ":dist", 4000),
	(assign, ":min_dist", 999999), (assign, ":assigned_company", -1),
		(try_for_range, ":company", 0, 8),
		(call_script, "script_cf_if_company_has_soldiers", "$g_enemy_team", ":company"),
		(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":company"),
		(team_slot_eq, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_generic),
		...
		(this_or_next|eq, ":type", pbs_troop_type_cavranged),
		(eq, ":type", pbs_troop_type_cavguard),
		(call_script, "script_store_company_average_position_to_pos30", "$g_enemy_team", ":company"),
		(get_distance_between_positions, ":dist", pos30, pos2),
		(le, ":dist", ":min_dist"),
		(assign, ":min_dist", ":dist"),
		(assign, ":assigned_company", ":company"),
		(try_end),
	(neq, ":assigned_company", -1),
	(le, ":min_dist", 7000),
	(store_add, ":slot_team_target_team", slot_team_company1_target_team, ":assigned_company"),
	(store_add, ":slot_team_target_company", slot_team_company1_target_company, ":assigned_company"),
	(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":assigned_company"),
	(team_set_slot, "$g_enemy_team", ":slot_team_target_team", ":target_team"),
	(team_set_slot, "$g_enemy_team", ":slot_team_target_company", ":target_company"),
	(team_set_slot, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_detached),
	(try_end),

	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_attack_charging), # All cavalry will charge during charging attack phase
		(try_for_range, ":company", 0, 8),
		(call_script, "script_cf_if_company_has_soldiers", "$g_enemy_team", ":company"),
		(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":type", "$g_enemy_team", ":slot_team_type"),
		...
		(call_script, "script_company_charge", "$g_enemy_team", ":company"),
		(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":company"),
		(team_set_slot, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_generic),
		(try_end),
	(try_end),

	(try_begin), # Detached cavalry company will chase it's target
		(try_for_range, ":company", 0, 8),
		(call_script, "script_cf_if_company_has_soldiers", "$g_enemy_team", ":company"),
		(store_add, ":slot_team_pai_state", slot_team_company1_pai_state, ":company"),
		(team_slot_eq, "$g_enemy_team", ":slot_team_pai_state", company_pai_state_detached),
		(store_add, ":slot_team_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":type", "$g_enemy_team", ":slot_team_type"),
		(this_or_next|eq, ":type", pbs_troop_type_cavmelee),
		(this_or_next|eq, ":type", pbs_troop_type_cavranged),
		(eq, ":type", pbs_troop_type_cavguard),
		(store_add, ":slot_team_target_team", slot_team_company1_target_team, ":company"),
		(team_get_slot, ":target_team", "$g_enemy_team", ":slot_team_target_team"),
		(store_add, ":slot_team_target_company", slot_team_company1_target_company, ":company"),
		(team_get_slot, ":target_company", "$g_enemy_team", ":slot_team_target_company"),
		(neq, ":target_team", -1),
		(neq, ":target_company", -1),
			(try_begin),
			(call_script, "script_cf_if_company_has_soldiers", ":target_team", ":target_company"),
			(call_script, "script_store_company_average_position_to_pos30", ":target_team", ":target_company"),
			(copy_position, pos1, pos30),
			(call_script, "script_store_company_average_position_to_pos30", "$g_enemy_team", ":company"),
			(copy_position, pos2, pos30),
			...
			(le, ":dist", 9000),
			(copy_position, pos30, pos1),
			(call_script, "script_company_hold_pos30", "$g_enemy_team", ":company"),
			(call_script, "script_company_hold_pos30", "$g_enemy_team", ":company"),
				(try_begin),
				(le, ":dist", 3000),
				(call_script, "script_company_charge", "$g_enemy_team", ":company"),
	...
	(try_begin),
	(eq, ":global_tactic", pai_global_tactic_siege_defend_initial),
	(team_set_slot, "$g_enemy_team", slot_team_pai_global_tactic, pai_global_tactic_siege_defend_holding_position),
		...
		(store_add, ":slot_team_run_mode", slot_team_company1_run_mode, ":company"),
		(team_set_slot, "$g_enemy_team", ":slot_team_run_mode", pbs_run_mode_running),
		(call_script, "script_get_company_soldiers_number", "$g_enemy_team", ":company"), (assign, ":number", reg0),
			(try_for_prop_instances, ":prop", "spr_pai_defensive_line"),
			(scene_prop_get_slot, ":is_occupied", ":prop", slot_prop_is_occupied),
			(eq, ":is_occupied", 0),
				(try_begin),
				(gt, ":number", 6),
				(scene_prop_set_slot, ":prop", slot_prop_is_occupied, 1),
				(try_end),
			(prop_instance_get_position, pos30, ":prop"),
			(call_script, "script_company_hold_pos30_defensive_line", "$g_enemy_team", ":company"),
			(try_end),
		(try_end),
	(try_end),
],
...
(set_fixed_point_multiplier, 1),
	...
	(team_set_slot, "$attacker_team", slot_team_pai_global_tactic, pai_global_tactic_attack_initial),
	(team_set_slot, "$attacker_team_2", slot_team_pai_global_tactic, pai_global_tactic_attack_initial),
	(else_try),
	...
	(team_set_slot, "$g_enemy_team", slot_team_pai_start_position_x, ":x_coor"),
	(team_set_slot, "$g_enemy_team", slot_team_pai_start_position_y, ":y_coor"),
	(team_set_slot, "$g_enemy_team", slot_team_pai_start_position_z_rot, ":z_coor"),
		(try_for_range, ":company", 0, 8),
		(store_add, ":slot_team_company_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":company_type", "$g_enemy_team", ":slot_team_company_type"),
		(neq, ":company_type", 0),
		(position_move_x, pos30, -1000, 0),
		(try_end),
		(try_for_range, ":company", 0, 8),
		(store_add, ":slot_team_company_type", slot_team_company1_type, ":company"),
		(team_get_slot, ":company_type", "$g_enemy_team", ":slot_team_company_type"),
		...
		(call_script, "script_cf_if_team_faction_uses_volley_fire", "$g_enemy_team"),
		(team_give_order, "$g_enemy_team", ":company", mordr_fire_at_my_command),
		(try_end),
	(else_try),
...
pai_volley_fire = (2, 0, 0, [],
[
	(try_for_range, ":team", 0, 4),
	(neq, ":team", "$g_player_team"),
	(call_script, "script_cf_if_team_faction_uses_volley_fire", ":team"),
		(try_for_range, ":company", 0, 8),
		(team_get_hold_fire_order, ":order", ":team", ":company"),
		...
		(store_add, ":slot_team_aiming_number", slot_team_company1_aiming_soldier_number, ":company"),
		(team_get_slot, ":aiming_soldier_number", ":team", ":slot_team_aiming_number"),
		(store_mul, ":proportion", ":aiming_soldier_number", 100),
		(val_div, ":proportion", ":soldier_number"),
		(ge, ":proportion", 50),
		(team_give_order, ":team", ":company", mordr_all_fire_now),
		(try_end),
	(try_end),
])
...
(team_set_slot, "$g_enemy_team", slot_team_company4_type, pbs_troop_type_light),
(team_set_slot, "$g_enemy_team", slot_team_company5_type, pbs_troop_type_guard),
(team_set_slot, "$g_enemy_team", slot_team_company6_type, pbs_troop_type_cavmelee),
(team_set_slot, "$g_enemy_team", slot_team_company7_type, pbs_troop_type_cavmelee),
(team_set_slot, "$g_enemy_team", slot_team_company8_type, pbs_troop_type_howitzers),
...
(assign, ":company_to_assign", -1),
	...
	(eq, ":company_to_assign", -1),
		...
		(else_try),
		(this_or_next|eq, ":pbs_troop_type", pbs_troop_type_fieldguns),
		(eq, ":pbs_troop_type", pbs_troop_type_howitzers),
		(assign, ":troop_type1", pbs_troop_type_fieldguns),
		(assign, ":troop_type2", pbs_troop_type_fieldguns),
		(assign, ":troop_type3", pbs_troop_type_howitzers),
		(else_try),
...
pbs_reload_cancellation = (0.8, 0, 0, [
	...
	(store_add, ":slot_team_energy", slot_team_company1_energy, ":company"),
	(team_get_slot, ":energy", ":team", ":slot_team_energy"),
	(val_div, ":discipline", 200),
	(val_div, ":energy", 100),
	(store_sub, ":chance", 150, ":discipline"),
	(store_random_in_range, ":random", 0, 3200),
	(le, ":random", ":chance"),
...
(get_player_agent_no, ":player"),
	...
	(position_get_y, ":y_coor", pos2),
	(gt, ":y_coor", 100),
	(call_script, "script_store_mouse_projection_to_pos3"),
	...
	(assign, ":target_agent", -1),
		...
		(get_distance_between_positions, ":dist", pos4, pos30),
		(le, ":dist", 1000),
		(le, ":dist", ":min"),
		(assign, ":min", ":dist"),
	...
	(agent_get_division, ":company", ":target_agent"),
		...
		(else_try),
		(team_set_order_listener, "$g_player_team", ":company", 0),
		(try_end),
	(try_end),
...
(set_fixed_point_multiplier, 1),
	...
	(set_fixed_point_multiplier, 100),
	(position_rotate_x_floating, pos1, 3, 0),
	(set_fixed_point_multiplier, 1),
	(try_end),
	(try_begin),
	(key_is_down, key_e),
...
(get_player_agent_no, ":player"),
	...
	(else_try),
		(try_begin),
		(eq, ":player", ":agent"),
		(agent_play_sound, ":agent", "snd_woman_hit_FP"),
		(else_try),
...
common_siege_init = (
  ...
  [
	...
	(music_set_situation, mtf_situation_siege_assault),
    ])
...
+ parabellum_script_set_battle,
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (3,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,3,[]),
     (1,mtef_team_0|mtef_use_exact_number,0,aif_start_alarmed, 21,[]),
     (1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,3,[]),
     ],
    [
      common_battle_tab_press,
      common_battle_init_banner,
...
+ parabellum_script_set_battle,
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (3,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,40,[]),
     (3,mtef_defenders|mtef_team_0,0,aif_start_alarmed,0,[]),
     (1,mtef_attackers|mtef_team_1,0,aif_start_alarmed,40,[]),
