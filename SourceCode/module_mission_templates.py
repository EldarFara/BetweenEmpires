...
(store_div, ":penalty", 4000, ":soldier_number"),
			...
			(val_mul, ":AngleAlpha", 100),
				...
				(scene_prop_set_slot, ":Cannonball", YuriSlotProp_CannonballHEType, ":HEType"),
					...
					(position_rotate_x_floating, pos2, ":AngleForHowitzer", 0), (position_move_y, pos2, 100, 0),
						...
						(store_random_in_range, ":Random2", -900, 900),
						(else_try),
						(store_random_in_range, ":Random1", -500, 500),
						(store_random_in_range, ":Random2", -500, 500),
						(try_end),
...
pbs_company_discipline = (0.2, 0, 0, [
	...
	(try_for_range, ":team", 0, 4),
		...
		(val_clamp, ":discipline", 500, 10001),
			(try_begin),
...
(call_script, "script_reset_companies_accuracy"),
	...
	(assign, ":energy_damage_modifier", 100),
		...
		(val_add, ":energy_damage_modifier", 60),
		(try_end),
	...
	(assign, ":discipline_accuracy_modifier", 100),
		(try_begin),
		(le, ":discipline", 40),
		(store_div, ":discipline_accuracy_modifier", ":discipline", 1),
		(val_add, ":discipline_accuracy_modifier", 60),
		(try_end),
