...
(get_player_agent_no, ":player"),
	(try_begin),
	(neg|is_presentation_active, "prsnt_pbm"),
	(start_presentation, "prsnt_pbm"),
	(try_end),
	(try_begin),
	(eq, 0, 1),
	(game_key_clicked, gk_action),
	(cast_ray, ":unused", pos3, pos1),
	(agent_get_team, ":player_team", ":player"),
		(try_begin),
			(try_for_range, ":platoon", 0, 9),
			(class_is_listening_order, ":player_team", ":platoon"),
			(team_give_order, ":player_team", ":platoon", mordr_hold),
			(team_set_order_position, ":player_team", ":platoon", pos3),
			(try_end),
		(try_end),
	(try_end),
	(try_begin),
