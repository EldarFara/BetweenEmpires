...
pbs_agents_moving_speed = (0.5, 0, 0, [
	...
	(store_add, ":slot_team_run_mode", slot_team_company1_run_mode, ":company"),
		(try_begin),
		(team_slot_eq, "$g_player_team", ":slot_team_run_mode", pbs_run_mode_running),
		(assign, ":marching_speed_modifier", 100),
		(else_try),
			(try_begin),
			(eq, ":pbs_state", pbs_state_moving_to_position),
			(agent_get_position, pos1, ":agent"),
			(agent_get_scripted_destination, pos2, ":agent"),
			(get_distance_between_positions, ":dist", pos1, pos2),
			(le, ":dist", 250),
			(assign, ":marching_speed_modifier", 105),
			(else_try),
			(assign, ":marching_speed_modifier", 45),
			(try_end),
			(try_begin),
			(eq, ":pbs_state", pbs_state_charging),
			(assign, ":marching_speed_modifier", 100),
			(try_end),
		(try_end),
...
bot_crouching = (0, 0, 0,[
	...
	(eq, ":horse", -1),
	(agent_slot_eq, ":agent", slot_agent_can_crouch, 1),
	(agent_slot_eq, ":agent", slot_agent_pbs_state, pbs_state_holding_position),
	(agent_get_animation, ":anim", ":agent", 0),
	(agent_get_crouch_mode, ":crouch", ":agent"),
		(try_begin),
		(eq, ":anim", "anim_crouch_to_stand"),
		(agent_set_animation, ":agent", "anim_crouch_staff", 0),
		(agent_set_animation, ":agent", "anim_crouch_staff", 1),
		(agent_set_crouch_mode, ":agent", 1),
		(else_try),
		(is_between, ":anim", "anim_stand_unarmed", "anim_turn_right"),
		(agent_get_crouch_mode, ":crouch", ":agent"),
		(eq, ":crouch", 0),
		(agent_set_animation, ":agent", "anim_crouch_staff", 0),
		(agent_set_animation, ":agent", "anim_crouch_staff", 1),
...
(team_set_slot, 0, slot_team_company_assignment_order_number, 1),
(team_set_slot, 1, slot_team_company_assignment_order_number, 1),
(team_set_slot, 2, slot_team_company_assignment_order_number, 1),
(team_set_slot, 3, slot_team_company_assignment_order_number, 1),
],
[])
...
(assign, "$g_player_team", ":team"),
	...
	(assign, "$g_enemy_team", 0),
	(try_end),
(team_set_slot, "$g_player_team", slot_team_company1_type, "$player_platoon1_type"),
(team_set_slot, "$g_player_team", slot_team_company2_type, "$player_platoon2_type"),
(team_set_slot, "$g_player_team", slot_team_company3_type, "$player_platoon3_type"),
(team_set_slot, "$g_player_team", slot_team_company4_type, "$player_platoon4_type"),
(team_set_slot, "$g_player_team", slot_team_company5_type, "$player_platoon5_type"),
(team_set_slot, "$g_player_team", slot_team_company6_type, "$player_platoon6_type"),
(team_set_slot, "$g_player_team", slot_team_company7_type, "$player_platoon7_type"),
(team_set_slot, "$g_player_team", slot_team_company8_type, "$player_platoon8_type"),
(call_script, "script_company_get_name", "$g_player_team", 0), (class_set_name, 0, "@1st {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 1), (class_set_name, 1, "@2nd {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 2), (class_set_name, 2, "@3rd {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 3), (class_set_name, 3, "@4th {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 4), (class_set_name, 4, "@5th {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 5), (class_set_name, 5, "@6th {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 6), (class_set_name, 6, "@7th {s1}"),
(call_script, "script_company_get_name", "$g_player_team", 7), (class_set_name, 7, "@8th {s1}"),
...
(agent_get_team, ":team", ":agent"),
(team_get_slot, ":global_company_assignment_order_number", ":team", slot_team_company_assignment_order_number),
(team_get_slot, reg0, ":team", slot_team_company_assignment_order_number),
(agent_get_troop_id, ":troop", ":agent"),
(troop_get_slot, ":pbs_troop_type", ":troop", slot_troop_pbs_type),
(assign, ":company_assigned", 0),
(assign, ":local_company_assignment_order_number", 0),
	(try_for_range, ":current_company", 0, 7+1),
	(eq, ":company_assigned", 0),
	(store_add, ":slot_team_company_type", slot_team_company1_type, ":current_company"),
	(team_get_slot, ":company_type", ":team", ":slot_team_company_type"),
	(eq, ":company_type", ":pbs_troop_type"),
	(val_add, ":local_company_assignment_order_number", 1),
	(eq, ":local_company_assignment_order_number", ":global_company_assignment_order_number"),
	(val_add, ":global_company_assignment_order_number", 1),
	(agent_set_division, ":agent", ":current_company"),
# (display_message, "@first"),
# (assign, reg0, ":local_company_assignment_order_number"),
# (display_message, "@local {reg0}"),
# (assign, reg0, ":global_company_assignment_order_number"),
# (display_message, "@global {reg0}"),
	(assign, ":company_assigned", 1),
	(try_end),
	(try_begin),
	(gt, ":global_company_assignment_order_number", 1),
	(eq, ":company_assigned", 0),
	(assign, ":global_company_assignment_order_number", 1),
	(assign, ":local_company_assignment_order_number", 0),
		(try_for_range, ":current_company", 0, 7+1),
		(eq, ":company_assigned", 0),
		(store_add, ":slot_team_company_type", slot_team_company1_type, ":current_company"),
...
# (display_message, "@global {reg0}"),
	...
	(eq, ":company_assigned", 0),
		...
		(assign, ":troop_type1", pbs_troop_type_cavmelee),
		(assign, ":troop_type2", pbs_troop_type_cavranged),
		(assign, ":troop_type3", pbs_troop_type_cavguard),
		(else_try),
		(assign, ":troop_type1", pbs_troop_type_line),
		(assign, ":troop_type2", pbs_troop_type_light),
		(assign, ":troop_type3", pbs_troop_type_guard),
		(try_end),
		(try_for_range, ":current_company", 0, 7+1),
		(eq, ":company_assigned", 0),
		(store_add, ":slot_team_company_type", slot_team_company1_type, ":current_company"),
		(team_get_slot, ":company_type", ":team", ":slot_team_company_type"),
		(this_or_next|eq, ":company_type", ":troop_type1"),
		(this_or_next|eq, ":company_type", ":troop_type2"),
		(eq, ":company_type", ":troop_type3"),
		(val_add, ":local_company_assignment_order_number", 1),
		(eq, ":local_company_assignment_order_number", ":global_company_assignment_order_number"),
		(val_add, ":global_company_assignment_order_number", 1),
		(agent_set_division, ":agent", ":current_company"),
		...
		(try_end),
	(try_end),
(team_set_slot, ":team", slot_team_company_assignment_order_number, ":global_company_assignment_order_number"),
],
[])
...
(key_clicked, key_q),
	...
	(store_add, reg0, ":company", 1),
		(try_begin),
		(team_slot_eq, "$g_player_team", ":slot_team_run_mode", pbs_run_mode_walking),
		(assign, ":run_mode", pbs_run_mode_running),
		(display_message, "@{reg0}. Company has switched to running."),
		(else_try),
		(assign, ":run_mode", pbs_run_mode_walking),
...
strategic_view_toggle = (0, 0.3, 0, [
(key_clicked, key_u),
(get_player_agent_no, ":player"),
(agent_is_alive, ":player"),
(agent_get_position, pos1, ":player"),
	(try_begin),
	(eq, "$strategic_view_state", 0),
	(assign, "$strategic_view_state", 1),
	(mission_cam_set_mode, 1, 0, 0),
	(position_move_z, pos1, 1000, 1),
	(position_rotate_x, pos1, -25),
	(mission_cam_animate_to_position, pos1, 300, 1),
	...
	(agent_get_horse, ":horse", ":player"),
		...
		(try_end),
	(else_try),
	(neq, "$strategic_view_state", 0),
	(assign, "$strategic_view_state", 0),
	(mission_cam_set_mode, 0, 400, 1),
...
(eq, "$strategic_view_state", 1),
(assign, "$strategic_view_state", 2),
(start_presentation, "prsnt_pbs"),
])

strategic_view_runtime = (0, 0, 0, [], [
(set_show_messages, 1),
(eq, "$strategic_view_state", 2),
(mission_cam_get_position, pos1),
(get_player_agent_no, ":player"),
	(try_begin),
	(neg|is_presentation_active, "prsnt_pbs"),
	(start_presentation, "prsnt_pbs"),
	(try_end),
	(try_begin),
	...
	(eq, ":visibility", 1),
	(prop_instance_get_position, pos30, "$pbs_point1"),
	(agent_get_team, ":player_team", ":player"),
	(set_show_messages, 0),
		(try_for_range, ":company", 0, 8),
		(class_is_listening_order, ":player_team", ":company"),
	...
	(val_mul, ":y_coor", 13),
	(val_div, ":y_coor", 100),
	(position_rotate_z, pos3, ":x_coor", 0),
	(position_rotate_x, pos3, ":y_coor"),
	(cast_ray, ":unused", pos30, pos3),
	(scene_prop_set_visibility, "$pbs_point1", 1),
	(init_position, pos31),
	(position_copy_origin, pos31, pos30),
	(position_get_rotation_around_z, ":z_rot", pos30),
	(position_rotate_z, pos31, ":z_rot", 1),
	(prop_instance_set_position, "$pbs_point1", pos31),
	(try_end),

	(try_begin),
	(neg|key_clicked, key_right_mouse_button),
	...
	(position_rotate_x, pos3, ":y_coor"),
	(cast_ray, ":unused", pos30, pos3),
	(prop_instance_get_position, pos31, "$pbs_point1"),
	(init_position, pos32),
	(set_fixed_point_multiplier, 100),
	(position_copy_origin, pos32, pos31),
	(position_get_x, ":x_coor", pos31),
	(position_get_y, ":y_coor", pos31),
	(position_get_x, ":x_coor2", pos30),
	(position_get_y, ":y_coor2", pos30),
	(store_sub, ":x_difference", ":x_coor2", ":x_coor"),
	(store_sub, ":y_difference", ":y_coor2", ":y_coor"),
	(store_sub, ":x_difference2", ":x_coor2", ":x_coor"),
	(store_sub, ":y_difference2", ":y_coor2", ":y_coor"),
	(call_script, "script_get_modulus_of_value", ":x_difference"), (assign, ":x_difference", reg0),
	(call_script, "script_get_modulus_of_value", ":y_difference"), (assign, ":y_difference", reg0),
	(neq, ":x_difference", 0),
	(neq, ":y_difference", 0),
	(store_mul, ":squared_x", ":x_difference", ":x_difference"),
	(store_mul, ":squared_y", ":y_difference", ":y_difference"),
	(val_add, ":squared_x", ":squared_y"),
	(set_fixed_point_multiplier, 1),
	(store_sqrt, ":squared_x", ":squared_x"),
	(set_fixed_point_multiplier, 100),
	(val_mul, ":y_difference", 100),
	(val_div, ":y_difference", ":squared_x"),
		(try_begin),
		(lt, ":x_difference2", 0),
		(lt, ":y_difference2", 0),
		(store_asin, ":y_difference", ":y_difference"), (val_div, ":y_difference", 100),(val_add, ":y_difference", 90),(position_rotate_z, pos32, ":y_difference", 1),
		(try_end),
		(try_begin),
		(gt, ":x_difference2", 0),
		(gt, ":y_difference2", 0),
		...
		(gt, ":x_difference2", 0),
		(lt, ":y_difference2", 0),
		(store_acos, ":y_difference", ":y_difference"), (val_div, ":y_difference", 100),(val_add, ":y_difference", 180),(position_rotate_z, pos32, ":y_difference", 1),
		(try_end),
		(try_begin),
		(lt, ":x_difference2", 0),
		(gt, ":y_difference2", 0),
		(store_acos, ":y_difference", ":y_difference"), (val_div, ":y_difference", 100),(position_rotate_z, pos32, ":y_difference", 1),
		(try_end),
	(prop_instance_set_position, "$pbs_point1", pos32),
	(set_fixed_point_multiplier, 1),
	(try_end),
	...
	(try_end),
(set_fixed_point_multiplier, 100),
(position_get_z, ":z_coor", pos1),
(set_fixed_point_multiplier, 1),
	(try_begin),
	(key_is_down, key_q),
	(position_rotate_z, pos1, 5, 1),
	(try_end),
	(try_begin),
	(key_is_down, key_e),
	(position_rotate_z, pos1, -5, 1),
...
(assign, ":y_coor2", 6000),
	...
	(spawn_scene_prop, "spr_flora_ash1"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
	(try_for_range, ":unused", 0, ":poplar"), 
	(store_random_in_range, ":x_coor", ":x_coor1", ":x_coor2"),
	(store_random_in_range, ":y_coor", ":y_coor1", ":y_coor2"),
	(val_mul, ":x_coor", 10),
	(val_mul, ":y_coor", 10),
	...
	(store_random_in_range, ":random", 85, 120),
	(set_spawn_position, pos3),
	(spawn_scene_prop, "spr_flora_poplar1"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
	...
	(store_random_in_range, ":random", 85, 120),
	(set_spawn_position, pos3),
	(store_random_in_range, ":random_prop", "spr_flora_bush3_1", "spr_flora_flower1_1"),
	(spawn_scene_prop, ":random_prop"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
	(try_for_range, ":unused", 0, ":flowers1a"), 
	(store_random_in_range, ":x_coor", ":x_coor1", ":x_coor2"),
	(store_random_in_range, ":y_coor", ":y_coor1", ":y_coor2"),
	(val_mul, ":x_coor", 10),
	(val_mul, ":y_coor", 10),
	...
	(store_random_in_range, ":random", 85, 120),
	(set_spawn_position, pos3),
	(spawn_scene_prop, "spr_spotflora_flowers1a"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
	(try_for_range, ":unused", 0, ":flowers1b"), 
	(store_random_in_range, ":x_coor", ":x_coor1", ":x_coor2"),
	(store_random_in_range, ":y_coor", ":y_coor1", ":y_coor2"),
	(val_mul, ":x_coor", 10),
	(val_mul, ":y_coor", 10),
	...
	(store_random_in_range, ":random", 85, 120),
	(set_spawn_position, pos3),
	(spawn_scene_prop, "spr_spotflora_flowers1b"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
	(try_for_range, ":unused", 0, ":flowers2"), 
	(store_random_in_range, ":x_coor", ":x_coor1", ":x_coor2"),
	(store_random_in_range, ":y_coor", ":y_coor1", ":y_coor2"),
	(val_mul, ":x_coor", 10),
	(val_mul, ":y_coor", 10),
	...
	(store_random_in_range, ":random", 85, 120),
	(set_spawn_position, pos3),
	(spawn_scene_prop, "spr_spotflora_flowers2"),
	(prop_instance_set_scale, reg0, ":random", ":random", ":random"),
	(try_end),
(rebuild_shadow_map),
	
	(try_for_prop_instances, ":prop", "spr_spotflora_flowers1a"),
	(prop_instance_get_position, pos1, ":prop"),
	(store_random_in_range, ":number", 4, 8),
	(store_random_in_range, ":interval", 275, 500),
	(store_mul, ":interval_x_number", ":interval", ":number"),
	(val_mul, ":interval_x_number", -1),
	(store_div, ":interval_div_2", ":interval", 2),
	(store_mul, ":minus_interval_div_2", ":interval_div_2", -1),
		(try_for_range, ":unused", 0, ":number"),
			(try_for_range, ":unused", 0, ":number"),
			(copy_position, pos2, pos1),
			(store_random_in_range, ":angle", -180, 180),
			(store_random_in_range, ":x_coor", ":minus_interval_div_2", ":interval_div_2"),
			(store_random_in_range, ":y_coor", ":minus_interval_div_2", ":interval_div_2"),
			(position_rotate_z, pos1, ":angle", 1),
			(position_move_x, pos1, ":x_coor"),
			(position_move_y, pos1, ":y_coor"),
			(position_set_z_to_ground_level, pos1),
			(copy_position, pos39, pos1),
			(call_script, "script_set_angle_of_pos39_to_ground_angle"),
			(position_copy_rotation, pos1, pos39),
			(set_spawn_position, pos1),
			(store_random_in_range, ":random_prop", "spr_flora_flower1_1", "spr_flora_flower1b_1"),
			(spawn_scene_prop, ":random_prop"),
			(copy_position, pos1, pos2),
			(position_move_y, pos1, ":interval", 0),
			(try_end),
		(position_move_y, pos1, ":interval_x_number", 0),
		(position_move_x, pos1, ":interval", 0),
		(try_end),
	(try_end),
	(try_for_prop_instances, ":prop", "spr_spotflora_flowers1b"),
	(prop_instance_get_position, pos1, ":prop"),
	(store_random_in_range, ":number", 4, 8),
	(store_random_in_range, ":interval", 250, 500),
	(store_mul, ":interval_x_number", ":interval", ":number"),
	(val_mul, ":interval_x_number", -1),
	(store_div, ":interval_div_2", ":interval", 2),
	(store_mul, ":minus_interval_div_2", ":interval_div_2", -1),
		(try_for_range, ":unused", 0, ":number"),
			...
			(position_copy_rotation, pos1, pos39),
			(set_spawn_position, pos1),
			(store_random_in_range, ":random_prop", "spr_flora_flower1b_1", "spr_flora_flower2_1"),
			(spawn_scene_prop, ":random_prop"),
			(copy_position, pos1, pos2),
			(position_move_y, pos1, ":interval", 0),
			(try_end),
		...
		(try_end),
	(try_end),
	(try_for_prop_instances, ":prop", "spr_spotflora_flowers2"),
	(prop_instance_get_position, pos1, ":prop"),
	(store_random_in_range, ":number", 4, 8),
	(store_random_in_range, ":interval", 250, 500),
	(store_mul, ":interval_x_number", ":interval", ":number"),
	...
	(store_mul, ":minus_interval_div_2", ":interval_div_2", -1),
		(try_for_range, ":unused", 0, ":number"),
			...
			(position_copy_rotation, pos1, pos39),
			(set_spawn_position, pos1),
			(spawn_scene_prop, "spr_flora_flower3_1"),
			(copy_position, pos1, pos2),
			(position_move_y, pos1, ":interval", 0),
			(try_end),
		(position_move_y, pos1, ":interval_x_number", 0),
	...
	(prop_instance_get_position, pos1, ":prop"),
		(try_for_range, ":unused", 0, ":number"),
			...
			(position_copy_rotation, pos1, pos39),
			(set_spawn_position, pos1),
			(spawn_scene_prop, "spr_flora_flower4_1"),
			(copy_position, pos1, pos2),
			(position_move_y, pos1, ":interval", 0),
			(try_end),
		(position_move_y, pos1, ":interval_x_number", 0),
...
battle_start,
strategic_view_runtime,
strategic_view_toggle,
pbs_order_player,
pbs_agent_spawn,
