...
##       (cur_tableau_add_mesh, ":banner_mesh", pos1, ":banner_scale", 0),
  ...
  ("faction_note_mesh_for_menu", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0,
   [
  ...
  ("faction_note_mesh", 0, "pic_arms_swadian", 0, 0, 0, 0, 0, 0,
   [
     # (store_script_param, ":faction_no", 1),
      (cur_tableau_set_background_color, 0xFFFFFFFF),
     # (set_fixed_point_multiplier, 100),
  ...
  ("faction_note_mesh_banner", 0, "tableau_with_transparency", 0, 0, 0, 0, 0, 0,
   [
     # (store_script_param, ":faction_no", 1),
     # (set_fixed_point_multiplier, 100),
     # (try_begin),
