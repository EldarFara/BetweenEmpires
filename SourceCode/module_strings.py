...
("faction_technology_fourbattalions_name", "Four-Battalion Regiments"),
("faction_technology_fourbattalions_description", "desc"),
("faction_technology_improvedlogistics_name", "Improved Combat Logistics"),
("faction_technology_improvedlogistics_description", "desc"),
("faction_technology_woundedevacuation_name", "Ambulances"),
("faction_technology_woundedevacuation_description", "desc"),
