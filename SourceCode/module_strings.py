...
("faction_technology_deepdefence_name", "Deep Defence"),
("faction_technology_deepdefence_description", "In early 1900s, most armies had already adopted the revolutionary infantry tactics that promotes fighting in small group instead of fighting in lines and encouraging the troops to work on defences on their own instead of relying on pioneers all the time. In 1905, a war between Russia and Japan broke out, the Japanese emerged victorious despite suffering heavy casualties against the Russians. Some military officers from many countries was sent to the battlefield to observe the battles, and as observed, troops aren't relying on pioneers for too much anymore and instead they made better fortifications than before with better artillery protection and barbed wires. Effects: not done yet"),
