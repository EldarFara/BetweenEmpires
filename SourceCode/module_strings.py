...
("bonapartists_desc", "Bonapartism is the political ideology supervening from Napoleon Bonaparte and his followers and successors. The term was later used to refer to people who hoped to restore the House of Bonaparte and its style of government."),
...
("republicains_moderes_desc", "Républicains modérés"),
("gauche_radicale", "Gauche radicale"),
("gauche_radicale_desc", "Gauche radicale"),
("bonapartists", "Bonapartistes"),
("bonapartists_desc", "Bonapartistes"),
("lantmannapartiet", "Lantmannapartiet"),
("dutch_antirev", "Anti-Revolutionaire Partij"),
("dutch_antirev_desc", "Anti-Revolutionaire Partij"),
("dutch_liberal", "Liberale partij"),
("dutch_liberal_desc", "Liberale partij"),
("dutch_conservative", "Conservatieve partij"),
("dutch_conservative_desc", "Conservatieve partij"),
("centern", "Centern"),
