...
("faction_technology_earlyshells_name", "Percussive Explosive Shells"),
("faction_technology_earlyshells_description", "Percussion shells are a type of cannon and howitzer shot that detonates after making contact with a solid object. Early percussion shells were simplistic, requiring direct contact with the ground, a wall, or similar objects, driving a firing pin into the fuse by sheer force. This would mean even cannon could fire explosive shells at a relatively fast speed, negating the need for the cannoneer to choose the fuse length.^^Unfortunately, early percussion shells, despite their almost immediate adoption once viable, often lacked stable gunpowder, and the archaic nature of the mechanism meant that often times, shells would simply fail to explode, especially if fired at muddy ground.^^Effects: Replaces all artillery cartridges with percussion shells, which explode upon impact, but have a 40% chance of misfiring. Howitzers reload slightly faster."),
("faction_technology_medicinecrimeanwar_name", "Crimean War Medical Experience"),
...
("faction_technology_hetypelate_description", "Smokeless powder describes a number of propellants used in modern firearms and artillery that produce negligible smoke when fired, unlike the black powder they replace. The smoke produced by black powder caused a number of severe issues, such as increased fouling, obscured visual orders during combat, and producing a much lower pressure when ignited due to it deflagrating rather than detonating, making both artillery shells and cartridges more powerful. Smokeless powder is up to three times as powerful as black powder when used in the same quantity, allowing for smaller cartridges, but at a similar stopping power.^Paul Vieille's smokeless poudre blanche revolutionized small arms and was used in the first smokeless black powder rifle, the Lebel, in 1886, laying the cornerstones for it's wider implementation.^^Effects: Enables smokeless powder, increasing the range and accuracy of small arms, aswell as increasing the blast radius and damage of artillery shells."),
...
("faction_technology_conscription_description", "Conscription, sometimes called the draft, is the compulsory enlistment of fighting age men into the military, massively enlarging a nation man-power pool and enabling them to raise larger armies without having to rely on professional soldiers or mercenaries as was the case before. Near-universal conscription for young men dates back to the French revolution, where it became the basis of France's military. Most European nations later copied the system in peacetime, so that men at a certain age would serve 1–8 years on active duty and then transfer to the reserve force. Remplacement meant that rich citizens chosen for the draft, which was done by lot, could avoid conscription by paying a large sum of money in most European nations which had enacted conscription.^^Effects: Increases party size limits (both the player's and generals')."),
("faction_technology_acwexperience_name", "American Civil War Logistical Experience"),
("faction_technology_acwexperience_description", "European observers to the American Secession War noted the great effect to which the Union army utilized both railway systems as an extension to their logistics system, as well as telegraph lines to aid communications. Especially railway usage permitted larger army operations, negating the need for scavenging and looting, as was the case with European armies during the NapoleonicWars, lessening the immediate impact of conflict on the local populations.^^Effects: Increases party size limits (both the player's and generals')."),
("faction_technology_ammoincrease_name", "Baggage Trains"),
("faction_technology_ammoincrease_description", "Baggage trains played a major role throughout the entirety of military history, supplying troops with supplies, munitions, new weaponry and clothes, and more. Reorganizing baggage trains to deal with modern supply requirements during the heat of battle allows for longer, more effective attacks and increased effectiveness in combat.^^Effects: If a Soldiers that run out of ammo receive new ammunitions faster. Increases artillery ammunition capacity."),
...
("faction_technology_adaptivetraining_name", "Adaptive Infantry Training"),
("faction_technology_adaptivetraining_description", "In the decades leading up to the second world war, infantry abandoned their traditional roles and tactics. Trenches, dug-ins, and raids slowly became a reality of day-to-day warfare, forcing armies to relegate greater control to officers and NCOs, rather than have specific platoon movements be controlled by generals. These smaller units, operating in extended order formations, were, by comparison to line infantry, much more resilient and could withstand enemy pressure much easier.^^Unconventional infantry tactics often put a conventional enemy at a disadvantage. During the Second Boer War, the Boers used guerrilla tactics to fight the conventional British Army. Boer marksmen would often pick off British soldiers from hundreds of yards away. These constant sniper attacks forced the British infantry to begin wearing khaki uniforms instead of their traditional red. The Boers were much more mobile than the British infantry and thus could usually choose where a battle would take place. These unconventional tactics forced the British to adopt some unorthodox tactics of their own. ^^Effects: Reduces discipline penalty from enemy small arms fire. Line formation becomes available for line and guard infantry. Extended Line formation becomes available for light infantry. Allows line and guard infantry to dig in."),
("faction_technology_fourbattalions_name", "Regimental System Reform"),
("faction_technology_fourbattalions_description", "During, or in preparation for, periods of major conflict, nations would grow their armed forces, reforming army hierarchies and organisation in order to incorporate new troops into existing military structures.^Over the course of the 19th century, most European nations would undertake such reforms, such as the Russian Empire's Four-Battalion Regiments, the French Brigade reforms of the 1800s, or British fencible regiments in time of war on the continent. Though sheer numerical superiority became less of a factor in small scale combat as weaponry progressed, the size of national armies would only continue to grow.^^Effects: Increases party size limits (both the player's and generals')."),
("faction_technology_improvedlogistics_name", "Machine Guns"),
("faction_technology_improvedlogistics_description", "Warfare in Europe changed forever with the advent of the machine gun. The Maxim Gun, invented in 1884 by it's namesake, was the first of these modern machine guns, quickly proving itself to be both effective and deadly. The British first utilised this new weapon in the Sudan and during the Abushiri Revolt, allowing more savvy army officers to quickly recognise the effectiveness of their newly acquired contraptions. The maxim quickly became a permanent fixture of trenches and defensive structures all over the world and played a crucial part in the wars of the beckoning 20th century.^^Effects: Unlocks the Maxim machine gun for purchase at armouries and battlefield usage."),
("faction_technology_woundedevacuation_name", "Ambulances"),
("faction_technology_woundedevacuation_description", "Horse drawn carriages carrying wounded soldiers off the battlefield, ambulances had existed in their original form since the Napoleonic Wars as ambulances volantes, flying ambulances, invented by Baron Larrey. More advances in medical care for the military were made during the United States’ Civil War, with US military physicians designing a prehospital care system for soldiers, which used new techniques and methods of transport.^^Effects: Adds a 10% chance a soldier will survive being wounded."),
