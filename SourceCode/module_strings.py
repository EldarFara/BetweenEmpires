...
("russian_socialist_desc", "Rossiyskaya sotsial-demokraticheskaya rabochaya partiya"),
...
("socialist_desc", "Socialist party defends the rights of the lower class and seeks major social reforms, while also supporting democracy as well. They oppose any aggressive foreign policy, and will gain influence in case of unsuccessful wars."),
("tories", "Conservative Party (Tories)"),
("whigs", "Liberal Party (Whigs)"),
("conservative_desc", "Conservatives stand for preservation of old order. Consisting of privileged aristocracy, most of them oppose liberal reforms and social welfare, striving to contain their political power. They support governmental actions and aggressive foreign policy."),
("liberal_desc", "Liberals seek political freedom for all estates of population and are supporting laissez-faire economic policies such as free trade and minimal government interference in the economy. Consisting of bourgeoisie, they don't support social reforms."),
("tories_desc", "Conservative party in British Empire originates from Tories political faction. Their political views are traditionalism and conservatism. Tories defend the ideas of hierarchy, natural order, and aristocracy. They tend to support governmental aggressive foreing policy more than liberals, and stand for protectionism."),
