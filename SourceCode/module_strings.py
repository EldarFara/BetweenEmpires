...
##  ("your_debt_to_s1_is_changed_from_reg1_to_reg2", "Your debt to {s1} is changed from {reg1} to {reg2}."),
  ...
  #Alternatives
  ("town_alt_prosperity_0",   "The town lives in abject poverty. In the dark alleys you see feral dogs and cats hiss and fight over scraps of food, in the shops there is little but the essentials (much of which is stale as it is). People are leaving, seeking their fortune elsewhere in the world at great risk, and those who cannot leave have little to their name. "),
  ("town_alt_prosperity_20",   "You hear some complaints from the locals about their conditions, about how jobs have fled or harvests have been bad. Beggars are common, and those who have enough money to set up life elsewhere leave, while others try to stick it through and come out of this crisis on the other side."),
  ("town_alt_prosperity_40",   "This town is average. Stratification is obvious, with tunic-wearing peasants bargaining with each other on prices while the rich and powerful stay near their own, exclusive clubs and buildings. It’s a town that is neither in a boom nor bust, and immigrants come in as much as others leave."),
  ("town_alt_prosperity_60",   "The town is wealthy, going through a period of economic boom. People are coming into the city to seek their fortunes, and the city’s markets are full of fresh produce. It’s not exactly a city of gold, but it’s close."),
  ("town_alt_prosperity_80",   "This is a city of gold - the economy is doing extremely well, the poorest people still eat well, and the city’s queue for immigrants is long and moving slow from sheer volume. When people speak of cities of opportunity and wealth, they should be speaking the name of this town."),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 It doesn't take you long to fritter away what little you bothered to save.\
 Once every pound has evaporated in your hands you are forced to start a life of crime in the backstreets of {s9},\
...
#npc16 = klethi
  ...
  ("npc2_intro", "Hello. Would you be so kind as to have a cup with me? I'm down to my last five pounds and I'd rather not drink alone."),
  ...
  ("npc2_intro_response_1", "Your last five pounds? What happened to you?"),
...
#backstory intro
  ...
  ("npc13_backstory_a", "You have not? Then perhaps you will have heard of my steed, who cuts across the Europen plains like a beam of moonlight? Or of my sword, a connoisseur of the blood of the highest-born princes of the land?"),
...
#backstory main body
  ...
  ("npc5_backstory_b", "For as long as any one can remember, our people have feuded with the tribe of Humyan, many of whom have settled in the next valley over. Many men have died in this feud, on both sides, including two of my brothers. The Khan himself has ordered us to cease, to save men for the wars in Europe. But I know my rights, and my brothers' blood cries out for vengeance. I waylaid and killed a Humyan on a track over the mountains, and I rode out of our village the same night, without even having had the chance to bid farewell to my father. I will bide my time in Europe, for a year or two, then return home when the Khan's men have forgotten. The Humyan will not forget, of course, but such is the price of honour."),
  ...
  ("npc11_backstory_b", "For 30 years I followed the armies of this land, selling them victuals and drink, watching their games of dice and finding them girls, and nary a pound was left in my purse at the end."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc2_backstory_later", "I sold my boots and have managed to make a few pounds peddling goods from town to town, but it's a hard living."),
  ...
  ("npc6_backstory_later", "I have been wandering Europe, but have yet to find redemption."),
  ("npc7_backstory_later", "I have been wandering, looking for work as a tracker, but it has not been easy. Europens are mostly ill-bred, lice-ridden, and ignorant, and it is not easy to work with such people."),
  ...
  ("npc12_backstory_later", "I have been here and about, tending to the sick and taking what reward I can. But the people of these parts are ignorant, and have little respect for my craft. The few pounds I make are barely enough for me to replenish my stock of medicine. I should be grateful for the chance to find other work."),
  ("npc13_backstory_later", "I have been wandering through the cities of Europe, leaving a string of love-sick women and cuckolded husbands in my wake. But I grow weary of such simple challenges, and had been thinking of turning myself to more martial pastimes."),
  ...
  ("npc15_signup", "Geroia, eventually, but I'd welcome the opportunity to get a few pounds in my pocket, first, so I don't come home empty handed. So if you promise me food and a share of the loot, I'd be happy to fight with you for a while."),
...
#11
  ...
  ("npc1_payment", "I will be very useful to you, {sir/madame}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} pounds? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."),
  ("npc2_payment", "{!}."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} pounds? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} pounds from you. It's an advice my father gave me. He told me 'Baheshtur, never fight for a barbarian before {he/she} pays you your worth of gold first'."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} pounds first. You aren't expecting me to work for free, do you?"),
  ("npc8_payment", "Then I will fight your enemies for you. But first I want a bounty of {reg3} pounds. If you are a worthy captain who can lead {his/her} company to riches and plunder, you should have no trouble paying. I cannot afford to follow a pauper."),
  ("npc9_payment", "That's very good of you. And before I join, can you lend me {reg3} pounds, so that I can buy some proper clothing that befits a gentleman of noble birth such as myself. The coat on me has been worn down badly due to my recent bad fortune, and I cannot let common soldiers mistake me as one of their own."),
  ("npc10_payment", "That's good news. But I'll ask for one last thing, captain. I have a woman here in {s20}, a tavern wench, and she says she has my child in her belly. I want to give her some money before I leave... for the child, you know. Do you think you can spare {reg3} pounds?"),
  ("npc11_payment", "Hey thank you captain. But before joining up with you, I would ask for a payment of {reg3} pounds. I know that in war parties soldiers can go on for weeks without seeing any wages. I am wise enough not to sign anywhere without having myself covered."),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} pounds. Do you think that you could cover those for me, as a gesture of friendship?"),
  ("npc14_payment", "Ah, one last thing. I would ask for an initial bounty of {reg3} pounds before I join your command. It's my principle never to enter someone's service without receiving the payment I deserve."),
  ("npc15_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} pounds would be fair, I think."),
  ...
  ("npc1_payment_response", "Very well, here's {reg3} pounds. Now, fall in with the rest."),
  ("npc2_payment_response", "{!}."),
  ("npc3_payment_response", "{!}."),
  ("npc4_payment_response", "Certainly. Here's {reg3} pounds."),
  ("npc5_payment_response", "Well... here's {reg3} pounds, then. Your first payment."),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "No, of course not. Here's {reg3} pounds."),
  ("npc8_payment_response", "Oh, I am no pauper, madame. Here's {reg3} pounds for you."),
  ("npc9_payment_response", "Very well, here's {reg3} pounds."),
  ("npc10_payment_response", "Of course. Here, {reg3} pounds."),
  ("npc11_payment_response", "Very well, here's {reg3} pounds. Make yourself ready. We leave soon."),
  ("npc12_payment_response", "{!}."),
  ("npc13_payment_response", "Of course, here's {reg3} pounds. Make ready to leave soon."),
  ("npc14_payment_response", "All right, here's {reg3} pounds. You are most welcome in our company."),
  ("npc15_payment_response", "All right, here's {reg3} pounds. Glad to have you with us."),
  ("npc16_payment_response", "All right, here's {reg3} pounds for you. Make yourself ready."),
...
#local color strings
  ...
  ("npc9_home_intro", "Behold the Rock of Rivacheg! The strongest fortress in Europe. My father was one of those who held the line here against the Nords, when they first tried to push inland from the coast."),
  ...
  ("npc8_home_description", "You haven't heard the story? When Gundig Hairy-Breeks came to Europe from Nordland, he planted his banner on the headland and said that it would remain there until he recaptured his 'inheritance.' His 'inheritance', he called it. Gundig believed the skalds who told him that the Emperor had bequeathed Europe to the Nords, when in fact he just gave us a small strip of land along the coast, so that we would crew his galleys."),
  ...
  ("npc11_home_description", "I'm from Uxkhal. You know the saying, {sir/madame} -- 'Barley grown in Uxkhal is made into ale in Praven, and we're all the better for it.' Not sure what that means, {sir/madame}, but it's true about the barley. And wheat, and oats. We grow more grain here in the Vale of Uxkhal then all the rest of Europe put together, and our ale is the best, too. You can see it in the soil here -- rich and black, and smells of good harvests and full bellies."),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc2_home_description_2", "I had loaded up on saffron, cinnamon, cloves, pepper and other spices and a chest full of pounds. I estimated that I could buy linens, furs, velvet, iron and wool, and the extra horses to carry them back, and I'd still make a profit. I just hadn't figured in the Khergits, who apparently don't care for others cutting in on their monopoly."),
  ...
  ("npc10_home_description_2", "We grow mulberry trees here for silk and kermes too for the dye. We take it to Jelkala where they weave it into the finest velvet -- not that I have ever had enough pounds in my pocket to buy velvet, mind. But the craftsmen of Jelkala also make good crossbows, and for that I'll not begrudge them their little luxuries"),
  ("npc11_home_description_2", "The Swadian king will tell you that Praven was the biggest city in Europe back under the Empire, and that's why he should rule the whole land today. Mind you, I don't care much about politics, {sir/madame} -- I've sold provisions to every army that ever marched in Europe, and I tell you that I wouldn't give a single one of them a single biscuit unless I had the cold, hard pounds in my hand first. Why these high and mighty kings and nobles can't pay their bills, I'll never know. But I prattle on a bit, there, don't I?"),
  ...
  ("npc14_home_description_2", "If anyone were ever to unify this little land of ours, I'd sign up to serve them, free of charge. I'd put together an army of Rhodok spears with Nord footmen on the flanks and Vaegir archers in front, take along some Khergit scouts to find and fix the enemy, and some Swadian lancers and Sarranid mamlukes to finish them off. I'd take that army over the mountains and make the whole world kneel to Europe.... Of course, that's what the Emperors thought, and in the end the tribes took away their Empire."),
  ...
  ("npc9_home_recap", "I am from the Vaegir homeland over the mountains, where the Vaegir lords lived before the Emperor brought them in Europe."),
  ...
  ("npc15_home_recap", "I'm from over the hills. But Europe is where the money is to be made, these days, if your trade is siegecraft."),
  ...
  ("npc1_kingsupport_1", "That's a great idea, Boss. All these kings and khans and landed nobles who rule now, with their prisons and gibbets and scaffolds, the whippings and brandings and hangings for any man who might be driven by the crying of his children to steal a loaf of bread, or maybe a horse -- Europe deserves something better."), #Borcha
  ...
  ("npc2_kingsupport_2", "Most of the lords of this land -- well, let's just say that they never held a pound that they didn't collect as rent or take as pillage. You, on the other hand, have some experience of commerce and trade, of the effort and risk involved in making sure that men don't go hungry in Sargoth while there's a glut of grain in Praven, to give an example.... If you like, captain, I reckon I could find some support for you among the merchants and burghers of this realm."), #marnid
...
###Add some variation to these
  ...
  ("comment_you_captured_a_lord_allied_friendly_spiteful",   "I heard that you captured {s54}. I hope that you squeezed him for every pound."), 
...
#multiplayer game type names
  ...
  ("s21__the_s5_has_no_outstanding_issues_with_the_s14", "{s21}^* The {s5} has stable diplomatic relationship with the {s14}."),
  ...
  ("the_s5_is_ruled_by_s6_it_occupies_s8_its_vassals_are_s10__s21", "The {s5} is ruled by {s6}.^Infamy is {reg12}.^It occupies {s8}.^Its army commanders are {s10}.^^{s21}"),
  ...
  ("khan", "khan"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom of the Europens, {s45} should be {s47}"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_player", "Commander {s0}"),
  ("faction_title_male_1", "Commander {s0}"),
  ("faction_title_male_2", "Commander {s0}"),
  ("faction_title_male_3", "Commander {s0}"),
  ("faction_title_male_4", "Commander {s0}"),
  ("faction_title_male_5", "Commander {s0}"),
  ("faction_title_male_6", "Commander {s0}"),
  ...
  ("default_kingdom_name", "{s0}'s State"),
...
("the_coast", "the coast"),
  ...
  ("describe_secondary_input", " In addition, you will also need to purchase {s11} worth {reg10} pounds."),
  ("profit", "profit"),
  ("loss", "loss"),
...
("faction_technology_riflesboltaction_description", "The evolution of military small arms cartridges towards smaller calibres firing higher-velocity bullets meant that magazines became viable. Magazine rifles had the obvious advantage of having not only a larger magazine, but hence also a faster firing rate, though reloading could be cumbersome and long-winded before the clip-fed revolution. Due to their cartridges higher velocity and better aerodynamic traits, long-ranged accuracy was also marginally improved.^^agazine rifles were adopted throughout Europe, America, and certain African states in the late 1880s, for example in France in 1886 with the adoption of the Lebel Model 1886, or in Britain in 1888 with the Lee-Metford replacing the Martini-Henry. Magazine-fed rifles would remain a staple of European militaries for close to a century, remaining in use throughout the world until this day.^^Effects: All breech-loading rifles are replaced by slightly more accurate magazine-fed rifles."),
("faction_technology_lateshells_name", "Improved Percussion Mechanisms"),
("faction_technology_lateshells_description", "Replacing the early direct action fuses of the mid-century, improved manufacturing methods and fine-tuning of percussion actions meant misfires became less likely, further manifesting artilleries deadly role in late 19th century combat. Investing in new, more precise machinery was costly, but it's effect ultimately invaluable.^^Effects: Replaces percussion mechanisms in artillery shells, making misfires less likely."),
("faction_technology_machineguns_name", "Machine Guns"),
("faction_technology_machineguns_description", "Warfare in Europe changed forever with the advent of the machine gun. The Maxim Gun, invented in 1884 by it's namesake, was the first of these modern machine guns, quickly proving itself to be both effective and deadly. The British first utilised this new weapon in the Sudan and during the Abushiri Revolt, allowing more savvy army officers to quickly recognise the effectiveness of their newly acquired contraptions. The maxim quickly became a permanent fixture of trenches and defensive structures all over the world and played a crucial part in the wars of the beckoning 20th century.^^Effects: Unlocks the Maxim machine gun for purchase at armouries and battlefield usage."),
("faction_technology_infantrymgtactics_name", "Infantry Machine Guns Tactics"),
("faction_technology_infantrymgtactics_description", "Machineguns are a new contraption at that time, meaning that armies need a way to master it. Most armies employed machine guns in battle and treated it as an artillery peace, like Gatling guns and earlier versions of Maxim guns with wheels. However, with the advent of tripod, machine guns became lighter than before. Yet some countries adopted small wheel carriage instead like those of Russian version of Maxim guns. In before, nations employed machine guns on artillery units but now, they widely distributed the machine guns, even to rank and file infantry and light infantry alike.^Effects: Increasing MG limit by 3, unlocks MG crew company type. "),
...
("faction_technology_modernartillery_name", "Rapid Firing Artillery"),
("faction_technology_modernartillery_description", "^^Effects: artillery models change to more rapid firing ones. Heavy howitzers becomes available for use as well as 'Heavy Howitzers' company type. Increases cannons limit by 5."),
("faction_technology_coveringfire_name", "Covering Fire"),
("faction_technology_coveringfire_description", "In military science, suppressive fire is 'fire that degrades the performance of an enemy force below the level needed to fulfill its mission'. When used to protect exposed friendly troops advancing on the battlefield, it is commonly called covering fire. Suppression is usually only effective for the duration of the fire. Suppressive fire usually achieves its effect by threatening casualties to individuals who expose themselves to it. Willingness to expose themselves varies depending on the morale, motivation and leadership of the target troops. Suppression can be delivered by any weapon or group of weapons capable of delivering the required intensity of fire for the required period of suppression. Suppressive fire capabilities vary widely because the suppressive effect area varies widely. For example, a rifle or machine gun bullet may only have a suppressive effect within about one metre of its trajectory, whereas a single artillery shell may suppress a few thousand square metres around its burst. Furthermore, sustained suppression over more than a few minutes may be difficult to achieve with small arms fire for logistic reasons, air delivered suppression is similarly affected by payload limits. In contrast, artillery can suppress an area for an extended period.^Effects: Unlocks the 'Suppression Fire' mode ability, which decreases accuracy but greatly increases disipline level damage inflicted to an enemy."),
("faction_technology_gasattacks_name", "Gas Attacks"),
("faction_technology_gasattacks_description", "Chemical warfare involves using the toxic properties of chemical substances as weapons. The modern use of chemical weapons began with World War I, when both sides to the conflict used poisonous gas to inflict agonizing suffering and to cause significant battlefield casualties. Such weapons basically consisted of well known commercial chemicals put into standard munitions such as grenades and artillery shells. Chlorine, phosgene (a choking agent) and mustard gas (which inflicts painful burns on the skin) were among the chemicals used. The results were indiscriminate and often devastating. Nearly 100,000 deaths resulted. Since World War I, chemical weapons have caused more than one million casualties globally. Effects: makes 'Gas attack' and 'Gas masks' abilitites available for artillery and infantry respectively."),
("faction_technology_skirmishline_name", "Skirmish Line Tactics"),
("faction_technology_skirmishline_description", "With the invention of new weaponry, the concept of line infantry began to wane. The Minié ball allowed individual infantrymen to shoot more accurately and over greatly increased range. Men walking in formation line-abreast became easy targets, as evidenced in the American Civil War. The Austro-Prussian War in 1866 showed that breech-loading rifles, which gave the individual shooter a greatly increased rate of fire, were greatly superior to muzzle-loaded rifles. In the 1860s, most German states and Russia converted their line infantry and riflemen into 'united' infantry, which used rifles and skirmish tactics. Extended order formations replaced lines almost entirely, relegating lines and columns to army movements.^^Effect: Dense Line formation becomes available for line and guard infantry. Line formation becomes available for light infantry. 'Position' toggleable ability becomes available, allowing to switch companies between prone, crouch or stand positions."),
("faction_technology_moderndefence_name", "Modern Defence Tactics"),
("faction_technology_moderndefence_description", "In the decades leading up to the second world war, infantry abandoned their traditional roles and tactics. Trenches, dug-ins, and raids slowly became a reality of day-to-day warfare, forcing armies to relegate greater control to officers and NCOs, rather than have specific platoon movements be controlled by generals. These smaller units, operating in extended order formations, were, by comparison to line infantry, much more resilient and could withstand enemy pressure much easier.^^Unconventional infantry tactics often put a conventional enemy at a disadvantage. During the Second Boer War, the Boers used guerrilla tactics to fight the conventional British Army. Boer marksmen would often pick off British soldiers from hundreds of yards away. These constant sniper attacks forced the British infantry to begin wearing khaki uniforms instead of their traditional red. The Boers were much more mobile than the British infantry and thus could usually choose where a battle would take place. These unconventional tactics forced the British to adopt some unorthodox tactics of their own. ^^Effects: Reduces discipline penalty from enemy small arms fire. Allows line and guard infantry to dig in."),
("faction_technology_lmgs_name", "Light Machine Guns"),
("faction_technology_lmgs_description", "In 1903, French military theorists noticed that the machine guns of the day, heavy and relatively immobile, were of little use in infantry assaults. They determined that 'the machine gun must learn to walk'. A marching fire tactic (French: feu de marche) was expected to involve incidental suppressive fire, with the advancing troops considered a deadlier threat than the unaimed bullets, causing the enemy to fall back. The prototype guns were not approved for production, and none were in service when World War I began. Also a year before, a Danish General named Herman Madsen invented a machinegun that is more portable than ever. it looks and weights similar to contemporary rifles albeit a bit heavier due to gun mechanisms and more ammunition in the weapon. In 1915, a French Colonel named Louis Chauchat invented the M1915 Chauchat Light Machine Gun. Despite it's notoriety in the hands of the Americans due to stoppages or jamming due to bad rechambering process, it works well against the Germans in terms of suppressing their troops when attacking German trenches.^Effects: small percentage of soldiers will spawn with light machine guns which are much more rapid-fire than rifles."),
("faction_technology_shocktroops_name", "Shock Troops"),
("faction_technology_shocktroops_description", "During the First World War, many combatants faced the deadlock of trench warfare. On the Western Front in 1915, the Germans formed a specialized unit called the Rohr Battalion to develop assault tactics. During the Brusilov Offensive of 1916, the Russian general Aleksei Brusilov developed and implemented the idea of shock troops to attack weak points along the Austrian lines to effect a breakthrough, which the main Russian Army could then exploit. The Russian Army had also formed hunter commando units in 1886, and used them in World War I to protect against ambushes, to perform reconnaissance and for low-intensity fights in no-man's-land. The von Hutier tactics (infiltration tactics) called for special infantry assault units to be detached from the main lines and sent to infiltrate enemy lines, supported by shorter and sharper (than usual for WWI) artillery fire missions targeting both the enemy front and rear, bypassing and avoiding what enemy strong points they could, and engaging to their best advantage when and where they were forced to, leaving decisive engagement against bypassed units to following heavier infantry. The primary goal of these detached units was to infiltrate the enemy's lines and break their cohesion as much as possible. These formations became known as Stoßtruppen, or shock troops, and the tactics they pioneered were the basis of post-WWI infantry tactics, such as the development of fire teams.^Effects: Unlocks 'Shock troops' company. Shock troops are equipped with carbines and improvised melee weapons, thus having less accuaracy but dealing better melee damage. Shock troops have better running speed and get less discipline penatlty from the enemy fire. Unlocks 'Grenade attack' ability that is only available to shock troops."),
("faction_technology_tanks_name", "Landships"),
("faction_technology_tanks_description", "A tank is an armored fighting vehicle intended as a primary offensive weapon in front-line ground combat. Tank designs are a balance of heavy firepower, strong armor, and good battlefield mobility provided by tracks and a powerful engine; usually their main armament is mounted in a turret. They are a mainstay of modern 20th and 21st century ground forces and a key part of combined arms combat. On 24 December 1915, a meeting took place of the Inter-Departmental Conference (including representatives of the Director of Naval Construction's Committee, the Admiralty, the Ministry of Munitions, and the War Office). Its purpose was to discuss the progress of the plans for what were described as 'Caterpillar Machine Gun Destroyers or Land Cruisers.' In his autobiography, Albert Gerald Stern (Secretary to the Landship Committee, later head of the Mechanical Warfare Supply Department) says that at that meeting 'Mr. (Thomas J.) Macnamara (M.P., and Parliamentary and Financial Secretary to the Admiralty) then suggested, for secrecy's sake, to change the title of the Landship Committee. Mr. d'Eyncourt agreed that it was very desirable to retain secrecy by all means, and proposed to refer to the vessel as a 'Water Carrier'. In Government offices, committees and departments are always known by their initials. For this reason I, as Secretary, considered the proposed title totally unsuitable. In our search for a synonymous term, we changed the word 'Water Carrier' to 'Tank,' and became the 'Tank Supply' or 'T.S.' Committee. That is how these weapons came to be called Tanks,' and incorrectly added, 'and the name has now been adopted by all countries in the world.'^Effects: not done yet"),
...
("italy_unification_defeat_sardinia_desc", "In order to unite Italy, {s1} will have to conquer the two Italian states still remaining on the Italian Peninsula. One of those states is the Kingdom of\
...
("italy_unification_defeat_sicily_desc", "In order to unite Italy, {s1} will have to conquer the two Italian states still remaining on the Italian Peninsula. One of those states is the Kingdom of Two\
...
("italy_unification_defeat_papalstates_desc", "In order to unite Italy, {s1} will have to conquer the two Italian states still remaining on the Italian Peninsula. One of those states is the Papal\
...
("turkish_conservative", "Muhafazakarlar"),
("turkish_liberal", "Jön Türkler"),
("turkish_socialist", "Sosyalistler"),
("italian_right", "Destra"),
("italian_left", "Sinistra"),
("italian_farleft", "Estrema sinistra"),
("italian_socialist", "Partito Socialista Italiano"),
("italian_right_desc", "Destra"),
("italian_left_desc", "Sinistra"),
("italian_farleft_desc", "Far Left Party is a radical liberal party seeking liberal freedoms as well as minimal social welfare reforms."),
("italian_socialist_desc", "Partito Socialista Italiano"),
("dutch_socialist", "Sociaal-Democratische partij"),
("dutch_socialist_desc", "Sociaal-Democratische Arbeiderspartij"),
("spanish_conservative", "Partido Conservador"),
("spanish_liberal", "Partido Liberal"),
("spanish_socialist", "Partido Socialista Obrero"),
("spanish_conservative_desc", " "),
("spanish_liberal_desc", " "),
("spanish_socialist_desc", " "),
("iran_conservative", "Moderate Party"),
("iran_liberal", "Liberal Party"),
("iran_socialist", "Socialist Party"),
("portugal_conservative", "Partido Regenerador"),
("portugal_liberal", "Partido Histórico"),
("portugal_liberal_late", "Partido Republicano"),
("portugal_socialist", "Partido Socialista"),
("denmark_conservative", "Højre"),
("denmark_liberal", "De Nationalliberale"),
("denmark_liberal_late", "Danmarks Liberale Parti"),
("denmark_socialist", "Socialdemokraterne"),
("greece_conservative", "Komma Ethnikofronon"),
("greece_liberal", "Neoteristikon Komma"),
("greece_socialist", "Sosialistiko Komma"),
("romania_conservative", "Partidul Conservator"),
("romania_liberal", "Partidul Național Liberal"),
("romania_socialist", "Partidul Muncei"),
("belgium_conservative", "Parti catholique"),
("belgium_liberal", "Parti libéral"),
("belgium_socialist", "Parti ouvrier"),
("serbia_conservative", "Narodna radikalna stranka"),
("serbia_liberal", "Liberalna partija"),
("serbia_socialist", "Srpska socijaldemokratska partija"),
...
("socialist_party_desc", "Socialist Party"),
("royalists", "Royalists"),
("slavophiles", "Slavyanofily"),
("slavophiles_desc", "Slavophilia is a movement that wanted the Russian Empire to be developed upon values and institutions derived from its early history. Slavophiles opposed the influences of Western Europe in Russia. They support authocracy, and are against political freedom. They value protectionism policy and support imperialist expansion."),
("liberals", "Liberaly"),
("liberals_desc", "Liberals are a group of intellectuals who believe that Russia's development depends upon the adoption of Western European technology and liberal government. In their view, western ideas such as industrialisation need to be implemented throughout Russia to make it a more successful country. In Russian, the term is known as zapadnichestvo, which can be translated as 'westernism'. Their main goal as political movement is implementation of political reforms. Liberals value laissez-faire policy and are less militant, as opposed to slavophilians."),
("legitimists", "Légitimistes"),
("bonapartists_liberal", "Bonapartistes Libéraux"),
("bonapartists_auth", "Bonapartistes Autoritaires"),
("legitimists_desc", "The Legitimists are royalists who adhere to the rights of dynastic succession to the French crown of the descendants of the eldest branch of the Bourbon dynasty, which was overthrown in the 1830 July Revolution. They hold right wing, counter-revolutionary views. While not being against constitutional monarchy, they strive to ensure that the aristocracy has all political power in France, and also stand against social welfare and agressive foreign policy."),
("bonapartists_liberal_desc", "Bonapartism is the political ideology supervening from Napoleon Bonaparte and his followers and successors. The term was later used to refer to people who hoped to restore the House of Bonaparte and its style of government. This bloc was made from Liberal Bonapartists who supported freedom of speech, consent of the governed and the equality of the law in general."),
("bonapartists_auth_desc", "Bonapartism is the political ideology supervening from Napoleon Bonaparte and his followers and successors. The term was later used to refer to people who hoped to restore the House of Bonaparte and its style of government. This bloc was made from Conservative Bonapartists who held traditional or old ideals about the Bonaparte instead of based it on liberty a la 1791 French Revolution."),
("soyuz17okt", "Soyuz 17 Oktyabrya"),
("soyuz17okt_desc", "The Union of October 17, commony known as the Octobrist Party, is a moderate right-wing political party of influential landowners, entrepreneurial groups and Imperial officials. It represents conservative, anti-revolutionary, and monarchist views, and supports imperialist expansionist policies."),
("kadet", "Kadety"),
("kadet_desc", "The Constitutional Democratic Party is a centrist-liberal party which promotes a Western-style constitutional government. The party consists of liberal-minded landowners, the middle urban bourgeoisie (industrialists, merchants, bankers,..), teachers, doctors, and clerks. Kadets seeks complete liberalization of the government and a few, albeit crucial social reforms."),
("rsdrp_b", "RSDRP(b)"),
("rsdrp_b_desc", "The Russian Social Democratic Labour Party is a socialist political party, mainly supported by the lower estates seeking major social reforms. The Bolshevik (''majority'') faction is a result of the RSDRP splitting due to internal conflicts. Bolsheviks are a more radical and pacifistic counterpart to the Mensheviks, seeking a world-wide proletarian revolution and a strict anti-war policy according to Marxist thought - their ultimate goal is centred around the establishment of a 'dictatorship of the proletariat' and a transition towards socialism."),
("rsdrp_m", "RSDRP(m)"),
("rsdrp_m_desc", "The Russian Social Democratic Labour Party is a socialist political party, mainly supported by the lower estates seeking major social reforms. The Menshevik (''minority'') faction is a result of the RSDRP splitting due to internal conflicts. Mensheviks are the more moderate counterpart to the Bolsheviks, and are willing to compromise with the government and show little animosity towards more moderate liberal views. Mensheviks aim to improve the conditions of the working class gradually, through reformation rather than outright revolution, and, despite the name, is decisively more popular among liberals than the Bolsheviks. "),
("bonapartists_desc", "Bonapartism is the political ideology supervening from Napoleon Bonaparte and his followers and successors. Bonaportist followers support imperialist aggressive foreign policy and protectionist economic policy."),
("russian_socialist", "RSDRP"),
("russian_socialist_desc", "Socialist party defends the rights of the lower class and seeks major social reforms, while also supporting democracy as well. They oppose any aggressive foreign policy, and will gain influence in case of unsuccessful wars."),
("french_internationale", "Internationale ouvrière"),
("french_internationale_desc", "Section française de l'Internationale ouvrière"),
("austrian_conservative", "Christlichsoziale Partei"),
("austrian_conservative_desc", "Christlichsoziale Partei"),
("austrian_liberal", "Progressive Partei"),
("austrian_liberal_desc", "Progressive Partei"),
("austrian_socialist", "Sozialdemokratische Partei"),
("austrian_socialist_desc", "SPÖ"),
("german_nlp", "Nationalliberale Partei"),
("german_nlp_desc", "The National Liberal Party is a party supporting the common ideals of liberalism and nationalism. One of its defining wings is the Nationalstaat-Flügel, which emphasizes the power of the state in order to enforce it's own power over it's citizens. National Liberal Party usually supports aggressive foreign policy, while standing for liberalization in the economic field. Social welfare is also popular among German liberals."),
("german_conservative", "Deutschkonservative Partei"),
("german_conservative_desc", "The Conservative party consists of reactionaries and stands for traditionalism and protectionist trade policy whilst standing against the fledgling German welfare state and the SPD. Conservatives also support Imperialist expansion, seeking the elusive ''Place in the sun'', and supporting governmental chauvinistic foreign policy."),
("german_progressive", "Fortschrittspartei"),
("german_progressive_desc", "The Progress Party is a German liberal party. Unlike the National Liberal Party, the Progress Party represents interests of less wealthy bourgeoisie groups, standing for the Rechtsstaat, which emphasizes civil rights over state control. While strongly supporting social welfare, the Progressive Party still stands for limited interference in the economy from the government, and for neutral foreign policy, seeking a hard limit on military spending in Prussia and Germany."),("german_socialist", "Sozialdemokratische Partei"),
("german_socialist_desc", "Sozialdemokratische Partei"),
("republicains", "Républicains"),
("republicains_desc", "The French Republicans under the Second Empire formed the strongest opposition to Napoleon III. From 1851, most of them defended the young Second Republic against the coup d'état of December 2, 1851. The final victory of the Bonapartists means that the coup d'etat is imposed on France, it then follows a period of terrible repression for the Republicans, forced into exile or condemned to heavy prison sentences for having resisted the coup by force. However, during the legislative elections of 1857, 5 Republican deputies were elected in the towns, traditional Republican strongholds. Napoleon III, furious and motivated by Orsini's failed attempt, decreed the general safety law, condemning the republicans to exile."),
("republicains_moderes", "Républicains modérés"),
("republicains_moderes_desc", "Moderate republicans are center-left wing liberals. They seek political freedom for all estates of population and are supporting laissez-faire economic policies such as free trade and minimal government interference in the economy. Consisting of bourgeoisie, they don't support social reforms."),
("gauche_radicale", "Gauche radicale"),
("gauche_radicale_desc", "Radical republicans are left wing liberals. While supporting universal equal direct suffrage, they also strive to defend rights of lower estates."),
("bonapartists", "Bonapartistes"),
("lantmannapartiet", "Lantmannapartiet"),
("dutch_antirev", "Anti-Revolutionaire Partij"),
("dutch_antirev_desc", "Dutch Anti-revolutionary party stands for preservation of old order. Consisting of privileged aristocracy, most of them oppose liberal reforms and social welfare, striving to contain their political power. They support governmental actions and aggressive foreign policy."),
("dutch_liberal", "Liberale partij"),
("dutch_liberal_desc", "Liberals seek political freedom for all estates of population and are supporting laissez-faire economic policies such as free trade and minimal government interference in the economy. Consisting of bourgeoisie, they don't support social reforms."),
("dutch_conservative", "Conservatieve partij"),
("dutch_conservative_desc", "Conservative Party is a center-right wing party. It is relatively liberal compared to it's foreign counterparts, and supports only minimum of social welfare and democratic reforms."),
("centern", "Centern"),
("radical_left", "Parti Radical-Démocratique"),
("catholic_right", "Parti Populaire Catholique"),
("liberal_centre", "Libéraux Modérés"),
("tories", "Conservative Party (Tories)"),
("whigs", "Liberal Party (Whigs)"),
("conservative_desc", "Conservative parties stand for the preservation of the old order, and a revision from recent liberal reformations. With most of their representatives belonging to the privileged aristocracy, most of them oppose liberal reforms and social welfare striving to maintain their own political power while limiting the new 'nouveau riche' strata from attaining political power. They unapologetically support governmental actions, as long as the government belongs to their own political persuasions, and aggressive foreign policy."),
("liberal_desc", "Liberals clasically seek certain political freedom for all estates and are heavily supportive of laissez-faire economic policies such as free trade and minimal tolls. Consisting primarily of the bourgeoisie, the developing middle class in the cities, they only support social reforms in an incrementalistic manner."),
("socialist_desc", "Socialist parties support the political and economic empowerment of the lower classes; in Marxist terms the proletariat and Lumpenproletariat. They will persue their goals with little room for compromise and view the upper classes, namely the aristocracy and bourgeoise as their open and declared enemy. Political zealousness with manifest itself especially during wartime, and prolonged and unsuccessful wars often help socialists in rallying the population behind themselves."),("tories_desc", "Conservative party in British Empire originates from Tories political faction. Their political views are traditionalism and conservatism. Tories defend the ideas of hierarchy, natural order, and aristocracy. They tend to support governmental aggressive foreing policy more than liberals, and stand for protectionism."),
...
("party_color1", "party_color1"),
("party_color2", "party_color2"),
("party_color3", "party_color3"),
("party_color4", "party_color4"),
("party_color5", "party_color5"),
("party_color6", "party_color6"),
("party_color7", "party_color7"),
("party_color8", "party_color8"),
("party_color9", "party_color9"),
("party_color10", "party_color10"),
("party_color11", "party_color11"),
("party_color12", "party_color12"),
("party_color13", "party_color13"),
("party_color14", "party_color14"),
("party_color15", "party_color15"),
("party_color16", "party_color16"),
("party_color17", "party_color17"),

("smokepillar1_01", "smokepillar1_01"),
("smokepillar1_02", "smokepillar1_02"),
("smokepillar1_03", "smokepillar1_03"),
("smokepillar1_04", "smokepillar1_04"),
("smokepillar1_05", "smokepillar1_05"),
("smokepillar1_06", "smokepillar1_06"),
("smokepillar1_07", "smokepillar1_07"),
("smokepillar1_08", "smokepillar1_08"),
("smokepillar1_09", "smokepillar1_09"),
("smokepillar1_10", "smokepillar1_10"),
("smokepillar1_11", "smokepillar1_11"),
("smokepillar1_12", "smokepillar1_12"),
("smokepillar1_13", "smokepillar1_13"),
("smokepillar1_14", "smokepillar1_14"),
("smokepillar1_15", "smokepillar1_15"),
("smokepillar1_16", "smokepillar1_16"),
("smokepillar1_17", "smokepillar1_17"),
("smokepillar1_18", "smokepillar1_18"),
("smokepillar1_19", "smokepillar1_19"),
("smokepillar1_20", "smokepillar1_20"),
("smokepillar1_21", "smokepillar1_21"),
("smokepillar1_22", "smokepillar1_22"),
("smokepillar1_23", "smokepillar1_23"),
("smokepillar1_24", "smokepillar1_24"),
("smokepillar1_25", "smokepillar1_25"),
("smokepillar1_26", "smokepillar1_26"),
("smokepillar1_27", "smokepillar1_27"),
("smokepillar1_28", "smokepillar1_28"),
("smokepillar1_29", "smokepillar1_29"),
("smokepillar1_30", "smokepillar1_30"),
("smokepillar1_31", "smokepillar1_31"),
("smokepillar1_32", "smokepillar1_32"),
("smokepillar1_33", "smokepillar1_33"),
("smokepillar1_34", "smokepillar1_34"),
("smokepillar1_35", "smokepillar1_35"),
("smokepillar1_36", "smokepillar1_36"),
("smokepillar1_37", "smokepillar1_37"),
("smokepillar1_38", "smokepillar1_38"),
("smokepillar1_39", "smokepillar1_39"),
("smokepillar1_40", "smokepillar1_40"),
("smokepillar1_41", "smokepillar1_41"),
("smokepillar1_42", "smokepillar1_42"),
("smokepillar1_43", "smokepillar1_43"),
("smokepillar1_44", "smokepillar1_44"),
("smokepillar1_45", "smokepillar1_45"),
("smokepillar1_46", "smokepillar1_46"),
("smokepillar1_47", "smokepillar1_47"),
("smokepillar1_48", "smokepillar1_48"),
("smokepillar1_49", "smokepillar1_49"),
("smokepillar1_50", "smokepillar1_50"),
("smokepillar1_51", "smokepillar1_51"),
("smokepillar1_52", "smokepillar1_52"),
("smokepillar1_53", "smokepillar1_53"),
("smokepillar1_54", "smokepillar1_54"),
("smokepillar1_55", "smokepillar1_55"),
("smokepillar1_56", "smokepillar1_56"),
("smokepillar1_57", "smokepillar1_57"),
("smokepillar1_58", "smokepillar1_58"),
("smokepillar1_59", "smokepillar1_59"),
("smokepillar1_60", "smokepillar1_60"),
("smokepillar1_61", "smokepillar1_61"),
("smokepillar1_62", "smokepillar1_62"),
...
("pas_rank_ukm_9", "General (9)"),
("pas_rank_ukm_10", "Field Marshall (10)"),
("pas_rank_rus_inf_1", "Ryadovoy (1)"),
("pas_rank_rus_inf_2", "Yefeytor (2)"),
("pas_rank_rus_inf_3", "Mladshy unter-ofitser (3)"),
("pas_rank_rus_inf_4", "Starshy unter-ofitser (4)"),
("pas_rank_rus_inf_5", "Poruchik (5)"),
("pas_rank_rus_inf_6", "Kapitan (6)"),
("pas_rank_rus_inf_7", "Polkovnik (7)"),
("pas_rank_rus_inf_8", "General-major (8)"),
("pas_rank_rus_inf_9", "General ot infanterii (9)"),
("pas_rank_rus_inf_10", "General-feldmarshal (10)"),
("pas_rank_rus_cav_1", "Ryadovoy (1)"),
("pas_rank_rus_cav_2", "Yefeytor (2)"),
("pas_rank_rus_cav_3", "Mladshy unter-ofitser (3)"),
("pas_rank_rus_cav_4", "Starshy unter-ofitser (4)"),
("pas_rank_rus_cav_5", "Poruchik (5)"),
("pas_rank_rus_cav_6", "Kapitan (6)"),
("pas_rank_rus_cav_7", "Polkovnik (7)"),
("pas_rank_rus_cav_8", "General-major (8)"),
("pas_rank_rus_cav_9", "General ot infanterii (9)"),
("pas_rank_rus_cav_10", "General-feldmarshal (10)"),
("pas_rank_rus_cos_1", "Kazak (1)"),
("pas_rank_rus_cos_2", "Prikazny (2)"),
("pas_rank_rus_cos_3", "Mladshy uryadnik (3)"),
("pas_rank_rus_cos_4", "Starshy uryadnik (4)"),
("pas_rank_rus_cos_5", "Sotnik (5)"),
("pas_rank_rus_cos_6", "Yesaul (6)"),
("pas_rank_rus_cos_7", "Voyskovoy starshina (7)"),
("pas_rank_rus_cos_8", "General-major (8)"),
("pas_rank_rus_cos_9", "General ot kavalrii (9)"),
("pas_rank_rus_cos_10", "General-feldmarshal (10)"),
("pas_rank_fra_1", "Soldat (1)"),
("pas_rank_fra_2", "Caporal (2)"),
("pas_rank_fra_3", "Sergent (3)"),
("pas_rank_fra_4", "Lieutenant (4)"),
("pas_rank_fra_5", "Capitaine (5)"),
("pas_rank_fra_6", "Major (6)"),
("pas_rank_fra_7", "Colonel (7)"),
("pas_rank_fra_8", "General de Division (8)"),
("pas_rank_fra_9", "General (9)"),
("pas_rank_fra_10", "Maréchal de France (10)"),
("pas_rank_ita_1", "Soldato (1)"),
("pas_rank_ita_2", "Caporale (2)"),
("pas_rank_ita_3", "Sergente (3)"),
("pas_rank_ita_4", "Tenente (4)"),
("pas_rank_ita_5", "Capitano (5)"),
("pas_rank_ita_6", "Maggiore (6)"),
("pas_rank_ita_7", "Colonnello (7)"),
("pas_rank_ita_8", "Maggiore Generale (8)"),
("pas_rank_ita_9", "Tenente de Generale (9)"),
("pas_rank_ita_10", "Generale (10)"),
("pas_rank_spa_1", "Soldado (1)"),
("pas_rank_spa_2", "Cabo (2)"),
("pas_rank_spa_3", "Sargento (3)"),
("pas_rank_spa_4", "Teniente (4)"),
("pas_rank_spa_5", "Capitan (5)"),
("pas_rank_spa_6", "Commandante (6)"),
("pas_rank_spa_7", "Coronel (7)"),
("pas_rank_spa_8", "General de Brigada (8)"),
("pas_rank_spa_9", "General de Division (9)"),
("pas_rank_spa_10", "General de Ejercito (10)"),
("pas_rank_ger_inf_1", "Soldat (1)"),
...
("pas_rank_ger_inf_9", "General der Infanterie (9)"),
("pas_rank_ger_inf_10", "Generalfeldmarshall (10)"),
("pas_rank_ger_cav_1", "Ulan (1)"),
("pas_rank_ger_cav_2", "Gefreiter (2)"),
("pas_rank_ger_cav_3", "Wachtmeister (3)"),
("pas_rank_ger_cav_4", "Leutnant (4)"),
("pas_rank_ger_cav_5", "Rittmeister (5)"),
("pas_rank_ger_cav_6", "Major (6)"),
("pas_rank_ger_cav_7", "Oberst (7)"),
("pas_rank_ger_cav_8", "Generalmajor (8)"),
("pas_rank_ger_cav_9", "General der Kavalerie (9)"),
("pas_rank_ger_cav_10", "Generalfeldmarshall (10)"),
("pas_rank_aus_inf_1", "Infanterist (1)"),
("pas_rank_aus_inf_2", "Korporal (2)"),
("pas_rank_aus_inf_3", "Feldwebel (3)"),
("pas_rank_aus_inf_4", "Leutnant (4)"),
("pas_rank_aus_inf_5", "Hauptmann (5)"),
("pas_rank_aus_inf_6", "Major (6)"),
("pas_rank_aus_inf_7", "Oberst (7)"),
("pas_rank_aus_inf_8", "Generalmajor (8)"),
("pas_rank_aus_inf_9", "General der Infanterie (9)"),
("pas_rank_aus_inf_10", "Feldmarschall (10)"),
("pas_rank_aus_cav_1", "Ulan (1)"),
("pas_rank_aus_cav_2", "Korporal (2)"),
("pas_rank_aus_cav_3", "Wachtmeister (3)"),
("pas_rank_aus_cav_4", "Leutnant (4)"),
("pas_rank_aus_cav_5", "Hauptmänn (5)"),
("pas_rank_aus_cav_6", "Major (6)"),
("pas_rank_aus_cav_7", "Oberst (7)"),
("pas_rank_aus_cav_8", "Generalmajor (8)"),
("pas_rank_aus_cav_9", "General der Infanterie (9)"),
("pas_rank_aus_cav_10", "Feldmarschall (10)"),
("pas_rank_tur_1", "Nefer (1)"),
("pas_rank_tur_2", "Onbaşı (2)"),
("pas_rank_tur_3", "Çavus (3)"),
("pas_rank_tur_4", "Mülazım (4)"),
("pas_rank_tur_5", "Yüzbaşı (5)"),
("pas_rank_tur_6", "Binbaşı (6)"),
("pas_rank_tur_7", "Kaymakam (7)"),
("pas_rank_tur_8", "Ferik (8)"),
("pas_rank_tur_9", "Serdar (9)"),
("pas_rank_tur_10", "Müşir (10)"),
("pas_rank_bel_1", "Soldaat (1)"),
("pas_rank_bel_2", "Korporaal (2)"),
("pas_rank_bel_3", "Sergeant (3)"),
("pas_rank_bel_4", "Luitenant (4)"),
("pas_rank_bel_5", "Kapitein (5)"),
("pas_rank_bel_6", "Majoor (6)"),
("pas_rank_bel_7", "Kolonel (7)"),
("pas_rank_bel_8", "Generaal Major (8)"),
("pas_rank_bel_9", "Luitenant-Generaal (9)"),
("pas_rank_bel_10", "Generaal (10)"),
("pas_rank_ser_1", "Vojnik (1)"),
("pas_rank_ser_2", "Kaplar (2)"),
("pas_rank_ser_3", "Narednik (3)"),
("pas_rank_ser_4", "Porucnik (4)"),
("pas_rank_ser_5", "Kapetan (5)"),
("pas_rank_ser_6", "Major (6)"),
("pas_rank_ser_7", "Pukovnik (7)"),
("pas_rank_ser_8", "Divizijski Deneral (8)"),
("pas_rank_ser_9", "Armijski Deneral (9)"),
("pas_rank_ser_10", "Vojvoda (10)"),
("pas_rank_por_1", "Soldato (1)"),
("pas_rank_por_2", "Cabo (2)"),
("pas_rank_por_3", "Sargento (3)"),
("pas_rank_por_4", "Tenente (4)"),
("pas_rank_por_5", "Capitaõ (5)"),
("pas_rank_por_6", "Major (6)"),
("pas_rank_por_7", "Coronel (7)"),
("pas_rank_por_8", "Brigadeiro-general (8)"),
("pas_rank_por_9", "Major-general (9)"),
("pas_rank_por_10", "General (10)"),
("pas_rank_rom_1", "Dorobant (1)"),
("pas_rank_rom_2", "Caporal (2)"),
("pas_rank_rom_3", "Sergent (3)"),
("pas_rank_rom_4", "Locotenent (4)"),
("pas_rank_rom_5", "Capitan (5)"),
("pas_rank_rom_6", "Major (6)"),
("pas_rank_rom_7", "Colonel (7)"),
("pas_rank_rom_8", "General-locotenent (8)"),
("pas_rank_rom_9", "General (9)"),
("pas_rank_rom_10", "Mareșal (10)"),
("pas_rank_gre_1", "Stratiotis (1)"),
("pas_rank_gre_2", "Dekaneas (2)"),
("pas_rank_gre_3", "Lochias (3)"),
("pas_rank_gre_4", "Hypolochagos (4)"),
("pas_rank_gre_5", "Lochagos (5)"),
("pas_rank_gre_6", "Tagmatarchos (6)"),
("pas_rank_gre_7", "Syntagmatarchos (7)"),
("pas_rank_gre_8", "Taxiarchos (8)"),
...
("lord_name_russian1", "Vasiliy"),
("lord_name_russian2", "Maksim"),
("lord_name_russian3", "Alexander"),
("lord_name_russian4", "Nikolay"),
("lord_name_russian5", "Kirill"),
("lord_name_russian6", "Yevgeniy"),
("lord_name_russian7", "Vladimir"),
("lord_name_russian8", "Ilya"),
("lord_name_russian9", "Ivan"),
("lord_name_russian10", "Mihail"),
("lord_surname_russian1", "Vasilyev"),
("lord_surname_russian2", "Nikolayev"),
("lord_surname_russian3", "Pavlov"),
("lord_surname_russian4", "Rybin"),
("lord_surname_russian5", "Ponomaryov"),
("lord_surname_russian6", "Melnikov"),
("lord_surname_russian7", "Andreyev"),
("lord_surname_russian8", "Ivanov"),
("lord_surname_russian9", "Alexandrov"),
("lord_surname_russian10", "Petrov"),
...
("lord_name_french1", "Jean"),
("lord_name_french2", "Louis"),
("lord_name_french3", "Pierre"),
("lord_name_french4", "Joseph"),
("lord_name_french5", "Henri"),
("lord_name_french6", "Georges"),
("lord_name_french7", "Rene"),
("lord_name_french8", "Francois"),
("lord_name_french9", "Ferdinand"),
("lord_name_french10", "Maurice"),
("lord_surname_french1", "Toussaint"),
("lord_surname_french2", "Lavigne"),
("lord_surname_french3", "Monet"),
("lord_surname_french4", "Dupont"),
("lord_surname_french5", "Moulin"),
("lord_surname_french6", "Lannes"),
("lord_surname_french7", "Dubois"),
("lord_surname_french8", "Laurent"),
("lord_surname_french9", "Arsenault"),
("lord_surname_french10", "Cartier"),
("lord_name_german1", "Karl"),
("lord_name_german2", "Wilhelm"),
("lord_name_german3", "Heinrich"),
("lord_name_german4", "Gunther"),
("lord_name_german5", "Otto"),
("lord_name_german6", "Adalbert"),
("lord_name_german7", "Ludwig"),
("lord_name_german8", "Friedrich"),
("lord_name_german9", "Maximillian"),
("lord_name_german10", "Erich"),
("lord_surname_german1", "von Bohm"),
("lord_surname_german2", "Schmidt"),
("lord_surname_german3", "von Prittwitz"),
("lord_surname_german4", "Vogel"),
("lord_surname_german5", "Hahn"),
("lord_surname_german6", "Graf"),
("lord_surname_german7", "von Humboldt"),
("lord_surname_german8", "Richter"),
("lord_surname_german9", "von Richtofen"),
("lord_surname_german10", "von Graff"),
("lord_name_italian1", "Matteo"),
("lord_name_italian2", "Antonio"),
("lord_name_italian3", "Alessandro"),
("lord_name_italian4", "Eduardo"),
("lord_name_italian5", "Luca"),
("lord_name_italian6", "Roberto"),
("lord_name_italian7", "Giuseppe"),
("lord_name_italian8", "Luigi"),
("lord_name_italian9", "Francesco"),
("lord_name_italian10", "Armando"),
("lord_surname_italian1", "Ricci"),
("lord_surname_italian2", "Bianchi"),
("lord_surname_italian3", "Rossi"),
("lord_surname_italian4", "Costa"),
("lord_surname_italian5", "Mancini"),
("lord_surname_italian6", "Lombardi"),
("lord_surname_italian7", "Graziani"),
("lord_surname_italian8", "Fontanelli"),
("lord_surname_italian9", "Lanza"),
("lord_surname_italian10", "Romano"),
("lord_name_portuguese1", "Manuel"),
("lord_name_portuguese2", "Antonio"),
("lord_name_portuguese3", "Luis"),
("lord_name_portuguese4", "Afonso"),
("lord_name_portuguese5", "Carlos"),
("lord_name_portuguese6", "Joaquim"),
("lord_name_portuguese7", "Teofilo"),
("lord_name_portuguese8", "Roberto"),
("lord_name_portuguese9", "Francisco"),
("lord_name_portuguese10", "Fernando"),
("lord_surname_portuguese1", "da Silva"),
("lord_surname_portuguese2", "da Costa"),
("lord_surname_portuguese3", "Alves"),
("lord_surname_portuguese4", "Santos"),
("lord_surname_portuguese5", "Pereira"),
("lord_surname_portuguese6", "Fernandes"),
("lord_surname_portuguese7", "Goncalves"),
("lord_surname_portuguese8", "Machado"),
("lord_surname_portuguese9", "Teixeira"),
("lord_surname_portuguese10", "Carvalho"),
("lord_name_dutch1", "Johan"),
("lord_name_dutch2", "Willem"),
("lord_name_dutch3", "Hendrik"),
("lord_name_dutch4", "Jeroen"),
("lord_name_dutch5", "Jan"),
("lord_name_dutch6", "Bartholomeus"),
("lord_name_dutch7", "Lodewijk"),
("lord_name_dutch8", "Frederik"),
("lord_name_dutch9", "Cornelis"),
("lord_name_dutch10", "Karel"),
("lord_surname_dutch1", "Dekker"),
("lord_surname_dutch2", "de Graaf"),
("lord_surname_dutch3", "Janssen"),
("lord_surname_dutch4", "de Wit"),
("lord_surname_dutch5", "de Vries"),
("lord_surname_dutch6", "Bosch"),
("lord_surname_dutch7", "Visser"),
("lord_surname_dutch8", "de Groot"),
("lord_surname_dutch9", "van Dijk"),
("lord_surname_dutch10", "van den Berg"),
("lord_name_danish1", "Sven"),
("lord_name_danish2", "Olaf"),
("lord_name_danish3", "Erasmus"),
("lord_name_danish4", "Lars"),
("lord_name_danish5", "Niels"),
("lord_name_danish6", "Christian"),
("lord_name_danish7", "Alfred"),
("lord_name_danish8", "August"),
("lord_name_danish9", "Frederik"),
("lord_name_danish10", "Edvard"),
("lord_surname_danish1", "Nielsen"),
("lord_surname_danish2", "Christiansen"),
("lord_surname_danish3", "Andersen"),
("lord_surname_danish4", "Pedersen"),
("lord_surname_danish5", "Madsen"),
("lord_surname_danish6", "Jansen"),
("lord_surname_danish7", "Rasmussen"),
("lord_surname_danish8", "Poulsen"),
("lord_surname_danish9", "Jorgensen"),
("lord_surname_danish10", "Moller"),
("lord_name_swedish1", "Sven"),
("lord_name_swedish2", "Olaf"),
("lord_name_swedish3", "Gustaf"),
("lord_name_swedish4", "Karl"),
("lord_name_swedish5", "Nils"),
("lord_name_swedish6", "Petter"),
("lord_name_swedish7", "Jens"),
("lord_name_swedish8", "Erik"),
("lord_name_swedish9", "Jakob"),
("lord_name_swedish10", "Johan"),
("lord_surname_swedish1", "Karlsson"),
("lord_surname_swedish2", "Persson"),
("lord_surname_swedish3", "Andersson"),
("lord_surname_swedish4", "Pettersson"),
("lord_surname_swedish5", "Magnusson"),
("lord_surname_swedish6", "Svensson"),
("lord_surname_swedish7", "Johansson"),
("lord_surname_swedish8", "Larsson"),
("lord_surname_swedish9", "Lindberg"),
("lord_surname_swedish10", "Eriksson"),
("lord_name_norwegian1", "Sven"),
("lord_name_norwegian2", "Olaf"),
("lord_name_norwegian3", "Erasmus"),
("lord_name_norwegian4", "Lars"),
("lord_name_norwegian5", "Nils"),
("lord_name_norwegian6", "Petter"),
("lord_name_norwegian7", "Jens"),
("lord_name_norwegian8", "Erik"),
("lord_name_norwegian9", "Jakob"),
("lord_name_norwegian10", "Johan"),
("lord_surname_norwegian1", "Berg"),
("lord_surname_norwegian2", "Hagen"),
("lord_surname_norwegian3", "Hansen"),
("lord_surname_norwegian4", "Johnsen"),
("lord_surname_norwegian5", "Kristiansen"),
("lord_surname_norwegian6", "Larsen"),
("lord_surname_norwegian7", "Olsen"),
("lord_surname_norwegian8", "Johannessen"),
("lord_surname_norwegian9", "Andreassen"),
("lord_surname_norwegian10", "Jacobsen"),
("lord_name_turkish1", "Kazim"),
("lord_name_turkish2", "Mustafa"),
("lord_name_turkish3", "Mehmet"),
("lord_name_turkish4", "Enver"),
("lord_name_turkish5", "Ahmet"),
("lord_name_turkish6", "Deniz"),
("lord_name_turkish7", "Celal"),
("lord_name_turkish8", "Cemal"),
("lord_name_turkish9", "Suleyman"),
("lord_name_turkish10", "Nuri"),
("lord_surname_turkish1", "Yilmaz"),
("lord_surname_turkish2", "Demir"),
("lord_surname_turkish3", "Sahin"),
("lord_surname_turkish4", "Yildirim"),
("lord_surname_turkish5", "Yavuz"),
("lord_surname_turkish6", "Arslan"),
("lord_surname_turkish7", "Khan"),
("lord_surname_turkish8", "Pasha"),
("lord_surname_turkish9", "Bey"),
("lord_surname_turkish10", "Effendi"),
("lord_name_romanian1", "Ion"),
("lord_name_romanian2", "Anton"),
("lord_name_romanian3", "Nicolae"),
("lord_name_romanian4", "Mihai"),
("lord_name_romanian5", "Alexandru"),
("lord_name_romanian6", "Florian"),
("lord_name_romanian7", "Teodor"),
("lord_name_romanian8", "Marius"),
("lord_name_romanian9", "Cristian"),
("lord_name_romanian10", "Adrian"),
("lord_surname_romanian1", "Radu"),
("lord_surname_romanian2", "Ionescu"),
("lord_surname_romanian3", "Popescu"),
("lord_surname_romanian4", "Dumitrescu"),
("lord_surname_romanian5", "Grigorescu"),
("lord_surname_romanian6", "Teodorescu"),
("lord_surname_romanian7", "Iliescu"),
("lord_surname_romanian8", "Averescu"),
("lord_surname_romanian9", "Berindei"),
("lord_surname_romanian10", "Bratianu"),
("lord_name_bulgarian1", "Boris"),
("lord_name_bulgarian2", "Hristo"),
("lord_name_bulgarian3", "Georgi"),
("lord_name_bulgarian4", "Nikola"),
("lord_name_bulgarian5", "Vasil"),
("lord_name_bulgarian6", "Simeon"),
("lord_name_bulgarian7", "Todor"),
("lord_name_bulgarian8", "Dimitar"),
("lord_name_bulgarian9", "Ivan"),
("lord_name_bulgarian10", "Stoyan"),
("lord_surname_bulgarian1", "Hristov"),
("lord_surname_bulgarian2", "Stoyanov"),
("lord_surname_bulgarian3", "Kovachev"),
("lord_surname_bulgarian4", "Todorov"),
("lord_surname_bulgarian5", "Kutinchev"),
("lord_surname_bulgarian6", "Georgiev"),
("lord_surname_bulgarian7", "Ivanov"),
("lord_surname_bulgarian8", "Toshev"),
("lord_surname_bulgarian9", "Petrov"),
("lord_surname_bulgarian10", "Dimitrov"),
("lord_name_serbian1", "Dragoljub"),
("lord_name_serbian2", "Draza"),
("lord_name_serbian3", "Radoslav"),
("lord_name_serbian4", "Zivojin"),
("lord_name_serbian5", "Pavle"),
("lord_name_serbian6", "Petar"),
("lord_name_serbian7", "Milan"),
("lord_name_serbian8", "Milos"),
("lord_name_serbian9", "Dusan"),
("lord_name_serbian10", "Slobodan"),
("lord_surname_serbian1", "Misic"),
("lord_surname_serbian2", "Jovanovic"),
("lord_surname_serbian3", "Ilic"),
("lord_surname_serbian4", "Stojanovic"),
("lord_surname_serbian5", "Milosevic"),
("lord_surname_serbian6", "Radovanovic"),
("lord_surname_serbian7", "Stankovic"),
("lord_surname_serbian8", "Nedic"),
("lord_surname_serbian9", "Mirkovic"),
("lord_surname_serbian10", "Mirkovic"),
("lord_name_croatian1", "Stjepan"),
("lord_name_croatian2", "Svetozar"),
("lord_name_croatian3", "Ivan"),
("lord_name_croatian4", "Franjo"),
("lord_name_croatian5", "Josip"),
("lord_name_croatian6", "Marko"),
("lord_name_croatian7", "Tomislav"),
("lord_name_croatian8", "Nikola"),
("lord_name_croatian9", "Leon"),
("lord_name_croatian10", "Slobodan"),
("lord_surname_croatian1", "Pavlovic"),
("lord_surname_croatian2", "Vukovic"),
("lord_surname_croatian3", "Sarkotic"),
("lord_surname_croatian4", "Filipovic"),
("lord_surname_croatian5", "Boroevic"),
("lord_surname_croatian6", "Popovic"),
("lord_surname_croatian7", "Barisic"),
("lord_surname_croatian8", "Pavelic"),
("lord_surname_croatian9", "Vlasic"),
("lord_surname_croatian10", "Cervenko"),
("lord_name_polish1", "Wladyslaw"),
("lord_name_polish2", "Jozef"),
("lord_name_polish3", "Mikolaj"),
("lord_name_polish4", "Jan"),
("lord_name_polish5", "Franciszek"),
("lord_name_polish6", "Jakub"),
("lord_name_polish7", "Zbigniew"),
("lord_name_polish8", "Ignacy"),
("lord_name_polish9", "Kazimierz"),
("lord_name_polish0", "Janusz"),
("lord_surname_polish1", "Nowak"),
("lord_surname_polish2", "Kowalski"),
("lord_surname_polish3", "Wisniewski"),
("lord_surname_polish4", "Dabrowski"),
("lord_surname_polish5", "Zielinski"),
("lord_surname_polish6", "Adamowicz"),
("lord_surname_polish7", "Poniatowski"),
("lord_surname_polish8", "Kaminski"),
("lord_surname_polish9", "Lewandowski"),
("lord_surname_polish10", "Potocki"),
("lord_name_albanian1", "Sali"),
("lord_name_albanian2", "Omer"),
("lord_name_albanian3", "Mehmet"),
("lord_name_albanian4", "Enver"),
("lord_name_albanian5", "Ahmet"),
("lord_name_albanian6", "Ramiz"),
("lord_name_albanian7", "Rexhep"),
("lord_name_albanian8", "Turhan"),
("lord_name_albanian9", "Ibrahim"),
("lord_name_albanian10", "Mehdi"),
("lord_surname_albanian1", "Hoxha"),
("lord_surname_albanian2", "Shehu"),
("lord_surname_albanian3", "Berisha"),
("lord_surname_albanian4", "Halili"),
("lord_surname_albanian5", "Leka"),
("lord_surname_albanian6", "Koroveshi"),
("lord_surname_albanian7", "Gashi"),
("lord_surname_albanian8", "Dervishi"),
("lord_surname_albanian9", "Brahimi"),
("lord_surname_albanian10", "Berisha"),
("lord_name_arabic1", "Jamal"),
("lord_name_arabic2", "Omar"),
("lord_name_arabic3", "Ahmed"),
("lord_name_arabic4", "Usman"),
("lord_name_arabic5", "Abdullah"),
("lord_name_arabic6", "Muhammad"),
("lord_name_arabic7", "Ali"),
("lord_name_arabic8", "Yusuf"),
("lord_name_arabic9", "Ibrahim"),
("lord_name_arabic10", "Bashar"),
("lord_surname_arabic1", "al Aziz"),
("lord_surname_arabic2", "Amin"),
("lord_surname_arabic3", "an Nasir"),
("lord_surname_arabic4", "Hussain"),
("lord_surname_arabic5", "Khan"),
("lord_surname_arabic6", "Darwish"),
("lord_surname_arabic7", "Abbas"),
("lord_surname_arabic8", "Karim"),
("lord_surname_arabic9", "Malik"),
("lord_surname_arabic10", "Quraishi"),
("lord_name_armenian1", "Khachaturi"),
("lord_name_armenian2", "Hovhannes"),
("lord_name_armenian3", "Hakob"),
("lord_name_armenian4", "Nikol"),
("lord_name_armenian5", "Arthur"),
("lord_name_armenian6", "David"),
("lord_name_armenian7", "Samuel"),
("lord_name_armenian8", "Andranik"),
("lord_name_armenian9", "Garegin"),
("lord_name_armenian10", "Ruben"),
("lord_surname_armenian1", "Sargsyan"),
("lord_surname_armenian2", "Harutyunyan"),
("lord_surname_armenian3", "Grigoryan"),
("lord_surname_armenian4", "Hovhannisyan"),
("lord_surname_armenian5", "Hakobyan"),
("lord_surname_armenian6", "Ozanian"),
("lord_surname_armenian7", "Petrosyan"),
("lord_surname_armenian8", "Babadzhanian"),
("lord_surname_armenian9", "Karapetyan"),
("lord_surname_armenian10", "Bagramyan"),
("lord_name_azeri1", "Mais"),
("lord_name_azeri2", "Huseyn"),
("lord_name_azeri3", "Mammad"),
("lord_name_azeri4", "Ilham"),
("lord_name_azeri5", "Ahmed"),
("lord_name_azeri6", "Jafar"),
("lord_name_azeri7", "Heydar"),
("lord_name_azeri8", "Abdullah"),
("lord_name_azeri9", "Ahsan"),
("lord_name_azeri10", "Zakir"),
("lord_surname_azeri1", "Aliyev"),
("lord_surname_azeri2", "Mammadov"),
("lord_surname_azeri3", "Huseynov"),
("lord_surname_azeri4", "Hasanov"),
("lord_surname_azeri5", "Guliyev"),
("lord_surname_azeri6", "Ismayilov"),
("lord_surname_azeri7", "Ahmadov"),
("lord_surname_azeri8", "Abdullayev"),
("lord_surname_azeri9", "Jafarov"),
("lord_surname_azeri10", "Efendi"),
("lord_name_turkestan1", "Ayubkhan"),
("lord_name_turkestan2", "Bolatbek"),
("lord_name_turkestan3", "Abdulloh"),
("lord_name_turkestan4", "Fayzulla"),
("lord_name_turkestan5", "Ahmed"),
("lord_name_turkestan6", "Nasruddin"),
("lord_name_turkestan7", "Muhammad"),
("lord_name_turkestan8", "Abdullah"),
("lord_name_turkestan9", "Ismail"),
("lord_name_turkestan10", "Shavkat"),
("lord_surname_turkestan1", "Niyaz"),
("lord_surname_turkestan2", "Ghazni"),
("lord_surname_turkestan3", "Usman"),
("lord_surname_turkestan4", "Rahmon"),
("lord_surname_turkestan5", "Akhmed"),
("lord_surname_turkestan6", "Sharip"),
("lord_surname_turkestan7", "Said"),
("lord_surname_turkestan8", "Gul"),
("lord_surname_turkestan9", "Khomid"),
("lord_surname_turkestan10", "Beg"),
("lord_name_persian1", "Jamshid"),
("lord_name_persian2", "Mehran"),
("lord_name_persian3", "Khosrow"),
("lord_name_persian4", "Jahangir"),
("lord_name_persian5", "Ahmed"),
("lord_name_persian6", "Farroukh"),
("lord_name_persian7", "Vahid"),
("lord_name_persian8", "Javad"),
("lord_name_persian9", "Abolhassan"),
("lord_name_persian10", "Reza"),
("lord_surname_persian1", "Pahlavi"),
("lord_surname_persian2", "Farrokhzad"),
("lord_surname_persian3", "Beg"),
("lord_surname_persian4", "Banisadr"),
("lord_surname_persian5", "Ghassemi"),
("lord_surname_persian6", "Rajavi"),
("lord_surname_persian7", "Sadegh"),
("lord_surname_persian8", "Soleimani"),
("lord_surname_persian9", "Rouhani"),
("lord_surname_persian10", "Parsi"),
("lord_name_pashtun1", "Mohammad"),
("lord_name_pashtun2", "Abdul"),
("lord_name_pashtun3", "Suhail"),
("lord_name_pashtun4", "Ghulam"),
("lord_name_pashtun5", "Ahmad"),
("lord_name_pashtun6", "Amanullah"),
("lord_name_pashtun7", "Ali"),
("lord_name_pashtun8", "Abdullah"),
("lord_name_pashtun9", "Mullah"),
("lord_name_pashtun10", "Habibullah"),
("lord_surname_pashtun1", "Shah"),
("lord_surname_pashtun2", "Ghani"),
("lord_surname_pashtun3", "Mirza"),
("lord_surname_pashtun4", "Khan"),
("lord_surname_pashtun5", "Haji"),
("lord_surname_pashtun6", "Hassan"),
("lord_surname_pashtun7", "Shaheen"),
("lord_surname_pashtun8", "Dost"),
("lord_surname_pashtun9", "Noor"),
("lord_surname_pashtun10", "Massoud"),
("lord_name_greek1", "Pavlos"),
("lord_name_greek2", "Alexandros"),
("lord_name_greek3", "Konstantinos"),
("lord_name_greek4", "Panagiotis"),
("lord_name_greek5", "Theodoros"),
("lord_name_greek6", "Dimitris"),
("lord_name_greek7", "Nikos"),
("lord_name_greek8", "Kostas"),
("lord_name_greek9", "Ioannis"),
("lord_name_greek10", "Thanos"),
("lord_surname_greek1", "Athanasiadis"),
("lord_surname_greek2", "Papagos"),
("lord_surname_greek3", "Papadopoulos"),
("lord_surname_greek4", "Karamanlis"),
("lord_surname_greek5", "Papandreou"),
("lord_surname_greek6", "Stavrou"),
("lord_surname_greek7", "Dimitriou"),
("lord_surname_greek8", "Kalogeros"),
("lord_surname_greek9", "Gavras"),
("lord_surname_greek10", "Kouris"),
("lord_name_czech1", "Stanislav"),
("lord_name_czech2", "Riško"),
("lord_name_czech3", "Břetislav"),
("lord_name_czech4", "Martin"),
("lord_name_czech5", "Bartolomej"),
("lord_name_czech6", "Cyril"),
("lord_name_czech7", "Vladimír"),
("lord_name_czech8", "Jarek"),
("lord_name_czech9", "Dušan"),
("lord_name_czech10", "Gregor"),
("lord_surname_czech1", "Kafka"),
("lord_surname_czech2", "Bosko"),
("lord_surname_czech3", "Marek"),
("lord_surname_czech4", "Černík"),
("lord_surname_czech5", "Beránek"),
("lord_surname_czech6", "Pospíšil"),
("lord_surname_czech7", "Kadlec"),
("lord_surname_czech8", "Vesela"),
("lord_surname_czech9", "Klement"),
("lord_surname_czech10", "Pražak"),
("lord_name_hungarian1", "Istvan"),
("lord_name_hungarian2", "Matyas"),
("lord_name_hungarian3", "Lajos"),
("lord_name_hungarian4", "Zoltan"),
("lord_name_hungarian5", "Bela"),
("lord_name_hungarian6", "Janos"),
("lord_name_hungarian7", "Karoly"),
("lord_name_hungarian8", "Sandor"),
("lord_name_hungarian9", "Miklos"),
("lord_name_hungarian10", "Laszlo"),
("lord_surname_hungarian1", "Nagy"),
("lord_surname_hungarian2", "Horvath"),
("lord_surname_hungarian3", "Szabo"),
("lord_surname_hungarian4", "Kovacs"),
("lord_surname_hungarian5", "Farkas"),
("lord_surname_hungarian6", "Nemeth"),
("lord_surname_hungarian7", "Varga"),
("lord_surname_hungarian8", "Molnas"),
("lord_surname_hungarian9", "Horthy"),
("lord_surname_hungarian10", "Gyulay"),
("lord_name_ukrainian1", "Volodymyr"),
("lord_name_ukrainian2", "Petro"),
("lord_name_ukrainian3", "Mykola"),
("lord_name_ukrainian4", "Ivan"),
("lord_name_ukrainian5", "Oleg"),
("lord_name_ukrainian6", "Symon"),
("lord_name_ukrainian7", "Bohuslav"),
("lord_name_ukrainian8", "Dmytro"),
("lord_name_ukrainian9", "Mykhailo"),
("lord_name_ukrainian10", "Yevhen"),
("lord_surname_ukrainian1", "Pavlenko"),
("lord_surname_ukrainian2", "Boyko"),
("lord_surname_ukrainian3", "Kovalenko"),
("lord_surname_ukrainian4", "Bondarenko"),
("lord_surname_ukrainian5", "Zelinskyi"),
("lord_surname_ukrainian6", "Tkachuk"),
("lord_surname_ukrainian7", "Kumanovych"),
("lord_surname_ukrainian8", "Yeroshevych"),
("lord_surname_ukrainian9", "Shevchenko"),
("lord_surname_ukrainian10", "Khmelnitskyi"),
("lord_name_lithuanian1", "Antanas"),
("lord_name_lithuanian2", "Lukas"),
("lord_name_lithuanian3", "Darius"),
("lord_name_lithuanian4", "Kazimieras"),
("lord_name_lithuanian5", "Mindaugas"),
("lord_name_lithuanian6", "Algirdas"),
("lord_name_lithuanian7", "Silvestras"),
("lord_name_lithuanian8", "Ignas"),
("lord_name_lithuanian9", "Leonas"),
("lord_name_lithuanian10", "Liudvikas"),
("lord_surname_lithuanian1", "Kazlauskas"),
("lord_surname_lithuanian2", "Jankauskas"),
("lord_surname_lithuanian3", "Petrauskas"),
("lord_surname_lithuanian4", "Stankevicius"),
("lord_surname_lithuanian5", "Vasiliauskas"),
("lord_surname_lithuanian6", "Butkus"),
("lord_surname_lithuanian7", "Zukauskas"),
("lord_surname_lithuanian8", "Paulauskas"),
("lord_surname_lithuanian9", "Urbonas"),
("lord_surname_lithuanian10", "Kavaiauskas"),
("lord_name_latvian1", "Andris"),
("lord_name_latvian2", "Davids"),
("lord_name_latvian3", "Andris"),
("lord_name_latvian4", "Peteris"),
("lord_name_latvian5", "Herberts"),
("lord_name_latvian6", "Krisjanis"),
("lord_name_latvian7", "Roberts"),
("lord_name_latvian8", "Oskars"),
("lord_name_latvian9", "Janis"),
("lord_name_latvian10", "Edgars"),
("lord_surname_latvian1", "Berzins"),
("lord_surname_latvian2", "Kalnins"),
("lord_surname_latvian3", "Ozolins"),
("lord_surname_latvian4", "Liepins"),
("lord_surname_latvian5", "Jansons"),
("lord_surname_latvian6", "Cukurs"),
("lord_surname_latvian7", "Levits"),
("lord_surname_latvian8", "Ulmanis"),
("lord_surname_latvian9", "Zemgals"),
("lord_surname_latvian10", "Kucinskis"),
("lord_name_estonian1", "Rasmus"),
("lord_name_estonian2", "Erik"),
("lord_name_estonian3", "Robert"),
("lord_name_estonian4", "Kaarel"),
("lord_name_estonian5", "Antero"),
("lord_name_estonian6", "Paul"),
("lord_name_estonian7", "Artur"),
("lord_name_estonian8", "Robin"),
("lord_name_estonian9", "Johan"),
("lord_name_estonian10", "Edgar"),
("lord_surname_estonian1", "Ratas"),
("lord_surname_estonian2", "Pats"),
("lord_surname_estonian3", "Eenpalu"),
("lord_surname_estonian4", "Uluots"),
("lord_surname_estonian5", "Vares"),
("lord_surname_estonian6", "Kukk"),
("lord_surname_estonian7", "Parn"),
("lord_surname_estonian8", "Tamm"),
("lord_surname_estonian9", "Saar"),
("lord_surname_estonian10", "Rehi"),
