...
("faction_technology_improvedlogistics_name", "Combat Logistics"),
("faction_technology_improvedlogistics_description", "Road networks, railway and telegraph lines improved the quality of late-century combat logistics immensely, allowing for faster and better supply runs while the army was out in the field. This meant not only that soldiers would have more ammunition available to them during combat, but also that larger artillery batteries and extensive fire missions were possible. Both the American Civil War and Prussia's performance in 1870/1871 inspired a new understanding for logistics, heavily pushing the development of new supply chain hierarchies forwards.^^Effects: Soldiers that run out of ammo receive new ammunitions faster. Increases artillery ammunition capacity."),
