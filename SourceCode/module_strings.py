...
("soyuz17okt_desc", "Union of October 17 is a moderate right-wing political party of large landowners, entrepreneurial groups and officials. It represents conservative, anti-revolutionary, and monarchist views, and supports imperialist expansion politics."),
("kadet", "Kadety"),
("kadet_desc", "Constitutional Democratic Party is a centrist, liberal political party that promotes Western constitutional government. The party consists of liberal-minded landowners, the middle urban bourgeoisie (industrialists, merchants, bankers), teachers, doctors, and clerks. Kadets seeks full liberalization of government and some social reforms."),
("rsdrp_b", "RSDRP(b)"),
("rsdrp_b_desc", "Russian Social Democratic Labour Party is a socialist political party, mainly supported by lower estates and seeking social reforms. Bolshevik (''majority'') faction is a result of RSDRP splitting because of internal conflicts. Bolsheviks are more radical and pacifist counterpart to the mensheviks, aiming for the world proletariat revolution and anti-war policy according to Marxism policy - their maximum program is focused on the the establishment of the dictatorship of the proletariat and transition to socialism."),
("rsdrp_m", "RSDRP(m)"),
("rsdrp_m_desc", "Russian Social Democratic Labour Party is a socialist political party, mainly supported by lower estates and seeking social reforms. Menshevik (''minority'') faction is a result of RSDRP splitting because of internal conflicts. Mensheviks are more moderate counterpart to the bolsheviks, are willing to compromise with the government and are positive towards the liberal views. Mensheviks aim to improve the conditions of workers gradually, in a reformatory way, and, despite the name, has better populatiry among liberal groups than Bolsheviks. "),
