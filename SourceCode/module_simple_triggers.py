...
#Randomly changing humidity
	(store_random_in_range, ":random", -4, 5),
...
(24,[
	(try_for_range, ":faction", kingdoms_begin, kingdoms_end),
	(faction_get_slot, ":rifle_type", ":faction", slot_faction_technology_rifle_type),
	(faction_get_slot, ":cannon_loading_type", ":faction", slot_faction_technology_cannon_loading_type),
	(faction_get_slot, ":cannon_he_type", ":faction", slot_faction_technology_cannon_he_type),
	(faction_get_slot, ":cannon_rifling_type", ":faction", slot_faction_technology_cannon_rifling_type),
	(faction_get_slot, ":cannon_projectile_type", ":faction", slot_faction_technology_cannon_projectile_type),
	(faction_get_slot, ":rifled", ":faction", slot_faction_preset_year_to_switch_rifle_type_to_rifled),
	(faction_get_slot, ":converted", ":faction", slot_faction_preset_year_to_switch_rifle_type_to_converted),
	(faction_get_slot, ":smallcaliber", ":faction", slot_faction_preset_year_to_switch_rifle_type_to_smallcaliber),
	(faction_get_slot, ":boltaction", ":faction", slot_faction_preset_year_to_switch_rifle_type_to_boltaction),
	(faction_get_slot, ":breechloading", ":faction", slot_faction_preset_year_to_switch_cannon_loading_type_to_breechloading),
	(faction_get_slot, ":he_late", ":faction", slot_faction_preset_year_to_switch_cannon_he_type_to_late_he),
	(faction_get_slot, ":rifled_cannon", ":faction", slot_faction_preset_year_to_switch_cannon_rifling_type_to_rifled),
	(faction_get_slot, ":early_shell", ":faction", slot_faction_preset_year_to_switch_cannon_projectile_type_to_early_shell),
	(faction_get_slot, ":late_shell", ":faction", slot_faction_preset_year_to_switch_cannon_projectile_type_to_late_shell),
		(try_begin),
		(lt, ":rifle_type", rifle_type_rifled),
		(gt, ":rifled", 0), (le, ":rifled", "$g_current_year"),
		(store_random_in_range, ":random", 1, 7), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_rifle_type, rifle_type_rifled),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses rifled muskets.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":rifle_type", rifle_type_converted),
		(gt, ":converted", 0), (le, ":converted", "$g_current_year"),
		(store_random_in_range, ":random", 1, 7), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_rifle_type, rifle_type_converted),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses converted breech loaded rifles.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":rifle_type", rifle_type_smallcaliber),
		(gt, ":smallcaliber", 0), (le, ":smallcaliber", "$g_current_year"),
		(store_random_in_range, ":random", 1, 7), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_rifle_type, rifle_type_smallcaliber),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses modern breech-loading rifles.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":rifle_type", rifle_type_boltaction),
		(gt, ":boltaction", 0), (le, ":boltaction", "$g_current_year"),
		(store_random_in_range, ":random", 1, 7), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_rifle_type, rifle_type_boltaction),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses magazine rifles.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":cannon_loading_type", cannon_loading_type_breechloading),
		(gt, ":breechloading", 0), (le, ":breechloading", "$g_current_year"),
		(store_random_in_range, ":random", 1, 16), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_cannon_loading_type, cannon_loading_type_breechloading),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses breech-loading cannons.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":cannon_he_type", cannon_he_type_late),
		(gt, ":he_late", 0), (le, ":he_late", "$g_current_year"),
		(store_random_in_range, ":random", 1, 16), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_cannon_he_type, cannon_he_type_late),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} have improved their weaponry and now uses smokeless powder explosive shells.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":cannon_rifling_type", cannon_rifling_type_rifled),
		(gt, ":rifled_cannon", 0), (le, ":rifled_cannon", "$g_current_year"),
		(store_random_in_range, ":random", 1, 16), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_cannon_rifling_type, cannon_rifling_type_rifled),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} have improved their weaponry and now uses rifled cannons.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":cannon_projectile_type", cannon_projectile_type_early_shell),
		(gt, ":early_shell", 0), (le, ":early_shell", "$g_current_year"),
		(store_random_in_range, ":random", 1, 16), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_cannon_projectile_type, cannon_projectile_type_early_shell),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} have improved their weaponry and now uses explosive shells.", 0x8ae2ff),
		(try_end),
		(try_begin),
		(lt, ":cannon_projectile_type", cannon_projectile_type_late_shell),
		(gt, ":late_shell", 0), (le, ":late_shell", "$g_current_year"),
		(store_random_in_range, ":random", 1, 16), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_cannon_projectile_type, cannon_projectile_type_late_shell),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} have improved their weaponry and now uses advanced explosive shells.", 0x8ae2ff),
		(try_end),
	(try_end),
]), 
(24,[
