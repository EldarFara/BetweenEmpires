...
(24,[
	(try_for_range, ":faction", kingdoms_begin, kingdoms_end),
	(faction_get_slot, ":type", ":faction", slot_faction_technology_rifle_type),
	...
	(faction_get_slot, ":boltaction", ":faction", slot_faction_preset_year_to_switch_rifle_type_to_boltaction),
		(try_begin),
		(lt, ":type", rifle_type_rifled),
		(gt, ":rifled", 0), (le, ":rifled", "$g_current_year"),
		(store_random_in_range, ":random", 1, 5), (eq, ":random", 1),
		(faction_set_slot, ":faction",  slot_faction_technology_rifle_type, rifle_type_rifled),
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses rifled muskets.", 0x006080),
		(try_end),
		(try_begin),
		(lt, ":type", rifle_type_converted),
		...
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses converted breech loaded rifles.", 0x006080),
		(try_end),
		(try_begin),
		(lt, ":type", rifle_type_smallcaliber),
		...
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses modern breech loaded rifles.", 0x006080),
		(try_end),
		(try_begin),
		(lt, ":type", rifle_type_boltaction),
		...
		(str_store_faction_name, s1, ":faction"), (display_message, "@Army of {s1} has been rearmed and now uses magazine rifles.", 0x006080),
		(try_end),
	(try_end),
]), 
(24,[
...
(display_message, "@The year is {reg0}.", 0x006080),
]), 
]
