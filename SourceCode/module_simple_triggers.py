...
[
	...
	(call_script, "script_faction_annex_faction", ":faction_russia", "fac_kingdom_22", 100),
	...
	(ge, "$g_current_year", 1862),
	(call_script, "script_cf_random", 5),
	(call_script, "script_faction_annex_faction", ":faction_russia", "fac_kingdom_23", 100),
	...
	(try_end),
	(try_begin),
	(eq, "$balkanwars_status", 0),
	(faction_slot_eq, ":faction_serbia", slot_faction_state, sfs_active),
	(faction_slot_eq, ":faction_bulgaria", slot_faction_state, sfs_active),
	(faction_slot_eq, ":faction_greece", slot_faction_state, sfs_active),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_serbia", ":faction_bulgaria"), (neq, reg0, -2),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_serbia", ":faction_greece"), (neq, reg0, -2),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_bulgaria", ":faction_greece"), (neq, reg0, -2),
	(store_faction_of_party, ":faction1", "p_castle_33"),
	(store_faction_of_party, ":faction2", "p_castle_36"),
	(store_faction_of_party, ":faction3", "p_castle_103"),
	(store_faction_of_party, ":faction4", "p_castle_159"),
	(this_or_next|eq, ":faction1", ":faction_turkey"),
	(this_or_next|eq, ":faction2", ":faction_turkey"),
	(this_or_next|eq, ":faction3", ":faction_turkey"),
	(eq, ":faction4", ":faction_turkey"),
		(try_begin),
		(eq, "$ww1_status", 0),
		(assign, ":chance", 0),
			(try_begin),
			(ge, "$g_current_year", 1912),
			(assign, ":chance", 50),
			(else_try),
			(ge, "$g_current_year", 1911),
			(assign, ":chance", 5),
			(else_try),
			(ge, "$g_current_year", 1910),
			(assign, ":chance", 2),
			(try_end),
			(try_begin),
		...
		(assign, "$balkanwars_status", 1),
		(jump_to_menu, "mnu_balkanwars_event1"),
		(try_end),
	(else_try),
	(is_between, "$balkanwars_status", 1, 3),
	(val_add, "$balkanwars_status", 1),
	(else_try),
	(eq, "$balkanwars_status", 3),
	(assign, "$balkanwars_status", 4),
	(jump_to_menu, "mnu_balkanwars_event2"),
	(else_try),
	(eq, "$balkanwars_status", 4),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_serbia", ":faction_turkey"), (neq, reg0, -2),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_greece", ":faction_turkey"), (neq, reg0, -2),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", ":faction_bulgaria", ":faction_turkey"), (neq, reg0, -2),
	(assign, "$balkanwars_status", 5),
	(else_try),
	(is_between, "$balkanwars_status", 5, 7),
	(val_add, "$balkanwars_status", 1),
	(else_try),
	...
	(val_add, "$ww1_status", 1),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_bulgaria", ":faction_germany"),
		(call_script, "script_create_alliance_between_factions", ":faction_bulgaria", ":faction_austria"),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 55),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_turkey", ":faction_germany"),
		(call_script, "script_create_alliance_between_factions", ":faction_turkey", ":faction_austria"),
		(call_script, "script_create_alliance_between_factions", ":faction_turkey", ":faction_bulgaria"),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 60),
		(neq, "$player_faction_preset", "fac_kingdom_4"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_italy", ":faction_austria", 1),
		(call_script, "script_create_alliance_between_factions", ":faction_italy", ":faction_belgium"),
		(call_script, "script_create_alliance_between_factions", ":faction_italy", ":faction_russia"),
		(call_script, "script_create_alliance_between_factions", ":faction_italy", ":faction_serbia"),
		(call_script, "script_create_alliance_between_factions", ":faction_italy", ":faction_france"),
		(call_script, "script_create_alliance_between_factions", ":faction_italy", ":faction_britain"),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 90),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_belgium"),
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_russia"),
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_serbia"),
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_france"),
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_britain"),
		(call_script, "script_create_alliance_between_factions", ":faction_romania", ":faction_italy"),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 120),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_belgium"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_russia"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_serbia"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_france"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_britain"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_italy"),
		(call_script, "script_create_alliance_between_factions", ":faction_greece", ":faction_romania"),
		(try_end),
	(try_end),
