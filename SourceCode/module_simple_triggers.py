   ...
   [
	...
	(assign, ":tech_faction", "$async_simple_trigger31"),
		...
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_lou_hat12", "itm_lou_infantry22", "itm_lou_infantry_trousers4"),
			...
			(troop_add_items, ":troop", "itm_lou_hat6", 1), (troop_add_items, ":troop", "itm_lou_infantry19", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
		...
		(eq, ":faction", "fac_kingdom_31"),
			...
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_eq, ":faction", slot_faction_flag_material, "str_flag1_63"),
		...
		(eq, ":faction", "fac_kingdom_30"),
			...
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_eq, ":faction", slot_faction_flag_material, "str_flag1_68"),
