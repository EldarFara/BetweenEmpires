  ...
  (0,
   [
	...
	(assign, ":tech_faction", "$async_simple_trigger31"),
		...
		(troop_add_items, "trp_faction19_mgoperator", "itm_pol_hat1", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_lou_infantry_trousers5", 1),
		...
		(str_store_string, s19, "@Czechoslovak MG Operator"), (str_store_string, s12, "@Czechoslovak MG Operator"),
		...
		(troop_set_name, "trp_faction19_mgoperator", s19), (troop_set_plural_name, "trp_faction19_mgoperator", s12),
		(else_try),
		...
		(troop_add_items, "trp_faction10_mgoperator", "itm_pol_hat3", 1), (troop_add_items, "trp_faction10_mgoperator", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction10_mgoperator", "itm_lou_infantry_trousers5", 1),
		...
		(str_store_string, s10, "@Hungarian MG Operator"), (str_store_string, s12, "@Hungarian MG Operator"),
		...
		(troop_set_name, "trp_faction10_mgoperator", s10), (troop_set_plural_name, "trp_faction10_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_11"),
...
[
	...
	(troop_set_name, "trp_kingdom_1_lord", "@President Armand Fallières"),
	(troop_set_name, "trp_kingdom_2_lord", "@Tsar Nicholas II"),
	(troop_set_name, "trp_kingdom_3_lord", "@Kaiser Franz Joseph I"),
	(troop_set_name, "trp_kingdom_4_lord", "@King Victor Emmanuel III"),
	(troop_set_name, "trp_kingdom_5_lord", "@Kaiser Wilhelm II"),
