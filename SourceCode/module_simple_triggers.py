   ...
   [
	...
	(assign, ":tech_faction", "$async_simple_trigger31"),
		...
		(troop_has_item_equipped, "trp_faction2_troop1", "itm_ria_infantry_trousers4"),
				...
				(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_ria_hat9", "itm_ria_infantry10", "itm_ria_infantry_trousers5"),
		...
		(troop_has_item_equipped, "trp_faction7_troop1", "itm_baf_infantry8"),
			...
			(gt, ":item", 1),
			(troop_remove_items, ":troop", ":item", 1),
			(troop_add_items, ":troop", "itm_baf_infantry11", 1),
			(troop_equip_items, ":troop"),
			(try_end),
		(else_try),
		(eq, ":faction", "fac_kingdom_5"),
		...
		(troop_has_item_equipped, "trp_faction5_troop1", "itm_pru_torso_infantry1"),
			...
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_pru_hat5", "itm_pru_torso_infantry6", "itm_pru_trousers_infantry2"),
			(try_for_range, ":item_slot", 4, 8),
			...
			(troop_add_items, ":troop", "itm_pru_hat1", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry5", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction5_troop5", "trp_faction5_troop7"),
			(troop_add_items, ":troop", "itm_pru_hat3", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry6", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction5_troop7", "trp_faction6_troop1"),
			(troop_add_items, ":troop", "itm_pru_hat1", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry5", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry2", 1),
			(try_end),
		(troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_torso_infantry6", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_trousers_infantry2", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_torso_infantry6", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_trousers_infantry2", 1),
		(troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_torso_infantry6", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_trousers_infantry2", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_torso_infantry6", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_trousers_infantry2", 1),
		(troop_add_items, "trp_faction5_mgoperator", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_torso_infantry6", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_trousers_infantry2", 1),
			(try_for_range, ":troop", "trp_faction5_troop1", "trp_faction6_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
