...
[
  ...
  (0,
   [
	(val_clamp, "$async_simple_trigger31", kingdoms_begin, kingdoms_end),
	(val_add, "$async_simple_trigger31", 1),
	(try_begin),	
	(ge, "$async_simple_trigger31", kingdoms_end),
	(assign, "$async_simple_trigger31", kingdoms_begin),
	(try_end),
	(try_begin),
	(assign, ":faction", "$async_simple_trigger31"),
		...
		(eq, "$player_faction_preset", "fac_kingdom_24"),
			...
			(try_end),
		(faction_slot_eq, ":faction", slot_faction_clothes_progression_state, 0),
		(faction_slot_ge, ":faction", slot_faction_technology_riflesconverted, 10000),
		(faction_set_slot, ":faction", slot_faction_clothes_progression_state, 1),
		...
		(troop_remove_item, "trp_faction24_troop2", "itm_els_hat2a"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop2", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop3", "itm_els_hat2a"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop3", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop4", "itm_els_hat2a"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop4", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop5", "itm_els_hat2b"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop5", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop6", "itm_els_hat2b"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop6", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop7", "itm_els_hat2b"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop7", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop8", "itm_els_hat2c"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop8", "itm_els_trousers1"),
		(troop_remove_item, "trp_faction24_troop9", "itm_els_hat2c"), (troop_remove_item, "trp_faction24_troop1", "itm_els_infantry1"), (troop_remove_item, "trp_faction24_troop9", "itm_els_trousers1"),
		(troop_add_items, "trp_faction24_troop1", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop1", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop1", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop2", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop2", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop2", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop3", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop3", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop3", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop4", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop4", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop4", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop5", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop5", "itm_els_infantry3", 1), (troop_add_items, "trp_faction24_troop5", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop6", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop6", "itm_els_infantry3", 1), (troop_add_items, "trp_faction24_troop6", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop7", "itm_els_hat4", 1), (troop_add_items, "trp_faction24_troop7", "itm_els_infantry3", 1), (troop_add_items, "trp_faction24_troop7", "itm_els_trousers2", 1),
		(troop_add_items, "trp_faction24_troop8", "itm_els_hat3", 1), (troop_add_items, "trp_faction24_troop8", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop8", "itm_els_trousers3", 1),
		(troop_add_items, "trp_faction24_troop9", "itm_els_hat3", 1), (troop_add_items, "trp_faction24_troop9", "itm_els_infantry2", 1), (troop_add_items, "trp_faction24_troop9", "itm_els_trousers3", 1),
