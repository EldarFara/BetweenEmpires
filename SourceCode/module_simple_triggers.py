		...
		(try_for_range, ":faction_2", kingdoms_begin, kingdoms_end),
			...
			(try_begin),
				...
				(try_begin),
					...
					(display_message, "@The truce between {s1} and {s2} has expired."),
				(try_end),
   ...
   [
	...
	(call_script, "script_cf_pas_faction_reinforcement_required", ":cur_faction", 0),
           ...
           (call_script, "script_create_kingdom_hero_party", ":troop_no", ":center_no"),
			...
			(party_set_slot, "$pout_party", slot_party_pas_lord_state, pas_lord_state_undefined),
             (party_detach, "$pout_party"),
             (party_relocate_near_party, "$pout_party", ":center_no", 1),
	(call_script, "script_pas_reinforce_party", "$pout_party"), (call_script, "script_pas_reinforce_party", "$pout_party"),
...
#Humidity affects precipitation
	...
	(val_add, "$pws_m_precipitation", ":random"),
		...
		(val_add, "$pws_n_precipitation", -1),
		(val_add, "$pws_m_precipitation", -1),
		(try_end),
...
(assign,"$g_battle_type", battle_type_nobattle),
      ...
      (try_for_range, ":troop", custom_troop_begin,  trp_array_a+6),
			...
			(else_try),
			(eq, ":troop", trp_array_a+6),
			(assign, ":troop", "trp_lordmodel_0"),
			(try_end),
			(try_begin),
...
(4,[
	...
	(assign, ":progress_add", 450),
		...
		(faction_get_slot, ":military_expenses", ":faction", slot_faction_law_military_expenses),
			...
			(faction_get_slot, ":education_expenses", "fac_player_supporters_faction", slot_faction_law_education_expenses),
			(faction_get_slot, ":military_expenses", "fac_player_supporters_faction", slot_faction_law_military_expenses),
			(try_end),
		(val_add, ":progress_add", ":education_expenses"),
		(val_add, ":progress_add", ":military_expenses"),
			(try_begin),
			(ge, "$ww1_status", 3),
			(val_add, ":progress_add", 400),
			(try_end),
		(try_end),
	(val_div, ":progress_add", "$g_game_speed"),
	...
	(faction_set_slot, ":faction",  ":current_research_technology", ":current_research_technology_progress"),
		(try_begin),
		(eq, ":faction", "fac_player_faction"),
		(faction_set_slot, "fac_player_supporters_faction",  ":current_research_technology", ":current_research_technology_progress"),
		(try_end),
		(try_begin),
...
(val_add, "$async_randomly_start_war_peace_new_cur_kingdom_2", 1),
	...
	(assign, "$async_randomly_start_war_peace_new_cur_kingdom", kingdoms_begin),
	(try_end),
...
(call_script, "script_create_random_war_peace", "$async_randomly_start_war_peace_new_cur_kingdom", "$async_randomly_start_war_peace_new_cur_kingdom_2"),
...
[
	...
	(this_or_next|eq, ":faction", "fac_player_faction"), (eq, ":faction", "fac_player_supporters_faction"),
	...
	(store_faction_of_party, ":faction", "p_town_46"), (this_or_next|eq, ":faction", "fac_player_faction"), (eq, ":faction", "fac_player_supporters_faction"),
	(store_faction_of_party, ":faction", "p_castle_162"), (this_or_next|eq, ":faction", "fac_player_faction"), (eq, ":faction", "fac_player_supporters_faction"),
	...
	(store_faction_of_party, ":faction", "p_castle_151"), (this_or_next|eq, ":faction", "fac_player_faction"), (eq, ":faction", "fac_player_supporters_faction"),
...
[
	...
	(faction_get_slot, ":faction_casus_belli_progress", ":faction", slot_faction_casus_belli_progress),
		(try_begin),
		(neq, ":faction_casus_belli_target", 0),
		(this_or_next|neg|is_between, ":faction_casus_belli_target", kingdoms_begin, kingdoms_end),
		(faction_slot_eq, ":faction_casus_belli_target", slot_faction_state, sfs_inactive),
		...
		(eq, reg0, 0),
		(lt, reg60, 1),
		(faction_get_slot, ":ruling_party", ":faction", slot_faction_ruling_political_party),
		(call_script, "script_get_slot_pvol_of_party", ":ruling_party", law_military_expenses), (faction_get_slot, ":law_military_expenses", ":faction", reg0),
			(try_begin),
			...
			(try_end),
		(val_add, ":faction_casus_belli_progress", ":progress_add"),
...
[
	...
	(faction_slot_eq, ":faction1", slot_faction_state, sfs_active),
		...
		(assign, ":break_alliance", 0),
			...
			(store_relation, ":relation", ":faction2", ":faction3"),
			(le, ":relation", -30),
...
[
	...
	(store_mul, ":alliance_price", ":modifier", 360000),
	(store_mul, ":increase_relations_price", ":modifier", 150000),
   ...
   [
	...
	(assign, ":tech_faction", "$async_simple_trigger31"),
		...
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_ria_hat9b", "itm_ria_infantry10", "itm_ria_infantry_trousers5"),
			...
			(troop_add_items, ":troop", "itm_ria_hat9", 1), (troop_add_items, ":troop", "itm_ria_infantry11", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_hat13", 1),
		(troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_hat13", 1),
		(troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_hat13", 1),
		(troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_hat13", 1),
		(troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_hat13", 1),
		(troop_add_items, "trp_faction2_mgoperator", "itm_ria_infantry_trousers5", 1), (troop_add_items, "trp_faction2_mgoperator", "itm_ria_infantry13", 1), (troop_add_items, "trp_faction2_mgoperator", "itm_ria_hat13", 1),
			(try_for_range, ":troop", "trp_faction2_troop1", "trp_faction3_troop1"),
		...
		(eq, ":faction", "fac_kingdom_5"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(this_or_next|faction_slot_eq, ":tech_faction", slot_faction_government_type, government_type_republic),
		(faction_slot_eq, ":tech_faction", slot_faction_government_type, government_type_soviet_republic),
		(troop_has_item_equipped, "trp_faction5_troop1", "itm_pru_torso_infantry8"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_pru_hat5", "itm_pru_torso_infantry11", "itm_pru_trousers_infantry5"),
			(try_for_range, ":item_slot", 4, 8),
			...
			(troop_add_items, ":troop", "itm_pru_hat2", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry12", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry5", 1),
			(try_end),
			...
			(troop_add_items, ":troop", "itm_pru_hat2", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry12", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry5", 1),
			(try_end),
		(troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_torso_infantry11", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_trousers_infantry5", 1),
		(troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_torso_infantry11", 1), (troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_trousers_infantry5", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_torso_infantry11", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_trousers_infantry5", 1),
		(troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_hat2", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_torso_infantry12", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_trousers_infantry5", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_hat2", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_torso_infantry12", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_trousers_infantry5", 1),
		(troop_add_items, "trp_faction5_mgoperator", "itm_pru_hat2", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_torso_infantry12", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_trousers_infantry5", 1),
			(try_for_range, ":troop", "trp_faction5_troop1", "trp_faction6_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		...
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_pru_hat5", "itm_pru_torso_infantry6", "itm_pru_trousers_infantry4"),
			...
			(troop_add_items, ":troop", "itm_pru_hat1", 1), (troop_add_items, ":troop", "itm_pru_torso_infantry5", 1), (troop_add_items, ":troop", "itm_pru_trousers_infantry4", 1),
			(try_end),
		(troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer_officer", "itm_pru_trousers_infantry4", 1),
		(troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_heavyhowitzer_cannoneer_officer", "itm_pru_trousers_infantry4", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_hat5", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer_officer", "itm_pru_trousers_infantry4", 1),
		(troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_howitzer_cannoneer", "itm_pru_trousers_infantry4", 1),
		(troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_fieldgun_cannoneer", "itm_pru_trousers_infantry4", 1),
		(troop_add_items, "trp_faction5_mgoperator", "itm_pru_hat1", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_torso_infantry9", 1), (troop_add_items, "trp_faction5_mgoperator", "itm_pru_trousers_infantry4", 1),
			(try_for_range, ":troop", "trp_faction5_troop1", "trp_faction6_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction5_howitzer_cannoneer_officer"),
		...
		(troop_has_item_equipped, "trp_faction5_troop1", "itm_pru_torso_infantry5"),
			(try_for_range, ":troop", "trp_faction5_troop1", "trp_faction6_troop1"),
			(neg|is_between, ":troop", "trp_faction5_troop9", "trp_faction5_troop14"),
			(neg|is_between, ":troop", "trp_faction5_prisonguard", "trp_faction6_troop1"),
				(try_begin),
				(troop_get_inventory_slot, ":item", ":troop", ek_body),
				(troop_set_inventory_slot, ":troop", ek_body, -1),
				(gt, ":item", 1),
				(troop_remove_items, ":troop", ":item", 1),
					(try_begin),
					(neg|is_between, ":troop", "trp_faction5_troop1", "trp_faction5_troop5"),
					(troop_add_items, ":troop", "itm_pru_torso_infantry7", 1),
					(else_try),
					(troop_add_items, ":troop", "itm_pru_torso_infantry8", 1),
					(try_end),
				(troop_equip_items, ":troop"),
				(try_end),
				(try_begin),
		...
		(troop_has_item_equipped, "trp_faction3_troop1", "itm_lou_infantry8"),
			...
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_lou_hat12", "itm_lou_infantry22", "itm_lou_infantry_trousers4"),
			(try_for_range, ":item_slot", 4, 8),
			...
			(troop_add_items, ":troop", "itm_lou_hat6", 1), (troop_add_items, ":troop", "itm_lou_infantry19", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers7", 1),
			(try_end),
			...
			(try_end),
		(troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_hat11", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry16", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry_trousers4", 1),
		(troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_hat11", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry16", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry_trousers4", 1),
		(troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_hat11", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry16", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry_trousers4", 1),
		...
		(troop_has_item_equipped, "trp_faction3_troop1", "itm_lou_infantry18"),
			...
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_lou_hat13", "itm_lou_infantry21", "itm_lou_infantry_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction3_troop1", "trp_faction4_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop7", "trp_faction3_troop9"),
			(troop_add_items, ":troop", "itm_lou_hat9", 1), (troop_add_items, ":troop", "itm_lou_infantry12", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers5", 1),
			(try_end),
			...
			(troop_add_items, ":troop", "itm_lou_hat8", 1), (troop_add_items, ":troop", "itm_lou_infantry12", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_hat10", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_hat10", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_hat10", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		...
		(this_or_next|faction_slot_eq, ":tech_faction", slot_faction_government_type, government_type_republic),
		(faction_slot_eq, ":tech_faction", slot_faction_government_type, government_type_soviet_republic),
		(troop_has_item_equipped, "trp_faction3_troop1", "itm_lou_infantry14"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_lou_hat16", "itm_lou_infantry25", "itm_lou_infantry_trousers8"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction3_troop1", "trp_faction4_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop1", "trp_faction3_troop5"),
			(troop_add_items, ":troop", "itm_lou_hat15", 1), (troop_add_items, ":troop", "itm_lou_infantry23", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop5", "trp_faction3_troop7"),
			(troop_add_items, ":troop", "itm_lou_hat15", 1), (troop_add_items, ":troop", "itm_lou_infantry24", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop7", "trp_faction3_troop9"),
			(troop_add_items, ":troop", "itm_lou_hat15", 1), (troop_add_items, ":troop", "itm_lou_infantry23", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop9", "trp_faction3_troop13"),
			(troop_add_items, ":troop", "itm_lou_hat14", 1), (troop_add_items, ":troop", "itm_lou_infantry23", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction3_troop13", "trp_faction3_troop14"),
			(troop_add_items, ":troop", "itm_lou_hat15", 1), (troop_add_items, ":troop", "itm_lou_infantry24", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
			...
			(troop_add_items, ":troop", "itm_lou_hat15", 1), (troop_add_items, ":troop", "itm_lou_infantry23", 1), (troop_add_items, ":troop", "itm_lou_infantry_trousers8", 1),
			(try_end),
		(troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_hat16", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry25", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer_officer", "itm_lou_infantry_trousers8", 1),
		(troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_hat16", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry25", 1), (troop_add_items, "trp_faction3_heavyhowitzer_cannoneer_officer", "itm_lou_infantry_trousers8", 1),
		(troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_hat16", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer_officer", "itm_lou_infantry_trousers8", 1),
		(troop_add_items, "trp_faction3_howitzer_cannoneer", "itm_lou_hat15", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer", "itm_lou_infantry23", 1), (troop_add_items, "trp_faction3_howitzer_cannoneer", "itm_lou_infantry_trousers8", 1),
		(troop_add_items, "trp_faction3_fieldgun_cannoneer", "itm_lou_hat15", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer", "itm_lou_infantry23", 1), (troop_add_items, "trp_faction3_fieldgun_cannoneer", "itm_lou_infantry_trousers8", 1),
		(troop_add_items, "trp_faction3_mgoperator", "itm_lou_hat15", 1), (troop_add_items, "trp_faction3_mgoperator", "itm_lou_infantry23", 1), (troop_add_items, "trp_faction3_mgoperator", "itm_lou_infantry_trousers8", 1),
			(try_for_range, ":troop", "trp_faction3_troop1", "trp_faction4_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction3_howitzer_cannoneer_officer"),
		...
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_tur_fez2b", "itm_tur_infantry6", "itm_tur_trousers_infantry3"),
			...
			(troop_add_items, ":troop", "itm_tur_fez2b", 1), (troop_add_items, ":troop", "itm_tur_infantry7", 1), (troop_add_items, ":troop", "itm_tur_trousers_infantry3", 1),
			(try_end),
		...
		(eq, ":faction", "fac_kingdom_31"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_31"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1914),
		(troop_has_item_equipped, "trp_faction31_fieldgun_cannoneer_officer", "itm_han_hat2"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_balkan_torso1", "itm_balkan_torso2", "itm_clothes_urban_male_trousers1"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction31_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction31_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction31_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction31_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction31_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction31_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction31_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionalbania_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionalbania_castleguard"),
		(troop_add_items, "trp_faction31_howitzer_cannoneer_officer", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_howitzer_cannoneer_officer", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_howitzer_cannoneer_officer", "itm_clothes_urban_male_trousers1", 1),
		(troop_add_items, "trp_faction31_heavyhowitzer_cannoneer_officer", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_heavyhowitzer_cannoneer_officer", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_heavyhowitzer_cannoneer_officer", "itm_clothes_urban_male_trousers1", 1),
		(troop_add_items, "trp_faction31_fieldgun_cannoneer_officer", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_fieldgun_cannoneer_officer", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_fieldgun_cannoneer_officer", "itm_clothes_urban_male_trousers1", 1),
		(troop_add_items, "trp_faction31_howitzer_cannoneer", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_howitzer_cannoneer", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_howitzer_cannoneer", "itm_clothes_urban_male_trousers1", 1),
		(troop_add_items, "trp_faction31_fieldgun_cannoneer", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_fieldgun_cannoneer", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_fieldgun_cannoneer", "itm_clothes_urban_male_trousers1", 1),
		(troop_add_items, "trp_faction31_mgoperator", "itm_balkan_torso1", 1), (troop_add_items, "trp_faction31_mgoperator", "itm_balkan_torso2", 1), (troop_add_items, "trp_faction31_mgoperator", "itm_clothes_urban_male_trousers1", 1),
		(troop_equip_items, "trp_faction31_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction31_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction31_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction31_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction31_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction31_mgoperator"),
		(str_store_string, s1, "@Albanian Howitzer Crew Officer"), (str_store_string, s2, "@Albanian Howitzer Crew Officers"),
		(str_store_string, s3, "@Albanian Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Albanian Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Albanian Field Gun Crew Officer"), (str_store_string, s6, "@Albanian Field Gun Crew Officers"),
		(str_store_string, s7, "@Albanian Howitzer Crew Cannoneer"), (str_store_string, s8, "@Albanian Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Albanian Field Gun Crew Cannoneer"), (str_store_string, s10, "@Albanian Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Albanian MG Operator"), (str_store_string, s12, "@Albanian MG Operator"),
		(troop_set_name, "trp_faction31_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction31_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction31_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction31_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction31_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction31_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction31_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction31_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction31_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction31_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction31_mgoperator", s11), (troop_set_plural_name, "trp_faction31_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_30"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_30"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1907),
		(troop_has_item_equipped, "trp_faction30_fieldgun_cannoneer_officer", "itm_bav_cap"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_nor_hat1", "itm_nor_infantry2", "itm_nor_trousers1"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction30_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction30_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction30_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction30_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction30_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction30_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionnorway_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionnorway_castleguard"),
		(troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_trousers1", 1),
		(troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_trousers1", 1),
		(troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_trousers1", 1),
		(troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_trousers1", 1),
		(troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_trousers1", 1),
		(troop_add_items, "trp_faction30_mgoperator", "itm_nor_hat1", 1), (troop_add_items, "trp_faction30_mgoperator", "itm_nor_infantry2", 1), (troop_add_items, "trp_faction30_mgoperator", "itm_nor_trousers1", 1),
		(troop_equip_items, "trp_faction30_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction30_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction30_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction30_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction30_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction30_mgoperator"),
		(str_store_string, s1, "@Norwegian Howitzer Crew Officer"), (str_store_string, s2, "@Norwegian Howitzer Crew Officers"),
		(str_store_string, s3, "@Norwegian Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Norwegian Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Norwegian Field Gun Crew Officer"), (str_store_string, s6, "@Norwegian Field Gun Crew Officers"),
		(str_store_string, s7, "@Norwegian Howitzer Crew Cannoneer"), (str_store_string, s8, "@Norwegian Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Norwegian Field Gun Crew Cannoneer"), (str_store_string, s10, "@Norwegian Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Norwegian MG Operator"), (str_store_string, s12, "@Norwegian MG Operator"),
		(troop_set_name, "trp_faction30_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction30_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction30_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction30_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction30_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction30_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction30_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction30_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction30_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction30_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction30_mgoperator", s11), (troop_set_plural_name, "trp_faction30_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_30"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_30"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_lmgs, 10000),
		(troop_has_item_equipped, "trp_factionnorway_troop1", "itm_nor_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_nor_hat2", "itm_nor_infantry4", "itm_nor_trousers2"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_factionnorway_troop1", "trp_factionalbania_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction30_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction30_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction30_heavyhowitzer_cannoneer_officer"),
			...
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_factionnorway_troop1", "trp_factionnorway_troop5"),
			(troop_add_items, ":troop", "itm_nor_hat2", 1), (troop_add_items, ":troop", "itm_nor_infantry4", 1), (troop_add_items, ":troop", "itm_nor_trousers2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionnorway_troop5", "trp_factionnorway_troop7"),
			(troop_add_items, ":troop", "itm_nor_hat2", 1), (troop_add_items, ":troop", "itm_nor_infantry3", 1), (troop_add_items, ":troop", "itm_nor_trousers2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionnorway_troop7", "trp_factionnorway_troop9"),
			(troop_add_items, ":troop", "itm_nor_hat2", 1), (troop_add_items, ":troop", "itm_nor_infantry3", 1), (troop_add_items, ":troop", "itm_nor_trousers2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionnorway_troop9", "trp_factionalbania_troop1"),
			(troop_add_items, ":troop", "itm_nor_hat2", 1), (troop_add_items, ":troop", "itm_nor_infantry4", 1), (troop_add_items, ":troop", "itm_nor_trousers2", 1),
			(try_end),
		(troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer_officer", "itm_nor_trousers2", 1),
		(troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_heavyhowitzer_cannoneer_officer", "itm_nor_trousers2", 1),
		(troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer_officer", "itm_nor_trousers2", 1),
		(troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_howitzer_cannoneer", "itm_nor_trousers2", 1),
		(troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_fieldgun_cannoneer", "itm_nor_trousers2", 1),
		(troop_add_items, "trp_faction30_mgoperator", "itm_nor_hat2", 1), (troop_add_items, "trp_faction30_mgoperator", "itm_nor_infantry4", 1), (troop_add_items, "trp_faction30_mgoperator", "itm_nor_trousers2", 1),
			(try_for_range, ":troop", "trp_factionnorway_troop1", "trp_factionalbania_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction30_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_27"),
			...
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1878),
		(troop_has_item_equipped, "trp_faction27_fieldgun_cannoneer_officer", "itm_wur_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_bul_hat5", "itm_bul_infantry6", "itm_bul_trousers3"),
			(try_for_range, ":item_slot", 4, 8),
			...
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionbulgaria_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionbulgaria_castleguard"),
		...
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_bul_hat5", "itm_bul_infantry7", "itm_bul_trousers5"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_factionbulgaria_troop1", "trp_factionnorway_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction27_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction27_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction27_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction27_heavyhowitzer_cannoneer_officer"),
			...
			(try_end),
			(try_for_range, ":troop", "trp_factionbulgaria_troop9", "trp_factionnorway_troop1"),
		...
		(eq, ":faction", "fac_kingdom_27"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_lmgs, 10000),
		(troop_has_item_equipped, "trp_faction27_troop1", "itm_bul_hat5"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_bul_hat9", "itm_bul_infantry13", "itm_bul_trousers6"),
			(try_for_range, ":troop", "trp_faction27_troop1", "trp_faction28_troop1"),
				(try_begin),
				(troop_get_inventory_slot, ":item", ":troop", ek_head),
				(troop_set_inventory_slot, ":troop", ek_head, -1),
				(gt, ":item", 1),
				(troop_has_item_equipped, ":troop", "itm_bul_hat5"),
				(troop_remove_items, ":troop", ":item", 1),
				(troop_add_items, ":troop", "itm_bul_hat7", 1),
				(troop_equip_items, ":troop"),
				(try_end),
			(try_end),
		(else_try),
		(eq, ":faction", "fac_kingdom_27"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_factionbulgaria_troop7", "itm_bul_hat6"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_bul_hat9", "itm_bul_infantry13", "itm_bul_trousers6"),
			...
			(try_end),
			(try_for_range, ":troop", "trp_factionbulgaria_troop1", "trp_factionbulgaria_troop5"),
			(troop_add_items, ":troop", "itm_bul_hat8", 1), (troop_add_items, ":troop", "itm_bul_infantry11", 1), (troop_add_items, ":troop", "itm_bul_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionbulgaria_troop5", "trp_factionbulgaria_troop7"),
			(troop_add_items, ":troop", "itm_bul_hat8", 1), (troop_add_items, ":troop", "itm_bul_infantry12", 1), (troop_add_items, ":troop", "itm_bul_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionbulgaria_troop7", "trp_factionbulgaria_troop9"),
			(troop_add_items, ":troop", "itm_pru_hat2", 1), (troop_add_items, ":troop", "itm_bul_infantry10", 1), (troop_add_items, ":troop", "itm_bul_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionbulgaria_troop9", "trp_factionnorway_troop1"),
			(troop_add_items, ":troop", "itm_bul_hat8", 1), (troop_add_items, ":troop", "itm_bul_infantry11", 1), (troop_add_items, ":troop", "itm_bul_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction27_howitzer_cannoneer_officer", "itm_bul_hat9", 1), (troop_add_items, "trp_faction27_howitzer_cannoneer_officer", "itm_bul_infantry13", 1), (troop_add_items, "trp_faction27_howitzer_cannoneer_officer", "itm_bul_trousers6", 1),
		(troop_add_items, "trp_faction27_heavyhowitzer_cannoneer_officer", "itm_bul_hat9", 1), (troop_add_items, "trp_faction27_heavyhowitzer_cannoneer_officer", "itm_bul_infantry13", 1), (troop_add_items, "trp_faction27_heavyhowitzer_cannoneer_officer", "itm_bul_trousers6", 1),
		(troop_add_items, "trp_faction27_fieldgun_cannoneer_officer", "itm_bul_hat9", 1), (troop_add_items, "trp_faction27_fieldgun_cannoneer_officer", "itm_bul_infantry13", 1), (troop_add_items, "trp_faction27_fieldgun_cannoneer_officer", "itm_bul_trousers6", 1),
		(troop_add_items, "trp_faction27_howitzer_cannoneer", "itm_bul_hat8", 1), (troop_add_items, "trp_faction27_howitzer_cannoneer", "itm_bul_infantry7", 1), (troop_add_items, "trp_faction27_howitzer_cannoneer", "itm_bul_trousers4", 1),
		(troop_add_items, "trp_faction27_fieldgun_cannoneer", "itm_bul_hat8", 1), (troop_add_items, "trp_faction27_fieldgun_cannoneer", "itm_bul_infantry7", 1), (troop_add_items, "trp_faction27_fieldgun_cannoneer", "itm_bul_trousers4", 1),
		(troop_add_items, "trp_faction27_mgoperator", "itm_bul_hat8", 1), (troop_add_items, "trp_faction27_mgoperator", "itm_bul_infantry7", 1), (troop_add_items, "trp_faction27_mgoperator", "itm_bul_trousers4", 1),
			(try_for_range, ":troop", "trp_factionbulgaria_troop1", "trp_factionnorway_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction27_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_28"),
			...
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernattack, 10000),
		(troop_has_item_equipped, "trp_faction28_troop1", "itm_srb_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_srb_hat5", "itm_srb_infantry7", "itm_srb_trousers3"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction28_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction28_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction28_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction28_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction28_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction28_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction28_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction28_troop5"),
			(troop_add_items, ":troop", "itm_srb_hat4", 1), (troop_add_items, ":troop", "itm_srb_infantry5", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop5", "trp_faction28_troop7"),
			(troop_add_items, ":troop", "itm_srb_hat4", 1), (troop_add_items, ":troop", "itm_srb_infantry4", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop13", "trp_faction28_troop14"),
			(troop_add_items, ":troop", "itm_srb_hat4", 1), (troop_add_items, ":troop", "itm_srb_infantry4", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop7", "trp_faction28_troop9"),
			(troop_add_items, ":troop", "itm_srb_hat5", 1), (troop_add_items, ":troop", "itm_srb_infantry5", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop9", "trp_faction28_troop13"),
			(troop_add_items, ":troop", "itm_srb_hat6", 1), (troop_add_items, ":troop", "itm_srb_infantry6", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop14", "trp_faction29_troop1"),
			(troop_add_items, ":troop", "itm_srb_hat4", 1), (troop_add_items, ":troop", "itm_srb_infantry5", 1), (troop_add_items, ":troop", "itm_srb_trousers3", 1),
			(try_end),
		(troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_hat5", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_trousers3", 1),
		(troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_hat5", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_trousers3", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_hat5", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_trousers3", 1),
		(troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_hat4", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_trousers3", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_hat4", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_trousers3", 1),
		(troop_add_items, "trp_faction28_mgoperator", "itm_srb_hat4", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_infantry5", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_trousers3", 1),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction28_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction28_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction28_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction28_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction28_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction28_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_28"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_28"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_infantrymgtactics, 10000),
		(troop_has_item_equipped, "trp_faction28_troop1", "itm_srb_hat4"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_srb_hat8", "itm_srb_infantry10", "itm_srb_trousers5"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction28_troop5"),
			(troop_add_items, ":troop", "itm_srb_hat7", 1), (troop_add_items, ":troop", "itm_srb_infantry8", 1), (troop_add_items, ":troop", "itm_srb_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop5", "trp_faction28_troop7"),
			(troop_add_items, ":troop", "itm_srb_hat7", 1), (troop_add_items, ":troop", "itm_srb_infantry8", 1), (troop_add_items, ":troop", "itm_srb_trousers5", 1),
			(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop7", "trp_faction28_troop9"),
			(troop_add_items, ":troop", "itm_srb_hat8", 1), (troop_add_items, ":troop", "itm_srb_infantry9", 1), (troop_add_items, ":troop", "itm_srb_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop9", "trp_faction28_troop13"),
			(troop_add_items, ":troop", "itm_srb_hat6", 1), (troop_add_items, ":troop", "itm_srb_infantry10", 1), (troop_add_items, ":troop", "itm_srb_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop14", "trp_faction29_troop1"),
			(troop_add_items, ":troop", "itm_srb_hat7", 1), (troop_add_items, ":troop", "itm_srb_infantry8", 1), (troop_add_items, ":troop", "itm_srb_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_hat8", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_infantry10", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_trousers5", 1),
		(troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_hat8", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_infantry10", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_trousers5", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_hat8", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_infantry10", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_trousers5", 1),
		(troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_hat7", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_infantry9", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_trousers5", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_hat7", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_infantry9", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_trousers5", 1),
		(troop_add_items, "trp_faction28_mgoperator", "itm_srb_hat7", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_infantry9", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_trousers5", 1),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction28_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_28"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_faction28_troop1", "itm_srb_hat7"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_srb_hat9", "itm_srb_infantry12", "itm_srb_trousers7"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction28_troop5"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry12", 1), (troop_add_items, ":troop", "itm_srb_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop5", "trp_faction28_troop7"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry11", 1), (troop_add_items, ":troop", "itm_srb_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop13", "trp_faction28_troop14"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry11", 1), (troop_add_items, ":troop", "itm_srb_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop7", "trp_faction28_troop9"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry11", 1), (troop_add_items, ":troop", "itm_srb_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop9", "trp_faction28_troop13"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry12", 1), (troop_add_items, ":troop", "itm_srb_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction28_troop14", "trp_faction29_troop1"),
			(troop_add_items, ":troop", "itm_srb_hat9", 1), (troop_add_items, ":troop", "itm_srb_infantry12", 1), (troop_add_items, ":troop", "itm_srb_trousers6", 1),
			(try_end),
		(troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer_officer", "itm_srb_trousers7", 1),
		(troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_heavyhowitzer_cannoneer_officer", "itm_srb_trousers7", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer_officer", "itm_srb_trousers7", 1),
		(troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_howitzer_cannoneer", "itm_srb_trousers6", 1),
		(troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_fieldgun_cannoneer", "itm_srb_trousers6", 1),
		(troop_add_items, "trp_faction28_mgoperator", "itm_srb_hat9", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction28_mgoperator", "itm_srb_trousers6", 1),
			(try_for_range, ":troop", "trp_faction28_troop1", "trp_faction29_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction28_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_24"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_infantrymgtactics, 10000),
		(troop_has_item_equipped, "trp_faction24_troop1", "itm_els_hat3"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_els_hat7", "itm_els_infantry6", "itm_els_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction24_troop1", "trp_faction25_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction24_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction24_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction24_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction24_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction24_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction24_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction24_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction24_troop1", "trp_faction25_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction24_troop1", "trp_faction24_troop5"),
			(troop_add_items, ":troop", "itm_els_hat7", 1), (troop_add_items, ":troop", "itm_els_infantry6", 1), (troop_add_items, ":troop", "itm_els_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction24_troop5", "trp_faction24_troop8"),
			(troop_add_items, ":troop", "itm_els_hat7", 1), (troop_add_items, ":troop", "itm_els_infantry5", 1), (troop_add_items, ":troop", "itm_els_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction24_troop8", "trp_faction25_troop1"),
			(troop_add_items, ":troop", "itm_els_hat7", 1), (troop_add_items, ":troop", "itm_els_infantry6", 1), (troop_add_items, ":troop", "itm_els_trousers6", 1),
			(try_end),
		(troop_add_items, "trp_faction24_howitzer_cannoneer_officer", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_howitzer_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_howitzer_cannoneer_officer", "itm_els_trousers6", 1),
		(troop_add_items, "trp_faction24_heavyhowitzer_cannoneer_officer", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_heavyhowitzer_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_heavyhowitzer_cannoneer_officer", "itm_els_trousers6", 1),
		(troop_add_items, "trp_faction24_fieldgun_cannoneer_officer", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_fieldgun_cannoneer_officer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_fieldgun_cannoneer_officer", "itm_els_trousers6", 1),
		(troop_add_items, "trp_faction24_howitzer_cannoneer", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_howitzer_cannoneer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_howitzer_cannoneer", "itm_els_trousers6", 1),
		(troop_add_items, "trp_faction24_fieldgun_cannoneer", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_fieldgun_cannoneer", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_fieldgun_cannoneer", "itm_els_trousers6", 1),
		(troop_add_items, "trp_faction24_mgoperator", "itm_els_hat7", 1), (troop_add_items, "trp_faction24_mgoperator", "itm_srb_infantry12", 1), (troop_add_items, "trp_faction24_mgoperator", "itm_els_trousers6", 1),
			(try_for_range, ":troop", "trp_faction24_troop1", "trp_faction25_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction24_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction24_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction24_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction24_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction24_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction24_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_25"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction25_troop1", "itm_far_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_far_hat7", "itm_far_infantry6", "itm_far_trousers3"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction26_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction25_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction25_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction25_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction25_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction25_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction25_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction25_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction26_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction25_troop5"),
			(troop_add_items, ":troop", "itm_far_hat7", 1), (troop_add_items, ":troop", "itm_far_infantry6", 1), (troop_add_items, ":troop", "itm_far_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop5", "trp_faction25_troop8"),
			(troop_add_items, ":troop", "itm_far_hat7", 1), (troop_add_items, ":troop", "itm_far_infantry5", 1), (troop_add_items, ":troop", "itm_far_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop8", "trp_faction25_troop10"),
			(troop_add_items, ":troop", "itm_far_hat8", 1), (troop_add_items, ":troop", "itm_far_infantry7", 1), (troop_add_items, ":troop", "itm_far_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop10", "trp_faction26_troop1"),
			(troop_add_items, ":troop", "itm_far_hat7", 1), (troop_add_items, ":troop", "itm_far_infantry6", 1), (troop_add_items, ":troop", "itm_far_trousers3", 1),
			(try_end),
		(troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_mgoperator", "itm_far_hat7", 1), (troop_add_items, "trp_faction25_mgoperator", "itm_far_infantry6", 1), (troop_add_items, "trp_faction25_mgoperator", "itm_far_trousers3", 1),
			(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction26_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction25_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction25_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction25_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction25_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction25_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction25_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_25"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_25"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_faction25_troop1", "itm_far_hat7"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_far_hat9", "itm_far_infantry11", "itm_far_trousers3"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction26_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction25_troop5"),
			(troop_add_items, ":troop", "itm_far_hat9", 1), (troop_add_items, ":troop", "itm_far_infantry8", 1), (troop_add_items, ":troop", "itm_far_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop5", "trp_faction25_troop8"),
			(troop_add_items, ":troop", "itm_far_hat9", 1), (troop_add_items, ":troop", "itm_far_infantry10", 1), (troop_add_items, ":troop", "itm_far_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop8", "trp_faction25_troop10"),
			(troop_add_items, ":troop", "itm_far_hat9", 1), (troop_add_items, ":troop", "itm_far_infantry11", 1), (troop_add_items, ":troop", "itm_far_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction25_troop10", "trp_faction26_troop1"),
			(troop_add_items, ":troop", "itm_far_hat9", 1), (troop_add_items, ":troop", "itm_far_infantry9", 1), (troop_add_items, ":troop", "itm_far_trousers4", 1),
			(try_end),
		(troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_infantry11", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_infantry11", 1), (troop_add_items, "trp_faction25_heavyhowitzer_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_infantry11", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer_officer", "itm_far_trousers3", 1),
		(troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_infantry9", 1), (troop_add_items, "trp_faction25_howitzer_cannoneer", "itm_far_trousers4", 1),
		(troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_infantry9", 1), (troop_add_items, "trp_faction25_fieldgun_cannoneer", "itm_far_trousers4", 1),
		(troop_add_items, "trp_faction25_mgoperator", "itm_far_hat9", 1), (troop_add_items, "trp_faction25_mgoperator", "itm_far_infantry9", 1), (troop_add_items, "trp_faction25_mgoperator", "itm_far_trousers4", 1),
			(try_for_range, ":troop", "trp_faction25_troop1", "trp_faction26_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction25_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_29"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction29_troop1", "itm_sve_hat4b"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_sve_hat5b", "itm_sve_torso_infantry7", "itm_sve_trousers_infantry4"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction29_troop1", "trp_faction30_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction29_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction29_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction29_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction29_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction29_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction29_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction29_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction29_troop1", "trp_faction30_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction29_troop1", "trp_faction29_troop7"),
			(troop_add_items, ":troop", "itm_sve_hat5", 1), (troop_add_items, ":troop", "itm_sve_torso_infantry6", 1), (troop_add_items, ":troop", "itm_sve_trousers_infantry3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction29_troop7", "trp_faction29_troop9"),
			(troop_add_items, ":troop", "itm_sve_hat5", 1), (troop_add_items, ":troop", "itm_sve_torso_infantry7", 1), (troop_add_items, ":troop", "itm_sve_trousers_infantry3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction29_troop9", "trp_faction30_troop1"),
			(troop_add_items, ":troop", "itm_sve_hat5", 1), (troop_add_items, ":troop", "itm_sve_torso_infantry7", 1), (troop_add_items, ":troop", "itm_sve_trousers_infantry3", 1),
			(try_end),
		(troop_add_items, "trp_faction29_howitzer_cannoneer_officer", "itm_sve_hat5b", 1), (troop_add_items, "trp_faction29_howitzer_cannoneer_officer", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_howitzer_cannoneer_officer", "itm_sve_trousers_infantry4", 1),
		(troop_add_items, "trp_faction29_heavyhowitzer_cannoneer_officer", "itm_sve_hat5b", 1), (troop_add_items, "trp_faction29_heavyhowitzer_cannoneer_officer", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_heavyhowitzer_cannoneer_officer", "itm_sve_trousers_infantry4", 1),
		(troop_add_items, "trp_faction29_fieldgun_cannoneer_officer", "itm_sve_hat5b", 1), (troop_add_items, "trp_faction29_fieldgun_cannoneer_officer", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_fieldgun_cannoneer_officer", "itm_sve_trousers_infantry4", 1),
		(troop_add_items, "trp_faction29_howitzer_cannoneer", "itm_sve_hat5", 1), (troop_add_items, "trp_faction29_howitzer_cannoneer", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_howitzer_cannoneer", "itm_sve_trousers_infantry4", 1),
		(troop_add_items, "trp_faction29_fieldgun_cannoneer", "itm_sve_hat5", 1), (troop_add_items, "trp_faction29_fieldgun_cannoneer", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_fieldgun_cannoneer", "itm_sve_trousers_infantry4", 1),
		(troop_add_items, "trp_faction29_mgoperator", "itm_sve_hat5", 1), (troop_add_items, "trp_faction29_mgoperator", "itm_sve_torso_infantry7", 1), (troop_add_items, "trp_faction29_mgoperator", "itm_sve_trousers_infantry4", 1),
			(try_for_range, ":troop", "trp_faction29_troop1", "trp_faction30_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction29_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_18"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_18"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction18_troop1", "itm_dan_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_dan_hat3", "itm_dan_torso_infantry5", "itm_dan_trousers2"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction19_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction18_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction18_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction18_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction18_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction18_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction18_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction18_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction19_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction18_troop7"),
			(troop_add_items, ":troop", "itm_dan_hat3", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry5", 1), (troop_add_items, ":troop", "itm_dan_trousers2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop5", "trp_faction18_troop7"),
			(troop_add_items, ":troop", "itm_dan_hat3", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry4", 1), (troop_add_items, ":troop", "itm_dan_trousers2", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop7", "trp_faction18_troop9"),
			(troop_add_items, ":troop", "itm_dan_hat6", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry8", 1), (troop_add_items, ":troop", "itm_dan_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop9", "trp_faction18_prisonguard"),
			(troop_add_items, ":troop", "itm_dan_hat3", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry9", 1), (troop_add_items, ":troop", "itm_dan_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_prisonguard", "trp_faction19_troop1"),
			(troop_add_items, ":troop", "itm_dan_hat3", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry5", 1), (troop_add_items, ":troop", "itm_dan_trousers2", 1),
			(try_end),
		(troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_trousers4", 1),
		(troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_trousers4", 1),
		(troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_trousers4", 1),
		(troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_trousers4", 1),
		(troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_trousers4", 1),
		(troop_add_items, "trp_faction18_mgoperator", "itm_dan_hat5", 1), (troop_add_items, "trp_faction18_mgoperator", "itm_dan_torso_infantry5", 1), (troop_add_items, "trp_faction18_mgoperator", "itm_dan_trousers4", 1),
			(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction19_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction18_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction18_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction18_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction18_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction18_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction18_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_18"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_18"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_gasattacks, 10000),
		(troop_has_item_equipped, "trp_faction18_troop1", "itm_dan_hat3"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_dan_hat4", "itm_dan_torso_infantry7", "itm_dan_trousers3"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction19_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction18_troop5"),
			(troop_add_items, ":troop", "itm_dan_hat4", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry7", 1), (troop_add_items, ":troop", "itm_dan_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop5", "trp_faction18_troop7"),
			(troop_add_items, ":troop", "itm_dan_hat4", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry6", 1), (troop_add_items, ":troop", "itm_dan_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop7", "trp_faction18_troop9"),
			(troop_add_items, ":troop", "itm_dan_hat6", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry8", 1), (troop_add_items, ":troop", "itm_dan_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop9", "trp_faction18_troop13"),
			(troop_add_items, ":troop", "itm_dan_hat4", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry7", 1), (troop_add_items, ":troop", "itm_dan_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_troop13", "trp_faction18_prisonguard"),
			(troop_add_items, ":troop", "itm_dan_hat4", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry6", 1), (troop_add_items, ":troop", "itm_dan_trousers3", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction18_prisonguard", "trp_faction19_troop1"),
			(troop_add_items, ":troop", "itm_dan_hat4", 1), (troop_add_items, ":troop", "itm_dan_torso_infantry7", 1), (troop_add_items, ":troop", "itm_dan_trousers3", 1),
			(try_end),
		(troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer_officer", "itm_dan_trousers3", 1),
		(troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_heavyhowitzer_cannoneer_officer", "itm_dan_trousers3", 1),
		(troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer_officer", "itm_dan_trousers3", 1),
		(troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_howitzer_cannoneer", "itm_dan_trousers3", 1),
		(troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_fieldgun_cannoneer", "itm_dan_trousers3", 1),
		(troop_add_items, "trp_faction18_mgoperator", "itm_dan_hat4", 1), (troop_add_items, "trp_faction18_mgoperator", "itm_dan_torso_infantry7", 1), (troop_add_items, "trp_faction18_mgoperator", "itm_dan_trousers3", 1),
			(try_for_range, ":troop", "trp_faction18_troop1", "trp_faction19_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction18_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_20"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction20_troop1", "itm_baf_hat10"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_baf_hat16", "itm_baf_infantry14", "itm_baf_trousers9"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction20_troop1", "trp_faction21_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction20_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction20_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction20_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction20_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction20_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction20_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction20_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_troop1", "trp_faction21_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_troop1", "trp_faction20_troop5"),
			(troop_add_items, ":troop", "itm_baf_hat18", 1), (troop_add_items, ":troop", "itm_baf_infantry13", 1), (troop_add_items, ":troop", "itm_baf_trousers9", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_troop5", "trp_faction20_troop8"),
			(troop_add_items, ":troop", "itm_baf_hat11", 1), (troop_add_items, ":troop", "itm_baf_infantry12", 1), (troop_add_items, ":troop", "itm_baf_trousers9", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_troop8", "trp_faction20_troop10"),
			(troop_add_items, ":troop", "itm_baf_hat16", 1), (troop_add_items, ":troop", "itm_baf_infantry14", 1), (troop_add_items, ":troop", "itm_baf_trousers9", 1), (troop_add_items, ":troop", "itm_baf_infantry15", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_troop10", "trp_faction20_prisonguard"),
			(troop_add_items, ":troop", "itm_baf_hat11", 1), (troop_add_items, ":troop", "itm_baf_infantry13", 1), (troop_add_items, ":troop", "itm_baf_trousers9", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction20_prisonguard", "trp_faction21_troop1"),
			(troop_add_items, ":troop", "itm_baf_hat18", 1), (troop_add_items, ":troop", "itm_baf_infantry13", 1), (troop_add_items, ":troop", "itm_baf_trousers9", 1),
			(try_end),
		(troop_add_items, "trp_faction20_howitzer_cannoneer_officer", "itm_baf_hat16", 1), (troop_add_items, "trp_faction20_howitzer_cannoneer_officer", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_howitzer_cannoneer_officer", "itm_baf_trousers9", 1),
		(troop_add_items, "trp_faction20_heavyhowitzer_cannoneer_officer", "itm_baf_hat16", 1), (troop_add_items, "trp_faction20_heavyhowitzer_cannoneer_officer", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_heavyhowitzer_cannoneer_officer", "itm_baf_trousers9", 1),
		(troop_add_items, "trp_faction20_fieldgun_cannoneer_officer", "itm_baf_hat18", 1), (troop_add_items, "trp_faction20_fieldgun_cannoneer_officer", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_fieldgun_cannoneer_officer", "itm_baf_trousers9", 1),
		(troop_add_items, "trp_faction20_howitzer_cannoneer", "itm_baf_hat18", 1), (troop_add_items, "trp_faction20_howitzer_cannoneer", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_howitzer_cannoneer", "itm_baf_trousers9", 1),
		(troop_add_items, "trp_faction20_fieldgun_cannoneer", "itm_baf_hat18", 1), (troop_add_items, "trp_faction20_fieldgun_cannoneer", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_fieldgun_cannoneer", "itm_baf_trousers9", 1),
		(troop_add_items, "trp_faction20_mgoperator", "itm_baf_hat18", 1), (troop_add_items, "trp_faction20_mgoperator", "itm_baf_infantry13", 1), (troop_add_items, "trp_faction20_mgoperator", "itm_baf_trousers9", 1),
			(try_for_range, ":troop", "trp_faction20_troop1", "trp_faction21_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction20_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_8"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_8"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_machineguns, 10000),
		(troop_has_item_equipped, "trp_faction8_troop1", "itm_sta_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_sta_hat6", "itm_sta_infantry5", "itm_sta_trousers5"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction8_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction8_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction8_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction8_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction8_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction8_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction8_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction8_troop5"),
			(troop_add_items, ":troop", "itm_sta_hat6", 1), (troop_add_items, ":troop", "itm_sta_infantry6", 1), (troop_add_items, ":troop", "itm_sta_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop5", "trp_faction8_troop8"),
			(troop_add_items, ":troop", "itm_sta_hat6", 1), (troop_add_items, ":troop", "itm_sta_infantry6", 1), (troop_add_items, ":troop", "itm_sta_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop8", "trp_faction8_troop10"),
			(troop_add_items, ":troop", "itm_sta_hat6", 1), (troop_add_items, ":troop", "itm_sta_infantry6", 1), (troop_add_items, ":troop", "itm_sta_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop10", "trp_faction8_prisonguard"),
			(troop_add_items, ":troop", "itm_sta_hat6", 1), (troop_add_items, ":troop", "itm_sta_infantry5", 1), (troop_add_items, ":troop", "itm_sta_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_prisonguard", "trp_faction9_troop1"),
			(troop_add_items, ":troop", "itm_sta_hat6", 1), (troop_add_items, ":troop", "itm_sta_infantry5", 1), (troop_add_items, ":troop", "itm_sta_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_trousers5", 1),
		(troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_trousers5", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_trousers5", 1),
		(troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_trousers5", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_trousers5", 1),
		(troop_add_items, "trp_faction8_mgoperator", "itm_sta_hat6", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_infantry5", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_trousers5", 1),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction8_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction8_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction8_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction8_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction8_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction8_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_8"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_8"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction8_troop1", "itm_sta_hat6"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_sta_hat3", "itm_sta_infantry7", "itm_sta_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction8_troop5"),
			(troop_add_items, ":troop", "itm_sta_hat3", 1), (troop_add_items, ":troop", "itm_sta_infantry8", 1), (troop_add_items, ":troop", "itm_sta_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop5", "trp_faction8_troop8"),
			(troop_add_items, ":troop", "itm_sta_hat3", 1), (troop_add_items, ":troop", "itm_sta_infantry9", 1), (troop_add_items, ":troop", "itm_sta_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop8", "trp_faction8_troop10"),
			(troop_add_items, ":troop", "itm_sta_hat3", 1), (troop_add_items, ":troop", "itm_sta_infantry10", 1), (troop_add_items, ":troop", "itm_sta_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop10", "trp_faction8_prisonguard"),
			(troop_add_items, ":troop", "itm_sta_hat3", 1), (troop_add_items, ":troop", "itm_sta_infantry11", 1), (troop_add_items, ":troop", "itm_sta_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_prisonguard", "trp_faction9_troop1"),
			(troop_add_items, ":troop", "itm_sta_hat3", 1), (troop_add_items, ":troop", "itm_sta_infantry7", 1), (troop_add_items, ":troop", "itm_sta_trousers6", 1),
			(try_end),
		(troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_trousers6", 1),
		(troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_trousers6", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_trousers6", 1),
		(troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_trousers6", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_trousers6", 1),
		(troop_add_items, "trp_faction8_mgoperator", "itm_sta_hat3", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_infantry11", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_trousers6", 1),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction8_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_2"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_infantrymgtactics, 10000),
		(troop_has_item_equipped, "trp_faction2_troop1", "itm_ria_hat9"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
			(try_begin),
			(assign, ":continue", 0),
			(eq, ":tech_faction", "fac_player_supporters_faction"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_flag_material, "str_flag1_2"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_flag_material, "str_flag1_34"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction_player, slot_faction_flag_material, "str_flag1_70"),
			(assign, ":continue", 1),
			(else_try),
			(neq, ":tech_faction", "fac_player_supporters_faction"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction, slot_faction_flag_material, "str_flag1_2"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction, slot_faction_flag_material, "str_flag1_34"),
			(this_or_next|faction_slot_eq, civil_war_dublicate_faction, slot_faction_state, sfs_inactive),
			(neg|faction_slot_eq, civil_war_dublicate_faction, slot_faction_flag_material, "str_flag1_70"),
			(assign, ":continue", 1),
			(try_end),
		(this_or_next|eq, "$g_start_date", 1919),
		(eq, ":continue", 1),
		(faction_slot_eq, ":tech_faction", slot_faction_government_type, government_type_soviet_republic),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_ria_hat11", "itm_ria_infantry15", "itm_ria_infantry_trousers5"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction2_troop1", "trp_faction9_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction2_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction2_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction2_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction2_heavyhowitzer_cannoneer_officer"),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction2_troop1", "trp_faction2_troop5"),
			(troop_add_items, ":troop", "itm_ria_hat11", 1), (troop_add_items, ":troop", "itm_ria_infantry15", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction2_troop5", "trp_faction2_troop7"),
			(troop_add_items, ":troop", "itm_ria_hat11", 1), (troop_add_items, ":troop", "itm_ria_infantry18", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction2_troop7", "trp_faction2_troop9"),
			(troop_add_items, ":troop", "itm_ria_hat12", 1), (troop_add_items, ":troop", "itm_ria_infantry15", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction2_troop9", "trp_faction2_prisonguard"),
			(troop_add_items, ":troop", "itm_ria_hat11", 1), (troop_add_items, ":troop", "itm_ria_infantry16", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction2_prisonguard", "trp_faction9_troop1"),
			(troop_add_items, ":troop", "itm_ria_hat11", 1), (troop_add_items, ":troop", "itm_ria_infantry15", 1), (troop_add_items, ":troop", "itm_ria_infantry_trousers5", 1),
			(try_end),
		(troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_infantry17", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer_officer", "itm_ria_infantry_trousers5", 1),
		(troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_infantry17", 1), (troop_add_items, "trp_faction2_heavyhowitzer_cannoneer_officer", "itm_ria_infantry_trousers5", 1),
		(troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_infantry17", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer_officer", "itm_ria_infantry_trousers5", 1),
		(troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_infantry19", 1), (troop_add_items, "trp_faction2_howitzer_cannoneer", "itm_ria_infantry_trousers5", 1),
		(troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_infantry19", 1), (troop_add_items, "trp_faction2_fieldgun_cannoneer", "itm_ria_infantry_trousers5", 1),
		(troop_add_items, "trp_faction2_mgoperator", "itm_ria_hat11", 1), (troop_add_items, "trp_faction2_mgoperator", "itm_ria_infantry19", 1), (troop_add_items, "trp_faction2_mgoperator", "itm_ria_infantry_trousers5", 1),
			(try_for_range, ":troop", "trp_faction2_troop1", "trp_faction9_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction2_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_8"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_lmgs, 10000),
		(troop_has_item_equipped, "trp_faction8_troop1", "itm_sta_hat3"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_sta_hat4", "itm_sta_infantry12", "itm_sta_trousers7"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction8_troop5"),
			(troop_add_items, ":troop", "itm_sta_hat4", 1), (troop_add_items, ":troop", "itm_sta_infantry13", 1), (troop_add_items, ":troop", "itm_sta_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop5", "trp_faction8_troop8"),
			(troop_add_items, ":troop", "itm_sta_hat5", 1), (troop_add_items, ":troop", "itm_sta_infantry14", 1), (troop_add_items, ":troop", "itm_sta_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop8", "trp_faction8_troop10"),
			(troop_add_items, ":troop", "itm_sta_hat8", 1), (troop_add_items, ":troop", "itm_sta_infantry15", 1), (troop_add_items, ":troop", "itm_sta_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_troop10", "trp_faction8_prisonguard"),
			(troop_add_items, ":troop", "itm_sta_hat8", 1), (troop_add_items, ":troop", "itm_sta_infantry16", 1), (troop_add_items, ":troop", "itm_sta_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction8_prisonguard", "trp_faction9_troop1"),
			(troop_add_items, ":troop", "itm_sta_hat4", 1), (troop_add_items, ":troop", "itm_sta_infantry12", 1), (troop_add_items, ":troop", "itm_sta_trousers7", 1),
			(try_end),
		(troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer_officer", "itm_sta_trousers7", 1),
		(troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_heavyhowitzer_cannoneer_officer", "itm_sta_trousers7", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer_officer", "itm_sta_trousers7", 1),
		(troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_howitzer_cannoneer", "itm_sta_trousers7", 1),
		(troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_fieldgun_cannoneer", "itm_sta_trousers7", 1),
		(troop_add_items, "trp_faction8_mgoperator", "itm_sta_hat8", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_infantry16", 1), (troop_add_items, "trp_faction8_mgoperator", "itm_sta_trousers7", 1),
			(try_for_range, ":troop", "trp_faction8_troop1", "trp_faction9_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction8_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_8"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_faction8_troop8", "itm_sta_hat8"),
			(try_for_range, ":troop", "trp_faction8_troop8", "trp_faction8_troop10"),
				(try_begin),
				(troop_get_inventory_slot, ":item", ":troop", ek_head),
				(troop_set_inventory_slot, ":troop", ek_head, -1),
				(gt, ":item", 1),
				(troop_remove_items, ":troop", ":item", 1),
				(troop_add_items, ":troop", "itm_sta_hat7", 1),
				(troop_equip_items, ":troop"),
				(try_end),
			(try_end),
		(else_try),
		(eq, ":faction", "fac_kingdom_24"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_faction24_troop1", "itm_els_hat7"),
			(try_for_range, ":troop", "trp_faction24_troop1", "trp_faction25_troop1"),
				(try_begin),
				(troop_get_inventory_slot, ":item", ":troop", ek_head),
				(troop_set_inventory_slot, ":troop", ek_head, -1),
				(gt, ":item", 1),
				(troop_remove_items, ":troop", ":item", 1),
				(troop_add_items, ":troop", "itm_srb_hat9", 1),
				(troop_equip_items, ":troop"),
				(try_end),
			(try_end),
		(else_try),
		(eq, ":faction", "fac_kingdom_9"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_9"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_lmgs, 10000),
		(troop_has_item_equipped, "trp_faction9_troop1", "itm_edt_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_edt_hat5", "itm_edt_infantry4", "itm_edt_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction10_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction9_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction9_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction9_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction9_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction9_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction9_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction9_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction10_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction9_troop5"),
			(troop_add_items, ":troop", "itm_edt_hat5", 1), (troop_add_items, ":troop", "itm_edt_infantry4", 1), (troop_add_items, ":troop", "itm_edt_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop5", "trp_faction9_troop7"),
			(troop_add_items, ":troop", "itm_edt_hat6", 1), (troop_add_items, ":troop", "itm_edt_infantry5", 1), (troop_add_items, ":troop", "itm_edt_trousers7", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop7", "trp_faction9_troop9"),
			(troop_add_items, ":troop", "itm_edt_hat5", 1), (troop_add_items, ":troop", "itm_edt_infantry4", 1), (troop_add_items, ":troop", "itm_edt_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop9", "trp_faction9_prisonguard"),
			(troop_add_items, ":troop", "itm_edt_hat8", 1), (troop_add_items, ":troop", "itm_edt_infantry4", 1), (troop_add_items, ":troop", "itm_edt_trousers6", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_prisonguard", "trp_faction10_troop1"),
			(troop_add_items, ":troop", "itm_edt_hat5", 1), (troop_add_items, ":troop", "itm_edt_infantry4", 1), (troop_add_items, ":troop", "itm_edt_trousers6", 1),
			(try_end),
		(troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_trousers6", 1),
		(troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_trousers6", 1),
		(troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_trousers6", 1),
		(troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_trousers6", 1),
		(troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_trousers6", 1),
		(troop_add_items, "trp_faction9_mgoperator", "itm_edt_hat5", 1), (troop_add_items, "trp_faction9_mgoperator", "itm_edt_infantry4", 1), (troop_add_items, "trp_faction9_mgoperator", "itm_edt_trousers6", 1),
			(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction10_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction9_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction9_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction9_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction9_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction9_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction9_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_9"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_9"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_gasattacks, 10000),
		(troop_has_item_equipped, "trp_faction9_troop1", "itm_edt_hat5"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_edt_hat7", "itm_edt_infantry6", "itm_edt_trousers8"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction10_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction9_troop5"),
			(troop_add_items, ":troop", "itm_edt_hat7", 1), (troop_add_items, ":troop", "itm_edt_infantry6", 1), (troop_add_items, ":troop", "itm_edt_trousers8", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction9_troop5", "trp_faction9_troop7"),
			(troop_add_items, ":troop", "itm_edt_hat7", 1), (troop_add_items, ":troop", "itm_edt_infantry6", 1), (troop_add_items, ":troop", "itm_edt_trousers8", 1),
			(try_end),
			...
			(troop_add_items, ":troop", "itm_edt_hat7", 1), (troop_add_items, ":troop", "itm_edt_infantry6", 1), (troop_add_items, ":troop", "itm_edt_trousers8", 1),
			(try_end),
		(troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer_officer", "itm_edt_trousers8", 1),
		(troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_heavyhowitzer_cannoneer_officer", "itm_edt_trousers8", 1),
		(troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer_officer", "itm_edt_trousers8", 1),
		(troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_howitzer_cannoneer", "itm_edt_trousers8", 1),
		(troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_fieldgun_cannoneer", "itm_edt_trousers8", 1),
		(troop_add_items, "trp_faction9_mgoperator", "itm_edt_hat7", 1), (troop_add_items, "trp_faction9_mgoperator", "itm_edt_infantry6", 1), (troop_add_items, "trp_faction9_mgoperator", "itm_edt_trousers8", 1),
			(try_for_range, ":troop", "trp_faction9_troop1", "trp_faction10_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction9_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_16"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_16"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_lmgs, 10000),
		(troop_has_item_equipped, "trp_faction16_troop1", "itm_exp_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_exp_hat5", "itm_exp_infantry6", "itm_exp_trousers4"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction17_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction16_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction16_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction16_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction16_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction16_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction16_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction16_mgoperator"),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction17_troop1"),
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction16_troop10"),
			(troop_add_items, ":troop", "itm_exp_hat5", 1), (troop_add_items, ":troop", "itm_exp_infantry5", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop10", "trp_faction16_prisonguard"),
			(troop_add_items, ":troop", "itm_exp_hat5", 1), (troop_add_items, ":troop", "itm_exp_infantry6", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_prisonguard", "trp_faction17_troop1"),
			(troop_add_items, ":troop", "itm_exp_hat5", 1), (troop_add_items, ":troop", "itm_exp_infantry6", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
		(troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_mgoperator", "itm_exp_hat5", 1), (troop_add_items, "trp_faction16_mgoperator", "itm_exp_infantry6", 1), (troop_add_items, "trp_faction16_mgoperator", "itm_exp_trousers4", 1),
			(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction17_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction16_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction16_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction16_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction16_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction16_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction16_mgoperator"),
		(else_try),
		(eq, ":faction", "fac_kingdom_16"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_16"),
			...
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(troop_has_item_equipped, "trp_faction16_troop1", "itm_exp_hat5"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_exp_hat6", "itm_exp_infantry8", "itm_exp_trousers4"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction17_troop1"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			...
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction16_troop8"),
			(troop_add_items, ":troop", "itm_exp_hat6", 1), (troop_add_items, ":troop", "itm_exp_infantry7", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop8", "trp_faction16_troop10"),
			(troop_add_items, ":troop", "itm_baf_hat15", 1), (troop_add_items, ":troop", "itm_exp_infantry8", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_troop10", "trp_faction16_prisonguard"),
			(troop_add_items, ":troop", "itm_exp_hat6", 1), (troop_add_items, ":troop", "itm_exp_infantry8", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_faction16_prisonguard", "trp_faction17_troop1"),
			(troop_add_items, ":troop", "itm_exp_hat6", 1), (troop_add_items, ":troop", "itm_exp_infantry8", 1), (troop_add_items, ":troop", "itm_exp_trousers4", 1),
			(try_end),
		(troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_heavyhowitzer_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer_officer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_howitzer_cannoneer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_fieldgun_cannoneer", "itm_exp_trousers4", 1),
		(troop_add_items, "trp_faction16_mgoperator", "itm_exp_hat6", 1), (troop_add_items, "trp_faction16_mgoperator", "itm_exp_infantry8", 1), (troop_add_items, "trp_faction16_mgoperator", "itm_exp_trousers4", 1),
			(try_for_range, ":troop", "trp_faction16_troop1", "trp_faction17_troop1"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction16_howitzer_cannoneer_officer"),
		...
		(eq, ":faction", "fac_kingdom_11"),
			...
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1919),
		(troop_has_item_equipped, "trp_faction11_fieldgun_cannoneer_officer", "itm_eds_hat3"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_pol_hat2", "itm_pol_infantry3", "itm_pol_trousers2"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction11_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction11_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction11_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction11_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction11_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction11_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionpoland_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionpoland_castleguard"),
		(troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_hat2", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_infantry3", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_trousers2", 1),
		(troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_hat2", 1), (troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_infantry3", 1), (troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_trousers2", 1),
		(troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_hat2", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_infantry3", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_trousers2", 1),
		(troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_hat1", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_infantry1", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_trousers1", 1),
		(troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_hat1", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_infantry1", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_trousers1", 1),
		(troop_add_items, "trp_faction11_mgoperator", "itm_pol_hat1", 1), (troop_add_items, "trp_faction11_mgoperator", "itm_pol_infantry1", 1), (troop_add_items, "trp_faction11_mgoperator", "itm_pol_trousers1", 1),
		(troop_equip_items, "trp_faction11_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction11_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction11_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction11_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction11_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction11_mgoperator"),
		(str_store_string, s1, "@Polish Howitzer Crew Officer"), (str_store_string, s2, "@Polish Howitzer Crew Officers"),
		(str_store_string, s3, "@Polish Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Polish Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Polish Field Gun Crew Officer"), (str_store_string, s6, "@Polish Field Gun Crew Officers"),
		(str_store_string, s7, "@Polish Howitzer Crew Cannoneer"), (str_store_string, s8, "@Polish Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Polish Field Gun Crew Cannoneer"), (str_store_string, s10, "@Polish Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Polish MG Operator"), (str_store_string, s12, "@Polish MG Operator"),
		(troop_set_name, "trp_faction11_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction11_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction11_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction11_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction11_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction11_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction11_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction11_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction11_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction11_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction11_mgoperator", s11), (troop_set_plural_name, "trp_faction11_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_19"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_19"),
			...
			(try_end),
		(ge, "$g_start_date", 1919),
		(troop_has_item_equipped, "trp_faction19_fieldgun_cannoneer_officer", "itm_esp_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_cze_hat2", "itm_lou_infantry20", "itm_lou_infantry_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction19_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction19_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction19_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction19_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction19_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction19_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionczech_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionczech_castleguard"),
		(troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_lou_infantry_trousers5", 1),
		(troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_lou_infantry_trousers5", 1),
		(troop_add_items, "trp_faction19_mgoperator", "itm_cze_hat2", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_lou_infantry_trousers5", 1),
		(troop_equip_items, "trp_faction19_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction19_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction19_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction19_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction19_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction19_mgoperator"),
		(str_store_string, s1, "@Czechoslovak Howitzer Crew Officer"), (str_store_string, s2, "@Czechoslovak Howitzer Crew Officers"),
		(str_store_string, s3, "@Czechoslovak Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Czechoslovak Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Czechoslovak Field Gun Crew Officer"), (str_store_string, s6, "@Czechoslovak Field Gun Crew Officers"),
		(str_store_string, s7, "@Czechoslovak Howitzer Crew Cannoneer"), (str_store_string, s8, "@Czechoslovak Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Czechoslovak Field Gun Crew Cannoneer"), (str_store_string, s10, "@Czechoslovak Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Czechoslovak MG Operator"), (str_store_string, s12, "@Czechoslovak MG Operator"),
		(troop_set_name, "trp_faction19_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction19_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction19_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction19_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction19_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction19_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction19_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction19_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction19_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction19_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction19_mgoperator", s11), (troop_set_plural_name, "trp_faction19_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_10"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_10"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1919),
		(troop_has_item_equipped, "trp_faction10_fieldgun_cannoneer_officer", "itm_esp_hat1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_hun_hat2", "itm_lou_infantry20", "itm_lou_infantry_trousers6"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction10_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction10_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction10_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction10_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction10_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction10_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction10_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionhungary_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionhungary_castleguard"),
		(troop_add_items, "trp_faction10_howitzer_cannoneer_officer", "itm_hun_hat2", 1), (troop_add_items, "trp_faction10_howitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction10_howitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction10_heavyhowitzer_cannoneer_officer", "itm_hun_hat2", 1), (troop_add_items, "trp_faction10_heavyhowitzer_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction10_heavyhowitzer_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction10_fieldgun_cannoneer_officer", "itm_hun_hat2", 1), (troop_add_items, "trp_faction10_fieldgun_cannoneer_officer", "itm_lou_infantry20", 1), (troop_add_items, "trp_faction10_fieldgun_cannoneer_officer", "itm_lou_infantry_trousers6", 1),
		(troop_add_items, "trp_faction10_howitzer_cannoneer", "itm_hun_hat1", 1), (troop_add_items, "trp_faction10_howitzer_cannoneer", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction10_howitzer_cannoneer", "itm_lou_infantry_trousers5", 1),
		(troop_add_items, "trp_faction10_fieldgun_cannoneer", "itm_hun_hat1", 1), (troop_add_items, "trp_faction10_fieldgun_cannoneer", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction10_fieldgun_cannoneer", "itm_lou_infantry_trousers5", 1),
		(troop_add_items, "trp_faction10_mgoperator", "itm_hun_hat1", 1), (troop_add_items, "trp_faction10_mgoperator", "itm_lou_infantry13", 1), (troop_add_items, "trp_faction10_mgoperator", "itm_lou_infantry_trousers5", 1),
		(troop_equip_items, "trp_faction10_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction10_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction10_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction10_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction10_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction10_mgoperator"),
		(str_store_string, s1, "@Hungarian Howitzer Crew Officer"), (str_store_string, s2, "@Hungarian Howitzer Crew Officers"),
		(str_store_string, s3, "@Hungarian Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Hungarian Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Hungarian Field Gun Crew Officer"), (str_store_string, s6, "@Hungarian Field Gun Crew Officers"),
		(str_store_string, s7, "@Hungarian Howitzer Crew Cannoneer"), (str_store_string, s8, "@Hungarian Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Hungarian Field Gun Crew Cannoneer"), (str_store_string, s10, "@Hungarian Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Hungarian MG Operator"), (str_store_string, s12, "@Hungarian MG Operator"),
		(troop_set_name, "trp_faction10_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction10_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction10_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction10_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction10_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction10_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction10_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction10_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction10_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction10_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction10_mgoperator", s11), (troop_set_plural_name, "trp_faction10_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_14"),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_14"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(ge, "$g_start_date", 1919),
		(troop_has_item_equipped, "trp_faction14_fieldgun_cannoneer_officer", "itm_egy_fez1"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_lit_hat1", "itm_lit_infantry4", "itm_lit_trousers2"),
			(try_for_range, ":item_slot", 4, 8),
			(troop_set_inventory_slot, "trp_faction14_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction14_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_heavyhowitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction14_fieldgun_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_fieldgun_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction14_howitzer_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_howitzer_cannoneer"),
			(troop_set_inventory_slot, "trp_faction14_fieldgun_cannoneer", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_fieldgun_cannoneer"),
			(troop_set_inventory_slot, "trp_faction14_mgoperator", ":item_slot", -1), (troop_clear_inventory, "trp_faction14_mgoperator"),
			(try_end),
		(faction_set_slot, ":tech_faction", slot_faction_prison_guard_troop, "trp_factionhungary_prisonguard"),
		(faction_set_slot, ":tech_faction", slot_faction_castle_guard_troop, "trp_factionhungary_castleguard"),
		(troop_add_items, "trp_faction14_howitzer_cannoneer_officer", "itm_lit_hat1", 1), (troop_add_items, "trp_faction14_howitzer_cannoneer_officer", "itm_lit_infantry4", 1), (troop_add_items, "trp_faction14_howitzer_cannoneer_officer", "itm_lit_trousers2", 1),
		(troop_add_items, "trp_faction14_heavyhowitzer_cannoneer_officer", "itm_lit_hat1", 1), (troop_add_items, "trp_faction14_heavyhowitzer_cannoneer_officer", "itm_lit_infantry4", 1), (troop_add_items, "trp_faction14_heavyhowitzer_cannoneer_officer", "itm_lit_trousers2", 1),
		(troop_add_items, "trp_faction14_fieldgun_cannoneer_officer", "itm_lit_hat1", 1), (troop_add_items, "trp_faction14_fieldgun_cannoneer_officer", "itm_lit_infantry4", 1), (troop_add_items, "trp_faction14_fieldgun_cannoneer_officer", "itm_lit_trousers2", 1),
		(troop_add_items, "trp_faction14_howitzer_cannoneer", "itm_lit_hat2", 1), (troop_add_items, "trp_faction14_howitzer_cannoneer", "itm_lit_infantry5", 1), (troop_add_items, "trp_faction14_howitzer_cannoneer", "itm_lit_trousers1", 1),
		(troop_add_items, "trp_faction14_fieldgun_cannoneer", "itm_lit_hat2", 1), (troop_add_items, "trp_faction14_fieldgun_cannoneer", "itm_lit_infantry5", 1), (troop_add_items, "trp_faction14_fieldgun_cannoneer", "itm_lit_trousers1", 1),
		(troop_add_items, "trp_faction14_mgoperator", "itm_lit_hat2", 1), (troop_add_items, "trp_faction14_mgoperator", "itm_lit_infantry5", 1), (troop_add_items, "trp_faction14_mgoperator", "itm_lit_trousers1", 1),
		(troop_equip_items, "trp_faction14_howitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction14_heavyhowitzer_cannoneer_officer"),
		(troop_equip_items, "trp_faction14_fieldgun_cannoneer_officer"),
		(troop_equip_items, "trp_faction14_howitzer_cannoneer"),
		(troop_equip_items, "trp_faction14_fieldgun_cannoneer"),
		(troop_equip_items, "trp_faction14_mgoperator"),
		(str_store_string, s1, "@Lithuanian Howitzer Crew Officer"), (str_store_string, s2, "@Lithuanian Howitzer Crew Officers"),
		(str_store_string, s3, "@Lithuanian Heavy Howitzer Crew Officer"), (str_store_string, s4, "@Lithuanian Heavy Howitzer Crew Officers"), 
		(str_store_string, s5, "@Lithuanian Field Gun Crew Officer"), (str_store_string, s6, "@Lithuanian Field Gun Crew Officers"),
		(str_store_string, s7, "@Lithuanian Howitzer Crew Cannoneer"), (str_store_string, s8, "@Lithuanian Howitzer Crew Cannoneers"),
		(str_store_string, s9, "@Lithuanian Field Gun Crew Cannoneer"), (str_store_string, s10, "@Lithuanian Field Gun Crew Cannoneers"),
		(str_store_string, s11, "@Lithuanian MG Operator"), (str_store_string, s12, "@Lithuanian MG Operator"),
		(troop_set_name, "trp_faction14_howitzer_cannoneer_officer", s1), (troop_set_plural_name, "trp_faction14_howitzer_cannoneer_officer", s2),
		(troop_set_name, "trp_faction14_heavyhowitzer_cannoneer_officer", s3), (troop_set_plural_name, "trp_faction14_heavyhowitzer_cannoneer_officer", s4),
		(troop_set_name, "trp_faction14_fieldgun_cannoneer_officer", s5), (troop_set_plural_name, "trp_faction14_fieldgun_cannoneer_officer", s6),
		(troop_set_name, "trp_faction14_howitzer_cannoneer", s7), (troop_set_plural_name, "trp_faction14_howitzer_cannoneer", s8),
		(troop_set_name, "trp_faction14_fieldgun_cannoneer", s9), (troop_set_plural_name, "trp_faction14_fieldgun_cannoneer", s10),
		(troop_set_name, "trp_faction14_mgoperator", s10), (troop_set_plural_name, "trp_faction14_mgoperator", s12),
		(else_try),
		(eq, ":faction", "fac_kingdom_11"),
		(store_add, ":troops_end", "trp_factionpoland_castleguard", 1),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_11"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_modernartillery, 10000),
		(troop_has_item_equipped, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_hat2"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_pol_hat5", "itm_pol_infantry7", "itm_pol_trousers5"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_factionpoland_troop1", ":troops_end"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction11_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction11_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction11_heavyhowitzer_cannoneer_officer"),
			...
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_factionpoland_troop1", "trp_factionpoland_troop5"),
			(troop_add_items, ":troop", "itm_pol_hat6", 1), (troop_add_items, ":troop", "itm_pol_infantry4", 1), (troop_add_items, ":troop", "itm_pol_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionpoland_troop5", "trp_factionpoland_troop7"),
			(troop_add_items, ":troop", "itm_pol_hat8", 1), (troop_add_items, ":troop", "itm_pol_infantry5", 1), (troop_add_items, ":troop", "itm_pol_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionpoland_troop7", "trp_factionpoland_troop9"),
			(troop_add_items, ":troop", "itm_pol_hat6", 1), (troop_add_items, ":troop", "itm_pol_infantry4", 1), (troop_add_items, ":troop", "itm_pol_trousers4", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionpoland_troop9", "trp_factionpoland_prisonguard"),
			(troop_add_items, ":troop", "itm_pol_hat7", 1), (troop_add_items, ":troop", "itm_pol_infantry6", 1), (troop_add_items, ":troop", "itm_pol_trousers5", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionpoland_prisonguard", ":troops_end"),
			(troop_add_items, ":troop", "itm_pol_hat6", 1), (troop_add_items, ":troop", "itm_pol_infantry4", 1), (troop_add_items, ":troop", "itm_pol_trousers4", 1),
			(try_end),
		(troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_hat5", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_infantry7", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer_officer", "itm_pol_trousers5", 1),
		(troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_hat5", 1), (troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_infantry7", 1), (troop_add_items, "trp_faction11_heavyhowitzer_cannoneer_officer", "itm_pol_trousers5", 1),
		(troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_hat5", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_infantry7", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer_officer", "itm_pol_trousers5", 1),
		(troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_hat8", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_infantry4", 1), (troop_add_items, "trp_faction11_howitzer_cannoneer", "itm_pol_trousers4", 1),
		(troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_hat8", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_infantry4", 1), (troop_add_items, "trp_faction11_fieldgun_cannoneer", "itm_pol_trousers4", 1),
		(troop_add_items, "trp_faction11_mgoperator", "itm_pol_hat8", 1), (troop_add_items, "trp_faction11_mgoperator", "itm_pol_infantry4", 1), (troop_add_items, "trp_faction11_mgoperator", "itm_pol_trousers4", 1),
			(try_for_range, ":troop", "trp_factionpoland_troop1", ":troops_end"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction11_howitzer_cannoneer_officer"),
		...
		(else_try),
		(eq, ":faction", "fac_kingdom_19"),
		(store_add, ":troops_end", "trp_factionczech_castleguard", 1),
			(try_begin),
			(eq, "$player_faction_preset", "fac_kingdom_19"),
			(assign, ":tech_faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":tech_faction", slot_faction_technology_shocktroops, 10000),
		(ge, "$g_current_year", 1921),
		(troop_has_item_equipped, "trp_faction19_fieldgun_cannoneer_officer", "itm_cze_hat2"),
			(try_begin),
			(eq, ":tech_faction", "fac_player_faction"),
			(assign, ":tech_faction", "fac_player_supporters_faction"),
			(try_end),
		(call_script, "script_uniform_progression_change_officer_clothes", ":tech_faction", "itm_cze_hat1", "itm_cze_infantry4", "itm_cze_trousers1"),
			(try_for_range, ":item_slot", 4, 8),
				(try_for_range, ":troop", "trp_factionczech_troop1", ":troops_end"),
				(troop_set_inventory_slot, ":troop", ":item_slot", -1),
				(try_end),
			(troop_set_inventory_slot, "trp_faction19_howitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_howitzer_cannoneer_officer"),
			(troop_set_inventory_slot, "trp_faction19_heavyhowitzer_cannoneer_officer", ":item_slot", -1), (troop_clear_inventory, "trp_faction19_heavyhowitzer_cannoneer_officer"),
			...
			(troop_clear_inventory, ":troop"),
			(try_end),
			(try_for_range, ":troop", "trp_factionczech_troop1", "trp_factionczech_troop5"),
			(troop_add_items, ":troop", "itm_cze_hat3", 1), (troop_add_items, ":troop", "itm_cze_infantry1", 1), (troop_add_items, ":troop", "itm_cze_trousers1", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionczech_troop5", "trp_factionczech_troop7"),
			(troop_add_items, ":troop", "itm_cze_hat3", 1), (troop_add_items, ":troop", "itm_cze_infantry2", 1), (troop_add_items, ":troop", "itm_cze_trousers1", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionczech_troop7", "trp_factionczech_troop9"),
			(troop_add_items, ":troop", "itm_cze_hat1", 1), (troop_add_items, ":troop", "itm_cze_infantry1", 1), (troop_add_items, ":troop", "itm_cze_trousers1", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionczech_troop9", "trp_factionczech_prisonguard"),
			(troop_add_items, ":troop", "itm_cze_hat3", 1), (troop_add_items, ":troop", "itm_cze_infantry3", 1), (troop_add_items, ":troop", "itm_cze_trousers1", 1),
			(try_end),
			(try_for_range, ":troop", "trp_factionczech_prisonguard", ":troops_end"),
			(troop_add_items, ":troop", "itm_cze_hat3", 1), (troop_add_items, ":troop", "itm_cze_infantry1", 1), (troop_add_items, ":troop", "itm_cze_trousers1", 1),
			(try_end),
		(troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_cze_hat1", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_cze_infantry4", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer_officer", "itm_cze_trousers1", 1),
		(troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_cze_hat1", 1), (troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_cze_infantry4", 1), (troop_add_items, "trp_faction19_heavyhowitzer_cannoneer_officer", "itm_cze_trousers1", 1),
		(troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_cze_hat1", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_cze_infantry4", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer_officer", "itm_cze_trousers1", 1),
		(troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_cze_hat3", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_cze_infantry1", 1), (troop_add_items, "trp_faction19_howitzer_cannoneer", "itm_cze_trousers1", 1),
		(troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_cze_hat3", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_cze_infantry1", 1), (troop_add_items, "trp_faction19_fieldgun_cannoneer", "itm_cze_trousers1", 1),
		(troop_add_items, "trp_faction19_mgoperator", "itm_cze_hat3", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_cze_infantry1", 1), (troop_add_items, "trp_faction19_mgoperator", "itm_cze_trousers1", 1),
			(try_for_range, ":troop", "trp_factionczech_troop1", ":troops_end"),
			(troop_equip_items, ":troop"),
			(try_end),
		(troop_equip_items, "trp_faction19_howitzer_cannoneer_officer"),
...
[
	(try_begin),
	(ge, "$g_current_year", 1919),
	(troop_set_name, "trp_kingdom_1_lord", "@President Raymond Poincare"),
	(troop_set_name, "trp_kingdom_2_lord", "@Alexander Kolchak"),
	(troop_set_name, "trp_kingdom_3_lord", "@President Karl Seitz"),
	(troop_set_name, "trp_kingdom_4_lord", "@King Victor Emmanuel III"),
	(troop_set_name, "trp_kingdom_5_lord", "@President Friedrich Ebert"),
	(troop_set_name, "trp_kingdom_6_lord", "@Sultan Mehmed VI"),
	(troop_set_name, "trp_kingdom_7_lord", "@King George V"),
	(troop_set_name, "trp_kingdom_8_lord", "@Queen Wilhelmina"),
	(troop_set_name, "trp_kingdom_9_lord", "@King Alfonso XIII"),
	(troop_set_name, "trp_kingdom_10_lord", "@Istvan Friedrich"),
	(troop_set_name, "trp_kingdom_11_lord", "@Chief of State Jozef Pilsudski"),
	(troop_set_name, "trp_kingdom_12_lord", "@Ahmad Shah Qajar"),
	(troop_set_name, "trp_kingdom_13_lord", "@President Gustave Ador"),
	(troop_set_name, "trp_kingdom_14_lord", "@President Antanas Smetona"),
	(troop_set_name, "trp_kingdom_15_lord", "@President Janis Cakste"),
	(troop_set_name, "trp_kingdom_16_lord", "@President Antonio Jose de Almeida"),
	(troop_set_name, "trp_kingdom_17_lord", "@President Konstantin Pats"),
	(troop_set_name, "trp_kingdom_18_lord", "@King Christian X"),
	(troop_set_name, "trp_kingdom_19_lord", "@President Tomas Garrigue Masaryk"),
	(troop_set_name, "trp_kingdom_20_lord", "@Sir Michael Francis O'Dwyer"),
	(troop_set_name, "trp_kingdom_21_lord", "@Emir Amanullah Khan"),
	(troop_set_name, "trp_kingdom_22_lord", "@Vladimir Lenin"),
	(troop_set_name, "trp_kingdom_24_lord", "@King Constantine I"),
	(troop_set_name, "trp_kingdom_25_lord", "@King Ferdinand I"),
	(troop_set_name, "trp_kingdom_26_lord", "@King Albert I"),
	(troop_set_name, "trp_kingdom_27_lord", "@Tsar Ferdinand I"),
	(troop_set_name, "trp_kingdom_28_lord", "@King Peter I"),
	(troop_set_name, "trp_kingdom_29_lord", "@King Gustav V"), 
	(troop_set_name, "trp_kingdom_30_lord", "@King Haakon VII"),
	(troop_set_name, "trp_kingdom_31_lord", "@Turhan Pasha Permeti"),
	(troop_set_name, "trp_kingdom_32_lord", "@Chairman Symon Petliura"),
	(troop_set_name, "trp_kingdom_33_lord", "@President Eamon de Valera"),
    ...
    (troop_set_name, "trp_kingdom_9_lord", "@King Alfonso XIII"),
    (troop_set_name, "trp_kingdom_12_lord", "@Ahmad Shah Qajar"),
    (troop_set_name, "trp_kingdom_13_lord", "@President Arthur Hoffmann"),
    (troop_set_name, "trp_kingdom_16_lord", "@President Manuel de Arriaga"),
    (troop_set_name, "trp_kingdom_17_lord", "@Sultan Taimur bin Faisal"),
    (troop_set_name, "trp_kingdom_18_lord", "@King Christian X"),
    (troop_set_name, "trp_kingdom_20_lord", "@Lord Hardinge of Penshurst"),
    (troop_set_name, "trp_kingdom_21_lord", "@Emir Habibullah Khan"),
    (troop_set_name, "trp_kingdom_24_lord", "@King Constantine I"),
    (troop_set_name, "trp_kingdom_25_lord", "@King Carol I"),
    (troop_set_name, "trp_kingdom_26_lord", "@King Albert I"),
    (troop_set_name, "trp_kingdom_27_lord", "@Tsar Ferdinand I"),
    (troop_set_name, "trp_kingdom_28_lord", "@King Peter I"),
    (troop_set_name, "trp_kingdom_29_lord", "@King Gustav V"),
    (troop_set_name, "trp_kingdom_30_lord", "@King Haakon VII"),
    (troop_set_name, "trp_kingdom_31_lord", "@Prince Wilhelm of Wied"),
    (troop_set_name, "trp_kingdom_32_lord", "@Sultan Abdulaziz ibn Abdul Rahman al Saud"),
    (troop_set_name, "trp_kingdom_33_lord", "@Emir Saud ibn Abdulaziz al Rashid"),
	(troop_set_type, "trp_kingdom_7_lord", 0),
	(troop_set_type, "trp_kingdom_8_lord", 1),
	(else_try),
	(ge, "$g_current_year", 1907),
	(troop_set_name, "trp_kingdom_1_lord", "@President Armand Fallieres"),
	(troop_set_name, "trp_kingdom_2_lord", "@Tsar Nicholas II"),
	(troop_set_name, "trp_kingdom_3_lord", "@Kaiser Franz Joseph I"),
	(troop_set_name, "trp_kingdom_4_lord", "@King Victor Emmanuel III"),
	(troop_set_name, "trp_kingdom_5_lord", "@Kaiser Wilhelm II"),
	...
	(troop_set_name, "trp_kingdom_8_lord", "@Queen Wilhelmina"),
	(troop_set_name, "trp_kingdom_9_lord", "@King Alfonso XIII"),
	(troop_set_name, "trp_kingdom_12_lord", "@Mohammad Ali Shah Qajar"),
	(troop_set_name, "trp_kingdom_13_lord", "@President Eduard Muller"),
	(troop_set_name, "trp_kingdom_16_lord", "@King Carlos I"),
	(troop_set_name, "trp_kingdom_17_lord", "@Sultan Faisal bin Turki"),
	(troop_set_name, "trp_kingdom_18_lord", "@King Christian X"),
	(troop_set_name, "trp_kingdom_20_lord", "@Earl of Minto"),
	(troop_set_name, "trp_kingdom_21_lord", "@Emir Habibullah Khan"),
	(troop_set_name, "trp_kingdom_24_lord", "@King George I"),
	(troop_set_name, "trp_kingdom_25_lord", "@King Carol I"),
	(troop_set_name, "trp_kingdom_26_lord", "@King Leopold II"),
	(troop_set_name, "trp_kingdom_27_lord", "@Knyaz Ferdinand I"),
	(troop_set_name, "trp_kingdom_28_lord", "@King Peter I"),
	(troop_set_name, "trp_kingdom_29_lord", "@King Oscar II"),
	(troop_set_name, "trp_kingdom_32_lord", "@Sultan Abdulaziz ibn Abdul Rahman al Saud"),
	(troop_set_name, "trp_kingdom_33_lord", "@Emir Saud ibn Hammud al Rashid"),
	(troop_set_type, "trp_kingdom_7_lord", 0),
	(troop_set_type, "trp_kingdom_8_lord", 1),
	(else_try),
    ...
    (troop_set_name, "trp_kingdom_8_lord", "@Queen Wilhelmina"),
    (troop_set_type, "trp_kingdom_8_lord", 1),
    (troop_set_name, "trp_kingdom_9_lord", "@Archduchess Maria Christina"),
    (troop_set_name, "trp_kingdom_12_lord", "@Naser al-Din Shah Qajar"),
    (troop_set_name, "trp_kingdom_13_lord", "@President Emil Welti"),
    (troop_set_name, "trp_kingdom_14_lord", "@Khedive Mohamed Tewfik Pasha"),
    (troop_set_name, "trp_kingdom_16_lord", "@King Carlos I"),
    (troop_set_name, "trp_kingdom_17_lord", "@Sultan Faisal bin Turki"),
    (troop_set_name, "trp_kingdom_18_lord", "@King Christian IX"),
    (troop_set_name, "trp_kingdom_20_lord", "@Marquess of Lansdowne"),
    (troop_set_name, "trp_kingdom_21_lord", "@Emir Abdur Rahman Khan"),
    (troop_set_name, "trp_kingdom_24_lord", "@King George I"),
    (troop_set_name, "trp_kingdom_25_lord", "@King Carol I"),
    (troop_set_name, "trp_kingdom_26_lord", "@King Leopold II"),
    (troop_set_name, "trp_kingdom_27_lord", "@Knyaz Ferdinand I"),
    (troop_set_name, "trp_kingdom_28_lord", "@King Alexander Obrenovic"),
    (troop_set_name, "trp_kingdom_29_lord", "@King Oscar II"),
    (troop_set_name, "trp_kingdom_32_lord", "@Emir Abdul Rahman bin Faisal"),
    (troop_set_name, "trp_kingdom_33_lord", "@Emir Muhammad bin Abdullah"),
	(troop_set_type, "trp_kingdom_8_lord", 1),
	(else_try),
...
[
	...
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_20"),
	(assign, ":faction_britain_colonies", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_britain_colonies", "fac_kingdom_20"),
	(try_end),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_27"),
	...
	(try_end),
	(try_begin),
	(eq, "$g_start_date", 1860),
	(faction_slot_eq, "fac_kingdom_5", slot_faction_state, sfs_active),
	(this_or_next|faction_slot_eq, "fac_kingdom_27", slot_faction_state, sfs_active),
	(faction_slot_eq, "fac_kingdom_31", slot_faction_state, sfs_active),
	(this_or_next|faction_slot_eq, "fac_kingdom_27", slot_faction_flag_material, "str_flag1_27"),
	(faction_slot_eq, "fac_kingdom_31", slot_faction_flag_material, "str_flag1_31"),
		(try_begin),
		(call_script, "script_cf_pas_if_faction_is_at_war_with_anyone", "fac_kingdom_5"),
		(else_try),
		(ge, "$g_current_year", 1866),
		(call_script, "script_cf_random", 5),
		(display_message, "@North German Confederation is formed."),
			(try_begin),
			(faction_slot_eq, "fac_kingdom_27", slot_faction_flag_material, "str_flag1_27"),
			(call_script, "script_faction_annex_faction", "fac_kingdom_5", "fac_kingdom_27"),
			(try_end),
			(try_begin),
			(faction_slot_eq, "fac_kingdom_31", slot_faction_flag_material, "str_flag1_31"),
			(call_script, "script_faction_annex_faction", "fac_kingdom_5", "fac_kingdom_31"),
			(try_end),
		(faction_set_name, "fac_kingdom_5", "@North German Confederation"),
	...
	(faction_slot_eq, "fac_kingdom_30", slot_faction_flag_material, "str_flag1_30"),
		(try_begin),
		(call_script, "script_cf_pas_if_faction_is_at_war_with_anyone", "fac_kingdom_5"),
		(else_try),
		(ge, "$g_current_year", 1870),
		(call_script, "script_cf_random", 5),
		(display_message, "@German Empire is formed."),
		(call_script, "script_faction_annex_faction", "fac_kingdom_5", "fac_kingdom_30"),
		(faction_set_name, "fac_kingdom_5", "@German Empire"),
		(try_end),
	(try_end),
	(try_begin),
	(faction_slot_eq, "fac_kingdom_22", slot_faction_state, sfs_active),
	(faction_slot_eq, "fac_kingdom_22", slot_faction_flag_material, "str_flag1_22"),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", "fac_kingdom_22", ":faction_russia"), (eq, reg0, -2),
	(ge, "$g_current_year", 1862),
	(call_script, "script_cf_random", 5),
	(call_script, "script_faction_annex_faction", ":faction_russia", "fac_kingdom_22"),
	(str_store_faction_name_link, s1, "fac_kingdom_22"),
	(str_store_faction_name_link, s2, ":faction_russia"),
	(str_store_troop_name, s3, "trp_kingdom_22_lord"),
	(display_message, "@{s1} agrees to become a protectorate! After taking several defeats from {s2}, {s3} signs agreement to become part of {s2}.^^Effects: {s1} becomes part of {s2}"),
	(try_end),
	(try_begin),
	(faction_slot_eq, "fac_kingdom_23", slot_faction_state, sfs_active),
	(faction_slot_eq, "fac_kingdom_23", slot_faction_flag_material, "str_flag1_23"),
	(call_script, "script_diplomacy_faction_get_diplomatic_status_with_faction", "fac_kingdom_23", ":faction_russia"), (eq, reg0, -2),
	(ge, "$g_current_year", 1862),
	(call_script, "script_cf_random", 5),
	(call_script, "script_faction_annex_faction", ":faction_russia", "fac_kingdom_23"),
	(str_store_faction_name_link, s1, "fac_kingdom_23"),
	(str_store_faction_name_link, s2, ":faction_russia"),
	(str_store_troop_name, s3, "trp_kingdom_23_lord"),
	(display_message, "@{s1} agrees to become a protectorate! After taking several defeats from {s2}, {s3} signs agreement to become part of {s2}.^^Effects: {s1} becomes part of {s2}"),
	(try_end),
	(try_begin),
	(eq, "$g_start_date", 1914),
	(eq, "$ww1_status", 0),
	(faction_slot_eq, ":faction_serbia", slot_faction_state, sfs_active),
	(faction_slot_eq, ":faction_austria", slot_faction_state, sfs_active),
	(jump_to_menu, "mnu_ww1_event1"),
	(else_try),
	(eq, "$ww1_status", 1),
	(assign, "$ww1_status", 2),
	(else_try),
	(eq, "$ww1_status", 2),
	(jump_to_menu, "mnu_ww1_event2"),
	(else_try),
	(eq, "$ww1_status", 3),
	(jump_to_menu, "mnu_ww1_event3"),
	(else_try),
	(ge, "$ww1_status", 4),
	(val_add, "$ww1_status", 1),
		(try_begin),
		(eq, "$ww1_status", 6),
		(neq, "$player_faction_preset", "fac_kingdom_5"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_germany", ":faction_belgium", 1),
		(call_script, "script_faction_change_infamy", ":faction_germany", 8),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 7),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_belgium", ":faction_britain_colonies"),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_russia", ":faction_britain_colonies"),
		...
		(call_script, "script_create_alliance_between_factions", ":faction_serbia", ":faction_britain_colonies"),
		...
		(try_begin),
		(eq, "$ww1_status", 50),
		(neq, "$player_faction_preset", "fac_kingdom_27"),
		(faction_slot_eq, ":faction_bulgaria", slot_faction_flag_material, "str_flag1_40"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_bulgaria", ":faction_serbia", 1),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 55),
		(neq, "$player_faction_preset", "fac_kingdom_6"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_turkey", ":faction_russia", 1),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 60),
		(neq, "$player_faction_preset", "fac_kingdom_4"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_italy", ":faction_austria", 1),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 90),
		(neq, "$player_faction_preset", "fac_kingdom_25"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_romania", ":faction_austria", 1),
		(try_end),
		(try_begin),
		(eq, "$ww1_status", 120),
		(neq, "$player_faction_preset", "fac_kingdom_24"),
		(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_greece", ":faction_bulgaria", 1),
		(try_end),
	(try_end),
...
(eq, "$enable_faction_reinforcements_to_player", 1),
	...
	(val_div, ":reinforcements_number", 10), (val_max, ":reinforcements_number", 2),
	(call_script, "script_game_get_party_companion_limit"), (store_sub, ":limit", reg0, 15), (val_sub, ":limit", ":reinforcements_number"),
	(party_get_num_companions, ":companions", "p_main_party"),
	(le, ":companions", ":limit"),
	(faction_get_slot, ":manpower", "$players_kingdom", slot_faction_manpower),
	(val_sub, ":manpower", ":reinforcements_number"),
	(faction_set_slot, "$players_kingdom", slot_faction_manpower, ":manpower"),
	(party_add_members, "p_main_party", ":lineinf", ":reinforcements_number"),
	(assign, reg1, ":reinforcements_number"),
	(str_store_troop_name_by_count, s1, ":lineinf"),
	(display_message, "@Your party is being reinforced by {reg1} {s1}."),
	(faction_get_slot, ":conscription_policy", "$players_kingdom",  slot_faction_conscription_policy),
		(try_begin),
		(eq, ":conscription_policy", conscription_policy_volunteer_army),
		(store_mul, ":xp", ":reinforcements_number", 160),
		(str_store_string, s1, "@Reinforcements are well trained:"),
		(else_try),
		(eq, ":conscription_policy", conscription_policy_limited_conscription),
		(store_mul, ":xp", ":reinforcements_number", 60),
		(str_store_string, s1, "@Reinforcements are sufficiently trained:"),
		(else_try),
		(eq, ":conscription_policy", conscription_policy_extended_conscription),
		(store_mul, ":xp", ":reinforcements_number", 30),
		(str_store_string, s1, "@Reinforcements are poorly trained:"),
		(else_try),
		(store_mul, ":xp", ":reinforcements_number", 2),
		(str_store_string, s1, "@Reinforcements are hardly trained:"),
		(try_end),
	(display_message, "@{s1}"),
	(party_add_xp, "p_main_party", ":xp"),
	(try_end),
	(try_begin),
...
(neg|faction_slot_ge, "fac_player_supporters_faction", slot_faction_budget, 0),
(display_message, "@Your country is bankrupt!", 0xFF0000),
(call_script, "script_faction_change_infamy", "fac_player_supporters_faction", 1),
]),
...
[
	...
	(assign, ":faction_france", "fac_kingdom_1"),
	(try_end),
(ge, "$g_current_year", 1871),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_1"),
		(try_begin),
		(faction_slot_eq, ":faction_france", slot_faction_ruling_political_party, 1),
		(call_script, "script_pps_france_init_post_napoleon_parties", ":faction_france"),
		(call_script, "script_pps_faction_change_government_type", ":faction_france", government_type_republic),
		(display_message, "@Government type was changed to Republic.", 0xFF0000),
		(try_end),
	(else_try),
	(call_script, "script_pps_france_init_post_napoleon_parties", ":faction_france"),
...
[
	...
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_18"),
	(assign, ":faction_denmark", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_denmark", "fac_kingdom_18"),
	(try_end),
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_16"),
	(assign, ":faction_portugal", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_portugal", "fac_kingdom_16"),
	(try_end),
	(try_begin),
	(ge, "$g_current_year", 1882),
	(faction_set_slot, ":faction_denmark", slot_faction_political_party2_name, "str_denmark_liberal_late"),
	(try_end),
	(try_begin),
	(faction_slot_eq, ":faction_portugal", slot_faction_government_type, government_type_republic),
	(faction_set_slot, ":faction_portugal", slot_faction_political_party2_name, "str_portugal_liberal_late"),
	(else_try),
	(faction_set_slot, ":faction_portugal", slot_faction_political_party2_name, "str_portugal_liberal"),
	(try_end),
	(try_begin),
	(ge, "$g_current_year", 1904),
...
(0,
[
(faction_slot_eq, civil_war_dublicate_faction, slot_faction_state, sfs_active),
(faction_slot_ge, civil_war_dublicate_faction, slot_faction_is_dublicate_of, 2),
(faction_get_slot, ":original_faction", civil_war_dublicate_faction, slot_faction_is_dublicate_of),
(faction_slot_eq, ":original_faction", slot_faction_state, sfs_inactive),
(faction_set_slot, civil_war_dublicate_faction, slot_faction_is_dublicate_of, 0),
(faction_set_slot, civil_war_dublicate_faction, slot_faction_state, sfs_inactive),
(faction_set_slot, ":original_faction", slot_faction_state, sfs_active),
	(try_for_range, ":slot", slot_faction_fieldgun_cannoneer_officer, end_of_faction_slots),
	(faction_get_slot, ":slot_value", civil_war_dublicate_faction, ":slot"),
	(faction_set_slot, ":original_faction",  ":slot", ":slot_value"),
	(try_end), 
(faction_get_color, ":color", civil_war_dublicate_faction),
(faction_set_color, ":original_faction", ":color"),
	(try_for_range, ":center", walled_centers_begin, walled_centers_end),
	(store_faction_of_party, ":party_faction", ":center"),
	(eq, ":party_faction", civil_war_dublicate_faction),
	(call_script, "script_give_center_to_faction_aux", ":center", ":original_faction"),
	(try_end),
	(try_for_range, ":troop", lords_begin, lords_end),
	(store_faction_of_troop, ":troop_faction", ":troop"),
	(eq, ":troop_faction", civil_war_dublicate_faction),
	(troop_set_faction, ":troop", ":original_faction"),
	(troop_get_slot, ":lord_party", ":troop", slot_troop_leaded_party),
		(try_begin),
		(neq, ":lord_party", "p_main_party"),
		(party_is_active,":lord_party"),
		(party_set_faction, ":lord_party", ":original_faction"),
		(try_end),
	(try_end),
...
(call_script, "script_remove_lord_from_game", ":dublicate_faction_lord"),
(set_relation, ":original_faction", civil_war_dublicate_faction, 0),
(set_relation, civil_war_dublicate_faction, ":original_faction", 0),
	(try_begin),
	(str_store_faction_name_link, s1, civil_war_dublicate_faction),
	(str_store_faction_name_link, s2, ":original_faction"),
		(try_begin),
		(faction_slot_eq, ":original_faction", slot_faction_government_type, government_type_soviet_republic),
		(assign, "$socialist_revolution_happened", 1),
		(str_store_string, s3, "@ {s1} triumphs over victory of socialist revolution.^Effects: Socialist parties around the worlds gain influence."),
		(else_try),
		(neg|faction_slot_eq, ":original_faction", slot_faction_government_type, government_type_republic),
		(str_store_string, s3, "@ {s1} triumphs over victory against revolutionaries."),
		(try_end),
	(try_end),
(display_message, "@Civil war is over in {s1}! {s2} has been fully defeated.{s3}"),
(str_store_faction_name, s1, civil_war_dublicate_faction),
(faction_set_name, ":original_faction", s1),
	(try_begin),
	(eq, "$players_kingdom", civil_war_dublicate_faction),
	(set_show_messages, 0),
	(call_script, "script_player_leave_faction"),
	(call_script, "script_player_join_faction", ":original_faction"),
	(set_show_messages, 1),
	(try_end),
(call_script, "script_update_faction_notes", ":original_faction"),
(call_script, "script_update_faction_notes", civil_war_dublicate_faction),
]),
...
[
	...
	(gt, ":party", 0),
	(party_is_active, ":party"),
	(get_party_ai_behavior, ":ai_behavior", ":party"),
	(party_get_slot, ":lord_state", ":party", slot_party_pas_lord_state),
	(this_or_next|eq, ":ai_behavior", ai_bhvr_escort_party),
	(eq, ":lord_state", pas_lord_state_following_marshall),
	(party_set_ai_behavior, ":party", ai_bhvr_patrol_location),
	(party_get_position, pos1, ":party"),
	(party_set_ai_target_position, ":party", pos1),
	(party_set_slot, ":party", slot_party_pas_lord_state, pas_lord_state_undefined),
	(try_end),
	(try_for_parties, ":party"),
	(party_get_template_id, ":party_template", ":party"),
	(eq, ":party_template", "pt_pps_rebels"),
	(party_get_slot, ":faction", ":party", slot_party_rebels_faction),
	(ge, ":faction", "fac_player_supporters_faction"),
	(faction_get_slot, ":leader", ":faction", slot_faction_leader),
	(troop_get_slot, ":lord_party", ":leader", slot_troop_leaded_party),
		(try_begin),
		(this_or_next|neq, ":lord_party", "p_main_party"),
		(eq, ":leader", "trp_player"),
		(party_is_active,":lord_party"),
		(party_set_ai_behavior, ":party", ai_bhvr_attack_party),
		(party_set_ai_object, ":party", ":lord_party"),
		...
		(str_store_faction_name, s1, "fac_player_supporters_faction"),
			(try_begin),
			(party_slot_eq, ":party", slot_party_rebels_type, 0),
			(jump_to_menu, "mnu_socialism_rebellion_won"),
			(else_try),
			(party_slot_eq, ":party", slot_party_rebels_type, 1),
			(jump_to_menu, "mnu_liberal_rebellion_won"),
			(try_end),
		(remove_party, ":party"),
		(else_try),
		(party_get_num_prisoner_stacks, ":number_of_stacks", ":party"),
			(try_for_range, ":stack", 0, ":number_of_stacks"),
			(party_is_active, ":party"),
			(party_prisoner_stack_get_troop_id, ":stack_troop", ":party", ":stack"),
			(this_or_next|eq, ":stack_troop", ":leader"),
			(neg|party_is_active,":lord_party"),
				(try_begin),
				(party_slot_eq, ":party", slot_party_rebels_type, 0),
				(call_script, "script_pps_faction_process_event_effect_socialism_rebellion_won",  ":faction", 1),
				(else_try),
				(party_slot_eq, ":party", slot_party_rebels_type, 1),
				(call_script, "script_pps_faction_process_event_effect_liberal_rebellion_won",  ":faction", 1),
				(try_end),
			(remove_party, ":party"),
			(assign, ":stack", ":number_of_stacks"),
			(try_end),
		(try_end),
	(try_end),
]),
