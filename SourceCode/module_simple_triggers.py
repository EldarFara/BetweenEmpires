   ...
   [
	...
	(assign, ":faction", "$async_simple_trigger31"),
		...
		(eq, "$player_faction_preset", "fac_kingdom_2"),
			...
			(assign, ":faction", "fac_player_faction"),
			(try_end),
		(faction_slot_ge, ":faction", slot_faction_technology_skirmishline, 10000),
		...
		(eq, "$player_faction_preset", "fac_kingdom_20"),
			...
			(try_end),
		(faction_slot_ge, ":faction", slot_faction_technology_woundedevacuation, 10000),
		(troop_has_item_equipped, "trp_faction20_troop1", "itm_baf_hat8"),
		(troop_remove_item, "trp_faction20_troop1", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop1", "itm_baf_infantry1"), (troop_remove_item, "trp_faction20_troop1", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop2", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop2", "itm_baf_infantry1"), (troop_remove_item, "trp_faction20_troop2", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop3", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop3", "itm_baf_infantry1"), (troop_remove_item, "trp_faction20_troop3", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop4", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop4", "itm_baf_infantry1"), (troop_remove_item, "trp_faction20_troop4", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop5", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop5", "itm_baf_infantry2"), (troop_remove_item, "trp_faction20_troop5", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop6", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop6", "itm_baf_infantry2"), (troop_remove_item, "trp_faction20_troop6", "itm_baf_trousers1"),
		(troop_remove_item, "trp_faction20_troop7", "itm_baf_hat8"), (troop_remove_item, "trp_faction20_troop7", "itm_baf_infantry2"), (troop_remove_item, "trp_faction20_troop7", "itm_baf_trousers1"),
