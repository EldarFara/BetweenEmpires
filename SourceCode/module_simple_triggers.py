...
(24,[
	(try_for_range, ":faction", npc_kingdoms_begin, npc_kingdoms_end),
		...
		(store_random_in_range, ":random", 0, "$g_game_speed"), (eq, ":random", 0),
		(faction_set_slot, ":faction",  ":slot_technology", 10000),
		#(assign,  reg0, ":slot_technology"),
		#(str_store_faction_name, s1, ":faction"), (display_message, "@{s1} invented technology #{reg0}", 0x8ae2ff),
		(try_end),
	(try_end),
]), 
(24,[
...
[
	...
	(call_script, "script_faction_annex_faction", "fac_player_supporters_faction", "fac_kingdom_4", 0),
	...
	(val_sub, ":slot_war_damage_suffered", kingdoms_begin),
	(faction_get_slot, ":war_damage_suffered", "fac_player_supporters_faction", ":slot_war_damage_suffered"),
# (faction_get_slot, reg1, "fac_player_supporters_faction", ":slot_war_damage_suffered"),
# (display_message, "@{reg1}"),
	(this_or_next|faction_slot_eq, "fac_kingdom_11", slot_faction_state, sfs_inactive),
	(ge, ":war_damage_suffered", 80),
	(call_script, "script_faction_annex_faction", "fac_player_supporters_faction", "fac_kingdom_11", 0),
	(complete_quest, "qst_italy_unification_defeat_sicily"),
	(str_store_faction_name, s1, "fac_player_supporters_faction"),
	(str_store_faction_name, s2, "fac_kingdom_11"),
	(str_store_troop_name, s3, "trp_player"),
	(jump_to_menu,"mnu_italian_unification"),
	(try_end),
	(try_begin),
	...
	(ge, ":war_damage_suffered", 80),
	(call_script, "script_faction_annex_faction", "fac_player_supporters_faction", "fac_kingdom_19", 0),
	(complete_quest, "qst_italy_unification_defeat_papalstates"),
	(str_store_faction_name, s1, "fac_player_supporters_faction"),
	(str_store_faction_name, s2, "fac_kingdom_19"),
	(str_store_troop_name, s3, "trp_player"),
	(jump_to_menu,"mnu_italian_unification"),
	(try_end),
