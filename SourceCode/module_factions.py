...
("kingdom_25",  "Principality_of_Wallachia_and_Moldavia", 0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("kingdom_7",0.1),("kingdom_10",0.1),("kingdom_11",0.1),("mountain_bandits", -0.05),("kingdom_26",-0.2),("kingdom_15",-0.2),("kingdom_9",-0.2),("forest_bandits", 0)], [], 8342049),
