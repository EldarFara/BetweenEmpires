  ...
  ("start_phase_2",mnf_disable_all_keys,
	...
	(ge, "$g_current_year", 1875),
		...
		(party_get_slot, ":population", ":center", slot_center_population),
			...
			(val_mul, ":urbanization", 108), (val_div, ":urbanization", 100),
		...
		(assign, ":chance", 0),
			...
			(assign, ":chance", preset_factory_slots_filling_percent_britain),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_8"),
			(eq, ":faction", "fac_kingdom_26"),
			(assign, ":chance", preset_factory_slots_filling_percent_benelux),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_1"),
			(eq, ":faction", "fac_kingdom_13"),
			(assign, ":chance", preset_factory_slots_filling_percent_france),
			(else_try),
			(eq, ":faction", "fac_kingdom_2"),
			(assign, ":chance", preset_factory_slots_filling_percent_russia),
			(else_try),
			(eq, ":faction", "fac_kingdom_3"),
			(assign, ":chance", preset_factory_slots_filling_percent_austria),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_6"),
			(eq, ":faction", "fac_kingdom_24"),
			(assign, ":chance", preset_factory_slots_filling_percent_balkans),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_5"),
			(this_or_next|eq, ":faction", "fac_kingdom_27"),
			(this_or_next|eq, ":faction", "fac_kingdom_30"),
			(eq, ":faction", "fac_kingdom_31"),
			(assign, ":chance", preset_factory_slots_filling_percent_germany),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_29"),
			(eq, ":faction", "fac_kingdom_18"),
			(assign, ":chance", preset_factory_slots_filling_percent_scandinavia),
			(else_try),
			(this_or_next|eq, ":faction", "fac_kingdom_4"),
			(this_or_next|eq, ":faction", "fac_kingdom_11"),
			(eq, ":faction", "fac_kingdom_19"),
			(assign, ":chance", preset_factory_slots_filling_percent_italy),
			(try_end),
			(try_begin),
			(ge, "$g_current_year", 1890),
			(val_div, ":chance", 4),
