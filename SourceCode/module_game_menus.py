...
##        ]),
	...
	#	(troop_add_item, "trp_player","itm_adventurer_amab1",0),
	#	(troop_add_item, "trp_player","itm_adventurer_amab_trousers1",0),
           (else_try),
	#	(troop_add_item, "trp_player","itm_adventurer_afab1",0),
	#	(troop_add_item, "trp_player","itm_adventurer_afab_trousers1",0),
