...
game_menus = [
  ...
  ("start_phase_2",mnf_disable_all_keys,
	...
	(eq, "$g_current_year", 1875),
		...
		(faction_set_slot, ":faction",  slot_faction_technology_riflesconverted, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_riflessmallcaliber, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_earlyshells, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_medicinecrimeanwar, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_cannonsrifling, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_conscription, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_acwexperience, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_ammoincrease, 10000),
		(faction_set_slot, ":faction",  slot_faction_technology_shootingtraining, 10000),
		(try_end),
	(try_end),
