...
game_menus = [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    ...
    "none",
    [
	(call_script, "script_game_start_second"),
	],
    [
      ("town_factionleader",[
	  (neq, "$player_faction_preset", -1),
	(faction_get_slot, "$g_starting_town", "fac_player_supporters_faction", slot_faction_capital),
...
(neq, "$player_faction_preset", "fac_kingdom_2"),],"Saint Petersburg.",
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),
(neq, "$player_faction_preset", "fac_kingdom_2"),],"Constantinople.",
       [
...
##      ]),
  ...
  ("reports",0,
   ...
   [
	...
	(str_store_string, s50, "@Your current rank is {s1}.^^Current points/points needed for promotion: {reg10}/{reg11}"),
	(try_end),
	(try_begin),
...
##        ]),
	...
	(troop_add_item, "trp_player","itm_bread",0),	
		...
		(troop_add_item, "trp_player","itm_clothes_urban_male5",0),
		(troop_add_item, "trp_player","itm_clothes_urban_male_trousers4",0),
		(else_try),
  ...
  ("camp_cheat",0,
   ...
   [
	...
	(try_end),
      ...
      ("camp_cheat_20_pes_pps_iterations",[], "Simulate 20 PES/PPS iterations.",
       [
	...
	(try_for_range, ":faction", "fac_player_faction", kingdoms_end),
		(try_for_range, ":technology", slot_faction_technology_modernattack, slot_faction_technology_riflesrifled+1),
	...
	(try_end),
      ...
      ("camp_cheat_6",[],"{!}Infinite camp",
       [
         ...
         (assign, "$g_player_icon_state", pis_camping),
         (rest_for_hours_interactive, 10 * 24 * 365, 5), #10 year rest while not attackable with 20x speed
         (change_screen_return),
        ]
       ),	   
...
(start_presentation, "prsnt_prebattle_custom_deployment"),
	...
	("camp_action_pas_enlistment_retire", [(gt, "$players_kingdom", "fac_player_supporters_faction"),],"Retire from service.",
       [
          ...
          (try_for_range, ":stack_no", "$last_defeated_hero", ":num_stacks"), #May 31 bug note -- this now returns some heroes in victorious party as well as in the other party
			...
			(else_try),
              ...
              (str_store_string, s17, "@{s1} of {s3} managed to escape."),
			   (call_script, "script_faction_inflict_war_damage_on_faction", "fac_player_supporters_faction", ":defeated_faction", 3),
...
#          (assign, "$waiting_for_arena_fight_result", 0),
        ...
        (try_begin), # same mnu_town
          ...
          (try_begin),
            ...
            (str_store_string,s11,"@ Your nation flag flies over the fort gate."),
          (else_try),
            (ge, ":center_lord", 0),
            (str_store_string,s11,"@ You see the banner of {s7} over the fort gate."),
          (else_try),
...
(music_set_situation, mtf_situation_siege_attacker_preparing),
      ...
      ("castle_cheat_interior",[(eq, "$cheat_mode", 1)], "{!}CHEAT! Interior.",[(set_jump_mission,"mt_ai_training"),
                                                       ...
                                                       (change_screen_mission)]),
      ("castle_cheat_town_european_walls2",[(eq, "$cheat_mode", 1)], "{!}CHEAT! town_european_walls1",[
                                                       (set_jump_mission,"mt_ai_training"),
                                                       (jump_to_scene,"scn_town_european_walls"),
                                                       (change_screen_mission)]),
      ("castle_cheat_town_european_walls2",[(eq, "$cheat_mode", 1)], "{!}CHEAT! town_european_walls2",[
                                                       (set_jump_mission,"mt_ai_training"),
                                                       (jump_to_scene,"scn_town_european_walls2"),
                                                       (change_screen_mission)]),
      ("castle_cheat_town_european_walls2",[(eq, "$cheat_mode", 1)], "{!}CHEAT! town_european_walls3",[
                                                       (set_jump_mission,"mt_ai_training"),
                                                       (jump_to_scene,"scn_town_european_walls3"),
                                                       (change_screen_mission)]),
      ...
      ("castle_cheat_town_european_walls5",[(eq, "$cheat_mode", 1)], "{!}CHEAT! town_european_walls5",[
                                                       ...
                                                       (change_screen_mission)]),
      ("castle_cheat_town_european_walls6",[(eq, "$cheat_mode", 1)], "{!}CHEAT! town_european_walls6",[
                                                       (set_jump_mission,"mt_ai_training"),
   ...
   (
    ...
    [
      ...
      ("build_ladders",[(party_slot_eq, "$current_town", slot_center_siege_with_belfry, 0),(eq, "$g_siege_method", 0)],
       "Prepare to attack the town.", [(jump_to_menu,"mnu_construct_ladders")]),
...
# TODO: To use for the future:
 ...
 You'll have to deal with them before you can attack the keep at the heart of the town."),
          (else_try),
            ...
            (eq, ":result", 1),
            (str_store_string, s1, "@The town is yours,\
...
##           (set_battle_advantage, reg0),
 ...
 {reg4} hours to prepare for the assault.",
    "none",
...
##        (else_try),
	 ...
	 #          (val_add, ":prosperity", 5),
        ...
        (try_begin),
		  ...
		  (else_try),
            (ge, ":center_lord", 0),
            (str_store_string,s11,"@ You see the flag of {s7} over the fort gate."),
          (else_try),
...
(party_get_current_terrain, ":terrain_type", "p_main_party"),
  ...
  (
	...
	(faction_set_name, "fac_kingdom_2", "@Russian Empire"),
	...
	(faction_set_name, "fac_kingdom_6", "@Ottoman_Empire"),
	(faction_set_name, "fac_kingdom_10", "@Emirate_of_Tunisia"),
	(faction_set_name, "fac_kingdom_11", "@Kingdom of Two Sicilies"),
	(faction_set_name, "fac_kingdom_14", "@Khedivate_of_Egypt"),
	(faction_set_name, "fac_kingdom_15", "@Sultanate_of_Morocco"),
	(faction_set_name, "fac_kingdom_17", "@Sultanate_of_Oman"),
	(faction_set_name, "fac_kingdom_16", "@Kingdom of Portugal"),
	(faction_set_name, "fac_kingdom_19", "@Papal States"),
	(faction_set_name, "fac_kingdom_23", "@Khanate_of_Khiva"),
	...
	(faction_set_name, "fac_kingdom_30", "@Kingdom_of_Bavaria"),
	...
	(faction_set_name, "fac_kingdom_4", "@Kingdom_of_Sardinia"),
	(faction_set_name, "fac_kingdom_5", "@Kingdom of Prussia"),
	(faction_set_name, "fac_kingdom_32", "@Emirate_of_Shammar"),
	(faction_set_name, "fac_kingdom_33", "@Emirate_of_Najd"),
	(call_script, "script_change_faction_flag", "fac_kingdom_2", 2),
	(call_script, "script_change_faction_flag", "fac_kingdom_3", 3),
	(call_script, "script_change_faction_flag", "fac_kingdom_5", 5),
	(call_script, "script_change_faction_flag", "fac_kingdom_10", 10),
	(call_script, "script_change_faction_flag", "fac_kingdom_11", 11),
	(call_script, "script_change_faction_flag", "fac_kingdom_14", 14),
	(call_script, "script_change_faction_flag", "fac_kingdom_15", 15),
	(call_script, "script_change_faction_flag", "fac_kingdom_16", 16),
	(call_script, "script_change_faction_flag", "fac_kingdom_17", 17),
	(call_script, "script_change_faction_flag", "fac_kingdom_19", 19),
	(call_script, "script_change_faction_flag", "fac_kingdom_23", 23),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 27),
	(call_script, "script_change_faction_flag", "fac_kingdom_28", 28),
	(call_script, "script_change_faction_flag", "fac_kingdom_29", 29),
	(call_script, "script_change_faction_flag", "fac_kingdom_30", 30),
	(call_script, "script_change_faction_flag", "fac_kingdom_31", 31),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 27),
	(call_script, "script_change_faction_flag", "fac_kingdom_32", 32),
	(call_script, "script_change_faction_flag", "fac_kingdom_33", 33),
	   (jump_to_menu, "mnu_start_game_speed_selection"),
        ]
		),
	...
	(faction_set_name, "fac_kingdom_16", "@Kingdom of Portugal"),
	(faction_set_name, "fac_kingdom_19", "@Papal States"),
	(faction_set_name, "fac_kingdom_22", "@Emirate_of_Bukhara"),
	(faction_set_name, "fac_kingdom_23", "@Khanate_of_Khiva"),
	(faction_set_name, "fac_kingdom_25", "@Romanian Principalities"),
	...
	(call_script, "script_change_faction_flag", "fac_kingdom_17", 17),
	(call_script, "script_change_faction_flag", "fac_kingdom_19", 19),
	(call_script, "script_change_faction_flag", "fac_kingdom_22", 22),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 27),
	(call_script, "script_change_faction_flag", "fac_kingdom_28", 28),
	(call_script, "script_change_faction_flag", "fac_kingdom_29", 29),
	(call_script, "script_change_faction_flag", "fac_kingdom_30", 30),
	...
	(faction_set_name, "fac_kingdom_28", "@Kingdom of Serbia"),
	(faction_set_name, "fac_kingdom_30", "@Kingdom of Norway"),
	(faction_set_name, "fac_kingdom_31", "@Kingdom_of_Hannover"),
	(faction_set_name, "fac_kingdom_32", "@Emirate_of_Shammar"),
	(faction_set_name, "fac_kingdom_33", "@Emirate_of_Najd"),
	(call_script, "script_change_faction_flag", "fac_kingdom_2", 70),
	(call_script, "script_change_faction_flag", "fac_kingdom_3", 35),
	(call_script, "script_change_faction_flag", "fac_kingdom_5", 36),
	(call_script, "script_change_faction_flag", "fac_kingdom_10", 10),
	(call_script, "script_change_faction_flag", "fac_kingdom_11", 11),
	...
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 27),
	(call_script, "script_change_faction_flag", "fac_kingdom_28", 28),
	(call_script, "script_change_faction_flag", "fac_kingdom_29", 69),
	(call_script, "script_change_faction_flag", "fac_kingdom_30", 68),
	(call_script, "script_change_faction_flag", "fac_kingdom_31", 31),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 40),
	(call_script, "script_change_faction_flag", "fac_kingdom_32", 32),
	(call_script, "script_change_faction_flag", "fac_kingdom_33", 33),
	...
	(faction_set_name, "fac_kingdom_15", "@Sultanate_of_Morocco"),
	(faction_set_name, "fac_kingdom_17", "@Sultanate_of_Oman"),
	(faction_set_name, "fac_kingdom_16", "@Republic of Portugal"),
	(faction_set_name, "fac_kingdom_19", "@Papal States"),
	(faction_set_name, "fac_kingdom_23", "@Khanate_of_Khiva"),
	(faction_set_name, "fac_kingdom_25", "@Kingdom of Romania"),
	(faction_set_name, "fac_kingdom_27", "@Kingdom of Bulgaria"),
	...
	(call_script, "script_change_faction_flag", "fac_kingdom_14", 14),
	(call_script, "script_change_faction_flag", "fac_kingdom_15", 15),
	(call_script, "script_change_faction_flag", "fac_kingdom_16", 91),
	(call_script, "script_change_faction_flag", "fac_kingdom_17", 17),
	(call_script, "script_change_faction_flag", "fac_kingdom_19", 19),
	(call_script, "script_change_faction_flag", "fac_kingdom_22", 22),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 40),
	...
	(jump_to_menu, "mnu_start_game_speed_selection"),
      ...
      ("start_game_choose_date_1919",[],"1919",
       [
	(assign, "$g_current_year", 1919),
	(faction_set_name, "fac_kingdom_1", "@French Republic"),
	(faction_set_name, "fac_kingdom_2", "@White Movement"),
	(faction_set_name, "fac_kingdom_3", "@Austrian Republic"),
	(faction_set_name, "fac_kingdom_4", "@Kingdom of Italy"),
	(faction_set_name, "fac_kingdom_5", "@Weimar Republic"),
	(faction_set_name, "fac_kingdom_6", "@Ottoman Empire"),
	(faction_set_name, "fac_kingdom_10", "@Kingdom of Hungary"),
	(faction_set_name, "fac_kingdom_11", "@Polish Republic"),
	(faction_set_name, "fac_kingdom_14", "@Lithaunian Republic"),
	(faction_set_name, "fac_kingdom_15", "@Latvian Republic"),
	(faction_set_name, "fac_kingdom_17", "@Estonian Republic"),
	(faction_set_name, "fac_kingdom_16", "@Republic of Portugal"),
	(faction_set_name, "fac_kingdom_19", "@Czechoslovak Republic"),
	(faction_set_name, "fac_kingdom_22", "@Soviet Russia"),
	(faction_set_name, "fac_kingdom_25", "@Kingdom of Romania"),
	(faction_set_name, "fac_kingdom_27", "@Kingdom of Bulgaria"),
	(faction_set_name, "fac_kingdom_28", "@Kingdom of Yugoslavia"),
	(faction_set_name, "fac_kingdom_30", "@Kingdom of Norway"),
	(faction_set_name, "fac_kingdom_31", "@Principality of Albania"),
	(faction_set_name, "fac_kingdom_32", "@Ukrainian People's Republic"),
	(faction_set_name, "fac_kingdom_33", "@Irish Republic"),
	(call_script, "script_change_faction_flag", "fac_kingdom_2", 34),
	(call_script, "script_change_faction_flag", "fac_kingdom_3", 43),
	(call_script, "script_change_faction_flag", "fac_kingdom_5", 85),
	(call_script, "script_change_faction_flag", "fac_kingdom_10", 96),
	(call_script, "script_change_faction_flag", "fac_kingdom_11", 41),
	(call_script, "script_change_faction_flag", "fac_kingdom_14", 97),
	(call_script, "script_change_faction_flag", "fac_kingdom_15", 98),
	(call_script, "script_change_faction_flag", "fac_kingdom_16", 91),
	(call_script, "script_change_faction_flag", "fac_kingdom_17", 99),
	(call_script, "script_change_faction_flag", "fac_kingdom_19", 95),
	(call_script, "script_change_faction_flag", "fac_kingdom_22", 71),
	(call_script, "script_change_faction_flag", "fac_kingdom_27", 40),
	(call_script, "script_change_faction_flag", "fac_kingdom_28", 64),
	(call_script, "script_change_faction_flag", "fac_kingdom_29", 69),
	(call_script, "script_change_faction_flag", "fac_kingdom_30", 68),
	(call_script, "script_change_faction_flag", "fac_kingdom_31", 63),
	(call_script, "script_change_faction_flag", "fac_kingdom_32", 42),
	(call_script, "script_change_faction_flag", "fac_kingdom_33", 50),
	(jump_to_menu, "mnu_start_game_speed_selection"),
        ]
		),
      ("go_back",[],"Go back",
...
("game_speed_debug",[(eq,"$cheat_mode",1)],"Debug mode (One year passes in 1 day).",
  ...
  ("cannoneers_store",menu_text_color(0xFF000000)|mnf_disable_all_keys,
	...
	(store_faction_of_party, ":faction", "$g_encountered_party"),
	(faction_slot_ge, ":faction", slot_faction_technology_modernartillery, 10000),
	(faction_get_slot, ":cannoneer_officer", ":faction",  slot_faction_heavyhowitzer_cannoneer_officer),
		(try_begin),
		(gt, ":cannoneer_officer", 0),
			(try_begin),
			(store_troop_gold, ":gold", "trp_player"),
			(ge, ":gold", 3000),
				...
				(display_message, "@You have bought a heavy howizer."),
				(party_add_members, "p_main_party", ":cannoneer_officer", 1),
				(else_try),
				(display_message, "@You have exceeded party size limit."),
				(try_end),
	...
	(store_faction_of_party, ":faction", "$g_encountered_party"),
	(faction_slot_ge, ":faction", slot_faction_technology_machineguns, 10000),
	  ],"Order a machine gun and hire an operator (2500 pounds).",
       [
	(store_faction_of_party, ":faction", "$g_encountered_party"),
	(faction_get_slot, ":cannoneer_officer", ":faction",  slot_faction_mgoperator),
		...
		(gt, ":cannoneer_officer", 0),
			...
			(ge, ":gold", 2500),
				...
				(display_message, "@You have bought a machine gun."),
				(party_add_members, "p_main_party", ":cannoneer_officer", 1),
				(else_try),
				(display_message, "@You have exceeded party size limit."),
				(try_end),
	...
	(jump_to_menu,"mnu_cannoneers_store"),
      ...
      ("cannoneers_store_access_wardrobe",[
		...
		(this_or_next|gt, ":items_begin", 0),
		(eq, "$custom_troops_set", 1),
		...
		(eq, "$custom_troops_set", 1),
			...
			(eq, "$custom_troops_set", 1),
				(try_for_range, ":troop", "trp_kingdom_recruit", "trp_array_a"), 
					...
					(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
					(eq, ":number", 0),
					(troop_add_item, "trp_temp_troop", ":item", 0),
					(try_end),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_lordmodel_0", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_factionplayer_fieldgun_cannoneer_officer", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_factionplayer_howitzer_cannoneer_officer", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_factionplayer_heavyhowitzer_cannoneer_officer", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_factionplayer_fieldgun_cannoneer", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
				(try_for_range, ":slot", ek_head, ek_gloves+1),   
				(troop_get_inventory_slot, ":item", "trp_factionplayer_howitzer_cannoneer", ":slot"),
				(store_item_kind_count, ":number", ":item", "trp_temp_troop"),
				(eq, ":number", 0),
				(troop_add_item, "trp_temp_troop", ":item", 0),
				(try_end),
  ...
  (
	...
	(store_sub, ":slot_number", ":current_research_technology", slot_faction_technology_modernattack),
  ...
  ("enlistment_office_select_class",0,
	...
	("enlistment_office_select_class_cossack", [
	...
	[
		(try_begin),
		(eq, "$g_encountered_party_faction", "fac_kingdom_2"),
		(assign, "$pas_enlistment_player_troop", "trp_faction2_troop13"),
		(else_try),
		(eq, "$g_encountered_party_faction", "fac_kingdom_12"),
		(assign, "$pas_enlistment_player_troop", "trp_faction12_troop13"),
		(try_end),
	(jump_to_menu, "mnu_enlistment_office_enlisted"),
        ]),
	("go_back", [],"Go back.",
  ...
  ("enlistment_office_enlisted",0,
	...
	(assign, "$pas_enlistment_points", reg2),
		(try_begin),
		(faction_get_slot, ":faction_rank", "$g_encountered_party_faction", slot_faction_pas_player_rank),
		(faction_get_slot, ":faction_points", "$g_encountered_party_faction", slot_faction_pas_player_points),
		(ge, ":faction_rank", "$pas_enlistment_rank"),
		(assign, "$pas_enlistment_rank", ":faction_rank"),
		(assign, "$pas_enlistment_points", ":faction_points"),
		(try_end),
		(try_begin),
		(ge, "$pas_enlistment_rank", 5),
		(jump_to_menu, "mnu_enlistment_office_enlisted_officer"),
		(else_try),
		(jump_to_menu, "mnu_enlistment_office_enlisted_soldier"),
		(try_end),
	],
    [
	("go_back", [],"Go back.", []),
	]),
  ("enlistment_office_enlisted_officer",0,
    "You became {s1} of {s2} and are ready to start your service.",
    "none",
    [
	(call_script, "script_pas_enlistment_get_rank_name", s1),
	(str_store_troop_name_plural, s2, "$pas_enlistment_player_troop"),
	],
    [
	("go_back", [],"Go back.",
       [
  ...
  ("enlistment_office_enlisted_soldier",0,
    ...
    "none",
    [
	(assign, "$pas_enlistment_lord", "$pas_enlistment_lord_temp"),
	(call_script, "script_pas_enlistment_get_rank_name", s3),
	...
	(gt, ":item", 1),
		...
		(gt, ":item", 1),
		(set_show_messages, 0),
		(troop_add_item, "trp_player", ":player_item", 0),
		(set_show_messages, 1),
		(try_end),
		(try_begin),
  ...
  ("pas_enlistment_menu",0,
	...
	(gt, ":opponent", 0),
	(str_store_party_name, s1, ":opponent"),
	],"Join battle against {s1}.",
       [
	(troop_get_slot, ":party", "$pas_enlistment_lord", slot_troop_leaded_party),
	(gt, ":party", 0),
	(party_is_active, ":party"),
	(start_encounter, ":party"),
	(change_screen_map),
        ]),
	("pas_enlistment_menu_talk_to_commander", [
	(troop_get_slot, ":party", "$pas_enlistment_lord", slot_troop_leaded_party),
	(gt, ":party", 0),
	(party_is_active, ":party"),
	(party_get_battle_opponent, ":opponent", ":party"),
	...
	("pas_enlistment_menu_continue", [],"Continue service.",
       [
(change_screen_return),
	(try_begin),
	(troop_get_slot, ":party", "$pas_enlistment_lord", slot_troop_leaded_party),
	...
	(party_is_active, ":party"),
	(party_get_battle_opponent, ":opponent", ":party"),
	(assign, "$pas_enlistment_opponent_to_ignore", ":opponent"),
	(assign, "$pas_enlistment_opponent_to_ignore_timer", 100),
	(try_end),
(rest_for_hours_interactive, 24 * 365, 5, 1),
        ]),
	("pas_enlistment_menu_retire", [],"Retire from service.",
       [
(call_script, "script_pas_enlistment_retire"),
(change_screen_return),
        ]),
	]),
  ("pas_enlistment_reassign",0,
    "You are being reassigned to {s1}.",
    "none",
    [ 
	(party_detach, "p_main_party"),
	(call_script, "script_pas_enlistment_get_lord_to_enlist_for_faction", "$players_kingdom"),
		(try_begin),
		(le, reg1, 0),
		(jump_to_menu, "mnu_pas_enlistment_end_service_no_lords"),
		(try_end),
	(gt, reg1, 0),
    ...
    [
	("pas_enlistment_reassign_continue", [],"Continue...",
       [
(change_screen_return),
        ]),
	]),
  ("pas_enlistment_end_service_no_lords",0,
    "All armies were defeated, so you retire from service.",
    "none",
    [ ],
    [
	("pas_enlistment_end_service_no_lords_continue", [],"Continue...",
       [
(call_script, "script_pas_enlistment_retire"),
(change_screen_return),
        ]),
...
(change_screen_return),
  ...
  ("balkanwars_event3",0,
    ...
    [
	("balkanwars_event3_s1", [
	(str_store_string, s1, "@Continue..."),
		(try_begin),
		(eq, "$player_faction_preset", "fac_kingdom_25"),
		(str_store_string, s1, "@Join Serbia and Greece and declare war on Bulgaria."),
		(try_end),
		],"{s1}",
       [
	(try_begin),
	...
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_25"),
	(assign, ":faction_romania", "fac_player_supporters_faction"),
	(else_try),
	(assign, ":faction_romania", "fac_kingdom_25"),
	(try_end),
(call_script, "script_create_alliance_between_factions", ":faction_romania", "fac_kingdom_24"),
(call_script, "script_create_alliance_between_factions", ":faction_romania", "fac_kingdom_28"),
(call_script, "script_diplomacy_start_war_between_kingdoms",  "fac_kingdom_24", ":faction_bulgaria", 1),
(call_script, "script_diplomacy_start_war_between_kingdoms",  ":faction_romania", ":faction_bulgaria", 1),
(call_script, "script_diplomacy_start_war_between_kingdoms",  "fac_kingdom_28", ":faction_bulgaria", 1),
(change_screen_return),
        ]),
	("balkanwars_event3_dont_take_part", [(eq, "$player_faction_preset", "fac_kingdom_25"),],"Don't participate in this war.",
       [
	(try_begin),
	(eq, "$player_faction_preset", "fac_kingdom_27"),
	(assign, ":faction_bulgaria", "fac_player_supporters_faction"),
...
("socialism_rebellion", 0, "Socialist movement uprising!^^With armed elements belonging to the entire spectrum of national politics and open fights and assassinations in the streets of our nation, civil war seems to be inevitable. Socialist militiamen have rallied in the capital and the industrial centres and seem to be set to overthrow the national government, while multiple protests have devolved into outright riots, setting administrative buildings ablaze in an ultimate escalation of tensions.", "none", [], [
...
("liberal_demonstration", 0, "Demonstrations in {s2}!^^The ideals of the ongoing revolution in Europe are spreading. Labour organisers, workers, and large parts of the intelligentsia have been united in protest in the streets of {s2} demanding immediate reformation. Speeches by the leading members of one of the most prolific movements in the city have sent the crowd into outspoken rage, and the governments reaction will decisively influence the results of the day.", "none", [], [
...
("liberal_riot", 0, "Riot in {s2}!^^With the earlier protest crushed by government forces and men and women dead in the street, the movement have come to a violent consensus. Now armed, a large mob is moving towards the government district, ready to enact revenge for the massacre.", "none", [], [
...
("liberal_rebellion", 0, "Liberal movement uprising!^^Rebellion has broken out. Riots having spread all across the streets of the capital and the government has to make an immediate decision. They might quell the rebellion by means of military force or negotiate with the rebels, but any misstep would prove to be disastrous.", "none", [], [
...
("liberal_rebellion_won", 0, "Revolution!^^After defeat of governmental army, the leaders of the revolutionary movement have proclaimed victory. A new constitution is now in the works, with international experts expecting widespread liberal reform and a complete reformation of the government.", "none", [(str_store_faction_name, s1, "fac_player_supporters_faction")], [
("liberal_rebellion_won_option1", [],"Continue fighting, gathering loyal commanders to fight revolutionaries in a civil war.", [(display_message, "@Unable to suppress the revolt, the rebellion has spread to other cities. Society has been split in two, liberals demanding the immediate disposition of the government, and reactionaries calling for the immediate jackbooted obliteration of the liberal rebellion. Martial law has been declared, and Habeas Corpus has made way for summary executions in the streets and villages.", 0xffc760), (call_script, "script_pps_faction_process_event_effect_liberal_rebellion_won",  "fac_player_supporters_faction", 1), (change_screen_return), ]),
