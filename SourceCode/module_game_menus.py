...
game_menus = [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    ...
    [
	(try_begin),
	(ge, "$g_current_year", 1875),
		(try_for_range, ":faction", kingdoms_begin, kingdoms_end),
		(assign, ":number_of_factories", 0),
			(try_begin),
			(assign, ":preset_faction", ":faction"),
			(eq, ":faction", "fac_player_supporters_faction"),
			(gt, "$player_faction_preset", 0),
			(assign, ":preset_faction", "$player_faction_preset"),
			(try_end),
			(try_begin),
			(eq, ":preset_faction", "fac_kingdom_7"),
			(assign, ":number_of_factories", preset_number_of_factories_britain),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_8"),
			(eq, ":preset_faction", "fac_kingdom_26"),
			(assign, ":number_of_factories", preset_number_of_factories_benelux),
			(else_try),
			(eq, ":preset_faction", "fac_kingdom_1"),
			(assign, ":number_of_factories", preset_number_of_factories_france),
			(else_try),
			(eq, ":preset_faction", "fac_kingdom_13"),
			(assign, ":number_of_factories", preset_number_of_factories_switzerland),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_9"),
			(eq, ":preset_faction", "fac_kingdom_16"),
			(assign, ":number_of_factories", preset_number_of_factories_iberia),
			(else_try),
			(eq, ":preset_faction", "fac_kingdom_2"),
			(assign, ":number_of_factories", preset_number_of_factories_russia),
			(else_try),
			(eq, ":preset_faction", "fac_kingdom_3"),
			(assign, ":number_of_factories", preset_number_of_factories_austria),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_6"),
			(eq, ":preset_faction", "fac_kingdom_24"),
			(assign, ":number_of_factories", preset_number_of_factories_balkans),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_5"),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_27"),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_30"),
			(eq, ":preset_faction", "fac_kingdom_31"),
			(assign, ":number_of_factories", preset_number_of_factories_germany),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_29"),
			(eq, ":preset_faction", "fac_kingdom_18"),
			(assign, ":number_of_factories", preset_number_of_factories_scandinavia),
			(else_try),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_4"),
			(this_or_next|eq, ":preset_faction", "fac_kingdom_11"),
			(eq, ":preset_faction", "fac_kingdom_19"),
			(assign, ":number_of_factories", preset_number_of_factories_italy),
			(try_end),
			(try_begin),
			(ge, "$g_current_year", 1914),
			(val_div, ":number_of_factories", 1),
			(else_try),
			(ge, "$g_current_year", 1905),
			(val_div, ":number_of_factories", 2),
			(else_try),
			(ge, "$g_current_year", 1890),
			(val_div, ":number_of_factories", 3),
			(else_try),
			(val_div, ":number_of_factories", 6),
			(try_end),
			(try_for_range, ":center", towns_begin, castles_end),
			(store_faction_of_party, ":center_faction", ":center"),
			(eq, ":center_faction", ":faction"),
			(party_get_slot, ":literacy", ":center", slot_center_literacy),
			(party_get_slot, ":urbanization", ":center", slot_center_urbanization),
			(party_get_slot, ":population", ":center", slot_center_population),
				(try_begin),
				(ge, "$g_current_year", 1914),
				(val_mul, ":literacy", 120), (val_div, ":literacy", 100),
				(val_mul, ":urbanization", 120), (val_div, ":urbanization", 100),
				(val_mul, ":population", 130), (val_div, ":population", 100),
				(else_try),
				(ge, "$g_current_year", 1905),
				(val_mul, ":literacy", 118), (val_div, ":literacy", 100),
				(val_mul, ":urbanization", 115), (val_div, ":urbanization", 100),
				(val_mul, ":population", 125), (val_div, ":population", 100),
				(else_try),
				(ge, "$g_current_year", 1890),
				(val_mul, ":literacy", 115), (val_div, ":literacy", 100),
				(val_mul, ":urbanization", 110), (val_div, ":urbanization", 100),
				(val_mul, ":population", 120), (val_div, ":population", 100),
				(else_try),
				(ge, "$g_current_year", 1875),
				(val_mul, ":literacy", 108), (val_div, ":literacy", 100),
				(val_mul, ":urbanization", 105), (val_div, ":urbanization", 100),
				(val_mul, ":population", 110), (val_div, ":population", 100),
				(try_end),
			(val_min, ":literacy", 8500),
			...
			(store_random_in_range, ":factory_type", resource_ammunition, resource_steel+1),
			(assign, ":current_chance", 60),
				(try_begin),
				(is_between, ":factory_type", resource_ammunition, resource_military_supplies+1),
				(val_div, ":current_chance", 999),
				(try_end),
			(call_script, "script_cf_random", ":current_chance"),
			(gt, ":number_of_factories", 0),
			(val_sub, ":number_of_factories", 1),
			(store_random_in_range, ":workers", 3000, 15000),
			(call_script, "script_pes_create_factory_in_center", ":factory_type", ":center", ":workers"),
			(try_end),
		(try_end),
	(try_end),
	(try_begin),
	...
	(try_end),
	(try_begin),
	(gt, "$g_current_year", 1871),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_22", 100),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_23", 100),
	(try_end),
	(try_begin),
	...
	(try_begin),
	(gt, "$g_current_year", 1871),
	(call_script, "script_give_center_to_faction_aux", "p_castle_139", ":faction"),
	(try_end),
	(try_begin),
	...
	(try_begin),
	(gt, "$g_current_year", 1871),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_27", 50),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_31", 50),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_30", 50),
	(call_script, "script_give_center_to_faction_aux", "p_castle_151", ":faction"),
	(call_script, "script_give_center_to_faction_aux", "p_castle_256", ":faction"),
	(try_end),
	(try_begin),
	...
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_11", 0),
	(call_script, "script_faction_annex_faction", ":faction", "fac_kingdom_19", 0),
	(call_script, "script_give_center_to_faction_aux", "p_town_8", ":faction"),
	(try_end),
	(try_begin),
	...
	(try_end),
	(try_begin),
	(eq, "$g_current_year", 1914),
		(try_for_range, ":faction", "fac_player_faction", kingdoms_end),
			(try_begin),
			(neq, ":faction", "fac_kingdom_10"),
			(neq, ":faction", "fac_kingdom_15"),
			(neq, ":faction", "fac_kingdom_17"),
			(neq, ":faction", "fac_kingdom_22"),
			(neq, ":faction", "fac_kingdom_23"),
			(neq, ":faction", "fac_kingdom_32"),
			(neq, ":faction", "fac_kingdom_33"),
			...
			(faction_set_slot, ":faction",  slot_faction_technology_riflessmallcaliber, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_skirmishline, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_crimeanwar, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_riflesboltactionmodern, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_lateshells, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_riflesboltaction, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_machineguns, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_cannonsbreechloading, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_deepdefence, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_infantrymgtactics, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_coveringfire, 10000),
			...
			(faction_set_slot, ":faction",  slot_faction_technology_antirecoil, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_shocktroops, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_tanks, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_lmgs, 10000),
			(else_try),
			(faction_set_slot, ":faction",  slot_faction_technology_riflesrifled, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_riflesconverted, 10000),
			(faction_set_slot, ":faction",  slot_faction_technology_riflessmallcaliber, 10000),
...
(party_get_current_terrain, ":terrain_type", "p_main_party"),
  ...
  (
	...
	(call_script, "script_change_faction_flag", "fac_kingdom_5", 5),
      ...
      ("start_game_choose_date_1875",[],"1875.",
       [
	(assign, "$g_current_year", 1875),
	...
	(jump_to_menu, "mnu_start_game_ai_party_size_selection"),
      ...
      ("start_game_choose_date_1890",[],"1890.",
       [
	...
	(jump_to_menu, "mnu_start_game_ai_party_size_selection"),
      ...
      ("start_game_choose_date_1905",[],"1905.",
       [
	(assign, "$g_current_year", 1905),
	(faction_set_name, "fac_kingdom_1", "@French Republic"),
	(faction_set_name, "fac_kingdom_3", "@Austria-Hungary"),
	(faction_set_name, "fac_kingdom_4", "@Kingdom of Italy"),
	(faction_set_name, "fac_kingdom_5", "@German Empire"),
