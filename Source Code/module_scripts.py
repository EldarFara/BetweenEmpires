...
(call_script, "script_add_province", 145, 54175, 40375, faction_ottoman),
...
(call_script, "script_add_province", 155, 54625, 40800, faction_romania),
(call_script, "script_add_province", 156, 55400, 40800, faction_romania),
...
(call_script, "script_add_province", 171, 56058, 41829, faction_russia),
(call_script, "script_add_province", 172, 55402, 42772, faction_russia),
(call_script, "script_add_province", 173, 55442, 42748, faction_russia),
(call_script, "script_add_province", 174, 55074, 43346, faction_russia),
(call_script, "script_add_province", 175, 55994, 43208, faction_russia),
(call_script, "script_add_province", 176, 56546, 43024, faction_russia),
(call_script, "script_add_province", 177, 56868, 42656, faction_russia),
(call_script, "script_add_province", 178, 57102, 42344, faction_russia),
(call_script, "script_add_province", 179, 57102, 41876, faction_russia),
(call_script, "script_add_province", 180, 57726, 41681, faction_russia),
(call_script, "script_add_province", 181, 58272, 41837, faction_russia),
(call_script, "script_add_province", 182, 57921, 42383, faction_russia),
(call_script, "script_add_province", 183, 57492, 42929, faction_russia),
(call_script, "script_add_province", 184, 56946, 43436, faction_russia),
(call_script, "script_add_province", 185, 57609, 43319, faction_russia),
(call_script, "script_add_province", 186, 58350, 42812, faction_russia),
(call_script, "script_add_province", 187, 58857, 42188, faction_russia),
(call_script, "script_add_province", 188, 59169, 42539, faction_russia),
(call_script, "script_add_province", 189, 57921, 41057, faction_russia),
(call_script, "script_add_province", 190, 54138, 43475, faction_russia),
(call_script, "script_add_province", 191, 53631, 43826, faction_russia),
(call_script, "script_add_province", 192, 54177, 44177, faction_russia),
(call_script, "script_add_province", 193, 53397, 43163, faction_russia),
(call_script, "script_add_province", 194, 53124, 43553, faction_russia),
(call_script, "script_add_province", 195, 52851, 43826, faction_russia),
(call_script, "script_add_province", 196, 54996, 43865, faction_russia),
(call_script, "script_add_province", 197, 54801, 44333, faction_russia),
(call_script, "script_add_province", 198, 55854, 44957, faction_russia),
(call_script, "script_add_province", 199, 55542, 44372, faction_russia),
(call_script, "script_add_province", 200, 56400, 44294, faction_russia),
(call_script, "script_add_province", 201, 56244, 43748, faction_russia),
...
(call_script, "script_add_province", 209, 55876, 47201, faction_russia),
(call_script, "script_add_province", 210, 55369, 47201, faction_russia),
(call_script, "script_add_province", 211, 55837, 47747, faction_russia),
(call_script, "script_add_province", 212, 55096, 47669, faction_russia),
(call_script, "script_add_province", 213, 55408, 48215, faction_russia),
(call_script, "script_add_province", 214, 54550, 49307, faction_russia),
(call_script, "script_add_province", 215, 54745, 48371, faction_russia),
(call_script, "script_add_province", 216, 53770, 47630, faction_russia),
(call_script, "script_add_province", 217, 54433, 47396, faction_russia),
(call_script, "script_add_province", 218, 53926, 46889, faction_russia),
(call_script, "script_add_province", 219, 54589, 46889, faction_russia),
(call_script, "script_add_province", 220, 54277, 50204, faction_sweden),
(call_script, "script_add_province", 221, 51859, 49463, faction_sweden),
(call_script, "script_add_province", 222, 50611, 48059, faction_sweden),
(call_script, "script_add_province", 223, 50416, 47201, faction_sweden),
(call_script, "script_add_province", 224, 50221, 46733, faction_sweden),
(call_script, "script_add_province", 225, 49649, 46337, faction_sweden),
(call_script, "script_add_province", 226, 49297, 47041, faction_sweden),
(call_script, "script_add_province", 227, 49737, 47657, faction_sweden),
(call_script, "script_add_province", 228, 52993, 49109, faction_sweden),
(call_script, "script_add_province", 229, 52377, 48405, faction_sweden),
(call_script, "script_add_province", 230, 51805, 47877, faction_sweden),
(call_script, "script_add_province", 231, 51717, 46997, faction_sweden),
(call_script, "script_add_province", 232, 52333, 46513, faction_sweden),
(call_script, "script_add_province", 233, 51761, 46205, faction_sweden),
(call_script, "script_add_province", 234, 51101, 46337, faction_sweden),
(call_script, "script_add_province", 235, 51321, 45721, faction_sweden),
