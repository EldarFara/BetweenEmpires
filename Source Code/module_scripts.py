...
(sss, s1, "@Lanfang Republic"), (sss, s2, "@Kongsi"), (sss, s3, "@faction_flag_lanfang"), (sss, s4, "@faction_color_lanfang"), (sss, s5, "@Lanfang"), (call_script, "script_add_faction", faction_lanfang),
...
(sss, s1, "@Oualata Tribes"), (sss, s2, "@Oualata"), (sss, s3, "@faction_flag_oualata"), (sss, s4, "@faction_color_oualata"), (sss, s5, "@Tuaregs"), (call_script, "script_add_faction", faction_oualata),
(sss, s1, "@Sahrawi Tribes"), (sss, s2, "@Sahrawi"), (sss, s3, "@faction_flag_sahrawi"), (sss, s4, "@faction_color_sahrawi"), (sss, s5, "@Berbers"), (call_script, "script_add_faction", faction_sahrawi),
(sss, s1, "@Papuan Tribes"), (sss, s2, "@Papua"), (sss, s3, "@faction_flag_papua"), (sss, s4, "@faction_color_papua"), (sss, s5, "@Papuan"), (call_script, "script_add_faction", faction_papua),
(sss, s1, "@Kingdom of Fiji"), (sss, s2, "@Fiji"), (sss, s3, "@faction_flag_fiji"), (sss, s4, "@faction_color_fiji"), (sss, s5, "@Fijian"), (call_script, "script_add_faction", faction_fiji),
(sss, s1, "@Kingdom of Tonga"), (sss, s2, "@Tonga"), (sss, s3, "@faction_flag_tonga"), (sss, s4, "@faction_color_tonga"), (sss, s5, "@Tongan"), (call_script, "script_add_faction", faction_tonga),
