...
(store_script_param, ":string", 2),
    ...
    (sss, ":string", "@Republic"),
    (else_try),
    (eq, ":government_type", government_type_council_republic),
    (sss, ":string", "@Council republic"),
    (else_try),
    (eq, ":government_type", government_type_tribal_union),
    (sss, ":string", "@Tribal union"),
    (else_try),
    (eq, ":government_type", government_type_fascist_dictatorship),
    (sss, ":string", "@Fascist dictatorship"),
    (try_end),
]),
