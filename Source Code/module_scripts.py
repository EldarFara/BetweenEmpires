...
# parameters that are dependant on starting date
    ...
    (array_set_val, "$factions", 11.9*10000, faction_denmark, faction_urbanization),
    ...
    (array_set_val, "$factions", 12.7*10000, faction_serbia, faction_urbanization),
    ...
    (array_set_val, "$factions", 7.8*10000, faction_bukhara, faction_urbanization),
    ...
    (array_set_val, "$factions", 1.1*10000, faction_oman, faction_urbanization),
    ...
    (array_set_val, "$factions", 12.9*10000, faction_trucial, faction_urbanization),
    ...
    (array_set_val, "$factions", 29.9*10000, faction_qatar, faction_urbanization),
    ...
    (array_set_val, "$factions", 13.4*10000, faction_afghanistan, faction_urbanization),
    ...
    (array_set_val, "$factions", 18.9*10000, faction_durrani, faction_urbanization),
    ...
    (array_set_val, "$factions", 9.6*10000, faction_nepal, faction_urbanization),
    ...
    (array_set_val, "$factions", 5.8*10000, faction_rajput, faction_literacy),
    ...
    (array_set_val, "$factions", 6.9*10000, faction_hyderabad, faction_urbanization),
    ...
    (array_set_val, "$factions", 10.7*10000, faction_mysore, faction_urbanization),
    (array_set_val, "$factions", 7973000, faction_oudh, faction_population),
    (array_set_val, "$factions", 9.2*10000, faction_mysore, faction_literacy),
    (array_set_val, "$factions", 8.4*10000, faction_mysore, faction_urbanization),
    ...
    (array_set_val, "$factions", 9.1*10000, faction_kalat, faction_urbanization),
