...
(call_script, "script_add_province", 44, 1, 1, faction_spain),
(call_script, "script_add_province", 45, 1, 1, faction_spain),
(call_script, "script_add_province", 46, 1, 1, faction_spain),
(call_script, "script_add_province", 47, 1, 1, faction_spain),
(call_script, "script_add_province", 48, 1, 1, faction_spain),
(call_script, "script_add_province", 49, 1, 1, faction_spain),
(call_script, "script_add_province", 50, 1, 1, faction_spain),
(call_script, "script_add_province", 51, 1, 1, faction_spain),
(call_script, "script_add_province", 52, 1, 1, faction_spain),
(call_script, "script_add_province", 53, 1, 1, faction_spain),
(call_script, "script_add_province", 54, 1, 1, faction_spain),
(call_script, "script_add_province", 55, 1, 1, faction_spain),
(call_script, "script_add_province", 56, 1, 1, faction_spain),
(call_script, "script_add_province", 57, 1, 1, faction_spain),
(call_script, "script_add_province", 58, 1, 1, faction_britain),
(call_script, "script_add_province", 59, 1, 1, faction_portugal),
(call_script, "script_add_province", 60, 1, 1, faction_portugal),
(call_script, "script_add_province", 61, 1, 1, faction_portugal),
(call_script, "script_add_province", 62, 1, 1, faction_portugal),
# parameters that are dependant on starting date
