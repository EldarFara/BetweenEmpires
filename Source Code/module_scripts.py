...
(sss, s1, "@Kingdom of Sardinia"), (sss, s2, "@Sardinia"), (sss, s3, "@faction_flag_italy"), (sss, s4, "@faction_color_italy"), (call_script, "script_add_faction", faction_italy),
(sss, s1, "@Austrian Empire"), (sss, s2, "@Austria"), (sss, s3, "@faction_flag_austria"), (sss, s4, "@faction_color_austria"), (call_script, "script_add_faction", faction_austria),
(sss, s1, "@State of the Church"), (sss, s2, "@Papal Sates"), (sss, s3, "@faction_flag_papal"), (sss, s4, "@faction_color_papal"), (call_script, "script_add_faction", faction_papal),
(sss, s1, "@Duchy of Parma and Piacenza"), (sss, s2, "@Parma"), (sss, s3, "@faction_flag_parma"), (sss, s4, "@faction_color_parma"), (call_script, "script_add_faction", faction_parma),
(sss, s1, "@Grand Duchy of Tuscany"), (sss, s2, "@Tuscany"), (sss, s3, "@faction_flag_tuscany"), (sss, s4, "@faction_color_tuscany"), (call_script, "script_add_faction", faction_tuscany),
(sss, s1, "@Kingdom of Two Sicilies"), (sss, s2, "@Two Sicilies"), (sss, s3, "@faction_flag_sicily"), (sss, s4, "@faction_color_sicily"), (call_script, "script_add_faction", faction_sicily),
(sss, s1, "@Kingdom of Prussia"), (sss, s2, "@Prussia"), (sss, s3, "@faction_flag_prussia"), (sss, s4, "@faction_color_prussia"), (call_script, "script_add_faction", faction_prussia),
(sss, s1, "@Kingdom of Bavaria"), (sss, s2, "@Bavaria"), (sss, s3, "@faction_flag_bavaria"), (sss, s4, "@faction_color_bavaria"), (call_script, "script_add_faction", faction_bavaria),
(sss, s1, "@Kingdom of Hanover"), (sss, s2, "@Hanover"), (sss, s3, "@faction_flag_hanover"), (sss, s4, "@faction_color_hanover"), (call_script, "script_add_faction", faction_hanover),
(sss, s1, "@Kingdom of Saxony"), (sss, s2, "@Saxony"), (sss, s3, "@faction_flag_saxony"), (sss, s4, "@faction_color_saxony"), (call_script, "script_add_faction", faction_saxony),
(sss, s1, "@Kingdom of Wurttemberg"), (sss, s2, "@Wurttemberg"), (sss, s3, "@faction_flag_wurttemberg"), (sss, s4, "@faction_color_wurttemberg"), (call_script, "script_add_faction", faction_wurttemberg),
(sss, s1, "@Electorate of Hesse"), (sss, s2, "@Hesse"), (sss, s3, "@faction_flag_hesse"), (sss, s4, "@faction_color_hesse"), (call_script, "script_add_faction", faction_hesse),
(sss, s1, "@Grand Duchy of Mecklenburg-Schwerin"), (sss, s2, "@Mecklenburg"), (sss, s3, "@faction_flag_mecklenburg"), (sss, s4, "@faction_color_mecklenburg"), (call_script, "script_add_faction", faction_mecklenburg),
(sss, s1, "@Grand Duchy of Oldenburg"), (sss, s2, "@Oldenburg"), (sss, s3, "@faction_flag_oldenburg"), (sss, s4, "@faction_color_oldenburg"), (call_script, "script_add_faction", faction_oldenburg),
(sss, s1, "@Kingdom of Denmark"), (sss, s2, "@Denmark"), (sss, s3, "@faction_flag_denmark"), (sss, s4, "@faction_color_denmark"), (call_script, "script_add_faction", faction_denmark),
