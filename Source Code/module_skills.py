...
# #######################################################################
# ("skill_id", "skill_name_string", flags, max_level ,"skill_desc_string"),
#
#  Each skill contains the following fields:
#  1) Skill id (string): used for referencing skills in other files. 
#		The prefix skl_ is automatically added before each skill-id .
#  2) Skill name (string).
#  3) Skill flags (int). See header_skills.py for a list of available flags
#  4) Maximum level of the skill (int). Max of 10 or 15 depending.
...
# #######################################################################
# Essentially leave them alone, or to add one, overwrite an unused one.
# #######################################################################
