...
void main()
{
	...
	VSOut = vs_main_standart_face_mod(CURRENT_PCF_MODE, false, vec4(inPosition, 1.0), inNormal, inTexCoord, inTangent, inBinormal, inColor0, inBlendWeight, inBlendIndices);
