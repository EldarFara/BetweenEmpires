...
void main()
{
	...
	VSOut = vs_main_standart(vec4(inPosition, 1.0), inTexCoord, inNormal, inColor0, inTangent, inBinormal, inBlendWeight, inBlendIndices, CURRENT_PCF_MODE, false, true, 0);
