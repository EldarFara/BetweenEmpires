...
void main()
{
	VS_OUTPUT_MAP_MOUNTAIN_BUMP VSOut;
	VSOut = vs_map_mountain_bump(CURRENT_PCF_MODE, vec4(inPosition, 1.0), inNormal, inTangent, inBinormal, inTexCoord, inColor0, inColor1);
